...
const mvEXT2_BG_INODE_ZEROED = 4
...
func sie2fs_fill_random(cgtls *iqlibc.ppTLS, aabuf ppuintptr, aalen tnsize_t) {

	var aai tnsize_t
	var aap ppuintptr
	var aaseed ppuint64
	pp_, pp_, pp_ = aai, aap, aaseed
	aap = aabuf
	aaseed = iqlibc.ppUint64FromInt64(Xtime(cgtls, iqlibc.ppUintptrFromInt32(0))) ^ ppuint64(aabuf)
	aai = ppuint64(0)
	for {
		if !(aai < aalen) {
			break
		}
		aaseed = ppuint64(ppuint64(aaseed)*ppuint64(6364136223846793005) + ppuint64(1442695040888963407))
		*(*ppuint8)(iqunsafe.ppPointer(aap + ppuintptr(aai))) = ppuint8(aaseed >> iqlibc.ppInt32FromInt32(33))
...
func si_e2fs_dirname(cgtls *iqlibc.ppTLS, aapath ppuintptr) (cgr ppuintptr) {

	var aalast ppuintptr
	pp_ = aalast
	...
	*(*ppint8)(iqunsafe.ppPointer(aalast)) = ppint8('\000')
	return aapath
}

func si_e2fs_basename(cgtls *iqlibc.ppTLS, aapath ppuintptr) (cgr ppuintptr) {

	var aalast, ccv1 ppuintptr
	pp_, pp_ = aalast, ccv1
	aalast = Xstrrchr(cgtls, aapath, ppint32('/'))
	if aalast != 0 {
		ccv1 = aalast + ppuintptr(1)
	} else {
		ccv1 = aapath
	}
	return ccv1
...
func sifind_or_mkdir_path(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaroot tnext2_ino_t, aapath ppuintptr, aaout ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aacur tnext2_ino_t
	var aadup, aap, aaslash ppuintptr
	var aaret tnerrcode_t
	var pp_ /* next at bp+0 */ tnext2_ino_t
	pp_, pp_, pp_, pp_, pp_ = aacur, aadup, aap, aaret, aaslash
	aacur = aaroot
	aadup = Xstrdup(cgtls, aapath)
	if !(aadup != 0) {
	...
	for ppint32(*(*ppint8)(iqunsafe.ppPointer(aap))) == ppint32('/') {
		aap = aap + 1
	}

	for *(*ppint8)(iqunsafe.ppPointer(aap)) != 0 {
		aaslash = Xstrchr(cgtls, aap, ppint32('/'))
		if aaslash != 0 {
			*(*ppint8)(iqunsafe.ppPointer(aaslash)) = ppint8('\000')
		}

		if ppint32(*(*ppint8)(iqunsafe.ppPointer(aap))) == ppint32('\000') || ppint32(*(*ppint8)(iqunsafe.ppPointer(aap))) == ppint32('.') && ppint32(*(*ppint8)(iqunsafe.ppPointer(aap + 1))) == ppint32('\000') {
			// skip empty or "." components
			if aaslash != 0 {
				aap = aaslash + ppuintptr(1)
				continue
			}
			break
		}

		aaret = Xext2fs_lookup(cgtls, aafs, aacur, aap, iqlibc.ppInt32FromUint64(Xstrlen(cgtls, aap)), ppuintptr(0), cgbp)
		if aaret == ppint64(2133571404) {
			// create the directory
			aaret = Xext2fs_mkdir(cgtls, aafs, aacur, ppuint32(0), aap)
			if aaret != 0 {
				Xfree(cgtls, aadup)
				return aaret
			}
		...
		aacur = *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp))
	...
	Xfree(cgtls, aadup)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(aaout)) = aacur
	return 0
}
...
func Xe2fs_create(cgtls *iqlibc.ppTLS, aapath ppuintptr, aasize_bytes tnuint64_t, aaout ppuintptr) (cgr tnerrcode_t) {
	...
	var aablocksize, aalpf_size, ccv12, ccv9 ppuint32
	var aai tndgrp_t
	var aai1, ccv1, ccv14, ccv16, ccv3, ccv6 ppint32
	var aaino, aaino1 tnext2_ino_t
	var aaret tnerrcode_t
	var pp_ /* compat_array at bp+1032 */ [3]tn__u32
	var pp_ /* fs at bp+0 */ tnext2_filsys
	var pp_ /* inode at bp+1044 */ tsext2_inode
	var pp_ /* jparams at bp+1176 */ tsext2fs_journal_params
	var pp_ /* lpf at bp+1172 */ tnext2_ino_t
	var pp_ /* param at bp+8 */ tsext2_super_block
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablocksize, aai, aai1, aaino, aaino1, aalpf_size, aaret, ccv1, ccv12, ccv14, ccv16, ccv3, ccv6, ccv9
	*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)) = iqlibc.ppUintptrFromInt32(0)

	Xmemset(cgtls, cgbp+8, 0, ppuint64(1024))

	aablocksize = ppuint32(4096)
	(*(*tsext2_super_block)(iqunsafe.ppPointer(cgbp + 8))).fds_log_block_size = ppuint32(2) // log2(4096) - log2(1024) = 2
	(*(*tsext2_super_block)(iqunsafe.ppPointer(cgbp + 8))).fds_blocks_count = ppuint32(aasize_bytes / ppuint64(aablocksize))

	// Set features BEFORE ext2fs_initialize so it can size structures
	// appropriately (e.g. 64-bit block numbers, metadata checksums).

	*(*[3]tn__u32)(iqunsafe.ppPointer(cgbp + 1032)) = [3]tn__u32{}
	if Xe2p_edit_feature2(cgtls, "has_journal,ext_attr,resize_inode,dir_index,filetype,extent,64bit,flex_bg,sparse_super,large_file,huge_file,dir_nlink,extra_isize,metadata_csum\x00", cgbp+1032, iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0)) != 0 {
		return iqlibc.ppInt64FromInt64(2133571399)
	}

	(*(*tsext2_super_block)(iqunsafe.ppPointer(cgbp + 8))).fds_feature_compat = (*(*[3]tn__u32)(iqunsafe.ppPointer(cgbp + 1032)))[0]
	(*(*tsext2_super_block)(iqunsafe.ppPointer(cgbp + 8))).fds_feature_incompat = (*(*[3]tn__u32)(iqunsafe.ppPointer(cgbp + 1032)))[ppint32(1)]
	(*(*tsext2_super_block)(iqunsafe.ppPointer(cgbp + 8))).fds_feature_ro_compat = (*(*[3]tn__u32)(iqunsafe.ppPointer(cgbp + 1032)))[ppint32(2)]
	...
	aaret = Xext2fs_initialize(cgtls, aapath, 0, cgbp+8, Xunix_io_manager, cgbp)
	if aaret != 0 {
		return aaret
	}

	// Mark kbytes_written so the kernel knows this is a modern fs.
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_kbytes_written = ppuint64(1)
	...
	sie2fs_fill_random(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper+104, ppuint64(16))

	// Initialize checksum seed from UUID (needed for metadata_csum).
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_CSUM_SEED) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_checksum_seed = Xext2fs_crc32c_le(cgtls, iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(0)), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper+104, ppuint64(16))
	}
	Xext2fs_init_csum_seed(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))

	// Set checksum type.
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_METADATA_CSUM) != ppuint32(0))
	goto cg_4
cg_4:
	if ccv1 != 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_checksum_type = ppuint8(mvEXT2_CRC32C_CHKSUM)
	}

	// Directory hash seed and algorithm.
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_def_hash_version = ppuint8(mvEXT2_HASH_HALF_MD4)
	sie2fs_fill_random(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper+236, ppuint64(16))

	// Allocate group tables (inode/block bitmaps and inode tables).
	aaret = Xext2fs_allocate_tables(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))
	if aaret != 0 {
	...
	aai = ppuint32(0)
	for {
		if !(aai < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdgroup_desc_count) {
			break
		}
		Xext2fs_bg_flags_set(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), aai, ppuint16(mvEXT2_BG_INODE_ZEROED))
		Xext2fs_group_desc_csum_set(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), aai)
...
cg_7:
	if ccv1 != 0 {
		Xmemset(cgtls, cgbp+1044, 0, ppuint64(128))
		aaino = ppuint32(1)
		for {
			if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_rev_level == ppuint32(mvEXT2_GOOD_OLD_REV) {
				ccv9 = ppuint32(mvEXT2_GOOD_OLD_FIRST_INO)
			} else {
				ccv9 = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_first_ino
			}
			if !(aaino < ccv9) {
				break
			}
			Xext2fs_write_inode(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), aaino, cgbp+1044)
	...
	aaret = Xext2fs_mkdir(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), ppuint32(mvEXT2_ROOT_INO), ppuint32(mvEXT2_ROOT_INO), ppuintptr(0))
	if aaret != 0 {
		Xext2fs_close_free(cgtls, cgbp)
		return aaret
	}
	...
	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdumask = ppuint32(077)
	aaret = Xext2fs_mkdir(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), ppuint32(mvEXT2_ROOT_INO), ppuint32(0), "lost+found\x00")
	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdumask = ppuint32(0)
	if aaret != 0 {
		Xext2fs_close_free(cgtls, cgbp)
		return aaret
	}
	aaret = Xext2fs_lookup(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), ppuint32(mvEXT2_ROOT_INO), "lost+found\x00", ppint32(10), ppuintptr(0), cgbp+1172)
	if aaret == 0 {
		aalpf_size = ppuint32(0)
		aai1 = ppint32(1)
		for {
			if !(aai1 < ppint32(mvEXT2_NDIR_BLOCKS)) {
				break
			}
			aalpf_size = aalpf_size + (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdblocksize
			if aalpf_size >= iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(16)*iqlibc.ppInt32FromInt32(1024)) && aalpf_size >= ppuint32(2)*(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdblocksize {
				break
			}
			Xext2fs_expand_dir(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 1172)))
	...
	aaino1 = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_ROOT_INO) + iqlibc.ppInt32FromInt32(1))
	for {
		if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_rev_level == ppuint32(mvEXT2_GOOD_OLD_REV) {
			ccv9 = ppuint32(mvEXT2_GOOD_OLD_FIRST_INO)
		} else {
		...
		Xext2fs_inode_alloc_stats2(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), aaino1, +iqlibc.ppInt32FromInt32(1), 0)
		goto cg_11
	cg_11:
		;
		aaino1 = aaino1 + 1
	...
	*(*ppint32)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)) + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)

	// Mark bad-block inode as used.
	pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdinode_map, ppuint64(ppuint32(mvEXT2_BAD_INO)))
	goto cg_13
cg_13:
	;
	Xext2fs_inode_alloc_stats2(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), ppuint32(mvEXT2_BAD_INO), +iqlibc.ppInt32FromInt32(1), 0)
	Xext2fs_update_bb_inode(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), iqlibc.ppUintptrFromInt32(0))

	// Create resize inode if the feature is enabled.
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_feature_compat&ppuint32(mvEXT2_FEATURE_COMPAT_RESIZE_INODE) != ppuint32(0))
	goto cg_15
cg_15:
	if ccv1 != 0 {
		aaret = Xext2fs_create_resize_inode(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))
		if aaret != 0 {
			Xext2fs_close_free(cgtls, cgbp)
			return aaret
		}
	...
	// Create journal.
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)).fds_feature_compat&ppuint32(mvEXT3_FEATURE_COMPAT_HAS_JOURNAL) != ppuint32(0))
	goto cg_17
cg_17:
	if ccv1 != 0 {
		Xmemset(cgtls, cgbp+1176, 0, ppuint64(8))
		(*(*tsext2fs_journal_params)(iqunsafe.ppPointer(cgbp + 1176))).fdnum_journal_blocks = iqlibc.ppUint32FromInt32(Xext2fs_default_journal_size(cgtls, Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)))).fdsuper)))
		if (*(*tsext2fs_journal_params)(iqunsafe.ppPointer(cgbp + 1176))).fdnum_journal_blocks > ppuint32(0) {
			...
			aaret = Xext2fs_add_journal_inode3(cgtls, *(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)), cgbp+1176, ^iqlibc.ppUint64FromUint64(0), ppint32(mvEXT2_MKJOURNAL_NO_MNT_CHECK))
			if aaret != 0 {
				Xext2fs_close_free(cgtls, cgbp)
				return aaret
			}
...
func Xe2fs_close(cgtls *iqlibc.ppTLS, aahandle tne2fs_t) (cgr tnerrcode_t) {
	...
	var pp_ /* fs at bp+0 */ tnext2_filsys
	*(*tnext2_filsys)(iqunsafe.ppPointer(cgbp)) = aahandle
	return Xext2fs_close_free(cgtls, cgbp)
}

func Xe2fs_mkdir(cgtls *iqlibc.ppTLS, aahandle tne2fs_t, aapath ppuintptr, aamode tnuint32_t, aauid tnuint32_t, aagid tnuint32_t, aamtime tnint64_t) (cgr tnerrcode_t) {
	...
	aaret = Xext2fs_mkdir(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), ppuint32(0), aabase)
	if aaret != 0 {
		goto ppout
	}
...
ppset_meta:
	...
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_mode = ppuint16(ppuint32(mvLINUX_S_IFDIR) | aamode&ppuint32(07777))
	...
	*(*tn__u16)(iqunsafe.ppPointer(cgbp + 8 + 116 + 6)) = ppuint16(aagid >> iqlibc.ppInt32FromInt32(16))
	...
	cg_3:
		...
		if aamtime < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
			...
			if aamtime > ppint64(iqlibc.ppInt32FromInt32(2147483647)) {
				ccv5 = ppint64(iqlibc.ppInt32FromInt32(2147483647))
			} else {
				ccv5 = aamtime
			}
			ccv4 = ccv5
...
func Xe2fs_write_file(cgtls *iqlibc.ppTLS, aahandle tne2fs_t, aapath ppuintptr, aamode tnuint32_t, aauid tnuint32_t, aagid tnuint32_t, aamtime tnint64_t, aadata ppuintptr, aasize tnuint64_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(160)
	defer cgtls.ppFree(160)

	var aabase, aadir, aadup1, aadup2, aaptr ppuintptr
	var aachunk, ccv18 ppuint32
	var aaextra, ccv12, ccv2, ccv7 tn__u32
	var aafs tnext2_filsys
	var aaremaining tnuint64_t
	var aaret tnerrcode_t
	var ccv1, ccv11, ccv6 tntime_t
	var ccv10, ccv14, ccv15, ccv4, ccv5, ccv9 ppint64
	var ccv16 ppint32
	var pp_ /* e2f at bp+144 */ tnext2_file_t
	var pp_ /* ehandle at bp+136 */ tnext2_extent_handle_t
	var pp_ /* inode at bp+8 */ tsext2_inode
	var pp_ /* newfile at bp+4 */ tnext2_ino_t
	var pp_ /* parent at bp+0 */ tnext2_ino_t
	var pp_ /* written at bp+152 */ ppuint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabase, aachunk, aadir, aadup1, aadup2, aaextra, aafs, aaptr, aaremaining, aaret, ccv1, ccv10, ccv11, ccv12, ccv14, ccv15, ccv16, ccv18, ccv2, ccv4, ccv5, ccv6, ccv7, ccv9
	aafs = aahandle
	...
	// Allocate inode.
	aaret = Xext2fs_new_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), ppint32(010755), ppuintptr(0), cgbp+4)
	if aaret != 0 {
		goto ppout
	}

	aaret = Xext2fs_link(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), aabase, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), iqlibc.ppInt32FromInt32(mvEXT2_FT_REG_FILE)|iqlibc.ppInt32FromInt32(mvEXT2FS_LINK_EXPAND))
	if aaret != 0 {
		goto ppout
	}

	Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), +iqlibc.ppInt32FromInt32(1), 0)

	Xmemset(cgtls, cgbp+8, 0, ppuint64(128))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_mode = ppuint16(ppuint32(mvLINUX_S_IFREG) | aamode&ppuint32(07777))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_uid = ppuint16(aauid)
	*(*tn__u16)(iqunsafe.ppPointer(cgbp + 8 + 116 + 4)) = ppuint16(aauid >> iqlibc.ppInt32FromInt32(16))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_gid = ppuint16(aagid)
	*(*tn__u16)(iqunsafe.ppPointer(cgbp + 8 + 116 + 6)) = ppuint16(aagid >> iqlibc.ppInt32FromInt32(16))
	...
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_links_count = ppuint16(1)
	aaret = Xext2fs_inode_size_set(cgtls, aafs, cgbp+8, iqlibc.ppInt64FromUint64(aasize))
	if aaret != 0 {
		goto ppout
	}

	ccv16 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT3_FEATURE_INCOMPAT_EXTENTS) != ppuint32(0))
	goto cg_17
cg_17:
	if ccv16 != 0 {

		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_flags &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_EXTENTS_FL))
		aaret = Xext2fs_extent_open2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), cgbp+8, cgbp+136)
		if aaret != 0 {
			goto ppout
		}
		Xext2fs_extent_free(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 136)))
	}

	aaret = Xext2fs_write_new_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), cgbp+8)
	if aaret != 0 {
		goto ppout
	}

	// Write file data.
	if aasize > ppuint64(0) {
		aaret = Xext2fs_file_open(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), ppint32(mvEXT2_FILE_WRITE), cgbp+144)
		if aaret != 0 {
			goto ppout
		}
		...
		aaptr = aadata
		aaremaining = aasize
		for aaremaining > ppuint64(0) {
			*(*ppuint32)(iqunsafe.ppPointer(cgbp + 152)) = ppuint32(0)
			if aaremaining > iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(20)) {
				ccv18 = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1) << iqlibc.ppInt32FromInt32(20))
			} else {
				ccv18 = ppuint32(aaremaining)
			}
			aachunk = ccv18
			aaret = Xext2fs_file_write(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 144)), aaptr, aachunk, cgbp+152)
			if aaret != 0 {
				Xext2fs_file_close(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 144)))
				goto ppout
			}
			if *(*ppuint32)(iqunsafe.ppPointer(cgbp + 152)) == ppuint32(0) {
				Xext2fs_file_close(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 144)))
				aaret = ppint64(mvEIO)
				goto ppout
			}
			aaptr = aaptr + ppuintptr(*(*ppuint32)(iqunsafe.ppPointer(cgbp + 152)))
			aaremaining = aaremaining - ppuint64(*(*ppuint32)(iqunsafe.ppPointer(cgbp + 152)))
		}
		aaret = Xext2fs_file_close(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 144)))
	}
...
func Xe2fs_mknod(cgtls *iqlibc.ppTLS, aahandle tne2fs_t, aapath ppuintptr, aamode tnuint32_t, aauid tnuint32_t, aagid tnuint32_t, aamtime tnint64_t, aamajor tnuint32_t, aaminor tnuint32_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(144)
	defer cgtls.ppFree(144)

	var aabase, aadir, aadup1, aadup2 ppuintptr
	var aaextra, ccv12, ccv2, ccv7 tn__u32
	var aafiletype ppint32
	var aafs tnext2_filsys
	var aalinux_mode ppuint64
	var aaret tnerrcode_t
	var ccv1, ccv11, ccv6 tntime_t
	var ccv10, ccv14, ccv15, ccv4, ccv5, ccv9 ppint64
	var pp_ /* ino at bp+4 */ tnext2_ino_t
	var pp_ /* inode at bp+8 */ tsext2_inode
	var pp_ /* parent at bp+0 */ tnext2_ino_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabase, aadir, aadup1, aadup2, aaextra, aafiletype, aafs, aalinux_mode, aaret, ccv1, ccv10, ccv11, ccv12, ccv14, ccv15, ccv2, ccv4, ccv5, ccv6, ccv7, ccv9
	aafs = aahandle
	...
	switch aamode & iqlibc.ppUint32FromInt32(0170000) {
	case ppuint32(0020000):
		aalinux_mode = ppuint64(mvLINUX_S_IFCHR)
		aafiletype = ppint32(mvEXT2_FT_CHRDEV)
		break
		fallthrough
	case ppuint32(0060000):
		aalinux_mode = ppuint64(mvLINUX_S_IFBLK)
		aafiletype = ppint32(mvEXT2_FT_BLKDEV)
		break
		fallthrough
	case ppuint32(0010000):
		aalinux_mode = ppuint64(mvLINUX_S_IFIFO)
		aafiletype = ppint32(mvEXT2_FT_FIFO)
		break
		fallthrough
	case ppuint32(0140000):
		aalinux_mode = ppuint64(mvLINUX_S_IFSOCK)
		aafiletype = ppint32(mvEXT2_FT_SOCK)
		break
		fallthrough
	default:
	...
	aaret = Xext2fs_link(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), aabase, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), aafiletype|ppint32(mvEXT2FS_LINK_EXPAND))
	if aaret != 0 {
		goto ppout
	}
	...
	Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), +iqlibc.ppInt32FromInt32(1), 0)
	Xmemset(cgtls, cgbp+8, 0, ppuint64(128))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_mode = ppuint16(aalinux_mode | ppuint64(aamode&iqlibc.ppUint32FromInt32(07777)))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_uid = ppuint16(aauid)
	*(*tn__u16)(iqunsafe.ppPointer(cgbp + 8 + 116 + 4)) = ppuint16(aauid >> iqlibc.ppInt32FromInt32(16))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_gid = ppuint16(aagid)
	*(*tn__u16)(iqunsafe.ppPointer(cgbp + 8 + 116 + 6)) = ppuint16(aagid >> iqlibc.ppInt32FromInt32(16))
	...
	if aafiletype == ppint32(mvEXT2_FT_CHRDEV) || aafiletype == ppint32(mvEXT2_FT_BLKDEV) {
		if aamajor < ppuint32(256) && aaminor < ppuint32(256) {
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40)) = aamajor*ppuint32(256) + aaminor
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40 + 1*4)) = ppuint32(0)
		} else {
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40)) = ppuint32(0)
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40 + 1*4)) = aaminor&ppuint32(0xff) | aamajor<<iqlibc.ppInt32FromInt32(8) | aaminor & ^iqlibc.ppUint32FromUint32(0xff) << ppint32(12)
		}
	}
...
func Xe2fs_hardlink(cgtls *iqlibc.ppTLS, aahandle tne2fs_t, aapath ppuintptr, aatarget ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(144)
	defer cgtls.ppFree(144)
	...
	var pp_ /* inode at bp+8 */ tsext2_inode
	var pp_ /* parent at bp+0 */ tnext2_ino_t
	var pp_ /* target_ino at bp+4 */ tnext2_ino_t
	pp_, pp_, pp_, pp_, pp_, pp_ = aabase, aadir, aadup1, aadup2, aafs, aaret
	aafs = aahandle
	...
	aaret = sifind_or_mkdir_path(cgtls, aafs, ppuint32(mvEXT2_ROOT_INO), aatarget, cgbp+4)
	if aaret != 0 {
		goto ppout
	}
	...
	aaret = Xext2fs_namei(cgtls, aafs, ppuint32(mvEXT2_ROOT_INO), ppuint32(mvEXT2_ROOT_INO), aatarget, cgbp+4)
	if aaret != 0 {
		goto ppout
	}
	...
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_links_count = (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_links_count + 1
	aaret = Xext2fs_write_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 4)), cgbp+8)
...
func _e2p_edit_feature2(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr, ppuintptr, ppuintptr, ppuintptr) ppint32

func _ext2fs_add_journal_inode3(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuint64, ppint32) ppint64

func _ext2fs_allocate_tables(*iqlibc.ppTLS, ppuintptr) ppint64
...
func _ext2fs_initialize(*iqlibc.ppTLS, ppuintptr, ppint32, ppuintptr, ppuintptr, ppuintptr) ppint64
...
func _ext2fs_link(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuint32, ppint32) ppint64

func _ext2fs_lookup(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppint32, ppuintptr, ppuintptr) ppint64

func _ext2fs_mark_generic_bmap(*iqlibc.ppTLS, ppuintptr, ppuint64) ppint32

func _ext2fs_mkdir(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint32, ppuintptr) ppint64
...
var _unix_io_manager ppuintptr
