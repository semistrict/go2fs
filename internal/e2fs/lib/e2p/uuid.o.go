...
func Xe2p_is_null_uuid(cgtls *iqlibc.ppTLS, aauu ppuintptr) (cgr ppint32) {
	...
	for {
		...
		ccv2 = aacp
		aacp = aacp + 1
		if *(*tn__u8)(iqunsafe.ppPointer(ccv2)) != 0 {
			return 0
		}
		goto cg_1
	cg_1:
...
func sie2p_unpack_uuid(cgtls *iqlibc.ppTLS, aain ppuintptr, aauu ppuintptr) {
...
func Xe2p_uuid_to_str(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr) {
	cgbp := cgtls.ppAlloc(112)
	defer cgtls.ppFree(112)

	var pp_ /* uuid at bp+0 */ tsuuid

	sie2p_unpack_uuid(cgtls, aauu, cgbp)
...
func Xe2p_uuid2str(cgtls *iqlibc.ppTLS, aauu ppuintptr) (cgr ppuintptr) {

	var snbuf [80]ppint8

	if Xe2p_is_null_uuid(cgtls, aauu) != 0 {
		return "<none>\x00"
	}
	Xe2p_uuid_to_str(cgtls, aauu, ppuintptr(iqunsafe.ppPointer(&snbuf)))
