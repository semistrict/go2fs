...
func Xe2p_errcode2str(cgtls *iqlibc.ppTLS, aaerr ppuint32) (cgr ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var snbuf [32]ppint8

	if ppuint64(aaerr) < iqlibc.ppUint64FromInt64(144)/iqlibc.ppUint64FromInt64(8) {
		return sierr_string[aaerr]
	}

	Xsprintf(cgtls, ppuintptr(iqunsafe.ppPointer(&snbuf)), "UNKNOWN_ERRCODE_%u\x00", iqlibc.ppVaList(cgbp+8, aaerr))
