...
func Xfgetversion(cgtls *iqlibc.ppTLS, aaname ppuintptr, aaversion ppuintptr) (cgr ppint32) {

	var aarc ppint32
	var aaver ppuint32
	pp_, pp_ = aarc, aaver
	aaver = iqlibc.ppUint32FromInt32(-iqlibc.ppInt32FromInt32(1))
	aarc = -ppint32(1)
	*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) = ppint32(mvEOPNOTSUPP)
	if aarc == 0 {
		*(*ppuint64)(iqunsafe.ppPointer(aaversion)) = ppuint64(aaver)
	}
