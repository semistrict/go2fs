...
func Xfgetflags(cgtls *iqlibc.ppTLS, aaname ppuintptr, aaflags ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(144)
	defer cgtls.ppFree(144)

	var pp_ /* buf at bp+0 */ tsstat

	if Xstat(cgtls, aaname, cgbp) == -ppint32(1) {
		return -ppint32(1)
	}
