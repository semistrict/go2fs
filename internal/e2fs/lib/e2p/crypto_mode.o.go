...
var simode_list = [5]tsmode{
	0: {
		fdstring1: "Invalid\x00",
	},
	1: {
		fdnum:     ppint32(mvEXT4_ENCRYPTION_MODE_AES_256_XTS),
		fdstring1: "AES-256-XTS\x00",
	},
	2: {
		fdnum:     ppint32(mvEXT4_ENCRYPTION_MODE_AES_256_GCM),
		fdstring1: "AES-256-GCM\x00",
	},
	3: {
		fdnum:     ppint32(mvEXT4_ENCRYPTION_MODE_AES_256_CBC),
		fdstring1: "AES-256-CBC\x00",
	},
	4: {},
}

func Xe2p_encmode2string(cgtls *iqlibc.ppTLS, aanum ppint32) (cgr ppuintptr) {
	...
	aap = ppuintptr(iqunsafe.ppPointer(&simode_list))
	for {
		if !((*tsmode)(iqunsafe.ppPointer(aap)).fdstring1 != 0) {
			break
		}
		if aanum == (*tsmode)(iqunsafe.ppPointer(aap)).fdnum {
			return (*tsmode)(iqunsafe.ppPointer(aap)).fdstring1
		}
	...
	Xsprintf(cgtls, ppuintptr(iqunsafe.ppPointer(&snbuf)), "ENC_MODE_%d\x00", iqlibc.ppVaList(cgbp+8, aanum))
...
//	 */
func Xe2p_string2encmode(cgtls *iqlibc.ppTLS, aastring ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	for {
		...
		if !(Xstrcasecmp(cgtls, aastring, (*tsmode)(iqunsafe.ppPointer(aap)).fdstring1) != 0) {
			return (*tsmode)(iqunsafe.ppPointer(aap)).fdnum
		}
	...
	if Xstrncasecmp(cgtls, aastring, "ENC_MODE_\x00", ppuint64(9)) != 0 {
		return -ppint32(1)
	}
