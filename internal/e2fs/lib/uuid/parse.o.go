...
func Xuuid_parse(cgtls *iqlibc.ppTLS, aain ppuintptr, aauu ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aacp, ccv10, ccv9 ppuintptr
	var aai, ccv2, ccv7 ppint32
	var ccv4, ccv5 tn__darwin_ct_rune_t
	var pp_ /* buf at bp+18 */ [3]ppint8
	var pp_ /* uuid at bp+0 */ tsuuid
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacp, aai, ccv10, ccv2, ccv4, ccv5, ccv7, ccv9

	if Xstrlen(cgtls, aain) != ppuint64(36) {
		return -ppint32(1)
	}
	aai = 0
	aacp = aain
	for {
		...
		if aai == ppint32(8) || aai == ppint32(13) || aai == ppint32(18) || aai == ppint32(23) {
		...
		ccv4 = ppint32(*(*ppint8)(iqunsafe.ppPointer(aacp)))
		if ccv4 < 0 || ccv4 >= iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(8) {
			ccv7 = 0
		} else {
			ccv7 = iqlibc.ppBoolInt32(!!(ppuint64(*(*tn__uint32_t)(iqunsafe.ppPointer(ppuintptr(iqunsafe.ppPointer(&X_DefaultRuneLocale)) + 60 + ppuintptr(ccv4)*4)))&ppuint64(0x00010000) != 0))
		}
		ccv5 = ccv7
		goto cg_6
	cg_6:
	...
	(*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_low = ppuint32(Xstrtoul(cgtls, aain, iqlibc.ppUintptrFromInt32(0), ppint32(16)))
	(*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_mid = ppuint16(Xstrtoul(cgtls, aain+ppuintptr(9), iqlibc.ppUintptrFromInt32(0), ppint32(16)))
	(*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_hi_and_version = ppuint16(Xstrtoul(cgtls, aain+ppuintptr(14), iqlibc.ppUintptrFromInt32(0), ppint32(16)))
	(*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdclock_seq = ppuint16(Xstrtoul(cgtls, aain+ppuintptr(19), iqlibc.ppUintptrFromInt32(0), ppint32(16)))
	aacp = aain + ppuintptr(24)
	(*(*[3]ppint8)(iqunsafe.ppPointer(cgbp + 18)))[ppint32(2)] = 0
	aai = 0
	for {
		if !(aai < ppint32(6)) {
			break
		...
		ccv9 = aacp
		aacp = aacp + 1
		(*(*[3]ppint8)(iqunsafe.ppPointer(cgbp + 18)))[0] = *(*ppint8)(iqunsafe.ppPointer(ccv9))
		ccv9 = aacp
		aacp = aacp + 1
		(*(*[3]ppint8)(iqunsafe.ppPointer(cgbp + 18)))[ppint32(1)] = *(*ppint8)(iqunsafe.ppPointer(ccv9))
		*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + ppuintptr(aai))) = ppuint8(Xstrtoul(cgtls, cgbp+18, iqlibc.ppUintptrFromInt32(0), ppint32(16)))
