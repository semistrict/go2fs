...
func Xuuid_unpack(cgtls *iqlibc.ppTLS, aain ppuintptr, aauu ppuintptr) {

	var aaptr, ccv1, ccv10, ccv2, ccv3, ccv4, ccv5, ccv6, ccv7, ccv8, ccv9 ppuintptr
	var aatmp tnuint32_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaptr, aatmp, ccv1, ccv10, ccv2, ccv3, ccv4, ccv5, ccv6, ccv7, ccv8, ccv9
	aaptr = aain

	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	(*tsuuid)(iqunsafe.ppPointer(aauu)).fdtime_low = aatmp
	...
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	(*tsuuid)(iqunsafe.ppPointer(aauu)).fdtime_mid = ppuint16(aatmp)
	...
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	(*tsuuid)(iqunsafe.ppPointer(aauu)).fdtime_hi_and_version = ppuint16(aatmp)
	...
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tnuint8_t)(iqunsafe.ppPointer(ccv1)))
	(*tsuuid)(iqunsafe.ppPointer(aauu)).fdclock_seq = ppuint16(aatmp)

	Xmemcpy(cgtls, aauu+10, aaptr, ppuint64(6))
}
