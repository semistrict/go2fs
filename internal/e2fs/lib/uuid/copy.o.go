...
func Xuuid_copy(cgtls *iqlibc.ppTLS, aadst ppuintptr, aasrc ppuintptr) {

	var aacp1, aacp2, ccv2, ccv3 ppuintptr
	var aai ppint32
	pp_, pp_, pp_, pp_, pp_ = aacp1, aacp2, aai, ccv2, ccv3
	...
	for {
		...
		ccv3 = aacp2
		aacp2 = aacp2 + 1
		*(*ppuint8)(iqunsafe.ppPointer(ccv2)) = *(*ppuint8)(iqunsafe.ppPointer(ccv3))
		goto cg_1
	cg_1:
		;
		aai = aai + 1
