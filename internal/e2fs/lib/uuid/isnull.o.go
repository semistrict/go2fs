...
func Xuuid_is_null(cgtls *iqlibc.ppTLS, aauu ppuintptr) (cgr ppint32) {

	var aacp, ccv2 ppuintptr
	var aai ppint32
	pp_, pp_, pp_ = aacp, aai, ccv2
	...
	for {
		...
		ccv2 = aacp
		aacp = aacp + 1
		if *(*ppuint8)(iqunsafe.ppPointer(ccv2)) != 0 {
			return 0
		}
		goto cg_1
	cg_1:
