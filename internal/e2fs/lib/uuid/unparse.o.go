...
var sifmt_lower = "%08x-%04x-%04x-%02x%02x-%02x%02x%02x%02x%02x%02x\x00"

var sifmt_upper = "%08X-%04X-%04X-%02X%02X-%02X%02X%02X%02X%02X%02X\x00"

func siuuid_unparse_x(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr, aafmt ppuintptr) {
	...
	Xsprintf(cgtls, aaout, aafmt, iqlibc.ppVaList(cgbp+24, (*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_low, iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_mid), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_hi_and_version), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdclock_seq)>>ppint32(8), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdclock_seq)&ppint32(0xFF), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10))), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + 1))), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + 2))), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + 3))), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + 4))), iqlibc.ppInt32FromUint8(*(*tnuint8_t)(iqunsafe.ppPointer(cgbp + 10 + 5)))))
}

func Xuuid_unparse_lower(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr) {

	siuuid_unparse_x(cgtls, aauu, aaout, sifmt_lower)
}

func Xuuid_unparse_upper(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr) {

	siuuid_unparse_x(cgtls, aauu, aaout, sifmt_upper)
}

func Xuuid_unparse(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr) {
