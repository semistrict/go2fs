...
func Xblkid_llseek(cgtls *iqlibc.ppTLS, aafd ppint32, aaoffset tnblkid_loff_t, aaorigin ppint32) (cgr tnblkid_loff_t) {

	if iqlibc.Bool(ppuint64(8) < ppuint64(8)) && aaoffset >= iqlibc.ppInt64FromInt32(1)<<(iqlibc.ppUint64FromInt64(8)*iqlibc.ppUint64FromInt32(8)-iqlibc.ppUint64FromInt32(1)) {
		*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) = ppint32(mvEOVERFLOW)
		return ppint64(-ppint32(1))
	}
	return Xlseek(cgtls, aafd, aaoffset, aaorigin)
}
