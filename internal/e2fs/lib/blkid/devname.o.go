...
const mvBLKID_DEV_FIND = 0
const mvBLKID_DEV_VERIFY = 2
...
const mvPRIxLEAST8 = "PRIx8"
const mvPRIxPTR = "lx"
const mvPROC_EVMS_VOLUMES = "/proc/evms/volumes"
const mvPROC_PARTITIONS = "/proc/partitions"
...
//	 */
func Xblkid_get_dev(cgtls *iqlibc.ppTLS, aacache tnblkid_cache, aadevname ppuintptr, aaflags ppint32) (cgr tnblkid_dev) {

	var aadev, aadev2, aatmp tnblkid_dev
	var aap, aapnext, ccv2, ccv3, ccv4, ccv5 ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadev, aadev2, aap, aapnext, aatmp, ccv2, ccv3, ccv4, ccv5
	aadev = iqlibc.ppUintptrFromInt32(0)

	if !(aacache != 0) || !(aadevname != 0) {
		return iqlibc.ppUintptrFromInt32(0)
	}

	aap = (*tslist_head)(iqunsafe.ppPointer(aacache)).fdnext
	for {
		if !(aap != aacache) {
			break
		}
		aatmp = aap - ppuintptr(ppuint64(iqlibc.ppUintptrFromInt32(0)))
		if Xstrcmp(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aatmp)).fdbid_name, aadevname) != 0 {
			goto cg_1
		}
	...
	cg_1:
		;
		aap = (*tslist_head)(iqunsafe.ppPointer(aap)).fdnext
	}

	if !(aadev != 0) && aaflags&ppint32(mvBLKID_DEV_CREATE) != 0 {
		if Xaccess(cgtls, aadevname, mvF_OK) < 0 {
			return iqlibc.ppUintptrFromInt32(0)
		}
		aadev = Xblkid_new_dev(cgtls)
		if !(aadev != 0) {
			return iqlibc.ppUintptrFromInt32(0)
		}
		(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_time = ppint64(-iqlibc.ppInt32FromInt32(mv__INT_MAX__) - iqlibc.ppInt32FromInt32(1))
		(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_name = Xblkid_strdup(cgtls, aadevname)
		(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_cache = aacache
		ccv2 = aacache
		ccv3 = aadev
		ccv4 = (*tslist_head)(iqunsafe.ppPointer(ccv2)).fdprev
		ccv5 = ccv2
		(*tslist_head)(iqunsafe.ppPointer(ccv5)).fdprev = ccv3
		(*tslist_head)(iqunsafe.ppPointer(ccv3)).fdnext = ccv5
		(*tslist_head)(iqunsafe.ppPointer(ccv3)).fdprev = ccv4
		(*tslist_head)(iqunsafe.ppPointer(ccv4)).fdnext = ccv3

		*(*ppuint32)(iqunsafe.ppPointer(aacache + 48)) |= ppuint32(mvBLKID_BIC_FL_CHANGED)
	}

	if aaflags&ppint32(mvBLKID_DEV_VERIFY) != 0 {
		aadev = Xblkid_verify(cgtls, aacache, aadev)
		if !(aadev != 0) || !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_flags&iqlibc.ppUint32FromInt32(mvBLKID_BID_FL_VERIFIED) != 0) {
			return aadev
		}
		/*
		 ...
		 */
		aap = (*tslist_head)(iqunsafe.ppPointer(aacache)).fdnext
		aapnext = (*tslist_head)(iqunsafe.ppPointer(aap)).fdnext
		for {
			if !(aap != aacache) {
				break
			}
			aadev2 = aap - ppuintptr(ppuint64(iqlibc.ppUintptrFromInt32(0)))
			if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_flags&ppuint32(mvBLKID_BID_FL_VERIFIED) != 0 {
				goto cg_6
			}
			if !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_type != 0) || !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_type != 0) || Xstrcmp(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_type, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_type) != 0 {
				goto cg_6
			}
			if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_label != 0 && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_label != 0 && Xstrcmp(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_label, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_label) != 0 {
				goto cg_6
			}
			if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_uuid != 0 && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_uuid != 0 && Xstrcmp(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_uuid, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_uuid) != 0 {
				goto cg_6
			}
			if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_label != 0 && !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_label != 0) || !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_label != 0) && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_label != 0 || (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_uuid != 0 && !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_uuid != 0) || !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_uuid != 0) && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_uuid != 0 {
				goto cg_6
			}
			aadev2 = Xblkid_verify(cgtls, aacache, aadev2)
			if aadev2 != 0 && !((*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev2)).fdbid_flags&iqlibc.ppUint32FromInt32(mvBLKID_BID_FL_VERIFIED) != 0) {
				Xblkid_free_dev(cgtls, aadev2)
			}
...
var sidirlist = [4]ppuintptr{
	0: "/dev\x00",
	1: "/devfs\x00",
	2: "/devices\x00",
	3: iqlibc.ppUintptrFromInt32(0),
}

func siis_dm_leaf(cgtls *iqlibc.ppTLS, aadevname ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(320)
	defer cgtls.ppFree(320)

	var aad_de, aad_dir, aade, aadir, ccv1, ccv2, ccv3, ccv4 ppuintptr
	var aaret ppint32
	var pp_ /* path at bp+0 */ [300]ppint8
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aad_de, aad_dir, aade, aadir, aaret, ccv1, ccv2, ccv3, ccv4
	aaret = ppint32(1)

	ccv1 = Xopendir(cgtls, "/sys/block\x00")
	aadir = ccv1
	...
	for {
		...
		if !(Xstrcmp(cgtls, aade+21, ".\x00") != 0) || !(Xstrcmp(cgtls, aade+21, "..\x00") != 0) || !(Xstrcmp(cgtls, aade+21, aadevname) != 0) || Xstrncmp(cgtls, aade+21, "dm-\x00", ppuint64(3)) != 0 || Xstrlen(cgtls, aade+21) > iqlibc.ppUint64FromInt64(300)-iqlibc.ppUint64FromInt32(32) {
			continue
		}
		Xsprintf(cgtls, cgbp, "/sys/block/%s/slaves\x00", iqlibc.ppVaList(cgbp+312, aade+21))
		ccv1 = Xopendir(cgtls, cgbp)
		aad_dir = ccv1
		if ccv1 == iqlibc.ppUintptrFromInt32(0) {
			continue
		}
		for {
			ccv1 = Xreaddir(cgtls, aad_dir)
			aad_de = ccv1
			if !(ccv1 != iqlibc.ppUintptrFromInt32(0)) {
				break
			}
			if !(Xstrcmp(cgtls, aad_de+21, aadevname) != 0) {
				aaret = 0
				break
			}

		}
		Xclosedir(cgtls, aad_dir)
		if !(aaret != 0) {
			break
		}
...
//	 */
func siget_dm_name(cgtls *iqlibc.ppTLS, aaptname ppuintptr) (cgr ppuintptr) {
	cgbp := cgtls.ppAlloc(576)
	defer cgtls.ppFree(576)

	var aaf, aares, ccv1 ppuintptr
	var aasz, ccv2 tnsize_t
	var ccv3 ppbool
	var pp_ /* name at bp+300 */ [256]ppint8
	var pp_ /* path at bp+0 */ [300]ppint8
	pp_, pp_, pp_, pp_, pp_, pp_ = aaf, aares, aasz, ccv1, ccv2, ccv3
	aares = iqlibc.ppUintptrFromInt32(0)

	X__builtin_snprintf(cgtls, cgbp, ppuint64(300), "/sys/block/%s/dm/name\x00", iqlibc.ppVaList(cgbp+568, aaptname))
	ccv1 = Xfopen(cgtls, cgbp, "r\x00")
	aaf = ccv1
	if ccv1 == iqlibc.ppUintptrFromInt32(0) {
		return iqlibc.ppUintptrFromInt32(0)
	}
	...
	if ccv3 = Xfgets(cgtls, cgbp+300, ppint32(256), aaf) != 0; ccv3 {
		ccv2 = Xstrlen(cgtls, cgbp+300)
		aasz = ccv2
	}
	if ccv3 && ccv2 > ppuint64(1) {
		(*(*[256]ppint8)(iqunsafe.ppPointer(cgbp + 300)))[aasz-ppuint64(1)] = ppint8('\000')
		X__builtin_snprintf(cgtls, cgbp, ppuint64(300), "/dev/mapper/%s\x00", iqlibc.ppVaList(cgbp+568, cgbp+300))
		aares = Xblkid_strdup(cgtls, cgbp)
	}
	Xfclose(cgtls, aaf)
	return aares
}
...
//	 */
func siprobe_one(cgtls *iqlibc.ppTLS, aacache tnblkid_cache, aaptname ppuintptr, aadevno tndev_t, aapri ppint32, aaonly_if_new ppint32) {
	cgbp := cgtls.ppAlloc(432)
	defer cgtls.ppFree(432)

	var aadev, aatmp, ccv10 tnblkid_dev
	var aadir, aap, aapnext ppuintptr
	var ccv11, ccv2, ccv7 ppint32
	var ccv13, ccv8 ppbool
	var ccv4, ccv5 tn__darwin_ct_rune_t
	var pp_ /* device at bp+152 */ [256]ppint8
	var pp_ /* devname at bp+0 */ ppuintptr
	var pp_ /* st at bp+8 */ tsstat
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadev, aadir, aap, aapnext, aatmp, ccv10, ccv11, ccv13, ccv2, ccv4, ccv5, ccv7, ccv8
	aadev = iqlibc.ppUintptrFromInt32(0)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = iqlibc.ppUintptrFromInt32(0)
	...
	for {
		...
		aatmp = aap - ppuintptr(ppuint64(iqlibc.ppUintptrFromInt32(0)))
		if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aatmp)).fdbid_devno == aadevno {
			if aaonly_if_new != 0 && !(Xaccess(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aatmp)).fdbid_name, mvF_OK) != 0) {
				return
			}
			aadev = Xblkid_verify(cgtls, aacache, aatmp)
			if aadev != 0 && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_flags&ppuint32(mvBLKID_BID_FL_VERIFIED) != 0 {
				break
			}
			aadev = ppuintptr(0)
		}
	...
	if aadev != 0 && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_devno == aadevno {
		goto ppset_pri
	}
	...
	if ccv8 = !(Xstrncmp(cgtls, aaptname, "dm-\x00", ppuint64(3)) != 0); ccv8 {
		ccv4 = ppint32(*(*ppint8)(iqunsafe.ppPointer(aaptname + 3)))
		if ccv4 < 0 || ccv4 >= iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(8) {
			ccv7 = 0
		} else {
			ccv7 = iqlibc.ppBoolInt32(!!(ppuint64(*(*tn__uint32_t)(iqunsafe.ppPointer(ppuintptr(iqunsafe.ppPointer(&X_DefaultRuneLocale)) + 60 + ppuintptr(ccv4)*4)))&ppuint64(0x00000400) != 0))
		}
		ccv5 = ccv7
		goto cg_6
	cg_6:
	...
	if ccv8 && ccv2 != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = siget_dm_name(cgtls, aaptname)
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
			Xblkid__scan_dir(cgtls, "/dev/mapper\x00", aadevno, ppuintptr(0), cgbp)
		}
		if *(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0 {
			goto ppget_dev
		}
	 ...
	 */
	aadir = ppuintptr(iqunsafe.ppPointer(&sidirlist))
	for {
		if !(*(*ppuintptr)(iqunsafe.ppPointer(aadir)) != 0) {
			break
		}

		Xsprintf(cgtls, cgbp+152, "%s/%s\x00", iqlibc.ppVaList(cgbp+416, *(*ppuintptr)(iqunsafe.ppPointer(aadir)), aaptname))
		ccv10 = Xblkid_get_dev(cgtls, aacache, cgbp+152, mvBLKID_DEV_FIND)
		aadev = ccv10
		if ccv10 != 0 && (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_devno == aadevno {
			goto ppset_pri
		}

		if ccv8 = Xstat(cgtls, cgbp+152, cgbp+8) == 0; ccv8 {
			ccv2 = iqlibc.ppBoolInt32(iqlibc.ppInt32FromUint16((*(*tsstat)(iqunsafe.ppPointer(cgbp + 8))).fdst_mode)&ppint32(mvS_IFMT) == ppint32(mvS_IFBLK))
			goto cg_12
		cg_12:
		}
		if ccv8 && ccv2 != 0 && (*(*tsstat)(iqunsafe.ppPointer(cgbp + 8))).fdst_rdev == aadevno {
			*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xblkid_strdup(cgtls, cgbp+152)
			goto ppget_dev
		}
	...
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xblkid_devno_to_devname(cgtls, aadevno)
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
			return
		}
	}
...
ppget_dev:
	;
	aadev = Xblkid_get_dev(cgtls, aacache, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), iqlibc.ppInt32FromInt32(mvBLKID_DEV_CREATE)|iqlibc.ppInt32FromInt32(mvBLKID_DEV_VERIFY))
...
ppset_pri:
	...
	if aadev != 0 {
		if aapri != 0 {
			(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_pri = aapri
		} else {
			if !(Xstrncmp(cgtls, (*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_name, "/dev/mapper/\x00", ppuint64(11)) != 0) {
				(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_pri = ppint32(mvBLKID_PRI_DM)
				if siis_dm_leaf(cgtls, aaptname) != 0 {

					*(*ppint32)(iqunsafe.ppPointer(aadev + 56)) += ppint32(5)
				}
			} else {
				if !(Xstrncmp(cgtls, aaptname, "md\x00", ppuint64(2)) != 0) {
					(*tsblkid_struct_dev)(iqunsafe.ppPointer(aadev)).fdbid_pri = ppint32(mvBLKID_PRI_MD)
				}
			}
		}
	}
...
//	 * safe thing to do?)
//	 */
func silvm_get_devno(cgtls *iqlibc.ppTLS, aalvm_device ppuintptr) (cgr tndev_t) {
	cgbp := cgtls.ppAlloc(1056)
	defer cgtls.ppFree(1056)

	var aalvf, ccv1 ppuintptr
	var aaret tndev_t
	var pp_ /* buf at bp+0 */ [1024]ppint8
	var pp_ /* ma at bp+1024 */ ppint32
	var pp_ /* mi at bp+1028 */ ppint32
	pp_, pp_, pp_ = aalvf, aaret, ccv1
	aaret = 0

	ccv1 = Xfopen(cgtls, aalvm_device, "r\x00")
	aalvf = ccv1
	if ccv1 == iqlibc.ppUintptrFromInt32(0) {
	...
	for Xfgets(cgtls, cgbp, ppint32(1024), aalvf) != 0 {
		if Xsscanf(cgtls, cgbp, "device: %d:%d\x00", iqlibc.ppVaList(cgbp+1040, cgbp+1024, cgbp+1028)) == ppint32(2) {
			aaret = *(*ppint32)(iqunsafe.ppPointer(cgbp + 1024))<<iqlibc.ppInt32FromInt32(24) | *(*ppint32)(iqunsafe.ppPointer(cgbp + 1028))
			break
		}
	}
	Xfclose(cgtls, aalvf)
...
func silvm_probe_all(cgtls *iqlibc.ppTLS, aacache tnblkid_cache, aaonly_if_new ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aadev tndev_t
	var aalv_iter, aalv_list, aalv_name, aalvm_device, aavdirname, aavg_iter, aavg_list, aavg_name, ccv1, ccv2, ccv3 ppuintptr
	var aavg_len ppint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadev, aalv_iter, aalv_list, aalv_name, aalvm_device, aavdirname, aavg_iter, aavg_len, aavg_list, aavg_name, ccv1, ccv2, ccv3
	aavg_len = iqlibc.ppInt32FromUint64(Xstrlen(cgtls, "/proc/lvm/VGs\x00"))

	ccv1 = Xopendir(cgtls, "/proc/lvm/VGs\x00")
	aavg_list = ccv1
	if ccv1 == iqlibc.ppUintptrFromInt32(0) {
		return
	}
	...
	for {
		ccv1 = Xreaddir(cgtls, aavg_list)
		aavg_iter = ccv1
		if !(ccv1 != iqlibc.ppUintptrFromInt32(0)) {
			break
		}

		aavg_name = aavg_iter + 21
		if !(Xstrcmp(cgtls, aavg_name, ".\x00") != 0) || !(Xstrcmp(cgtls, aavg_name, "..\x00") != 0) {
			continue
		}
		aavdirname = Xmalloc(cgtls, iqlibc.ppUint64FromInt32(aavg_len)+Xstrlen(cgtls, aavg_name)+ppuint64(8))
		if !(aavdirname != 0) {
			goto ppexit
		}
		Xsprintf(cgtls, aavdirname, "%s/%s/LVs\x00", iqlibc.ppVaList(cgbp+8, "/proc/lvm/VGs\x00", aavg_name))

		aalv_list = Xopendir(cgtls, aavdirname)
		Xfree(cgtls, aavdirname)
		if aalv_list == iqlibc.ppUintptrFromInt32(0) {
			continue
		}

		for {
			ccv1 = Xreaddir(cgtls, aalv_list)
			aalv_iter = ccv1
			if !(ccv1 != iqlibc.ppUintptrFromInt32(0)) {
				break
			}

			aalv_name = aalv_iter + 21
			if !(Xstrcmp(cgtls, aalv_name, ".\x00") != 0) || !(Xstrcmp(cgtls, aalv_name, "..\x00") != 0) {
				continue
			}

			aalvm_device = Xmalloc(cgtls, iqlibc.ppUint64FromInt32(aavg_len)+Xstrlen(cgtls, aavg_name)+Xstrlen(cgtls, aalv_name)+ppuint64(8))
			if !(aalvm_device != 0) {
				Xclosedir(cgtls, aalv_list)
				goto ppexit
			}
			Xsprintf(cgtls, aalvm_device, "%s/%s/LVs/%s\x00", iqlibc.ppVaList(cgbp+8, "/proc/lvm/VGs\x00", aavg_name, aalv_name))
			aadev = silvm_get_devno(cgtls, aalvm_device)
			Xsprintf(cgtls, aalvm_device, "%s/%s\x00", iqlibc.ppVaList(cgbp+8, aavg_name, aalv_name))

			siprobe_one(cgtls, aacache, aalvm_device, aadev, ppint32(mvBLKID_PRI_LVM), aaonly_if_new)
			Xfree(cgtls, aalvm_device)
...
ppexit:
	;
	Xclosedir(cgtls, aavg_list)
}

func sievms_probe_all(cgtls *iqlibc.ppTLS, aacache tnblkid_cache, aaonly_if_new ppint32) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(272)
	defer cgtls.ppFree(272)

	var aanum ppint32
	var aaprocpt ppuintptr
	var pp_ /* device at bp+112 */ [110]ppint8
	var pp_ /* line at bp+0 */ [100]ppint8
	var pp_ /* ma at bp+100 */ ppint32
	var pp_ /* mi at bp+104 */ ppint32
	var pp_ /* sz at bp+108 */ ppint32
	pp_, pp_ = aanum, aaprocpt
	aanum = 0

	aaprocpt = Xfopen(cgtls, "/proc/evms/volumes\x00", "r\x00")
	if !(aaprocpt != 0) {
		return 0
	}
	for Xfgets(cgtls, cgbp, ppint32(100), aaprocpt) != 0 {
		if Xsscanf(cgtls, cgbp, " %d %d %d %*s %*s %[^\n ]\x00", iqlibc.ppVaList(cgbp+232, cgbp+100, cgbp+104, cgbp+108, cgbp+112)) != ppint32(4) {
			continue
		}

		siprobe_one(cgtls, aacache, cgbp+112, *(*ppint32)(iqunsafe.ppPointer(cgbp + 100))<<iqlibc.ppInt32FromInt32(24)|*(*ppint32)(iqunsafe.ppPointer(cgbp + 104)), ppint32(mvBLKID_PRI_EVMS), aaonly_if_new)
		aanum = aanum + 1
	}
	Xfclose(cgtls, aaprocpt)
	return aanum
}
...
//	 */
func siprobe_all(cgtls *iqlibc.ppTLS, aacache tnblkid_cache, aaonly_if_new ppint32) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(1344)
	defer cgtls.ppFree(1344)

	var aadevs [2]tndev_t
	var aalast, aawhich, ccv1, ccv6 ppint32
	var aalens [2]ppint32
	var aap, aapnext, aaproc, aaptname ppuintptr
	var aaptnames [2]ppuintptr
	var aatmp tnblkid_dev
	var ccv3, ccv4 tn__darwin_ct_rune_t
	var pp_ /* line at bp+0 */ [1024]ppint8
	var pp_ /* ma at bp+1284 */ ppint32
	var pp_ /* mi at bp+1288 */ ppint32
	var pp_ /* ptname0 at bp+1024 */ [129]ppint8
	var pp_ /* ptname1 at bp+1153 */ [129]ppint8
	var pp_ /* sz at bp+1296 */ ppuint64
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadevs, aalast, aalens, aap, aapnext, aaproc, aaptname, aaptnames, aatmp, aawhich, ccv1, ccv3, ccv4, ccv6
	aaptname = ppuintptr(0)
	aalens = [2]ppint32{}
	aawhich = 0
	aalast = 0

	aaptnames[0] = cgbp + 1024
	aaptnames[ppint32(1)] = cgbp + 1153

	if !(aacache != 0) {
		return -ppint32(mvBLKID_ERR_PARAM)
	}

	if (*tsblkid_struct_cache)(iqunsafe.ppPointer(aacache)).fdbic_flags&ppuint32(mvBLKID_BIC_FL_PROBED) != 0 && Xtime(cgtls, ppuintptr(0))-(*tsblkid_struct_cache)(iqunsafe.ppPointer(aacache)).fdbic_time < ppint64(mvBLKID_PROBE_INTERVAL) {
		return 0
	}

	Xblkid_read_cache(cgtls, aacache)
	sievms_probe_all(cgtls, aacache, aaonly_if_new)
	silvm_probe_all(cgtls, aacache, aaonly_if_new)

	aaproc = Xfopen(cgtls, "/proc/partitions\x00", "r\x00")
	if !(aaproc != 0) {
		return -ppint32(mvBLKID_ERR_PROC)
	}

	for Xfgets(cgtls, cgbp, ppint32(1024), aaproc) != 0 {
		aalast = aawhich
		aawhich = aawhich ^ ppint32(1)
		aaptname = aaptnames[aawhich]

		if Xsscanf(cgtls, cgbp, " %d %d %llu %128[^\n ]\x00", iqlibc.ppVaList(cgbp+1312, cgbp+1284, cgbp+1288, cgbp+1296, aaptname)) != ppint32(4) {
			continue
		}
		aadevs[aawhich] = *(*ppint32)(iqunsafe.ppPointer(cgbp + 1284))<<iqlibc.ppInt32FromInt32(24) | *(*ppint32)(iqunsafe.ppPointer(cgbp + 1288))
		...
		aalens[aawhich] = iqlibc.ppInt32FromUint64(Xstrlen(cgtls, aaptname))

		/* ends in a digit, clearly a partition, so check */
		ccv3 = ppint32(*(*ppint8)(iqunsafe.ppPointer(aaptname + ppuintptr(aalens[aawhich]-ppint32(1)))))
		if ccv3 < 0 || ccv3 >= iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(8) {
			ccv6 = 0
		} else {
			ccv6 = iqlibc.ppBoolInt32(!!(ppuint64(*(*tn__uint32_t)(iqunsafe.ppPointer(ppuintptr(iqunsafe.ppPointer(&X_DefaultRuneLocale)) + 60 + ppuintptr(ccv3)*4)))&ppuint64(0x00000400) != 0))
		}
		ccv4 = ccv6
		goto cg_5
	cg_5:
	...
	cg_2:
		if ccv1 != 0 {
			...
			if *(*ppuint64)(iqunsafe.ppPointer(cgbp + 1296)) > ppuint64(1) {
				siprobe_one(cgtls, aacache, aaptname, aadevs[aawhich], 0, aaonly_if_new)
			}
			aalens[aawhich] = 0 /* mark as checked */
		}
		 ...
		 * it exists.
		 */
		if aalens[aalast] != 0 && !(Xstrncmp(cgtls, aaptnames[aalast], aaptname, iqlibc.ppUint64FromInt32(aalens[aalast])) != 0) {
			aap = (*tslist_head)(iqunsafe.ppPointer(aacache)).fdnext
			aapnext = (*tslist_head)(iqunsafe.ppPointer(aap)).fdnext
			for {
				if !(aap != aacache) {
				...
				aatmp = aap - ppuintptr(ppuint64(iqlibc.ppUintptrFromInt32(0)))
				if (*tsblkid_struct_dev)(iqunsafe.ppPointer(aatmp)).fdbid_devno == aadevs[aalast] {

					Xblkid_free_dev(cgtls, aatmp)
		...
		if aalens[aalast] != 0 && Xstrncmp(cgtls, aaptnames[aalast], aaptname, iqlibc.ppUint64FromInt32(aalens[aalast])) != 0 {
			...
			siprobe_one(cgtls, aacache, aaptnames[aalast], aadevs[aalast], 0, aaonly_if_new)
			aalens[aalast] = 0
		}
	}
	...
	Xfclose(cgtls, aaproc)
	Xblkid_flush_cache(cgtls, aacache)
	return 0
}

func Xblkid_probe_all(cgtls *iqlibc.ppTLS, aacache tnblkid_cache) (cgr ppint32) {

	var aaret ppint32
	pp_ = aaret

	aaret = siprobe_all(cgtls, aacache, 0)
	(*tsblkid_struct_cache)(iqunsafe.ppPointer(aacache)).fdbic_time = Xtime(cgtls, ppuintptr(0))

	*(*ppuint32)(iqunsafe.ppPointer(aacache + 48)) |= ppuint32(mvBLKID_BIC_FL_PROBED)

	return aaret
}

func Xblkid_probe_all_new(cgtls *iqlibc.ppTLS, aacache tnblkid_cache) (cgr ppint32) {

	var aaret ppint32
	pp_ = aaret

	aaret = siprobe_all(cgtls, aacache, ppint32(1))
...
func _access(*iqlibc.ppTLS, ppuintptr, ppint32) ppint32

func _blkid__scan_dir(*iqlibc.ppTLS, ppuintptr, ppint32, ppuintptr, ppuintptr)

func _blkid_devno_to_devname(*iqlibc.ppTLS, ppint32) ppuintptr

func _blkid_flush_cache(*iqlibc.ppTLS, ppuintptr) ppint32

func _blkid_free_dev(*iqlibc.ppTLS, ppuintptr)

func _blkid_new_dev(*iqlibc.ppTLS) ppuintptr

func _blkid_read_cache(*iqlibc.ppTLS, ppuintptr)

func _blkid_strdup(*iqlibc.ppTLS, ppuintptr) ppuintptr

func _blkid_verify(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppuintptr

func _closedir(*iqlibc.ppTLS, ppuintptr) ppint32

func _devname(*iqlibc.ppTLS, ppint32, ppuint16) ppuintptr
