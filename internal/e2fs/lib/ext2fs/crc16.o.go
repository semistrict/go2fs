...
//	 */
func Xext2fs_crc16(cgtls *iqlibc.ppTLS, aacrc tncrc16_t, aabuffer ppuintptr, aalen ppuint32) (cgr tncrc16_t) {

	var aacp, ccv2 ppuintptr
	var ccv1 ppuint32
	pp_, pp_, pp_ = aacp, ccv1, ccv2
	aacp = aabuffer
	...
	for {
		...
		ccv2 = aacp
		aacp = aacp + 1
		aacrc = (aacrc>>iqlibc.ppInt32FromInt32(8)&ppuint32(0xff) ^ ppuint32(sicrc16_table[(aacrc^ppuint32(*(*ppuint8)(iqunsafe.ppPointer(ccv2))))&ppuint32(0xff)])) & ppuint32(0x0000ffff)
	}
	return aacrc
}
