...
//	 */
func siflexbg_offset(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aastart_blk tnblk64_t, aabmap tnext2fs_block_bitmap, aarem_grp ppint32, aaelem_size ppint32) (cgr tnblk64_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaflexbg, aaflexbg_size, aasize ppint32
	var aalast_blk tnblk64_t
	var aalast_grp tndgrp_t
	var pp_ /* first_free at bp+0 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_ = aaflexbg, aaflexbg_size, aalast_blk, aalast_grp, aasize
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(0)

	aaflexbg_size = iqlibc.ppInt32FromUint32(ppuint32(1) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_groups_per_flex)
	aaflexbg = iqlibc.ppInt32FromUint32(aagroup / iqlibc.ppUint32FromInt32(aaflexbg_size))
	aasize = aarem_grp * aaelem_size

	if aasize > iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group/iqlibc.ppUint32FromInt32(4)) {
		aasize = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group) / ppint32(4)
	}
	 ...
	 */
	if aastart_blk != 0 && aastart_blk < Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) && Xext2fs_get_free_blocks2(cgtls, aafs, aastart_blk, aastart_blk+iqlibc.ppUint64FromInt32(aasize), aaelem_size, aabmap, cgbp) == 0 {
		return *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))
	}

	aastart_blk = Xext2fs_group_first_block2(cgtls, aafs, iqlibc.ppUint32FromInt32(aaflexbg_size*aaflexbg))
	aalast_grp = aagroup | iqlibc.ppUint32FromInt32(aaflexbg_size-iqlibc.ppInt32FromInt32(1))
	if aalast_grp > (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1) {
		aalast_grp = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count - ppuint32(1)
	}
	aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, aalast_grp)

	/* Find the first available block */
	if Xext2fs_get_free_blocks2(cgtls, aafs, aastart_blk, aalast_blk, aasize, aabmap, cgbp) == 0 {
		return *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))
	}

	if Xext2fs_get_free_blocks2(cgtls, aafs, aastart_blk, aalast_blk, aaelem_size, aabmap, cgbp) == 0 {
		return *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))
	}

	if Xext2fs_get_free_blocks2(cgtls, aafs, ppuint64(0), aalast_blk, aaelem_size, aabmap, cgbp) == 0 {
		return *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))
	}
...
func Xext2fs_allocate_group_table(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aabmap tnext2fs_block_bitmap) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aablk, aagroup_blk, aalast_blk, aan, aanum, aaprev_block, aaprev_block1, aaprev_block2 tnblk64_t
	var aaflexbg_size, aagr2, aarem_grps, aatable_offset, ccv1 ppint32
	var aagr, aagr1, aalast_grp tndgrp_t
	var aaretval tnerrcode_t
	var pp_ /* new_blk at bp+8 */ tnblk64_t
	var pp_ /* start_blk at bp+0 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablk, aaflexbg_size, aagr, aagr1, aagr2, aagroup_blk, aalast_blk, aalast_grp, aan, aanum, aaprev_block, aaprev_block1, aaprev_block2, aarem_grps, aaretval, aatable_offset, ccv1
	aalast_grp = ppuint32(0)
	aarem_grps = 0
	aaflexbg_size = 0
	aatable_offset = 0

	aagroup_blk = Xext2fs_group_first_block2(cgtls, aafs, aagroup)
	aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, aagroup)
...
cg_2:
	;
	if ccv1 != 0 && (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_groups_per_flex != 0 {
		aaflexbg_size = iqlibc.ppInt32FromUint32(ppuint32(1) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_groups_per_flex)
		aalast_grp = aagroup | iqlibc.ppUint32FromInt32(aaflexbg_size-iqlibc.ppInt32FromInt32(1))
		if aalast_grp > (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1) {
			aalast_grp = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count - ppuint32(1)
		}
		aarem_grps = iqlibc.ppInt32FromUint32(aalast_grp - aagroup + ppuint32(1))
	}

	/*
	 * Allocate the block and inode bitmaps, if necessary
	 */
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdstride != 0 && !(aaflexbg_size != 0) {
		aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, aagroup_blk, aalast_blk, ppint32(1), aabmap, cgbp)
		if aaretval != 0 {
			return aaretval
		}
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) + ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group)
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) + ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdstride*aagroup)%(aalast_blk-*(*tnblk64_t)(iqunsafe.ppPointer(cgbp))+ppuint64(1))
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) >= aalast_blk {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = aagroup_blk
		}
	} else {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = aagroup_blk
	}
	...
	if aaflexbg_size != 0 {
		aaprev_block = ppuint64(0)

		aatable_offset = aaflexbg_size
		if aagroup%iqlibc.ppUint32FromInt32(aaflexbg_size) != 0 {
			aaprev_block = Xext2fs_block_bitmap_loc(cgtls, aafs, aagroup-ppuint32(1)) + ppuint64(1)
		} else {
			if aalast_grp == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1) {
				/*
				 ...
				 */
				aatable_offset = iqlibc.ppInt32FromUint32(aalast_grp & iqlibc.ppUint32FromInt32(aaflexbg_size-iqlibc.ppInt32FromInt32(1)))
				if aatable_offset == 0 {
					aatable_offset = aaflexbg_size
				} else {
					aatable_offset = aatable_offset + 1
				}
			}
		}
		/* FIXME: Take backup group descriptor blocks into account
		 * if the flexbg allocations will grow to overlap them... */
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = siflexbg_offset(cgtls, aafs, aagroup, aaprev_block, aabmap, aarem_grps, ppint32(1))
		aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, aalast_grp)
	}

	if !(Xext2fs_block_bitmap_loc(cgtls, aafs, aagroup) != 0) {
		aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), aalast_blk, ppint32(1), aabmap, cgbp+8)
		if aaretval == ppint64(2133571400) {
			aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, aagroup_blk, aalast_blk, ppint32(1), aabmap, cgbp+8)
		}
		if aaretval != 0 {
			return aaretval
		}
		pp_ = Xext2fs_mark_generic_bmap(cgtls, aabmap, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
		goto cg_3
	cg_3:
		;
		Xext2fs_block_bitmap_loc_set(cgtls, aafs, aagroup, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
		if aaflexbg_size != 0 {
			aagr = Xext2fs_group_of_blk2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
			Xext2fs_bg_free_blocks_count_set(cgtls, aafs, aagr, Xext2fs_bg_free_blocks_count(cgtls, aafs, aagr)-ppuint32(1))
			Xext2fs_free_blocks_count_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper, iqlibc.ppUint64FromInt32(-iqlibc.ppInt32FromInt32(1)))
			Xext2fs_bg_flags_clear(cgtls, aafs, aagr, ppuint16(mvEXT2_BG_BLOCK_UNINIT))
			Xext2fs_group_desc_csum_set(cgtls, aafs, aagr)
		}
	}

	if aaflexbg_size != 0 {
		aaprev_block1 = ppuint64(0)
		if aagroup%iqlibc.ppUint32FromInt32(aaflexbg_size) != 0 {
			aaprev_block1 = Xext2fs_inode_bitmap_loc(cgtls, aafs, aagroup-ppuint32(1)) + ppuint64(1)
		} else {
			aaprev_block1 = Xext2fs_block_bitmap_loc(cgtls, aafs, aagroup) + iqlibc.ppUint64FromInt32(aatable_offset)
		}
		/* FIXME: Take backup group descriptor blocks into account
		 * if the flexbg allocations will grow to overlap them... */
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = siflexbg_offset(cgtls, aafs, aagroup, aaprev_block1, aabmap, aarem_grps, ppint32(1))
		aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, aalast_grp)
	}

	if !(Xext2fs_inode_bitmap_loc(cgtls, aafs, aagroup) != 0) {
		aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), aalast_blk, ppint32(1), aabmap, cgbp+8)
		if aaretval == ppint64(2133571400) {
			aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, aagroup_blk, aalast_blk, ppint32(1), aabmap, cgbp+8)
		}
	...
	cg_4:
		;
		Xext2fs_inode_bitmap_loc_set(cgtls, aafs, aagroup, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
		if aaflexbg_size != 0 {
			aagr1 = Xext2fs_group_of_blk2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
			Xext2fs_bg_free_blocks_count_set(cgtls, aafs, aagr1, Xext2fs_bg_free_blocks_count(cgtls, aafs, aagr1)-ppuint32(1))
			Xext2fs_free_blocks_count_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper, iqlibc.ppUint64FromInt32(-iqlibc.ppInt32FromInt32(1)))
			Xext2fs_bg_flags_clear(cgtls, aafs, aagr1, ppuint16(mvEXT2_BG_BLOCK_UNINIT))
			Xext2fs_group_desc_csum_set(cgtls, aafs, aagr1)
		}
	}
	 ...
	 */
	if aaflexbg_size != 0 {
		aaprev_block2 = ppuint64(0)

		if aagroup%iqlibc.ppUint32FromInt32(aaflexbg_size) != 0 {
			aaprev_block2 = Xext2fs_inode_table_loc(cgtls, aafs, aagroup-ppuint32(1)) + ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group)
		} else {
			aaprev_block2 = Xext2fs_inode_bitmap_loc(cgtls, aafs, aagroup) + iqlibc.ppUint64FromInt32(aatable_offset)
		}

		/* FIXME: Take backup group descriptor blocks into account
		 * if the flexbg allocations will grow to overlap them... */
		aagroup_blk = siflexbg_offset(cgtls, aafs, aagroup, aaprev_block2, aabmap, aarem_grps, iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group))
		aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, aalast_grp)
	}

	if !(Xext2fs_inode_table_loc(cgtls, aafs, aagroup) != 0) {
		aaretval = Xext2fs_get_free_blocks2(cgtls, aafs, aagroup_blk, aalast_blk, iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group), aabmap, cgbp+8)
		if aaretval != 0 {
			return aaretval
		}

		Xext2fs_mark_block_bitmap_range2(cgtls, aabmap, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group)
		if aaflexbg_size != 0 {
			aanum = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group)
			aablk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8))
			for aanum != 0 {
				aagr2 = iqlibc.ppInt32FromUint32(Xext2fs_group_of_blk2(cgtls, aafs, aablk))
				aalast_blk = Xext2fs_group_last_block2(cgtls, aafs, iqlibc.ppUint32FromInt32(aagr2))
				aan = aanum

				if aablk+aanum > aalast_blk {
					aan = aalast_blk - aablk + ppuint64(1)
				}

				Xext2fs_bg_free_blocks_count_set(cgtls, aafs, iqlibc.ppUint32FromInt32(aagr2), ppuint32(ppuint64(Xext2fs_bg_free_blocks_count(cgtls, aafs, iqlibc.ppUint32FromInt32(aagr2)))-aan/iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)))
				Xext2fs_bg_flags_clear(cgtls, aafs, iqlibc.ppUint32FromInt32(aagr2), ppuint16(mvEXT2_BG_BLOCK_UNINIT))
				Xext2fs_group_desc_csum_set(cgtls, aafs, iqlibc.ppUint32FromInt32(aagr2))
				Xext2fs_free_blocks_count_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper, -aan)
				aablk = aablk + aan
				aanum = aanum - aan
			}
		}
		Xext2fs_inode_table_loc_set(cgtls, aafs, aagroup, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
	}
	Xext2fs_group_desc_csum_set(cgtls, aafs, aagroup)
	return 0
}

func Xext2fs_allocate_tables(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdinit1 != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr, tn__u64))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdinit1})))(cgtls, aafs, cgbp, iqlibc.ppUintptrFromInt32(0), ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count))
	}
	...
	for {
		...
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdupdate != 0 {
			(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tn__u64))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdupdate})))(cgtls, aafs, cgbp, ppuint64(aai))
		}
		aaretval = Xext2fs_allocate_group_table(cgtls, aafs, aai, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map)
		if aaretval != 0 {
			return aaretval
		}
	...
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdclose1 != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdprogress_ops)).fdclose1})))(cgtls, aafs, cgbp, iqlibc.ppUintptrFromInt32(0))
	}
	return 0
}
...
func _ext2fs_block_bitmap_loc_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint64)

func _ext2fs_blocks_count(*iqlibc.ppTLS, ppuintptr) ppuint64

func _ext2fs_free_blocks_count_add(*iqlibc.ppTLS, ppuintptr, ppuint64)

func _ext2fs_get_free_blocks2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppint32, ppuintptr, ppuintptr) ppint64
...
func _ext2fs_group_last_block2(*iqlibc.ppTLS, ppuintptr, ppuint32) ppuint64
...
func _ext2fs_inode_bitmap_loc_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint64)

func _ext2fs_inode_table_loc(*iqlibc.ppTLS, ppuintptr, ppuint32) ppuint64

func _ext2fs_inode_table_loc_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint64)
