...
type tsbmap_rb_extent = struct {
	fdnode  tsrb_node
	fdstart tn__u64
	fdcount tn__u64
}

type tsext2fs_rb_private = struct {
	fdroot         tsrb_root
	fdwcursor      ppuintptr
	fdrcursor      ppuintptr
	fdrcursor_next ppuintptr
}

func sinode_to_extent(cgtls *iqlibc.ppTLS, aanode ppuintptr) (cgr ppuintptr) {
...
func sirb_get_new_extent(cgtls *iqlibc.ppTLS, aaext ppuintptr, aastart tn__u64, aacount tn__u64) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval ppint32
	var ccv1 tnerrcode_t
	var pp_ /* new_ext at bp+8 */ ppuintptr
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(40))
	...
	goto cg_2
cg_2:
	aaretval = ppint32(ccv1)
	if aaretval != 0 {
		Xabort(cgtls)
	}

	(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdstart = aastart
	(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdcount = aacount
	*(*ppuintptr)(iqunsafe.ppPointer(aaext)) = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8))
}

func sirb_free_extent(cgtls *iqlibc.ppTLS, aabp ppuintptr, cg_ext ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = cg_ext

	var ccv1 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_ = ccv1
	if (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdwcursor == *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) {
		(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdwcursor = iqlibc.ppUintptrFromInt32(0)
	}
	if (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor == *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) {
		(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor = iqlibc.ppUintptrFromInt32(0)
	}
	if (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next == *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) {
		(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next = iqlibc.ppUintptrFromInt32(0)
	}
	ccv1 = cgbp + 8
...
func sirb_alloc_private_data(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval, ccv1 tnerrcode_t
	var pp_ /* bp at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_ = aaretval, ccv1

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(32))
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_2
	}
...
cg_2:
	...
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdroot = tsrb_root{}
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdrcursor = iqlibc.ppUintptrFromInt32(0)
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdrcursor_next = iqlibc.ppUintptrFromInt32(0)
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdwcursor = iqlibc.ppUintptrFromInt32(0)

	(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdprivate = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8))
	return 0
}

func sirb_new_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aabitmap tnext2fs_generic_bitmap_64) (cgr tnerrcode_t) {

	var aaretval tnerrcode_t
	pp_ = aaretval

	aaretval = sirb_alloc_private_data(cgtls, aabitmap)
	if aaretval != 0 {
		return aaretval
	}
...
func sirb_free_tree(cgtls *iqlibc.ppTLS, aaroot ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aanext, aanode, ccv2 ppuintptr
	var pp_ /* ext at bp+8 */ ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_ = aanext, aanode, ccv2

	aanode = Xext2fs_rb_first(cgtls, aaroot)
	for {
		if !(aanode != 0) {
			break
		}
		aanext = Xext2fs_rb_next(cgtls, aanode)
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = sinode_to_extent(cgtls, aanode)
		Xext2fs_rb_erase(cgtls, aanode, aaroot)
		ccv2 = cgbp + 8
...
func sirb_free_bmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdprivate

	sirb_free_tree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
	ccv1 = cgbp + 8
	Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
	Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
...
func sirb_copy_bmap(cgtls *iqlibc.ppTLS, aasrc tnext2fs_generic_bitmap_64, aadest tnext2fs_generic_bitmap_64) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aadest_bp, aadest_last, aadest_node, aan, aasrc_bp, aasrc_ext, aasrc_node, ccv3, ccv4 ppuintptr
	var aaretval, ccv1 tnerrcode_t
	var pp_ /* dest_ext at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadest_bp, aadest_last, aadest_node, aan, aaretval, aasrc_bp, aasrc_ext, aasrc_node, ccv1, ccv3, ccv4
	aaretval = 0

	aaretval = sirb_alloc_private_data(cgtls, aadest)
	if aaretval != 0 {
		return aaretval
	}
	...
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(aasrc_bp)).fdrcursor = iqlibc.ppUintptrFromInt32(0)
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(aadest_bp)).fdrcursor = iqlibc.ppUintptrFromInt32(0)

	aasrc_node = Xext2fs_rb_first(cgtls, aasrc_bp)
	for aasrc_node != 0 {
		aasrc_ext = sinode_to_extent(cgtls, aasrc_node)
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(40))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
			ccv1 = iqlibc.ppInt64FromInt64(2133571398)
			goto cg_2
	...
	cg_2:
		...
		Xmemcpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), aasrc_ext, ppuint64(40))

		aadest_node = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8))
		aan = aadest_bp

		aadest_last = iqlibc.ppUintptrFromInt32(0)
		if *(*ppuintptr)(iqunsafe.ppPointer(aan)) != 0 {
			aadest_last = Xext2fs_rb_last(cgtls, aadest_bp)
			aan = aadest_last + 8
		}

		ccv3 = aadest_node
		(*tsrb_node)(iqunsafe.ppPointer(ccv3)).fdrb_parent_color = ppuint64(aadest_last)
		ccv4 = iqlibc.ppUintptrFromInt32(0)
		(*tsrb_node)(iqunsafe.ppPointer(ccv3)).fdrb_right = ccv4
		(*tsrb_node)(iqunsafe.ppPointer(ccv3)).fdrb_left = ccv4
		*(*ppuintptr)(iqunsafe.ppPointer(aan)) = ccv3
		Xext2fs_rb_insert_color(cgtls, aadest_node, aadest_bp)

		aasrc_node = Xext2fs_rb_next(cgtls, aasrc_node)
	}

	return aaretval
}

func sirb_truncate(cgtls *iqlibc.ppTLS, aanew_max tn__u64, aaroot ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aanode, ccv1 ppuintptr
	var pp_ /* ext at bp+8 */ ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_ = aanode, ccv1

	aanode = Xext2fs_rb_last(cgtls, aaroot)
	for aanode != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = sinode_to_extent(cgtls, aanode)

		if (*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdcount-ppuint64(1) <= aanew_max {
			break
		} else {
			if (*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdstart > aanew_max {
				Xext2fs_rb_erase(cgtls, aanode, aaroot)
				ccv1 = cgbp + 8
				Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
				Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
			...
			cg_2:
				...
				(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdcount = aanew_max - (*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))).fdstart + ppuint64(1)
			}
		}
	}
}

func sirb_resize_bmap(cgtls *iqlibc.ppTLS, aabmap tnext2fs_generic_bitmap_64, aanew_end tn__u64, aanew_real_end tn__u64) (cgr tnerrcode_t) {
	...
	if aanew_end < (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdend {
		...
		ccv1 = (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdend
	}
	sirb_truncate(cgtls, ccv1-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdstart, aabp)
	...
	if (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdend < (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdreal_end {
		sirb_insert_extent(cgtls, (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdend+ppuint64(1)-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdstart, (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdreal_end-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdend, aabp)
	}
	return 0

}

func sirb_test_bit(cgtls *iqlibc.ppTLS, aabp ppuintptr, aabit tn__u64) (cgr ppint32) {

	var aaext, aan, aanext, aanext_ext, aaparent, aarcursor ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_ = aaext, aan, aanext, aanext_ext, aaparent, aarcursor
	aanext_ext = iqlibc.ppUintptrFromInt32(0)
	aaparent = iqlibc.ppUintptrFromInt32(0)
	aan = aabp

	aarcursor = (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor
	if !(aarcursor != 0) {
		goto ppsearch_tree
	}

	if aabit >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aarcursor)).fdstart && aabit < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aarcursor)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aarcursor)).fdcount {
		return ppint32(1)
	}

	aanext_ext = (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next
	if !(aanext_ext != 0) {
		aanext = Xext2fs_rb_next(cgtls, aarcursor)
		if aanext != 0 {
			aanext_ext = sinode_to_extent(cgtls, aanext)
		}
		(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next = aanext_ext
	}
	if aanext_ext != 0 {
		if aabit >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aarcursor)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aarcursor)).fdcount && aabit < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aanext_ext)).fdstart {
			return 0
		}
	}
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor = iqlibc.ppUintptrFromInt32(0)
	...
	aarcursor = (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdwcursor
	if !(aarcursor != 0) {
		goto ppsearch_tree
	}
...
ppsearch_tree:
	...
	for *(*ppuintptr)(iqunsafe.ppPointer(aan)) != 0 {
		aaparent = *(*ppuintptr)(iqunsafe.ppPointer(aan))
		aaext = sinode_to_extent(cgtls, aaparent)
		if aabit < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart {
			aan = *(*ppuintptr)(iqunsafe.ppPointer(aan)) + 16
		} else {
			if aabit >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
				aan = *(*ppuintptr)(iqunsafe.ppPointer(aan)) + 8
			} else {
				(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor = aaext
				(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next = iqlibc.ppUintptrFromInt32(0)
				return ppint32(1)
			}
		}
...
func sirb_insert_extent(cgtls *iqlibc.ppTLS, aastart tn__u64, aacount tn__u64, aabp ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaext, aan, aanew_node, aanext, aanode1, aaparent1, aaroot, ccv7, ccv8 ppuintptr
	var aaretval ppint32
	var pp_ /* new_ext at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaext, aan, aanew_node, aanext, aanode1, aaparent1, aaretval, aaroot, ccv7, ccv8
	aaroot = aabp
	aaparent1 = iqlibc.ppUintptrFromInt32(0)
	aan = aaroot
	aaretval = 0
	...
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdrcursor_next = iqlibc.ppUintptrFromInt32(0)
	aaext = (*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdwcursor
	if aaext != 0 {
		if aastart >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart && aastart <= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
			goto ppgot_extent
		}
	}
...
cg_2:
	...
	aaparent1 = *(*ppuintptr)(iqunsafe.ppPointer(aan))
	aaext = sinode_to_extent(cgtls, aaparent1)

	if !(aastart < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart) {
		goto cg_3
	}
	aan = *(*ppuintptr)(iqunsafe.ppPointer(aan)) + 16
	goto cg_4
cg_3:
	;
	if !(aastart > (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount) {
		goto cg_5
	}
	aan = *(*ppuintptr)(iqunsafe.ppPointer(aan)) + 8
	goto cg_6
...
ppgot_extent:
	;
	if aastart+aacount <= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
		return ppint32(1)
	}

	if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount == aastart {
		aaretval = 0
	} else {
		aaretval = ppint32(1)
	}

	aacount = aacount + (aastart - (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart)
	aastart = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = aaext
	aanew_node = aaext
...
cg_1:
	...
	sirb_get_new_extent(cgtls, cgbp, aastart, aacount)

	aanew_node = *(*ppuintptr)(iqunsafe.ppPointer(cgbp))
	ccv7 = aanew_node
	(*tsrb_node)(iqunsafe.ppPointer(ccv7)).fdrb_parent_color = ppuint64(aaparent1)
	ccv8 = iqlibc.ppUintptrFromInt32(0)
	(*tsrb_node)(iqunsafe.ppPointer(ccv7)).fdrb_right = ccv8
	(*tsrb_node)(iqunsafe.ppPointer(ccv7)).fdrb_left = ccv8
	*(*ppuintptr)(iqunsafe.ppPointer(aan)) = ccv7
	Xext2fs_rb_insert_color(cgtls, aanew_node, aaroot)
	(*tsext2fs_rb_private)(iqunsafe.ppPointer(aabp)).fdwcursor = *(*ppuintptr)(iqunsafe.ppPointer(cgbp))

	aanode1 = Xext2fs_rb_prev(cgtls, aanew_node)
	if aanode1 != 0 {
		aaext = sinode_to_extent(cgtls, aanode1)
		if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount == aastart {
			aastart = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart
			aacount = aacount + (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount
			Xext2fs_rb_erase(cgtls, aanode1, aaroot)
			sirb_free_extent(cgtls, aabp, aaext)
		}
	}
...
ppskip_insert:
	...
	aanode1 = Xext2fs_rb_next(cgtls, aanew_node)
	for {
		if !(aanode1 != iqlibc.ppUintptrFromInt32(0)) {
			break
		}
		aanext = Xext2fs_rb_next(cgtls, aanode1)
		aaext = sinode_to_extent(cgtls, aanode1)
		...
		/* No more merging */
		if aastart+aacount < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart {
			break
		}
		...
		if aastart+aacount >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
			...
			aacount = aacount + ((*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart + (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount - (aastart + aacount))
			Xext2fs_rb_erase(cgtls, aanode1, aaroot)
			sirb_free_extent(cgtls, aabp, aaext)
			break
		}
	...
	(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)))).fdstart = aastart
	(*tsbmap_rb_extent)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)))).fdcount = aacount

	return aaretval
}

func sirb_remove_extent(cgtls *iqlibc.ppTLS, aastart tn__u64, aacount tn__u64, aabp ppuintptr) (cgr ppint32) {

	var aaext, aan, aanode, aaparent, aaroot1 ppuintptr
	var aanew_count, aanew_start tn__u64
	var aaretval, ccv1 ppint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaext, aan, aanew_count, aanew_start, aanode, aaparent, aaretval, aaroot1, ccv1
	aaroot1 = aabp
	aaparent = iqlibc.ppUintptrFromInt32(0)
	aan = aaroot1
	aaretval = 0

	ccv1 = iqlibc.ppBoolInt32((*tsrb_root)(iqunsafe.ppPointer(aaroot1)).fdrb_node == iqlibc.ppUintptrFromInt32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		return 0
	...
	for *(*ppuintptr)(iqunsafe.ppPointer(aan)) != 0 {
		...
		if aastart > (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart && aastart+aacount < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
			/* We have to split extent into two */
			aanew_start = aastart + aacount
			aanew_count = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart + (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount - aanew_start

			(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount = aastart - (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart

			sirb_insert_extent(cgtls, aanew_start, aanew_count, aabp)
			return ppint32(1)
		}
		...
		if ppuint64(0) == (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
			aaparent = Xext2fs_rb_next(cgtls, aaext)
			Xext2fs_rb_erase(cgtls, aaext, aaroot1)
			sirb_free_extent(cgtls, aabp, aaext)
			break
		}
		...
		if aastart == (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart {
			...
			*(*tn__u64)(iqunsafe.ppPointer(aaext + 24)) += aacount

			*(*tn__u64)(iqunsafe.ppPointer(aaext + 32)) -= aacount
			return ppint32(1)
		}
	}
	...
	for {
		if !(aaparent != iqlibc.ppUintptrFromInt32(0)) {
			break
		}
		aanode = Xext2fs_rb_next(cgtls, aaparent)
		aaext = sinode_to_extent(cgtls, aaparent)
		if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount <= aastart {
			goto cg_3
		}
		...
		if aastart+aacount >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
			Xext2fs_rb_erase(cgtls, aaparent, aaroot1)
			sirb_free_extent(cgtls, aabp, aaext)
			aaretval = ppint32(1)
			goto cg_3
		} else {
			...
			*(*tn__u64)(iqunsafe.ppPointer(aaext + 32)) -= aastart + aacount - (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart
			(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart = aastart + aacount
			aaretval = ppint32(1)
			break
		}
...
func sirb_mark_bmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aaarg tn__u64) (cgr ppint32) {

	var aabp ppuintptr
	var aaretval ppint32
	pp_, pp_ = aabp, aaretval

	aabp = (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdprivate
	aaarg = aaarg - (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart

	aaretval = sirb_insert_extent(cgtls, aaarg, ppuint64(1), aabp)

	return aaretval
}

func sirb_unmark_bmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aaarg tn__u64) (cgr ppint32) {
	...
	aaretval = sirb_remove_extent(cgtls, aaarg, ppuint64(1), aabp)

	return aaretval
}

func sirb_test_bmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aaarg tn__u64) (cgr ppint32) {
	...
	return sirb_test_bit(cgtls, aabp, aaarg)
}

func sirb_mark_bmap_extent(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aaarg tn__u64, aanum ppuint32) {
	...
	sirb_insert_extent(cgtls, aaarg, ppuint64(aanum), aabp)

}

func sirb_unmark_bmap_extent(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aaarg tn__u64, aanum ppuint32) {
	...
	sirb_remove_extent(cgtls, aaarg, ppuint64(aanum), aabp)

}

func sirb_test_clear_bmap_extent(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aastart tn__u64, aalen ppuint32) (cgr ppint32) {

	var aabp, aaext, aan, aanext, aanode, aaparent ppuintptr
	var aaretval, ccv1 ppint32
	var ccv3 ppbool
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabp, aaext, aan, aanext, aanode, aaparent, aaretval, ccv1, ccv3
	aaparent = iqlibc.ppUintptrFromInt32(0)
	aaretval = ppint32(1)
	...
	if ccv3 = aalen == ppuint32(0); !ccv3 {
		ccv1 = iqlibc.ppBoolInt32((*tsrb_root)(iqunsafe.ppPointer(aabp)).fdrb_node == iqlibc.ppUintptrFromInt32(0))
		goto cg_2
	cg_2:
	}
	if ccv3 || ccv1 != 0 {
	...
	for aanode != 0 {
		aanext = Xext2fs_rb_next(cgtls, aanode)
		aaext = sinode_to_extent(cgtls, aanode)
		aanode = aanext
		...
		/* No more merging */
		if aastart+ppuint64(aalen) <= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart {
			break
		}
...
func sirb_set_bmap_range(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aastart tn__u64, aanum tnsize_t, aain ppuintptr) (cgr tnerrcode_t) {

	var aabp, aacp ppuintptr
	var aac ppuint8
	var aafirst_set ppint32
	var aai tnsize_t
	pp_, pp_, pp_, pp_, pp_ = aabp, aac, aacp, aafirst_set, aai
	aacp = aain
	aafirst_set = -ppint32(1)
	...
	for {
		...
		if aai&ppuint64(7) == ppuint64(0) {
			aac = *(*ppuint8)(iqunsafe.ppPointer(aacp + ppuintptr(aai/ppuint64(8))))
			if iqlibc.ppInt32FromUint8(aac) == ppint32(0xFF) {
				if aafirst_set == -ppint32(1) {
					aafirst_set = iqlibc.ppInt32FromUint64(aai)
				}
				aai = aai + ppuint64(7)
				goto cg_1
			}
			if iqlibc.ppInt32FromUint8(aac) == 0x00 && aafirst_set == -ppint32(1) {
				aai = aai + ppuint64(7)
				goto cg_1
			}
		}
		if Xext2fs_test_bit(cgtls, ppuint32(aai), aain) != 0 {
			if aafirst_set == -ppint32(1) {
				aafirst_set = iqlibc.ppInt32FromUint64(aai)
			}
			goto cg_1
		...
		sirb_insert_extent(cgtls, aastart+iqlibc.ppUint64FromInt32(aafirst_set)-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart, ppuint64(aai-iqlibc.ppUint64FromInt32(aafirst_set)), aabp)
	...
	if aafirst_set != -ppint32(1) {
		sirb_insert_extent(cgtls, aastart+iqlibc.ppUint64FromInt32(aafirst_set)-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart, ppuint64(aanum-iqlibc.ppUint64FromInt32(aafirst_set)), aabp)
...
func sirb_get_bmap_range(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aastart tn__u64, aanum tnsize_t, aaout ppuintptr) (cgr tnerrcode_t) {

	var aaADDR, aabp, aaext, aan, aanext, aaparent, ccv5 ppuintptr
	var aacount, aapos, ccv4 tn__u64
	var aanbytes, aaoffset, ccv1 ppint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaADDR, aabp, aacount, aaext, aan, aanbytes, aanext, aaoffset, aaparent, aapos, ccv1, ccv4, ccv5
...
cg_2:
	...
	Xmemset(cgtls, aaout, 0, (aanum+ppuint64(7))>>ppint32(3))

	for {
		if !(aaparent != iqlibc.ppUintptrFromInt32(0)) {
			break
		}
		aanext = Xext2fs_rb_next(cgtls, aaparent)
		aaext = sinode_to_extent(cgtls, aaparent)

		aapos = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart
		aacount = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount
		if aapos >= aastart+ppuint64(aanum) {
			break
		}
		if aapos < aastart {
			if aapos+aacount < aastart {
				goto cg_3
			}
			aacount = aacount - (aastart - aapos)
			aapos = aastart
		}
		if aapos+aacount > aastart+ppuint64(aanum) {
			aacount = aastart + ppuint64(aanum) - aapos
		}

		for aacount > ppuint64(0) {
			if aacount >= ppuint64(8) && (aapos-aastart)%ppuint64(8) == ppuint64(0) {
				aanbytes = iqlibc.ppInt32FromUint64(aacount >> ppint32(3))
				aaoffset = iqlibc.ppInt32FromUint64((aapos - aastart) >> ppint32(3))

				Xmemset(cgtls, aaout+ppuintptr(aaoffset), ppint32(0xFF), iqlibc.ppUint64FromInt32(aanbytes))
				aapos = aapos + iqlibc.ppUint64FromInt32(aanbytes<<ppint32(3))
				aacount = aacount - iqlibc.ppUint64FromInt32(aanbytes<<ppint32(3))
				continue
			}
			ccv4 = aapos - aastart
			aaADDR = aaout
			aaADDR = aaADDR + ppuintptr(ccv4>>ppint32(3))
			ccv5 = aaADDR
			*(*ppuint8)(iqunsafe.ppPointer(ccv5)) = ppuint8(ppint32(*(*ppuint8)(iqunsafe.ppPointer(ccv5))) | iqlibc.ppInt32FromUint8(iqlibc.ppUint8FromInt32(iqlibc.ppInt32FromInt32(1)<<(ccv4&iqlibc.ppUint64FromInt32(0x07)))))
			aapos = aapos + 1
			aacount = aacount - 1
		}
...
func sirb_clear_bmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64) {
...
func sirb_find_first_zero(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aastart tn__u64, aaend tn__u64, aaout ppuintptr) (cgr tnerrcode_t) {

	var aabp, aaext, aan, aaparent ppuintptr
	var ccv1 ppint32
	pp_, pp_, pp_, pp_, pp_ = aabp, aaext, aan, aaparent, ccv1
	aaparent = iqlibc.ppUintptrFromInt32(0)

	aabp = (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdprivate
	aan = aabp
	aastart = aastart - (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart
	aaend = aaend - (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart
...
cg_2:
	...
	for *(*ppuintptr)(iqunsafe.ppPointer(aan)) != 0 {
		...
		if aastart < (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart {
			...
			if aastart >= (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount {
				...
				if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart+(*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount <= aaend {
					*(*tn__u64)(iqunsafe.ppPointer(aaout)) = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart + (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount + (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart
					return 0
				} else {
					return ppint64(mvENOENT)
				}
	...
	*(*tn__u64)(iqunsafe.ppPointer(aaout)) = aastart + (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart
	return 0
}

func sirb_find_first_set(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64, aastart tn__u64, aaend tn__u64, aaout ppuintptr) (cgr tnerrcode_t) {

	var aabp, aaext, aan, aanode, aaparent ppuintptr
	var ccv1 ppint32
	pp_, pp_, pp_, pp_, pp_, pp_ = aabp, aaext, aan, aanode, aaparent, ccv1
	aaparent = iqlibc.ppUintptrFromInt32(0)
...
cg_2:
	...
	aanode = aaparent
	aaext = sinode_to_extent(cgtls, aanode)
	if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart < aastart {
		aanode = Xext2fs_rb_next(cgtls, aanode)
		if aanode == iqlibc.ppUintptrFromInt32(0) {
			return ppint64(mvENOENT)
		}
		aaext = sinode_to_extent(cgtls, aanode)
	}
	if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart <= aaend {
		*(*tn__u64)(iqunsafe.ppPointer(aaout)) = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdstart + (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart
		return 0
	}
	return ppint64(mvENOENT)
}

func sirb_print_stats(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap_64) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaavg_size, aacount, aamax_size, aamin_size, aasize tn__u64
	var aabp, aaext, aanode ppuintptr
	var aaeff ppfloat64
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaavg_size, aabp, aacount, aaeff, aaext, aamax_size, aamin_size, aanode, aasize
	aanode = iqlibc.ppUintptrFromInt32(0)
	aacount = ppuint64(0)
	aamax_size = ppuint64(0)
	aamin_size = ppuint64(iqlibc.ppUint64FromInt64(9223372036854775807)*iqlibc.ppUint64FromUint64(2) + iqlibc.ppUint64FromUint64(1))
	aasize = ppuint64(0)
	aaavg_size = ppuint64(0)

	aabp = (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdprivate

	aanode = Xext2fs_rb_first(cgtls, aabp)
	for {
		if !(aanode != iqlibc.ppUintptrFromInt32(0)) {
			break
		}
		aaext = sinode_to_extent(cgtls, aanode)
		aacount = aacount + 1
		if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount > aamax_size {
			aamax_size = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount
		}
		if (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount < aamin_size {
			aamin_size = (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount
		}
		aasize = aasize + (*tsbmap_rb_extent)(iqunsafe.ppPointer(aaext)).fdcount
	...
	if aacount != 0 {
		aaavg_size = aasize / aacount
	}
	if aamin_size == ppuint64(iqlibc.ppUint64FromInt64(9223372036854775807)*iqlibc.ppUint64FromUint64(2)+iqlibc.ppUint64FromUint64(1)) {
		aamin_size = ppuint64(0)
	}
	aaeff = ppfloat64(aacount*iqlibc.ppUint64FromInt64(40)<<iqlibc.ppInt32FromInt32(3)) / ppfloat64((*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdreal_end-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart)
	Xfprintf(cgtls, X__stderrp, "%16llu extents (%llu bytes)\n\x00", iqlibc.ppVaList(cgbp+8, aacount, aacount*iqlibc.ppUint64FromInt64(40)+iqlibc.ppUint64FromInt64(32)))
	Xfprintf(cgtls, X__stderrp, "%16llu bits minimum size\n\x00", iqlibc.ppVaList(cgbp+8, aamin_size))
	Xfprintf(cgtls, X__stderrp, "%16llu bits maximum size\n%16llu bits average size\n\x00", iqlibc.ppVaList(cgbp+8, aamax_size, aaavg_size))
	Xfprintf(cgtls, X__stderrp, "%16llu bits set in bitmap (out of %llu)\n\x00", iqlibc.ppVaList(cgbp+8, aasize, (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdreal_end-(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabitmap)).fdstart))
	Xfprintf(cgtls, X__stderrp, "%16.4lf memory / bitmap bit memory ratio (bitarray = 1)\n\x00", iqlibc.ppVaList(cgbp+8, aaeff))
}

var Xext2fs_blkmap64_rbtree = tsext2_bitmap_ops{
	fdtype1: ppint32(mvEXT2FS_BMAP64_RBTREE),
}

func init() {
	p := iqunsafe.ppPointer(&Xext2fs_blkmap64_rbtree)
	*(*uintptr)(iqunsafe.ppAdd(p, 8)) = pp__ccgo_fp(sirb_new_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 16)) = pp__ccgo_fp(sirb_free_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 24)) = pp__ccgo_fp(sirb_copy_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 32)) = pp__ccgo_fp(sirb_resize_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 40)) = pp__ccgo_fp(sirb_mark_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 48)) = pp__ccgo_fp(sirb_unmark_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 56)) = pp__ccgo_fp(sirb_test_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 64)) = pp__ccgo_fp(sirb_mark_bmap_extent)
	*(*uintptr)(iqunsafe.ppAdd(p, 72)) = pp__ccgo_fp(sirb_unmark_bmap_extent)
	*(*uintptr)(iqunsafe.ppAdd(p, 80)) = pp__ccgo_fp(sirb_test_clear_bmap_extent)
	*(*uintptr)(iqunsafe.ppAdd(p, 88)) = pp__ccgo_fp(sirb_set_bmap_range)
	*(*uintptr)(iqunsafe.ppAdd(p, 96)) = pp__ccgo_fp(sirb_get_bmap_range)
	*(*uintptr)(iqunsafe.ppAdd(p, 104)) = pp__ccgo_fp(sirb_clear_bmap)
	*(*uintptr)(iqunsafe.ppAdd(p, 112)) = pp__ccgo_fp(sirb_print_stats)
	*(*uintptr)(iqunsafe.ppAdd(p, 120)) = pp__ccgo_fp(sirb_find_first_zero)
	*(*uintptr)(iqunsafe.ppAdd(p, 128)) = pp__ccgo_fp(sirb_find_first_set)
}
...
func _ext2fs_rb_erase(*iqlibc.ppTLS, ppuintptr, ppuintptr)

func _ext2fs_rb_first(*iqlibc.ppTLS, ppuintptr) ppuintptr

func _ext2fs_rb_insert_color(*iqlibc.ppTLS, ppuintptr, ppuintptr)

func _ext2fs_rb_last(*iqlibc.ppTLS, ppuintptr) ppuintptr

func _ext2fs_rb_next(*iqlibc.ppTLS, ppuintptr) ppuintptr

func _ext2fs_rb_prev(*iqlibc.ppTLS, ppuintptr) ppuintptr
