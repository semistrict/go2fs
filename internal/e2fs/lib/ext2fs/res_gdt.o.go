...
//	 */
func Xext2fs_list_backups(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aathree ppuintptr, aafive ppuintptr, aaseven ppuintptr) (cgr tndgrp_t) {

	var aamin ppuintptr
	var aamult ppuint64
	var aaret tndgrp_t
	var ccv1, ccv4 ppint32
	var ccv3, ccv6 ppbool
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aamin, aamult, aaret, ccv1, ccv3, ccv4, ccv6
	aamin = aathree
	aamult = ppuint64(3)
	...
	if ccv3 && ccv1 != 0 {
		if *(*tndgrp_t)(iqunsafe.ppPointer(aamin)) == ppuint32(1) {

			*(*tndgrp_t)(iqunsafe.ppPointer(aamin)) += ppuint32(1)
			if *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588)) != 0 {
				return *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588))
			}
		}
		if *(*tndgrp_t)(iqunsafe.ppPointer(aamin)) == ppuint32(2) {

			*(*tndgrp_t)(iqunsafe.ppPointer(aamin)) += ppuint32(1)
			if *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588 + 1*4)) != 0 {
				return *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588 + 1*4))
			}
		}

		return (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count
	}
	...
	if ccv3 && !(ccv1 != 0) {
		aaret = *(*tndgrp_t)(iqunsafe.ppPointer(aamin))
	...
	if *(*tndgrp_t)(iqunsafe.ppPointer(aafive)) < *(*tndgrp_t)(iqunsafe.ppPointer(aamin)) {
		aamin = aafive
		aamult = ppuint64(5)
	}
	if *(*tndgrp_t)(iqunsafe.ppPointer(aaseven)) < *(*tndgrp_t)(iqunsafe.ppPointer(aamin)) {
		aamin = aaseven
		aamult = ppuint64(7)
	}

	aaret = *(*tndgrp_t)(iqunsafe.ppPointer(aamin))
	aamult = aamult * ppuint64(*(*tndgrp_t)(iqunsafe.ppPointer(aamin)))
	if aamult > ppuint64(iqlibc.ppUint32FromInt32(-iqlibc.ppInt32FromInt32(1))) {
		*(*tndgrp_t)(iqunsafe.ppPointer(aamin)) = iqlibc.ppUint32FromInt32(-iqlibc.ppInt32FromInt32(1))
	} else {
		*(*tndgrp_t)(iqunsafe.ppPointer(aamin)) = ppuint32(aamult)
	}
...
//	 */
func Xext2fs_create_resize_inode(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)

	var aaapb, aainode_size, ccv1, ccv2 ppuint64
	var aadindir_dirty, aagdt_dirty, aainode_dirty, aasb_blk, ccv13, ccv14, ccv16, ccv8 ppint32
	var aaexpect, aagdt_blk, aagdt_off, aagoal, aarsv_off, ccv7 tnblk_t
	var aaextra, ccv21, ccv26 tn__u32
	var aagdt_buf, aasb, ccv30 ppuintptr
	var aagrp, aalast, ccv15 tndgrp_t
	var aanow, ccv10, ccv18, ccv20, ccv25 tntime_t
	var aaretval, aaretval2, ccv3, ccv5 tnerrcode_t
	var ccv17, ccv9 tnext2_filsys
	var ccv23, ccv24, ccv28, ccv29 ppint64
	var pp_ /* dindir_blk at bp+152 */ tnblk_t
	var pp_ /* dindir_buf at bp+144 */ ppuintptr
	var pp_ /* five at bp+160 */ tndgrp_t
	var pp_ /* inode at bp+16 */ tsext2_inode
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* seven at bp+164 */ tndgrp_t
	var pp_ /* three at bp+156 */ tndgrp_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaapb, aadindir_dirty, aaexpect, aaextra, aagdt_blk, aagdt_buf, aagdt_dirty, aagdt_off, aagoal, aagrp, aainode_dirty, aainode_size, aalast, aanow, aaretval, aaretval2, aarsv_off, aasb, aasb_blk, ccv1, ccv10, ccv13, ccv14, ccv15, ccv16, ccv17, ccv18, ccv2, ccv20, ccv21, ccv23, ccv24, ccv25, ccv26, ccv28, ccv29, ccv3, ccv30, ccv5, ccv7, ccv8, ccv9
	aadindir_dirty = 0
	aainode_dirty = 0
	aasb_blk = 0
	...
	aasb = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper

	ccv1 = ppuint64(2)
	ccv2 = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize)
...
cg_4:
	...
	aagdt_buf = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize)

	aaretval = Xext2fs_read_inode(cgtls, aafs1, ppuint32(mvEXT2_RESIZE_INO), cgbp+16)
	if aaretval != 0 {
		goto ppout_free
	}
	 ...
	 */
	aasb_blk = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_first_data_block)
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize == ppuint32(1024) && aasb_blk == 0 {
		aasb_blk = ppint32(1)
	}

	/* Maximum possible file size (we only use double indirect blocks) */
	aaapb = ppuint64(iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE)<<(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_log_block_size) / iqlibc.ppUint64FromInt64(4))
	ccv7 = *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4))
	*(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)) = ccv7
	if ccv7 != 0 {
		aaretval = Xext2fs_read_ind_block(cgtls, aafs1, *(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)))
		if aaretval != 0 {
			goto ppout_inode
		}
	} else {
		aagoal = ppuint32(iqlibc.ppUint64FromInt32(aasb_blk) + (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks + ppuint64((*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_reserved_gdt_blocks) + ppuint64(2) + ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdinode_blocks_per_group))

		aaretval = Xext2fs_alloc_block(cgtls, aafs1, aagoal, ppuintptr(0), cgbp+152)
		if aaretval != 0 {
			goto ppout_free
		}
		...
		*(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4)) = *(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152))
		Xext2fs_iblk_set(cgtls, aafs1, cgbp+16, ppuint64(1))
		Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)), 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
		ccv8 = iqlibc.ppInt32FromInt32(1)
		aainode_dirty = ccv8
		aadindir_dirty = ccv8
		aainode_size = aaapb*aaapb + aaapb + ppuint64(mvEXT2_NDIR_BLOCKS)
		aainode_size = aainode_size * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize)
		aaretval = Xext2fs_inode_size_set(cgtls, aafs1, cgbp+16, iqlibc.ppInt64FromUint64(aainode_size))
		if aaretval != 0 {
			goto ppout_free
		}
		ccv9 = aafs1
		...
		goto cg_11
	cg_11:
		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_ctime = iqlibc.ppUint32FromInt64(ccv10)
	}

	aarsv_off = ppuint32(0)
	aagdt_off = ppuint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks)
	aagdt_blk = ppuint32(iqlibc.ppUint64FromInt32(aasb_blk+iqlibc.ppInt32FromInt32(1)) + (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks)
	for {
		if !(aarsv_off < ppuint32((*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_reserved_gdt_blocks)) {
			break
		}
		*(*tndgrp_t)(iqunsafe.ppPointer(cgbp + 156)) = ppuint32(1)
		*(*tndgrp_t)(iqunsafe.ppPointer(cgbp + 160)) = ppuint32(5)
		*(*tndgrp_t)(iqunsafe.ppPointer(cgbp + 164)) = ppuint32(7)
		aalast = ppuint32(0)
		aagdt_dirty = 0

		aagdt_off = ppuint32(ppuint64(aagdt_off) % aaapb)
		if !(*(*tn__u32)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) + ppuintptr(aagdt_off)*4)) != 0) {
			/* FIXME XXX XXX
			blk_t new_blk;
			...
			*/
			ccv13 = iqlibc.ppInt32FromInt32(1)
			aainode_dirty = ccv13
			ccv8 = ccv13
			aadindir_dirty = ccv8
			aagdt_dirty = ccv8
			Xmemset(cgtls, aagdt_buf, 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
			*(*tn__u32)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) + ppuintptr(aagdt_off)*4)) = aagdt_blk
			Xext2fs_iblk_add_blocks(cgtls, aafs1, cgbp+16, ppuint64(1))
		} else {
			if *(*tn__u32)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) + ppuintptr(aagdt_off)*4)) == aagdt_blk {
				aaretval = Xext2fs_read_ind_block(cgtls, aafs1, aagdt_blk, aagdt_buf)
				if aaretval != 0 {
					goto ppout_dindir
				}
			} else {
				aaretval = iqlibc.ppInt64FromInt64(2133571422)
				goto ppout_dindir
			}
		}

		for {
			ccv15 = Xext2fs_list_backups(cgtls, aafs1, cgbp+156, cgbp+160, cgbp+164)
			aagrp = ccv15
			if !(ccv15 < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc_count) {
				break
			}
			aaexpect = aagdt_blk + aagrp*(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_blocks_per_group

			if !(*(*tn__u32)(iqunsafe.ppPointer(aagdt_buf + ppuintptr(aalast)*4)) != 0) {
				*(*tn__u32)(iqunsafe.ppPointer(aagdt_buf + ppuintptr(aalast)*4)) = aaexpect
				Xext2fs_iblk_add_blocks(cgtls, aafs1, cgbp+16, ppuint64(1))
				ccv8 = iqlibc.ppInt32FromInt32(1)
				aainode_dirty = ccv8
				aagdt_dirty = ccv8
			} else {
				if *(*tn__u32)(iqunsafe.ppPointer(aagdt_buf + ppuintptr(aalast)*4)) != aaexpect {
					aaretval = iqlibc.ppInt64FromInt64(2133571422)
					goto ppout_dindir
				}
			}
		...
		if aagdt_dirty != 0 {
			aaretval = Xext2fs_write_ind_block(cgtls, aafs1, aagdt_blk, aagdt_buf)
			if aaretval != 0 {
				goto ppout_dindir
			}
		}
	...
	cg_12:
		;
		aarsv_off = aarsv_off + 1
		aagdt_off = aagdt_off + 1
		aagdt_blk = aagdt_blk + 1
	}
...
ppout_dindir:
	;
	if aadindir_dirty != 0 {
		aaretval2 = Xext2fs_write_ind_block(cgtls, aafs1, *(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)))
		if !(aaretval != 0) {
			aaretval = aaretval2
		}
	}
...
ppout_inode:
	...
	cg_19:
		...
		if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+140) {
			...
			ccv21 = aaextra | ppuint32(0)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)
			goto cg_22
		cg_22:
			(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 16)).fdi_atime_extra = ccv21
		} else {
			if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
				ccv23 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
			} else {
				if aanow > ppint64(iqlibc.ppInt32FromInt32(2147483647)) {
					ccv24 = ppint64(iqlibc.ppInt32FromInt32(2147483647))
				} else {
					ccv24 = aanow
				}
				ccv23 = ccv24
			}
			(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_atime = iqlibc.ppUint32FromInt64(ccv23)
		}
		if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+136) {
			...
			goto cg_27
		cg_27:
			(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 16)).fdi_mtime_extra = ccv21
		} else {
			if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
				ccv23 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
			} else {
			...
			(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_mtime = iqlibc.ppUint32FromInt64(ccv23)
		}
		aaretval2 = Xext2fs_write_new_inode(cgtls, aafs1, ppuint32(mvEXT2_RESIZE_INO), cgbp+16)
		if !(aaretval != 0) {
			aaretval = aaretval2
		}
	}
