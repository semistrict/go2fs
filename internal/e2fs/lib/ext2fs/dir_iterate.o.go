...
func Xext2fs_get_rec_len(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadirent ppuintptr, aarec_len ppuintptr) (cgr tnerrcode_t) {

	var aalen ppuint32
	pp_ = aalen
	aalen = ppuint32((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize < ppuint32(65536) {
		*(*ppuint32)(iqunsafe.ppPointer(aarec_len)) = aalen
	} else {
		if aalen == iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(16)-iqlibc.ppInt32FromInt32(1)) || aalen == ppuint32(0) {
			*(*ppuint32)(iqunsafe.ppPointer(aarec_len)) = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize
		} else {
			*(*ppuint32)(iqunsafe.ppPointer(aarec_len)) = aalen&ppuint32(65532) | aalen&ppuint32(3)<<ppint32(16)
		}
	}
	return 0
}

func Xext2fs_set_rec_len(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aalen ppuint32, aadirent ppuintptr) (cgr tnerrcode_t) {

	if aalen > (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize > iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(18)) || aalen&ppuint32(3) != 0 {
		return ppint64(mvEINVAL)
	}
	if aalen < ppuint32(65536) {
		(*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len = ppuint16(aalen)
		return 0
	}
	if aalen == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize {
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize == ppuint32(65536) {
			(*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(16) - iqlibc.ppInt32FromInt32(1))
		} else {
			(*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len = ppuint16(0)
		}
	} else {
		(*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len = ppuint16(aalen&ppuint32(65532) | aalen>>ppint32(16)&ppuint32(3))
	}
	return 0
}
...
//	 * if not valid.
//	 */
func siext2fs_validate_entry(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aabuf ppuintptr, aaoffset ppuint32, aafinal_offset ppuint32) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aadirent ppuintptr
	var ccv1 ppint32
	var ccv3 ppbool
	var pp_ /* rec_len at bp+0 */ ppuint32
	pp_, pp_, pp_ = aadirent, ccv1, ccv3

	for aaoffset < aafinal_offset && aaoffset <= (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize-ppuint32(mvDIRENT_MIN_LENGTH) {
		aadirent = aabuf + ppuintptr(aaoffset)
		if Xext2fs_get_rec_len(cgtls, aafs, aadirent, cgbp) != 0 {
			return 0
		}
		aaoffset = aaoffset + *(*ppuint32)(iqunsafe.ppPointer(cgbp))

		if ccv3 = *(*ppuint32)(iqunsafe.ppPointer(cgbp)) < ppuint32(8) || *(*ppuint32)(iqunsafe.ppPointer(cgbp))%ppuint32(4) != ppuint32(0); !ccv3 {
			ccv1 = iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdname_len) & ppint32(0xff)
			goto cg_2
		cg_2:
		}
		if ccv3 || ccv1+ppint32(8) > iqlibc.ppInt32FromUint32(*(*ppuint32)(iqunsafe.ppPointer(cgbp))) {
			return 0
		}
	}
	return iqlibc.ppBoolInt32(aaoffset == aafinal_offset)
}

type tn__ccgo_fp__Xext2fs_dir_iterate2_4 = func(*iqlibc.ppTLS, ppuint32, ppint32, ppuintptr, ppint32, ppint32, ppuintptr, ppuintptr) ppint32

func Xext2fs_dir_iterate2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadir tnext2_ino_t, aaflags ppint32, aablock_buf ppuintptr, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(64)
	defer cgtls.ppFree(64)

	var aaretval, ccv1 tnerrcode_t
	var ccv3 ppuintptr
	var pp_ /* ctx at bp+16 */ tsdir_context
	...
	aaretval = Xext2fs_check_directory(cgtls, aafs, aadir)
	if aaretval != 0 {
		return aaretval
	}

	(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fddir = aadir
	(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fdflags = aaflags
	if aablock_buf != 0 {
		(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fdbuf = aablock_buf
	} else {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		...
		Xmemcpy(cgtls, cgbp+16+8, cgbp, ppuint64(8))
		ccv1 = 0
		goto cg_2
	cg_2:
		aaretval = ccv1
	...
	(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fdfunc1 = aa__ccgo_fp_func
	(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fdpriv_data = aapriv_data
	(*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fderrcode = 0
	aaretval = Xext2fs_block_iterate3(cgtls, aafs, aadir, ppint32(mvBLOCK_FLAG_READ_ONLY), ppuintptr(0), pp__ccgo_fp(Xext2fs_process_dir_block), cgbp+16)
	if !(aablock_buf != 0) {
		ccv3 = cgbp + 16 + 8
	...
	if aaretval == ppint64(2133571485) {
		Xext2fs_inline_data_dir_iterate(cgtls, aafs, aadir, cgbp+16)
		aaretval = 0
	}
	if aaretval != 0 {
		return aaretval
	}
	return (*(*tsdir_context)(iqunsafe.ppPointer(cgbp + 16))).fderrcode
}
...
func sixlate_func(cgtls *iqlibc.ppTLS, aadir tnext2_ino_t, aaentry ppint32, aadirent ppuintptr, aaoffset ppint32, aablocksize ppint32, aabuf ppuintptr, aapriv_data ppuintptr) (cgr ppint32) {

	var aaxl ppuintptr
	pp_ = aaxl
	aaxl = aapriv_data

	return (*(*func(*iqlibc.ppTLS, ppuintptr, ppint32, ppint32, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsxlate)(iqunsafe.ppPointer(aaxl)).fdfunc1})))(cgtls, aadirent, aaoffset, aablocksize, aabuf, (*tsxlate)(iqunsafe.ppPointer(aaxl)).fdreal_private)
}

type tn__ccgo_fp__Xext2fs_dir_iterate_4 = func(*iqlibc.ppTLS, ppuintptr, ppint32, ppint32, ppuintptr, ppuintptr) ppint32

func Xext2fs_dir_iterate(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadir tnext2_ino_t, aaflags ppint32, aablock_buf ppuintptr, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	return Xext2fs_dir_iterate2(cgtls, aafs, aadir, aaflags, aablock_buf, pp__ccgo_fp(sixlate_func), cgbp)
}
...
//	 */
func Xext2fs_process_dir_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablocknr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_block tnblk64_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabuflen, aafinal_offset, aanext_real_entry, aaoffset, aasize ppuint32
	var aachanged, aacsum_size, aado_abort, aaentry1, aainline_data, aaret, ccv1, ccv2, ccv4, ccv7, ccv8 ppint32
	var aactx, aadirent ppuintptr
	var aaretval tnerrcode_t
	var ccv6 ppbool
	var pp_ /* rec_len at bp+0 */ ppuint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabuflen, aachanged, aacsum_size, aactx, aadirent, aado_abort, aaentry1, aafinal_offset, aainline_data, aanext_real_entry, aaoffset, aaret, aaretval, aasize, ccv1, ccv2, ccv4, ccv6, ccv7, ccv8
	aactx = aapriv_data
	aaoffset = ppuint32(0)
	aanext_real_entry = ppuint32(0)
	aaret = 0
	aachanged = 0
	aado_abort = 0
	aacsum_size = 0
	...
	if aablockcnt != 0 {
		ccv1 = ppint32(mvDIRENT_OTHER_FILE)
	} else {
		ccv1 = ppint32(mvDIRENT_DOT_FILE)
	}
	aaentry1 = ccv1

	/* If a dir has inline data, we don't need to read block */
	aainline_data = iqlibc.ppBoolInt32(!!((*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvDIRENT_FLAG_INCLUDE_INLINE_DATA) != 0))
	if !(aainline_data != 0) {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_read_dir_block4(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(aablocknr)), (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf, 0, (*tsdir_context)(iqunsafe.ppPointer(aactx)).fddir)
		...
		aabuflen = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize
	} else {
		aabuflen = (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuflen
	}
...
cg_3:
	...
	if aabuflen < ppuint32(8) {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571363)
		return ppint32(mvBLOCK_ABORT)
	}
	for aaoffset < aabuflen-ppuint32(8) {
		aadirent = (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf + ppuintptr(aaoffset)
		if Xext2fs_get_rec_len(cgtls, aafs, aadirent, cgbp) != 0 {
			return ppint32(mvBLOCK_ABORT)
		}

		if ccv6 = aaoffset+*(*ppuint32)(iqunsafe.ppPointer(cgbp)) > aabuflen || *(*ppuint32)(iqunsafe.ppPointer(cgbp)) < ppuint32(8) || *(*ppuint32)(iqunsafe.ppPointer(cgbp))%ppuint32(4) != ppuint32(0); !ccv6 {
			ccv1 = iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdname_len) & ppint32(0xff)
			goto cg_5
		cg_5:
		}
		if ccv6 || ccv1+ppint32(8) > iqlibc.ppInt32FromUint32(*(*ppuint32)(iqunsafe.ppPointer(cgbp))) {
			(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571363)
			return ppint32(mvBLOCK_ABORT)
		}
		if !((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdinode != 0) {
			 ...
			 * should be blocksize.
			 */
			if !(aainline_data != 0) && aaoffset == aabuflen-iqlibc.ppUint32FromInt32(aacsum_size) && iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdrec_len) == aacsum_size && iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdname_len) == ppint32(mvEXT2_DIR_NAME_LEN_CSUM) {
				if !((*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvDIRENT_FLAG_INCLUDE_CSUM) != 0) {
					goto ppnext
				}
				aaentry1 = ppint32(mvDIRENT_CHECKSUM)
			} else {
				if !((*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvDIRENT_FLAG_INCLUDE_EMPTY) != 0) {
					goto ppnext
				}
			}
		}

		if aanext_real_entry > aaoffset {
			ccv1 = ppint32(mvDIRENT_DELETED_FILE)
		} else {
			ccv1 = aaentry1
		}
		aaret = (*(*func(*iqlibc.ppTLS, tnext2_ino_t, ppint32, ppuintptr, ppint32, ppint32, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsdir_context)(iqunsafe.ppPointer(aactx)).fddir, ccv1, aadirent, iqlibc.ppInt32FromUint32(aaoffset), iqlibc.ppInt32FromUint32(aabuflen), (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf, (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
		if aaentry1 < ppint32(mvDIRENT_OTHER_FILE) {
			aaentry1 = aaentry1 + 1
		}

		if aaret&ppint32(mvDIRENT_CHANGED) != 0 {
			if Xext2fs_get_rec_len(cgtls, aafs, aadirent, cgbp) != 0 {
				return ppint32(mvBLOCK_ABORT)
			}
			aachanged = aachanged + 1
		}
		if aaret&ppint32(mvDIRENT_ABORT) != 0 {
			aado_abort = aado_abort + 1
			break
		}
		goto ppnext
	ppnext:
		;
		if aanext_real_entry == aaoffset {
			aanext_real_entry = aanext_real_entry + *(*ppuint32)(iqunsafe.ppPointer(cgbp))
		}

		if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvDIRENT_FLAG_INCLUDE_REMOVED) != 0 {
			ccv1 = iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aadirent)).fdname_len) & ppint32(0xff)
			goto cg_9
		cg_9:
			aasize = iqlibc.ppUint32FromInt32((ccv1 + ppint32(11)) & ^iqlibc.ppInt32FromInt32(3))

			if *(*ppuint32)(iqunsafe.ppPointer(cgbp)) != aasize {

				aafinal_offset = aaoffset + *(*ppuint32)(iqunsafe.ppPointer(cgbp))
				aaoffset = aaoffset + aasize
				for aaoffset < aafinal_offset && !(siext2fs_validate_entry(cgtls, aafs, (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf, aaoffset, aafinal_offset) != 0) {
					aaoffset = aaoffset + ppuint32(4)
				}
				continue
			}
		}
	...
	if aachanged != 0 {
		if !(aainline_data != 0) {
			(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_write_dir_block4(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(aablocknr)), (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf, 0, (*tsdir_context)(iqunsafe.ppPointer(aactx)).fddir)
			if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
				return ppint32(mvBLOCK_ABORT)
			}
		} else {
			 ...
			 */
			aaretval = ppint64(mvBLOCK_INLINE_DATA_CHANGED)
		}
	}
	if aado_abort != 0 {
		return ppint32(aaretval | ppint64(mvBLOCK_ABORT))
	}
...
func _ext2fs_check_directory(*iqlibc.ppTLS, ppuintptr, ppuint32) ppint64

func _ext2fs_inline_data_dir_iterate(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint32
