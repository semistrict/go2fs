...
//	 */
func Xext2fs_inode_has_valid_blocks2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr ppint32) {

	/*
	 * Only directories, regular files, and some symbolic links
	 * have valid block entries.
	 */
	if !(iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&iqlibc.ppInt32FromInt32(mvLINUX_S_IFMT) == iqlibc.ppInt32FromInt32(mvLINUX_S_IFDIR)) && !(iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&iqlibc.ppInt32FromInt32(mvLINUX_S_IFMT) == iqlibc.ppInt32FromInt32(mvLINUX_S_IFREG)) && !(iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&iqlibc.ppInt32FromInt32(mvLINUX_S_IFMT) == iqlibc.ppInt32FromInt32(mvLINUX_S_IFLNK)) {
		return 0
	}
	 ...
	 */
	if iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&ppint32(mvLINUX_S_IFMT) == ppint32(mvLINUX_S_IFLNK) {
		if Xext2fs_file_acl_block(cgtls, aafs, aainode) == ppuint64(0) {
			/* With no EA block, we can rely on i_blocks */
			if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks == ppuint32(0) {
				return 0
			}
			return iqlibc.ppBoolInt32(!(Xext2fs_is_fast_symlink(cgtls, aainode) != 0))
		} else {
			/* With an EA block, life gets more tricky */
			if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size >= iqlibc.ppUint32FromInt32((iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))*iqlibc.ppInt32FromInt32(4)) {
				return ppint32(1)
			} /* definitely using i_block[] */
			if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size > ppuint32(4) && *(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + 1*4)) == ppuint32(0) {
				return ppint32(1)
			} /* definitely using i_block[] */
...
func Xext2fs_inode_has_valid_blocks(cgtls *iqlibc.ppTLS, aainode ppuintptr) (cgr ppint32) {

	return Xext2fs_inode_has_valid_blocks2(cgtls, iqlibc.ppUintptrFromInt32(0), aainode)
}
