...
//	 */
func Xext2fs_get_device_sectsize(cgtls *iqlibc.ppTLS, aafile ppuintptr, aasectsize ppuintptr) (cgr tnerrcode_t) {
	...
	*(*ppint32)(iqunsafe.ppPointer(aasectsize)) = 0
	Xclose(cgtls, aafd)
	return 0
...
//	 */
func Xext2fs_get_dio_alignment(cgtls *iqlibc.ppTLS, aafd ppint32) (cgr ppint32) {
	...
	if aaalign <= 0 {
		aaalign = ppint32(Xsysconf(cgtls, ppint32(mv_SC_PAGESIZE)))
	}
	if aaalign <= 0 {
		aaalign = ppint32(4096)
	}
...
//	 */
func Xext2fs_get_device_phys_sectsize(cgtls *iqlibc.ppTLS, aafile ppuintptr, aasectsize ppuintptr) (cgr tnerrcode_t) {
