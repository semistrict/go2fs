...
type tsset_badblock_record = struct {
	fdbb_iter         tnext2_badblocks_iterate
	fdbad_block_count ppint32
	fdind_blocks      ppuintptr
	fdmax_ind_blocks  ppint32
	fdind_blocks_size ppint32
	fdind_blocks_ptr  ppint32
	fdblock_buf       ppuintptr
	fderr             tnerrcode_t
}
...
//	 * the map.
//	 */
func Xext2fs_update_bb_inode(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aabb_list tnext2_badblocks_list) (cgr tnerrcode_t) {
	...
	var aaretval, ccv3, ccv5, ccv7 tnerrcode_t
	var ccv1, ccv2 ppuint64
	var ccv15, ccv16, ccv20, ccv21, ccv25, ccv26 ppint64
	var ccv27, ccv29 ppuintptr
	var ccv9 tnext2_filsys
	var pp_ /* inode at bp+72 */ tsext2_inode
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* rec at bp+16 */ tsset_badblock_record
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaextra, aanow, aaretval, ccv1, ccv10, ccv12, ccv13, ccv15, ccv16, ccv17, ccv18, ccv2, ccv20, ccv21, ccv22, ccv23, ccv25, ccv26, ccv27, ccv29, ccv3, ccv5, ccv7, ccv9

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblock_map != 0) {
		return iqlibc.ppInt64FromInt64(2133571368)
	}

	Xmemset(cgtls, cgbp+16, 0, ppuint64(56))
	(*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdmax_ind_blocks = ppint32(10)
	ccv1 = iqlibc.ppUint64FromInt32((*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdmax_ind_blocks)
	ccv2 = ppuint64(4)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv1*ccv2)
	...
	Xmemcpy(cgtls, cgbp+16+16, cgbp, ppuint64(8))
	ccv5 = 0
	goto cg_6
cg_6:
	ccv3 = ccv5
...
cg_4:
	...
	Xmemset(cgtls, (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdind_blocks, 0, iqlibc.ppUint64FromInt32((*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdmax_ind_blocks)*ppuint64(4))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv3 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_8
	}
	Xmemcpy(cgtls, cgbp+16+40, cgbp, ppuint64(8))
	ccv3 = 0
	goto cg_8
cg_8:
	aaretval = ccv3
	...
	Xmemset(cgtls, (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdblock_buf, 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
	(*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fderr = 0

	/*
	 * First clear the old bad blocks (while saving the indirect blocks)
	 */
	aaretval = Xext2fs_block_iterate2(cgtls, aafs1, ppuint32(mvEXT2_BAD_INO), ppint32(mvBLOCK_FLAG_DEPTH_TRAVERSE), ppuintptr(0), pp__ccgo_fp(siclear_bad_block_proc), cgbp+16)
	if aaretval != 0 {
		goto ppcleanup
	}
	if (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fderr != 0 {
		aaretval = (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fderr
		goto ppcleanup
	}
	 ...
	 */
	if aabb_list != 0 {
		aaretval = Xext2fs_badblocks_list_iterate_begin(cgtls, aabb_list, cgbp+16)
		if aaretval != 0 {
			goto ppcleanup
		}
		aaretval = Xext2fs_block_iterate2(cgtls, aafs1, ppuint32(mvEXT2_BAD_INO), ppint32(mvBLOCK_FLAG_APPEND), ppuintptr(0), pp__ccgo_fp(siset_bad_block_proc), cgbp+16)
		Xext2fs_badblocks_list_iterate_end(cgtls, (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdbb_iter)
		if aaretval != 0 {
			goto ppcleanup
		}
		if (*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fderr != 0 {
	 ...
	 * field.
	 */
	aaretval = Xext2fs_read_inode(cgtls, aafs1, ppuint32(mvEXT2_BAD_INO), cgbp+72)
	if aaretval != 0 {
		goto ppcleanup
	}
...
cg_11:
	...
	if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+140) {
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_atime = iqlibc.ppUint32FromInt64(aanow & iqlibc.ppInt64FromInt32(0xfffffff))
		ccv10 = aanow
		aaextra = ppuint32(0)
		...
		goto cg_14
	cg_14:
		(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 72)).fdi_atime_extra = ccv13
	} else {
		...
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_atime = iqlibc.ppUint32FromInt64(ccv15)
	}
	if !(iqlibc.ppInt64FromUint32((*tsext2_inode)(iqunsafe.ppPointer(cgbp+72)).fdi_ctime) != 0) {
		if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+132) {
			(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_ctime = iqlibc.ppUint32FromInt64(aanow & iqlibc.ppInt64FromInt32(0xfffffff))
			ccv10 = aanow
			aaextra = ppuint32(0)
			aaextra = iqlibc.ppUint32FromInt64((ccv10 - ppint64(ppint32(ccv10&iqlibc.ppInt64FromUint32(0xffffffff)))) >> ppint32(32) & ppint64(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)-iqlibc.ppInt32FromInt32(1)))
			ccv13 = aaextra | ppuint32(0)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)
			goto cg_19
		cg_19:
			(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 72)).fdi_ctime_extra = ccv13
		} else {
			if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
				ccv15 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
			} else {
			...
			(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_ctime = iqlibc.ppUint32FromInt64(ccv15)
		}
	}
	if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+136) {
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_mtime = iqlibc.ppUint32FromInt64(aanow & iqlibc.ppInt64FromInt32(0xfffffff))
		ccv10 = aanow
		aaextra = ppuint32(0)
		aaextra = iqlibc.ppUint32FromInt64((ccv10 - ppint64(ppint32(ccv10&iqlibc.ppInt64FromUint32(0xffffffff)))) >> ppint32(32) & ppint64(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)-iqlibc.ppInt32FromInt32(1)))
		ccv13 = aaextra | ppuint32(0)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)
		goto cg_24
	cg_24:
		(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 72)).fdi_mtime_extra = ccv13
	} else {
		if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
			ccv15 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
		} else {
		...
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 72)).fdi_mtime = iqlibc.ppUint32FromInt64(ccv15)
	}
	Xext2fs_iblk_set(cgtls, aafs1, cgbp+72, iqlibc.ppUint64FromInt32((*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdbad_block_count))
	aaretval = Xext2fs_inode_size_set(cgtls, aafs1, cgbp+72, iqlibc.ppInt64FromUint32(iqlibc.ppUint32FromInt32((*(*tsset_badblock_record)(iqunsafe.ppPointer(cgbp + 16))).fdbad_block_count)*(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
	if aaretval != 0 {
		goto ppcleanup
	}

	aaretval = Xext2fs_write_inode(cgtls, aafs1, ppuint32(mvEXT2_BAD_INO), cgbp+72)
	if aaretval != 0 {
		goto ppcleanup
	}
...
//	 * indirect blocks.
//	 */
func siclear_bad_block_proc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock_nr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_block tnblk_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaold_size1 ppuint64
	var aarec, ccv1, ccv5 ppuintptr
	var aaretval, ccv2 tnerrcode_t
	var ccv4 ppint32
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaold_size1, aarec, aaretval, ccv1, ccv2, ccv4, ccv5
	aarec = aapriv_data

	if !(*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) != 0) {
		return 0
	}
	 ...
	 */
	if ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr))) >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) || *(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) < (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block {
		*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) = ppuint32(0)
		return ppint32(mvBLOCK_CHANGED)
	}

	if aablockcnt < 0 {
		if (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdind_blocks_size >= (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdmax_ind_blocks {
			aaold_size1 = iqlibc.ppUint64FromInt32((*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdmax_ind_blocks) * ppuint64(4)

			*(*ppint32)(iqunsafe.ppPointer(aarec + 24)) += ppint32(10)
			pp_ = aaold_size1
			ccv1 = aarec + 16
			Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
			*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xrealloc(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), iqlibc.ppUint64FromInt32((*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdmax_ind_blocks)*ppuint64(4))
			if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		...
		cg_3:
			...
			if aaretval != 0 {
				...
				*(*ppint32)(iqunsafe.ppPointer(aarec + 24)) -= ppint32(10)
				(*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fderr = aaretval
		...
		*(*tnblk_t)(iqunsafe.ppPointer((*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdind_blocks + ppuintptr(ccv4)*4)) = *(*tnblk_t)(iqunsafe.ppPointer(aablock_nr))
	}

	/*
	 * Mark the block as unused, and update accounting information
	 */
	Xext2fs_block_alloc_stats2(cgtls, aafs, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr))), -ppint32(1))
...
//	 */
func siset_bad_block_proc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock_nr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_block tnblk_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aarec, ccv2 ppuintptr
	var aaretval tnerrcode_t
	var ccv1, ccv3 ppint32
	var pp_ /* blk at bp+0 */ tnblk_t
	pp_, pp_, pp_, pp_, pp_ = aarec, aaretval, ccv1, ccv2, ccv3
	aarec = aapriv_data
	...
	if aablockcnt >= 0 {
		 ...
		 */
		if !(Xext2fs_badblocks_list_iterate(cgtls, (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdbb_iter, cgbp) != 0) {
			return ppint32(mvBLOCK_ABORT)
		}
		(*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdbad_block_count = (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdbad_block_count + 1
	} else {
		/*
	...
	ppretry:
		;
		if (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdind_blocks_ptr < (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdind_blocks_size {
			ccv2 = aarec + 32
			ccv1 = *(*ppint32)(iqunsafe.ppPointer(ccv2))
			*(*ppint32)(iqunsafe.ppPointer(ccv2)) = *(*ppint32)(iqunsafe.ppPointer(ccv2)) + 1
			*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = *(*tnblk_t)(iqunsafe.ppPointer((*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdind_blocks + ppuintptr(ccv1)*4))
			ccv1 = Xext2fs_test_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp))))
			goto cg_4
		cg_4:
			if ccv1 != 0 {
				goto ppretry
			...
			aaretval = Xext2fs_new_block(cgtls, aafs, ppuint32(0), ppuintptr(0), cgbp)
			if aaretval != 0 {
				(*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fderr = aaretval
				return ppint32(mvBLOCK_ABORT)
			}
		}
		aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp))), ppint32(1), (*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fdblock_buf)
		if aaretval != 0 {
			(*tsset_badblock_record)(iqunsafe.ppPointer(aarec)).fderr = aaretval
			return ppint32(mvBLOCK_ABORT)
		}
	 ...
	 * Update block counts
	 */
	Xext2fs_block_alloc_stats2(cgtls, aafs, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp))), +iqlibc.ppInt32FromInt32(1))

	*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) = *(*tnblk_t)(iqunsafe.ppPointer(cgbp))
	return ppint32(mvBLOCK_CHANGED)
}

func _ext2fs_badblocks_list_iterate(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32

func _ext2fs_badblocks_list_iterate_begin(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64

func _ext2fs_badblocks_list_iterate_end(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_block_alloc_stats2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppint32)

func _ext2fs_block_iterate2(*iqlibc.ppTLS, ppuintptr, ppuint32, ppint32, ppuintptr, ppuintptr, ppuintptr) ppint64
...
func _ext2fs_new_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuintptr) ppint64
