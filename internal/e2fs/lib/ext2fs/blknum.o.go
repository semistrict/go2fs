...
const mvEXT4_HUGE_FILE_FL = 262144
...
//	 */
func Xext2fs_group_of_blk2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablk tnblk64_t) (cgr tndgrp_t) {

	return ppuint32((aablk - ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block)) / ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group))
}
...
//	 */
func Xext2fs_group_first_block2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk64_t) {

	return ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block) + ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group)*ppuint64(aagroup)
}
...
//	 */
func Xext2fs_group_last_block2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk64_t) {

	var ccv1 ppuint64
	pp_ = ccv1
	if aagroup == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1) {
		ccv1 = Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) - ppuint64(1)
	} else {
		ccv1 = Xext2fs_group_first_block2(cgtls, aafs, aagroup) + ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group-iqlibc.ppUint32FromInt32(1))
	}
	return ccv1
}
...
//	 */
func Xext2fs_group_blocks_count(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr ppint32) {

	var aanum_blocks ppint32
	pp_ = aanum_blocks

	if aagroup == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1) {
		aanum_blocks = iqlibc.ppInt32FromUint64((Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) - ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block)) % ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group))
		if !(aanum_blocks != 0) {
			aanum_blocks = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group)
		}
	} else {
		aanum_blocks = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group)
	}
...
//	 */
func Xext2fs_inode_data_blocks2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr tnblk64_t) {

	var ccv1 ppuint64
	var ccv2, ccv4 ppint32
	pp_, pp_, pp_ = ccv1, ccv2, ccv4
	ccv2 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_HUGE_FILE) != ppuint32(0))
	goto cg_3
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint64((*(*struct {
			fdl_i_blocks_hi     tn__u16
			fdl_i_file_acl_high tn__u16
			fdl_i_uid_high      tn__u16
			fdl_i_gid_high      tn__u16
			fdl_i_checksum_lo   tn__u16
			fdl_i_reserved      tn__u16
		})(iqunsafe.ppPointer(aainode + 116))).fdl_i_blocks_hi) << ppint32(32)
	} else {
		ccv1 = ppuint64(0)
	}
	if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_file_acl != 0 {
		ccv4 = iqlibc.ppInt32FromInt32(1) << iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_cluster_size >> ppint32(9)
	} else {
		ccv4 = 0
	}
	return ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks) | ccv1 - iqlibc.ppUint64FromInt32(ccv4)
}
...
//	 */
func Xext2fs_inode_i_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr tnblk64_t) {
...
cg_3:
	...
	return ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks) | ccv1
}
...
//	 */
func Xext2fs_get_stat_i_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr tnblk64_t) {

	var aaret tnblk64_t
	var ccv1 ppint32
	pp_, pp_ = aaret, ccv1
	aaret = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks)

	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_HUGE_FILE) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		aaret = aaret + iqlibc.ppUint64FromInt64(iqlibc.ppInt64FromUint16((*(*struct {
			fdl_i_blocks_hi     tn__u16
			fdl_i_file_acl_high tn__u16
			fdl_i_uid_high      tn__u16
			fdl_i_gid_high      tn__u16
		...
		if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&ppuint32(mvEXT4_HUGE_FILE_FL) != 0 {
			aaret = aaret * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize/iqlibc.ppUint32FromInt32(512))
		}
	}
	return aaret
}
...
//	 */
func Xext2fs_blocks_count(cgtls *iqlibc.ppTLS, aasuper ppuintptr) (cgr tnblk64_t) {
...
//	 */
func Xext2fs_blocks_count_set(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var ccv1 ppint32
	pp_ = ccv1
	(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_blocks_count = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_blocks_count_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_blocks_count_add(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var aatmp tnblk64_t
	pp_ = aatmp
	aatmp = Xext2fs_blocks_count(cgtls, aasuper) + aablk
	Xext2fs_blocks_count_set(cgtls, aasuper, aatmp)
}
...
//	 */
func Xext2fs_r_blocks_count(cgtls *iqlibc.ppTLS, aasuper ppuintptr) (cgr tnblk64_t) {
...
//	 */
func Xext2fs_r_blocks_count_set(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var ccv1 ppint32
	pp_ = ccv1
	(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_r_blocks_count = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_r_blocks_count_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_r_blocks_count_add(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var aatmp tnblk64_t
	pp_ = aatmp
	aatmp = Xext2fs_r_blocks_count(cgtls, aasuper) + aablk
	Xext2fs_r_blocks_count_set(cgtls, aasuper, aatmp)
}
...
//	 */
func Xext2fs_free_blocks_count(cgtls *iqlibc.ppTLS, aasuper ppuintptr) (cgr tnblk64_t) {
...
//	 */
func Xext2fs_free_blocks_count_set(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var ccv1 ppint32
	pp_ = ccv1
	(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_free_blocks_count = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer(aasuper)).fds_free_blocks_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_free_blocks_count_add(cgtls *iqlibc.ppTLS, aasuper ppuintptr, aablk tnblk64_t) {

	var aatmp tnblk64_t
	pp_ = aatmp
	aatmp = Xext2fs_free_blocks_count(cgtls, aasuper) + aablk
	Xext2fs_free_blocks_count_set(cgtls, aasuper, aatmp)
}
...
//	 * do the swap there.
//	 */
func Xext2fs_group_desc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagdp ppuintptr, aagroup tndgrp_t) (cgr ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aablk tnblk64_t
	var aadesc_per_blk, aadesc_size, ccv1, ccv2, ccv4, ccv5 ppint32
	var aaret_gdp, ccv7 ppuintptr
	var aaretval, ccv9 tnerrcode_t
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablk, aadesc_per_blk, aadesc_size, aaret_gdp, aaretval, ccv1, ccv2, ccv4, ccv5, ccv7, ccv9
	var snbuf = ppuintptr(0)
	var snbufsize ppuint32
...
cg_3:
	...
	aadesc_size = ccv1 & ^iqlibc.ppInt32FromInt32(7)
	ccv5 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_6
cg_6:
	if ccv5 != 0 {
		ccv4 = iqlibc.ppInt32FromUint16((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_desc_size)
	} else {
		ccv4 = ppint32(mvEXT2_MIN_DESC_SIZE)
	}
	aadesc_per_blk = iqlibc.ppInt32FromInt32(1) << iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_block_size / ccv4

	if aagroup > (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count {
		return iqlibc.ppUintptrFromInt32(0)
	}
	if aagdp != 0 {
		return aagdp + ppuintptr(aagroup*iqlibc.ppUint32FromInt32(aadesc_size))
	}
	/*
	 * If fs->group_desc wasn't read in when the file system was
	 * opened, then read it on demand here.
	 */
	if snbufsize < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize {
		ccv7 = ppuintptr(iqunsafe.ppPointer(&snbuf))
	...
	if !(snbuf != 0) {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
			ccv9 = iqlibc.ppInt64FromInt64(2133571398)
			goto cg_10
		}
		Xmemcpy(cgtls, ppuintptr(iqunsafe.ppPointer(&snbuf)), cgbp, ppuint64(8))
		ccv9 = 0
		goto cg_10
	cg_10:
		aaretval = ccv9
		...
		snbufsize = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize
	}
	aablk = Xext2fs_descriptor_block_loc2(cgtls, aafs, ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block), aagroup/iqlibc.ppUint32FromInt32(aadesc_per_blk))
	aaretval = (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdread_blk})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(aablk), ppint32(1), snbuf)
	if aaretval != 0 {
		return iqlibc.ppUintptrFromInt32(0)
	}
	aaret_gdp = snbuf + ppuintptr(aagroup%iqlibc.ppUint32FromInt32(aadesc_per_blk)*iqlibc.ppUint32FromInt32(aadesc_size))
	return aaret_gdp
}
...
func siext4fs_group_desc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagdp ppuintptr, aagroup tndgrp_t) (cgr ppuintptr) {

	return Xext2fs_group_desc(cgtls, aafs, aagdp, aagroup)
}
...
//	 */
func Xext2fs_block_bitmap_checksum(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {

	var aacsum tn__u32
	var aagdp ppuintptr
	var ccv1, ccv2 ppint32
	pp_, pp_, pp_, pp_ = aacsum, aagdp, ccv1, ccv2

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	aacsum = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap_csum_lo)
	ccv2 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_3
cg_3:
	if ccv2 != 0 {
	...
	if iqlibc.ppUint64FromInt32(ccv1) >= ppuint64(iqlibc.ppUintptrFromInt32(0)+56)+iqlibc.ppUint64FromInt64(2) {
		aacsum = aacsum | ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap_csum_hi)<<iqlibc.ppInt32FromInt32(16)
	}
	return aacsum
}
...
//	 */
func Xext2fs_block_bitmap_loc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk64_t) {

	var aagdp ppuintptr
	var ccv1 ppuint64
	var ccv2 ppint32
	pp_, pp_, pp_ = aagdp, ccv1, ccv2
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap_hi) << ppint32(32)
	} else {
		ccv1 = ppuint64(0)
	}
	return ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap) | ccv1
}
...
//	 */
func Xext2fs_block_bitmap_loc_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aablk tnblk64_t) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_block_bitmap_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_inode_bitmap_checksum(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	aacsum = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap_csum_lo)
	ccv2 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_3
cg_3:
	if ccv2 != 0 {
	...
	if iqlibc.ppUint64FromInt32(ccv1) >= ppuint64(iqlibc.ppUintptrFromInt32(0)+58)+iqlibc.ppUint64FromInt64(2) {
		aacsum = aacsum | ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap_csum_hi)<<iqlibc.ppInt32FromInt32(16)
	}
	return aacsum
}
...
//	 */
func Xext2fs_inode_bitmap_loc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk64_t) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap_hi) << ppint32(32)
	} else {
		ccv1 = ppuint64(0)
	}
	return ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap) | ccv1
}
...
//	 */
func Xext2fs_inode_bitmap_loc_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aablk tnblk64_t) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_bitmap_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_inode_table_loc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk64_t) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_table_hi) << ppint32(32)
	} else {
		ccv1 = ppuint64(0)
	}
	return ppuint64((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_table) | ccv1
}
...
//	 */
func Xext2fs_inode_table_loc_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aablk tnblk64_t) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_table = ppuint32(aablk)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_inode_table_hi = ppuint32(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_bg_free_blocks_count(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_blocks_count_hi) << ppint32(16)
	} else {
		ccv1 = ppuint32(0)
	}
	return ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_blocks_count) | ccv1
}
...
//	 */
func Xext2fs_bg_free_blocks_count_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aan tn__u32) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_blocks_count = ppuint16(aan)

	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_blocks_count_hi = ppuint16(aan >> ppint32(16))
	}
}
...
//	 */
func Xext2fs_bg_free_inodes_count(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_inodes_count_hi) << ppint32(16)
	} else {
		ccv1 = ppuint32(0)
	}
	return ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_inodes_count) | ccv1
}
...
//	 */
func Xext2fs_bg_free_inodes_count_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aan tn__u32) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_inodes_count = ppuint16(aan)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_free_inodes_count_hi = ppuint16(aan >> ppint32(16))
	}
}
...
//	 */
func Xext2fs_bg_used_dirs_count(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_used_dirs_count_hi) << ppint32(16)
	} else {
		ccv1 = ppuint32(0)
	}
	return ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_used_dirs_count) | ccv1
}
...
//	 */
func Xext2fs_bg_used_dirs_count_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aan tn__u32) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_used_dirs_count = ppuint16(aan)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_used_dirs_count_hi = ppuint16(aan >> ppint32(16))
	}
}
...
//	 */
func Xext2fs_bg_itable_unused(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u32) {
...
cg_3:
	if ccv2 != 0 {
		ccv1 = ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_itable_unused_hi) << ppint32(16)
	} else {
		ccv1 = ppuint32(0)
	}
	return ppuint32((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_itable_unused) | ccv1
}
...
//	 */
func Xext2fs_bg_itable_unused_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aan tn__u32) {
	...
	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_itable_unused = ppuint16(aan)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_itable_unused_hi = ppuint16(aan >> ppint32(16))
	}
}
...
//	 */
func Xext2fs_bg_flags(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u16) {

	var aagdp ppuintptr
	pp_ = aagdp

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	return (*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_flags
}
...
//	 */
func Xext2fs_bg_flags_zap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) {

	var aagdp ppuintptr
	pp_ = aagdp

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_flags = ppuint16(0)
	return
}
...
//	 */
func Xext2fs_bg_flags_test(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aabg_flag tn__u16) (cgr ppint32) {

	var aagdp ppuintptr
	pp_ = aagdp

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	return iqlibc.ppInt32FromUint16((*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_flags) & iqlibc.ppInt32FromUint16(aabg_flag)
}
...
//	 */
func Xext2fs_bg_flags_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aabg_flags tn__u16) {

	var aagdp, ccv1 ppuintptr
	pp_, pp_ = aagdp, ccv1

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)

	ccv1 = aagdp + 18
	*(*tn__u16)(iqunsafe.ppPointer(ccv1)) = tn__u16(ppint32(*(*tn__u16)(iqunsafe.ppPointer(ccv1))) | iqlibc.ppInt32FromUint16(aabg_flags))
	return
}
...
//	 */
func Xext2fs_bg_flags_clear(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aabg_flags tn__u16) {
...
//	 */
func Xext2fs_bg_checksum(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tn__u16) {

	var aagdp ppuintptr
	pp_ = aagdp

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	return (*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_checksum
}
...
//	 */
func Xext2fs_bg_checksum_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aachecksum tn__u16) {

	var aagdp ppuintptr
	pp_ = aagdp

	aagdp = siext4fs_group_desc(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc, aagroup)
	(*tsext4_group_desc)(iqunsafe.ppPointer(aagdp)).fdbg_checksum = aachecksum
	return
}
...
//	 */
func Xext2fs_file_acl_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr tnblk64_t) {

	var aablk tnblk64_t
	var ccv1 ppint32
	var ccv3 ppbool
	pp_, pp_, pp_ = aablk, ccv1, ccv3
	aablk = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_file_acl)
	...
	if ccv3 && ccv1 != 0 {
		aablk = aablk | ppuint64((*(*struct {
			...
			fdl_i_checksum_lo   tn__u16
			fdl_i_reserved      tn__u16
		})(iqunsafe.ppPointer(aainode + 116))).fdl_i_file_acl_high)<<ppint32(32)
	}
	return aablk
}
...
//	 */
func Xext2fs_file_acl_block_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aablk tnblk64_t) {

	var ccv1 ppint32
	var ccv3 ppbool
	pp_, pp_ = ccv1, ccv3
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_file_acl = ppuint32(aablk)
	...
	if ccv3 && ccv1 != 0 {
		(*(*struct {
			...
			fdl_i_checksum_lo   tn__u16
			fdl_i_reserved      tn__u16
		})(iqunsafe.ppPointer(aainode + 116))).fdl_i_file_acl_high = ppuint16(aablk >> ppint32(32))
	}
}
...
//	 */
func Xext2fs_inode_size_set(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aainode ppuintptr, aasize tnext2_off64_t) (cgr tnerrcode_t) {

	var aadirty_sb, ccv1, ccv3, ccv5 ppint32
	pp_, pp_, pp_, pp_ = aadirty_sb, ccv1, ccv3, ccv5
	if aasize < 0 {
		return ppint64(mvEINVAL)
	}

	/* If writing a large inode, set the large_file or large_dir flag */
	ccv1 = iqlibc.ppBoolInt32(iqlibc.ppUint64FromInt64(aasize) >= ppuint64(0x80000000))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		aadirty_sb = 0

		if iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&ppint32(mvLINUX_S_IFMT) == ppint32(mvLINUX_S_IFREG) {
			ccv3 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT2_FEATURE_RO_COMPAT_LARGE_FILE) != ppuint32(0))
			goto cg_4
		cg_4:
			if !(ccv3 != 0) {

				*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 100)) |= ppuint32(mvEXT2_FEATURE_RO_COMPAT_LARGE_FILE)
				aadirty_sb = ppint32(1)
			}
		} else {
			if iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&ppint32(mvLINUX_S_IFMT) == ppint32(mvLINUX_S_IFDIR) {
			...
			cg_6:
				if !(ccv1 != 0) {
					...
					*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 96)) |= ppuint32(mvEXT4_FEATURE_INCOMPAT_LARGEDIR)
					aadirty_sb = ppint32(1)
				}
			} else {
		...
		if aadirty_sb != 0 {
			if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_rev_level == ppuint32(mvEXT2_GOOD_OLD_REV) {
				Xext2fs_update_dynamic_rev(cgtls, aafs1)
			}
	...
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size = iqlibc.ppUint32FromInt64(aasize & iqlibc.ppInt64FromUint32(0xffffffff))
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size_high = iqlibc.ppUint32FromInt64(aasize >> iqlibc.ppInt32FromInt32(32))

	return 0
}

func _ext2fs_descriptor_block_loc2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32) ppuint64

func _ext2fs_update_dynamic_rev(*iqlibc.ppTLS, ppuintptr)
