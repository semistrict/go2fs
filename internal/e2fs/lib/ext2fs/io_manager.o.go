...
func Xio_channel_set_options(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aaopts ppuintptr) (cgr tnerrcode_t) {

	var aaarg, aanext, aaoptions, aaptr, ccv1, ccv2 ppuintptr
	var aaretval tnerrcode_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaarg, aanext, aaoptions, aaptr, aaretval, ccv1, ccv2
	aaretval = 0
	...
	if !((*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdset_option != 0) {
		return iqlibc.ppInt64FromInt64(2133571399)
	}

	aaoptions = Xmalloc(cgtls, Xstrlen(cgtls, aaopts)+ppuint64(1))
	if !(aaoptions != 0) {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	Xstrcpy(cgtls, aaoptions, aaopts)
	aaptr = aaoptions

	for aaptr != 0 && *(*ppint8)(iqunsafe.ppPointer(aaptr)) != 0 {
		aanext = Xstrchr(cgtls, aaptr, ppint32('&'))
		if aanext != 0 {
			ccv1 = aanext
			aanext = aanext + 1
		...
		aaarg = Xstrchr(cgtls, aaptr, ppint32('='))
		if aaarg != 0 {
			ccv1 = aaarg
			aaarg = aaarg + 1
			*(*ppint8)(iqunsafe.ppPointer(ccv1)) = 0
		...
		aaretval = (*(*func(*iqlibc.ppTLS, tnio_channel, ppuintptr, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdset_option})))(cgtls, aachannel, aaptr, aaarg)
		if aaretval != 0 {
			break
		}
		aaptr = aanext
	}
	Xfree(cgtls, aaoptions)
	return aaretval
}

func Xio_channel_write_byte(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aaoffset ppuint64, aacount ppint32, aadata ppuintptr) (cgr tnerrcode_t) {

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmagic != ppint64(2133571333) {
		return iqlibc.ppInt64FromInt64(2133571333)
	}

	if (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdwrite_byte != 0 {
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdwrite_byte})))(cgtls, aachannel, aaoffset, aacount, aadata)
	}

	return iqlibc.ppInt64FromInt64(2133571408)
}

func Xio_channel_read_blk64(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aablock ppuint64, aacount ppint32, aadata ppuintptr) (cgr tnerrcode_t) {

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmagic != ppint64(2133571333) {
		return iqlibc.ppInt64FromInt64(2133571333)
	}

	if (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdread_blk64 != 0 {
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdread_blk64})))(cgtls, aachannel, aablock, aacount, aadata)
	}

	if aablock>>ppint32(32) != ppuint64(0) {
		return iqlibc.ppInt64FromInt64(2133571463)
	}

	return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdread_blk})))(cgtls, aachannel, ppuint64(aablock), aacount, aadata)
}

func Xio_channel_write_blk64(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aablock ppuint64, aacount ppint32, aadata ppuintptr) (cgr tnerrcode_t) {

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmagic != ppint64(2133571333) {
		return iqlibc.ppInt64FromInt64(2133571333)
	}

	if (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdwrite_blk64 != 0 {
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdwrite_blk64})))(cgtls, aachannel, aablock, aacount, aadata)
	}
	...
	return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdwrite_blk})))(cgtls, aachannel, ppuint64(aablock), aacount, aadata)
}

func Xio_channel_discard(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aablock ppuint64, aacount ppuint64) (cgr tnerrcode_t) {

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmagic != ppint64(2133571333) {
		return iqlibc.ppInt64FromInt64(2133571333)
	}

	if (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fddiscard != 0 {
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppuint64) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fddiscard})))(cgtls, aachannel, aablock, aacount)
	}

	return iqlibc.ppInt64FromInt64(2133571408)
}

func Xio_channel_zeroout(cgtls *iqlibc.ppTLS, aachannel tnio_channel, aablock ppuint64, aacount ppuint64) (cgr tnerrcode_t) {

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmagic != ppint64(2133571333) {
		return iqlibc.ppInt64FromInt64(2133571333)
	}

	if (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdzeroout != 0 {
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppuint64) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aachannel)).fdmanager)).fdzeroout})))(cgtls, aachannel, aablock, aacount)
	}

	return iqlibc.ppInt64FromInt64(2133571408)
}

func Xio_channel_alloc_buf(cgtls *iqlibc.ppTLS, aaio tnio_channel, aacount ppint32, aaptr1 ppuintptr) (cgr tnerrcode_t) {
	...
	pp_, pp_ = aasize1, ccv1

	if aacount == 0 {
		aasize1 = iqlibc.ppUint64FromInt32((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdblock_size)
	} else {
		if aacount > 0 {
			aasize1 = iqlibc.ppUint64FromInt32((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdblock_size * aacount)
		} else {
			aasize1 = iqlibc.ppUint64FromInt32(-aacount)
		}
	}

	if (*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdalign > 0 {
		if ppuint64(iqlibc.ppUint32FromInt32((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdalign)) > aasize1 {
			aasize1 = iqlibc.ppUint64FromInt32((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdalign)
		}
		return Xext2fs_get_memalign(cgtls, aasize1, iqlibc.ppUint64FromInt32((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdalign), aaptr1)
	} else {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, aasize1)
		...
		Xmemcpy(cgtls, aaptr1, cgbp, ppuint64(8))
		ccv1 = 0
		goto cg_2
	cg_2:
		return ccv1
...
func Xio_channel_cache_readahead(cgtls *iqlibc.ppTLS, aaio tnio_channel, aablock ppuint64, aacount ppuint64) (cgr tnerrcode_t) {

	if !((*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdmanager)).fdcache_readahead != 0) {
		return iqlibc.ppInt64FromInt64(2133571457)
	}

	return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppuint64) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer(aaio)).fdmanager)).fdcache_readahead})))(cgtls, aaio, aablock, aacount)
}
