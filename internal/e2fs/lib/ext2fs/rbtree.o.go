...
type tsrb_node = struct {
	fdrb_parent_color tnuintptr_t
	fdrb_right        ppuintptr
	fdrb_left         ppuintptr
}

type tsrb_root = struct {
	fdrb_node ppuintptr
}

func si__rb_rotate_left(cgtls *iqlibc.ppTLS, aanode ppuintptr, aaroot ppuintptr) {

	var aaparent, aaright, ccv1, ccv2, ccv3, ccv4 ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_ = aaparent, aaright, ccv1, ccv2, ccv3, ccv4
	aaright = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
	aaparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))

	ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aaright)).fdrb_left
	(*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right = ccv1
	if ccv1 != 0 {
		ccv2 = (*tsrb_node)(iqunsafe.ppPointer(aaright)).fdrb_left
		(*tsrb_node)(iqunsafe.ppPointer(ccv2)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv2)).fdrb_parent_color&ppuint64(3) | ppuint64(aanode)
	}
	(*tsrb_node)(iqunsafe.ppPointer(aaright)).fdrb_left = aanode

	ccv1 = aaright
	(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aaparent)

	if aaparent != 0 {

		if aanode == (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left = aaright
		} else {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right = aaright
		}
	} else {
		(*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node = aaright
	}
	ccv1 = aanode
	(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aaright)
}

func si__rb_rotate_right(cgtls *iqlibc.ppTLS, aanode ppuintptr, aaroot ppuintptr) {

	var aaleft, aaparent, ccv1, ccv2, ccv3, ccv4 ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_ = aaleft, aaparent, ccv1, ccv2, ccv3, ccv4
	aaleft = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left
	aaparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))

	ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aaleft)).fdrb_right
	(*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left = ccv1
	if ccv1 != 0 {
		ccv2 = (*tsrb_node)(iqunsafe.ppPointer(aaleft)).fdrb_right
		(*tsrb_node)(iqunsafe.ppPointer(ccv2)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv2)).fdrb_parent_color&ppuint64(3) | ppuint64(aanode)
	}
	(*tsrb_node)(iqunsafe.ppPointer(aaleft)).fdrb_right = aanode
	...
	if aaparent != 0 {
		...
		if aanode == (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right = aaleft
		} else {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left = aaleft
		}
	} else {
		(*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node = aaleft
	}
	ccv1 = aanode
	(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aaleft)
}

func Xext2fs_rb_insert_color(cgtls *iqlibc.ppTLS, aanode ppuintptr, aaroot ppuintptr) {

	var aagparent, aaparent, aatmp, aatmp1, aauncle, aauncle1, ccv1 ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aagparent, aaparent, aatmp, aatmp1, aauncle, aauncle1, ccv1

	for {
		ccv1 = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))
		aaparent = ccv1
		if !(ccv1 != 0 && !((*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1) != 0)) {
			break
		}

		aagparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))

		if aaparent == (*tsrb_node)(iqunsafe.ppPointer(aagparent)).fdrb_left {

			aauncle = (*tsrb_node)(iqunsafe.ppPointer(aagparent)).fdrb_right
			if aauncle != 0 && !((*tsrb_node)(iqunsafe.ppPointer(aauncle)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1) != 0) {

				*(*tnuintptr_t)(iqunsafe.ppPointer(aauncle)) |= ppuint64(1)

				*(*tnuintptr_t)(iqunsafe.ppPointer(aaparent)) |= ppuint64(1)

				*(*tnuintptr_t)(iqunsafe.ppPointer(aagparent)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
				aanode = aagparent
				continue
			}

			if (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right == aanode {

				si__rb_rotate_left(cgtls, aaparent, aaroot)
				aatmp = aaparent
				aaparent = aanode
				aanode = aatmp
			}
			...
			*(*tnuintptr_t)(iqunsafe.ppPointer(aagparent)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
			si__rb_rotate_right(cgtls, aagparent, aaroot)
		} else {

			aauncle1 = (*tsrb_node)(iqunsafe.ppPointer(aagparent)).fdrb_left
			if aauncle1 != 0 && !((*tsrb_node)(iqunsafe.ppPointer(aauncle1)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1) != 0) {

				*(*tnuintptr_t)(iqunsafe.ppPointer(aauncle1)) |= ppuint64(1)
			...
			if (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left == aanode {

				si__rb_rotate_right(cgtls, aaparent, aaroot)
				aatmp1 = aaparent
				aaparent = aanode
				aanode = aatmp1
			}
			...
			*(*tnuintptr_t)(iqunsafe.ppPointer(aagparent)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
			si__rb_rotate_left(cgtls, aagparent, aaroot)
		}

	}

	*(*tnuintptr_t)(iqunsafe.ppPointer((*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node)) |= ppuint64(1)
}

func si__rb_erase_color(cgtls *iqlibc.ppTLS, aanode ppuintptr, aaparent ppuintptr, aaroot ppuintptr) {

	var aaother, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_ = aaother, ccv1, ccv2

	for (!(aanode != 0) || (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color&ppuint64(1) != 0) && aanode != (*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node {

		if (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left == aanode {

			aaother = (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right
			if !((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1) != 0) {

				*(*tnuintptr_t)(iqunsafe.ppPointer(aaother)) |= ppuint64(1)

				*(*tnuintptr_t)(iqunsafe.ppPointer(aaparent)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
				si__rb_rotate_left(cgtls, aaparent, aaroot)
				aaother = (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right
			}
			if (!((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left)).fdrb_parent_color&ppuint64(1) != 0) && (!((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right)).fdrb_parent_color&ppuint64(1) != 0) {

				*(*tnuintptr_t)(iqunsafe.ppPointer(aaother)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
				aanode = aaparent
				aaparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))
			} else {

				if !((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right)).fdrb_parent_color&ppuint64(1) != 0 {

					*(*tnuintptr_t)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left)) |= ppuint64(1)

					*(*tnuintptr_t)(iqunsafe.ppPointer(aaother)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
					si__rb_rotate_right(cgtls, aaother, aaroot)
					aaother = (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right
				}
				ccv1 = aaother
				(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1)) | iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromUint64((*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1)))

				*(*tnuintptr_t)(iqunsafe.ppPointer(aaparent)) |= ppuint64(1)

				*(*tnuintptr_t)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right)) |= ppuint64(1)
				si__rb_rotate_left(cgtls, aaparent, aaroot)
				aanode = (*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node
				break
			}
		} else {

			aaother = (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left
			if !((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1) != 0) {
			...
			if (!((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left)).fdrb_parent_color&ppuint64(1) != 0) && (!((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right)).fdrb_parent_color&ppuint64(1) != 0) {
				...
				*(*tnuintptr_t)(iqunsafe.ppPointer(aaother)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
				...
				if !((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left != 0) || (*tsrb_node)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_left)).fdrb_parent_color&ppuint64(1) != 0 {

					*(*tnuintptr_t)(iqunsafe.ppPointer((*tsrb_node)(iqunsafe.ppPointer(aaother)).fdrb_right)) |= ppuint64(1)

					*(*tnuintptr_t)(iqunsafe.ppPointer(aaother)) &= iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1))
					si__rb_rotate_left(cgtls, aaother, aaroot)
					aaother = (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left
				}
				ccv1 = aaother
				(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(1)) | iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromUint64((*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_parent_color&iqlibc.ppUint64FromInt32(1)))
	...
	if aanode != 0 {
		...
		*(*tnuintptr_t)(iqunsafe.ppPointer(aanode)) |= ppuint64(1)
	}
}

func Xext2fs_rb_erase(cgtls *iqlibc.ppTLS, aanode ppuintptr, aaroot ppuintptr) {

	var aachild, aaleft, aaold, aaparent, ccv1, ccv2, ccv3, ccv4, ccv5 ppuintptr
	var aacolor ppint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aachild, aacolor, aaleft, aaold, aaparent, ccv1, ccv2, ccv3, ccv4, ccv5

	if !((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left != 0) {
		aachild = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
	} else {
		if !((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right != 0) {
			aachild = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left
		} else {

			aaold = aanode

			aanode = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
			for {
				ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left
				aaleft = ccv1
			...
			if ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_parent_color&iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))) != 0 {
				if (*tsrb_node)(iqunsafe.ppPointer(ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_parent_color&iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))))).fdrb_left == aaold {
					(*tsrb_node)(iqunsafe.ppPointer(ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))))).fdrb_left = aanode
				} else {
					(*tsrb_node)(iqunsafe.ppPointer(ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))))).fdrb_right = aanode
				}
			} else {
				(*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node = aanode
			}

			aachild = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
			aaparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))
			aacolor = iqlibc.ppInt32FromUint64((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(1))
			...
			if aaparent == aaold {
				...
				(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left = aachild

				(*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right = (*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_right
				ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_right
				(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aanode)
			}

			(*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_parent_color
			(*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left = (*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_left
			ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aaold)).fdrb_left
			(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aanode)
	...
	if aaparent != 0 {
		...
		if (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left == aanode {
			...
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right = aachild
		}
	} else {
		(*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node = aachild
	}

	goto ppcolor
ppcolor:
	;
	if aacolor == ppint32(mvRB_BLACK) {
		si__rb_erase_color(cgtls, aachild, aaparent, aaroot)
	}
}
...
//	 */
func Xext2fs_rb_first(cgtls *iqlibc.ppTLS, aaroot ppuintptr) (cgr ppuintptr) {

	var aan ppuintptr
	pp_ = aan

	aan = (*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node
	if !(aan != 0) {
		return iqlibc.ppUintptrFromInt32(0)
	}
	for (*tsrb_node)(iqunsafe.ppPointer(aan)).fdrb_left != 0 {
		aan = (*tsrb_node)(iqunsafe.ppPointer(aan)).fdrb_left
	}
	return aan
}

func Xext2fs_rb_last(cgtls *iqlibc.ppTLS, aaroot ppuintptr) (cgr ppuintptr) {
	...
	for (*tsrb_node)(iqunsafe.ppPointer(aan)).fdrb_right != 0 {
		aan = (*tsrb_node)(iqunsafe.ppPointer(aan)).fdrb_right
	}
	return aan
}

func Xext2fs_rb_next(cgtls *iqlibc.ppTLS, aanode ppuintptr) (cgr ppuintptr) {

	var aaparent, ccv1 ppuintptr
	pp_, pp_ = aaparent, ccv1

	if ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color&iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))) == aanode {
		return iqlibc.ppUintptrFromInt32(0)
	}
	...
	if (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right != 0 {
		aanode = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
		for (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left != 0 {
			aanode = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left
		}
		return aanode
	}
	...
	for {
		ccv1 = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))
		aaparent = ccv1
		if !(ccv1 != 0 && aanode == (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right) {
			break
		}
		aanode = aaparent
	}
...
func Xext2fs_rb_prev(cgtls *iqlibc.ppTLS, aanode ppuintptr) (cgr ppuintptr) {
	...
	if (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left != 0 {
		aanode = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_left
		for (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right != 0 {
			aanode = (*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_right
		}
		return aanode
	}
	...
	for {
		ccv1 = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aanode)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))
		aaparent = ccv1
		if !(ccv1 != 0 && aanode == (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left) {
			break
		}
		aanode = aaparent
	}
...
func Xext2fs_rb_replace_node(cgtls *iqlibc.ppTLS, aavictim ppuintptr, aanew ppuintptr, aaroot ppuintptr) {

	var aaparent, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_ = aaparent, ccv1, ccv2
	aaparent = ppuintptr((*tsrb_node)(iqunsafe.ppPointer(aavictim)).fdrb_parent_color & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3)))

	/* Set the surrounding nodes to point to the replacement */
	if aaparent != 0 {
		if aavictim == (*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_left = aanew
		} else {
			(*tsrb_node)(iqunsafe.ppPointer(aaparent)).fdrb_right = aanew
		}
	} else {
		(*tsrb_root)(iqunsafe.ppPointer(aaroot)).fdrb_node = aanew
	}
	if (*tsrb_node)(iqunsafe.ppPointer(aavictim)).fdrb_left != 0 {
		ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aavictim)).fdrb_left
		(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aanew)
	}
	if (*tsrb_node)(iqunsafe.ppPointer(aavictim)).fdrb_right != 0 {
		ccv1 = (*tsrb_node)(iqunsafe.ppPointer(aavictim)).fdrb_right
		(*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color = (*tsrb_node)(iqunsafe.ppPointer(ccv1)).fdrb_parent_color&ppuint64(3) | ppuint64(aanew)
	}

	/* Copy the pointers/colour from the victim to the replacement */
	*(*tsrb_node)(iqunsafe.ppPointer(aanew)) = *(*tsrb_node)(iqunsafe.ppPointer(aavictim))
}
