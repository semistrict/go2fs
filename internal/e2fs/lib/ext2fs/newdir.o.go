...
//	 */
func Xext2fs_new_dir_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadir_ino tnext2_ino_t, aaparent_ino tnext2_ino_t, aablock ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aacsum_size, aafiletype, aarec_len, aarec_len1, ccv3, ccv7 ppint32
	var aadir, aat, ccv10, ccv15, ccv17, ccv18, ccv5, ccv9 ppuintptr
	var aaretval, ccv1 tnerrcode_t
	var ccv11, ccv13 ppuint32
	var pp_ /* buf at bp+16 */ ppuintptr
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacsum_size, aadir, aafiletype, aarec_len, aarec_len1, aaretval, aat, ccv1, ccv10, ccv11, ccv13, ccv15, ccv17, ccv18, ccv3, ccv5, ccv7, ccv9
	aadir = iqlibc.ppUintptrFromInt32(0)
	aafiletype = 0
	aacsum_size = 0
...
cg_2:
	...
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
	aadir = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16))

	ccv3 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_METADATA_CSUM) != ppuint32(0))
	goto cg_4
cg_4:
	if ccv3 != 0 {
	...
	aaretval = Xext2fs_set_rec_len(cgtls, aafs, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize-iqlibc.ppUint32FromInt32(aacsum_size), aadir)
	if aaretval != 0 {
		ccv5 = cgbp + 16
	...
	if aadir_ino != 0 {
		ccv3 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT2_FEATURE_INCOMPAT_FILETYPE) != ppuint32(0))
		goto cg_8
	cg_8:
		if ccv3 != 0 {
		 ...
		 * Set up entry for '.'
		 */
		(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdinode = aadir_ino
		ccv5 = aadir
		...
		*(*ppint8)(iqunsafe.ppPointer(aadir + 8)) = ppint8('.')
		...
		ccv11 = iqlibc.ppUint32FromInt32(aarec_len)
		goto cg_12
	cg_12:
		aarec_len1 = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize - iqlibc.ppUint32FromInt32(aacsum_size) - ccv11)
		aarec_len = iqlibc.ppInt32FromUint8(ppuint8(1)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
		aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
		if 0 != 0 {
			aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
		...
		goto cg_14
	cg_14:
		(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdrec_len = ppuint16(ccv11)

		/*
		 * Set up entry for '..'
		 */
		aadir = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) + ppuintptr((*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdrec_len)
		aaretval = Xext2fs_set_rec_len(cgtls, aafs, iqlibc.ppUint32FromInt32(aarec_len1), aadir)
		if aaretval != 0 {
			ccv5 = cgbp + 16
			Xmemcpy(cgtls, cgbp+8, ccv5, ppuint64(8))
			Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		...
		(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdinode = aaparent_ino
		ccv5 = aadir
	...
	if aacsum_size != 0 {
		aat = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) - iqlibc.ppUintptrFromInt64(12)
		Xext2fs_initialize_dirent_tail(cgtls, aafs, aat)
	}
	*(*ppuintptr)(iqunsafe.ppPointer(aablock)) = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16))
	return 0
}
...
//	 */
func Xext2fs_new_dir_inline_data(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadir_ino tnext2_ino_t, aaparent_ino tnext2_ino_t, aaiblock ppuintptr) (cgr tnerrcode_t) {

	var aadir ppuintptr
	var aarec_len ppint32
	var aaretval tnerrcode_t
	pp_, pp_, pp_ = aadir, aarec_len, aaretval
	aadir = iqlibc.ppUintptrFromInt32(0)
	...
	*(*tn__u32)(iqunsafe.ppPointer(aaiblock)) = aaparent_ino

	aadir = aaiblock + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE))
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdinode = ppuint32(0)
	aarec_len = iqlibc.ppInt32FromUint64(iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) - iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE)))
	aaretval = Xext2fs_set_rec_len(cgtls, aafs, iqlibc.ppUint32FromInt32(aarec_len), aadir)
	if aaretval != 0 {
		goto pperrout
	}
