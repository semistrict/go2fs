...
type tsext2fs_struct_generic_bitmap_32 = struct {
	fdmagic           tnerrcode_t
	fdfs              tnext2_filsys
	fdstart           tn__u32
	fdend             tn__u32
	...
	fdreserved        [7]tn__u32
}

type tnext2fs_generic_bitmap_32 = ppuintptr
...
//	 */
func Xext2fs_warn_bitmap2(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_generic_bitmap, aacode ppint32, aaarg ppuint64) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aabitmap tnext2fs_generic_bitmap_32
	pp_ = aabitmap
	aabitmap = aagen_bitmap

	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription != 0 {
		Xcom_err(cgtls, ppuintptr(0), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdbase_error_code+ppint64(aacode), "#%lu for %s\x00", iqlibc.ppVaList(cgbp+8, aaarg, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription))
	} else {
		Xcom_err(cgtls, ppuintptr(0), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdbase_error_code+ppint64(aacode), "#%lu\x00", iqlibc.ppVaList(cgbp+8, aaarg))
	}
}

func sicheck_magic(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap) (cgr tnerrcode_t) {

	if !(aabitmap != 0) || !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336)) {
		return iqlibc.ppInt64FromInt64(2133571338)
	}
	return 0
}

func Xext2fs_make_generic_bitmap(cgtls *iqlibc.ppTLS, aamagic tnerrcode_t, aafs tnext2_filsys, aastart tn__u32, aaend tn__u32, aareal_end tn__u32, aadescr ppuintptr, aainit_map ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaretval, ccv1, ccv3, ccv7 tnerrcode_t
	var aasize1 tnsize_t
	var ccv11, ccv5, ccv9 ppuintptr
	var pp_ /* bitmap at bp+16 */ tnext2fs_generic_bitmap_32
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaretval, aasize1, ccv1, ccv11, ccv3, ccv5, ccv7, ccv9

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(88))
...
cg_2:
	...
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdmagic = aamagic
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdfs = aafs
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdstart = aastart
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdend = aaend
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdreal_end = aareal_end
	switch aamagic {
	case iqlibc.ppInt64FromInt64(2133571337):
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdbase_error_code = iqlibc.ppInt64FromInt64(2133571376)
		break
		fallthrough
	case iqlibc.ppInt64FromInt64(2133571336):
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdbase_error_code = iqlibc.ppInt64FromInt64(2133571373)
		break
		fallthrough
	default:
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdbase_error_code = iqlibc.ppInt64FromInt64(2133571389)
	}
	if aadescr != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, Xstrlen(cgtls, aadescr)+ppuint64(1))
		...
		Xmemcpy(cgtls, *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16))+32, cgbp, ppuint64(8))
		ccv1 = 0
		goto cg_4
	cg_4:
		aaretval = ccv1
		...
		Xstrcpy(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fddescription, aadescr)
	} else {
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fddescription = ppuintptr(0)
	}

	aasize1 = ppuint64(((*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdreal_end-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdstart)/iqlibc.ppUint32FromInt32(8) + iqlibc.ppUint32FromInt32(1))
	/* Round up to allow for the BT x86 instruction */
	aasize1 = (aasize1 + ppuint64(7)) & iqlibc.ppUint64FromInt32(^iqlibc.ppInt32FromInt32(3))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, aasize1)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_8
	}
	Xmemcpy(cgtls, *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16))+40, cgbp, ppuint64(8))
	ccv1 = 0
	goto cg_8
cg_8:
	aaretval = ccv1
	if aaretval != 0 {
		ccv5 = *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)) + 32
		Xmemcpy(cgtls, cgbp+8, ccv5, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
		Xmemcpy(cgtls, ccv5, cgbp+8, ppuint64(8))
	...
	if aainit_map != 0 {
		Xmemcpy(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdbitmap, aainit_map, aasize1)
	} else {
		Xmemset(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16)))).fdbitmap, 0, aasize1)
	}
	*(*tnext2fs_generic_bitmap)(iqunsafe.ppPointer(aaret)) = *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 16))
	return 0
}

func Xext2fs_allocate_generic_bitmap(cgtls *iqlibc.ppTLS, aastart tn__u32, aaend tn__u32, aareal_end tn__u32, aadescr ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_make_generic_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571338), ppuintptr(0), aastart, aaend, aareal_end, aadescr, ppuintptr(0), aaret)
}

func Xext2fs_copy_generic_bitmap(cgtls *iqlibc.ppTLS, aagen_src tnext2fs_generic_bitmap, aadest ppuintptr) (cgr tnerrcode_t) {

	var aasrc tnext2fs_generic_bitmap_32
	pp_ = aasrc
	aasrc = aagen_src

	return Xext2fs_make_generic_bitmap(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdmagic, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdfs, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdend, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdreal_end, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fddescription, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aasrc)).fdbitmap, aadest)
}

func Xext2fs_free_generic_bitmap(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_inode_bitmap) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var ccv1, ccv3, ccv5 ppuintptr
	var pp_ /* bitmap at bp+8 */ tnext2fs_generic_bitmap_32
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_ = ccv1, ccv3, ccv5
	*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)) = aagen_bitmap

	if sicheck_magic(cgtls, aagen_bitmap) != 0 {
		return
	}

	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic = 0
	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)))).fddescription != 0 {
		ccv1 = *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)) + 32
	...
	cg_2:
		;
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)))).fddescription = ppuintptr(0)
	}
	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)))).fdbitmap != 0 {
		ccv1 = *(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)) + 40
		Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
		Xmemcpy(cgtls, ccv1, cgbp, ppuint64(8))
	...
	cg_4:
		;
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(*(*tnext2fs_generic_bitmap_32)(iqunsafe.ppPointer(cgbp + 8)))).fdbitmap = ppuintptr(0)
	}
	ccv1 = cgbp + 8
	Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
	Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
...
func Xext2fs_test_generic_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap, aabitno tnblk_t) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [27]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 't', 'e', 's', 't', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p'}
	aabitmap32 = aabitmap
	...
	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			return Xext2fs_test_generic_bmap(cgtls, aabitmap, ppuint64(aabitno))
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "test_bitmap(%lu)\x00", iqlibc.ppVaList(cgbp+8, ppuint64(aabitno)))
		return 0
	}

	if aabitno < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart || aabitno > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdend {
		Xext2fs_warn_bitmap2(cgtls, aabitmap, ppint32(mvEXT2FS_TEST_ERROR), ppuint64(aabitno))
		return 0
	}
	return Xext2fs_test_bit(cgtls, aabitno-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdbitmap)
}

func Xext2fs_mark_generic_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap, aabitno tn__u32) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [27]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 'm', 'a', 'r', 'k', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p'}
	aabitmap32 = aabitmap

	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			return Xext2fs_mark_generic_bmap(cgtls, aabitmap, ppuint64(aabitno))
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "mark_bitmap(%lu)\x00", iqlibc.ppVaList(cgbp+8, ppuint64(aabitno)))
		return 0
	}

	if aabitno < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart || aabitno > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdend {
		Xext2fs_warn_bitmap2(cgtls, aabitmap, mvEXT2FS_MARK_ERROR, ppuint64(aabitno))
		return 0
	}
	return Xext2fs_set_bit(cgtls, aabitno-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdbitmap)
}

func Xext2fs_unmark_generic_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap, aabitno tnblk_t) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [29]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 'u', 'n', 'm', 'a', 'r', 'k', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p'}
	aabitmap32 = aabitmap

	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			return Xext2fs_unmark_generic_bmap(cgtls, aabitmap, ppuint64(aabitno))
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "mark_bitmap(%lu)\x00", iqlibc.ppVaList(cgbp+8, ppuint64(aabitno)))
		return 0
	}
	...
	if aabitno < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart || aabitno > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdend {
		Xext2fs_warn_bitmap2(cgtls, aabitmap, ppint32(mvEXT2FS_UNMARK_ERROR), ppuint64(aabitno))
		return 0
	}
	return Xext2fs_clear_bit(cgtls, aabitno-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdbitmap)
}

func Xext2fs_get_generic_bitmap_start(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap) (cgr tn__u32) {

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [32]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 'g', 'e', 't', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p', '_', 's', 't', 'a', 'r', 't'}
	aabitmap32 = aabitmap

	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			return ppuint32(Xext2fs_get_generic_bmap_start(cgtls, aabitmap))
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "get_bitmap_start\x00", 0)
		return ppuint32(0)
	}

	return (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart
}

func Xext2fs_get_generic_bitmap_end(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap) (cgr tn__u32) {

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [30]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 'g', 'e', 't', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p', '_', 'e', 'n', 'd'}
	aabitmap32 = aabitmap

	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			return ppuint32(Xext2fs_get_generic_bmap_end(cgtls, aabitmap))
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "get_bitmap_end\x00", 0)
		return ppuint32(0)
	}
	return (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdend
}

func Xext2fs_clear_generic_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_generic_bitmap) {

	var aabitmap32 tnext2fs_generic_bitmap_32
	pp_ = aabitmap32
	var sn__func__ = [28]ppint8{'e', 'x', 't', '2', 'f', 's', '_', 'c', 'l', 'e', 'a', 'r', '_', 'g', 'e', 'n', 'e', 'r', 'i', 'c', '_', 'b', 'i', 't', 'm', 'a', 'p'}
	aabitmap32 = aabitmap

	if !((*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571338) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571336) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571337)) {
		if (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571437) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571438) || (*tsext2fs_struct_generic_bitmap_base)(iqunsafe.ppPointer(aabitmap)).fdmagic == ppint64(2133571439) {
			Xext2fs_warn_bitmap32(cgtls, aabitmap, ppuintptr(iqunsafe.ppPointer(&sn__func__)))
			Xext2fs_clear_generic_bmap(cgtls, aabitmap)
			return
		}
		Xcom_err(cgtls, ppuintptr(0), ppint64(2133571338), "clear_generic_bitmap\x00", 0)
		return
	}

	Xmemset(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdbitmap, 0, ppuint64(((*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdreal_end-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap32)).fdstart)/iqlibc.ppUint32FromInt32(8)+iqlibc.ppUint32FromInt32(1)))
}

func Xext2fs_fudge_generic_bitmap_end(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_inode_bitmap, aamagic tnerrcode_t, aaneq tnerrcode_t, aaend tnext2_ino_t, aaoend ppuintptr) (cgr tnerrcode_t) {

	var aabitmap tnext2fs_generic_bitmap_32
	pp_ = aabitmap
	aabitmap = aagen_bitmap

	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdmagic != aamagic {
		return aamagic
	}

	if aaend > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdreal_end {
		return aaneq
	}
	if aaoend != 0 {
		*(*tnext2_ino_t)(iqunsafe.ppPointer(aaoend)) = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend
	}
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend = aaend
	return 0
}

func Xext2fs_resize_generic_bitmap(cgtls *iqlibc.ppTLS, aamagic tnerrcode_t, aanew_end tn__u32, aanew_real_end tn__u32, aagen_bmap tnext2fs_generic_bitmap) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabitno tn__u32
	var aabmap tnext2fs_generic_bitmap_32
	var aanew_size, aasize1 tnsize_t
	var aaretval, ccv3 tnerrcode_t
	var ccv2 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabitno, aabmap, aanew_size, aaretval, aasize1, ccv2, ccv3
	aabmap = aagen_bmap

	if !(aabmap != 0) || (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdmagic != aamagic {
		return aamagic
	}
	 ...
	 */
	if aanew_end > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdend {
		aabitno = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdreal_end
		if aabitno > aanew_end {
			aabitno = aanew_end
		}
		for {
			if !(aabitno > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdend) {
				break
			}
			Xext2fs_clear_bit(cgtls, aabitno-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdbitmap)
			goto cg_1
		cg_1:
			;
			aabitno = aabitno - 1
	...
	if aanew_real_end == (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdreal_end {
		(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdend = aanew_end
		return 0
	}

	aasize1 = ppuint64(((*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdreal_end-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart)/ppuint32(8) + ppuint32(1))
	aanew_size = ppuint64((aanew_real_end-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart)/ppuint32(8) + ppuint32(1))
	...
	if aanew_size > aasize1 {
		Xmemset(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdbitmap+ppuintptr(aasize1), 0, aanew_size-aasize1)
	}

	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdend = aanew_end
	(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdreal_end = aanew_real_end
	return 0
}

func Xext2fs_compare_generic_bitmap(cgtls *iqlibc.ppTLS, aamagic tnerrcode_t, aaneq tnerrcode_t, aagen_bm1 tnext2fs_generic_bitmap, aagen_bm2 tnext2fs_generic_bitmap) (cgr tnerrcode_t) {

	var aabm1, aabm2 tnext2fs_generic_bitmap_32
	var aai tnblk_t
	var ccv2, ccv4 ppint32
	pp_, pp_, pp_, pp_, pp_ = aabm1, aabm2, aai, ccv2, ccv4
	aabm1 = aagen_bm1
	aabm2 = aagen_bm2

	if !(aabm1 != 0) || (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdmagic != aamagic {
		return aamagic
	}
	if !(aabm2 != 0) || (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm2)).fdmagic != aamagic {
		return aamagic
	}

	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdstart != (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm2)).fdstart || (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdend != (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm2)).fdend || Xmemcmp(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdbitmap, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm2)).fdbitmap, ppuint64((*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdend-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdstart)/ppuint64(8)) != 0 {
		return aaneq
	}

	aai = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdend - ((*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdend-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdstart)%ppuint32(8)
	for {
		if !(aai <= (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabm1)).fdend) {
			break
		}
		ccv2 = Xext2fs_test_generic_bitmap(cgtls, aagen_bm1, aai)
		goto cg_3
	cg_3:
		ccv4 = Xext2fs_test_generic_bitmap(cgtls, aagen_bm2, aai)
		goto cg_5
	cg_5:
		if ccv2 != ccv4 {
			return aaneq
...
func Xext2fs_set_generic_bitmap_padding(cgtls *iqlibc.ppTLS, aagen_map tnext2fs_generic_bitmap) {

	var aai, aaj tn__u32
	var aamap tnext2fs_generic_bitmap_32
	pp_, pp_, pp_ = aai, aaj, aamap
	aamap = aagen_map

	/* Protect loop from wrap-around if map->real_end is maxed */
	aai = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aamap)).fdend + ppuint32(1)
	aaj = aai - (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aamap)).fdstart
	for {
		if !(aai <= (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aamap)).fdreal_end && aai > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aamap)).fdend) {
			break
		}
		Xext2fs_set_bit(cgtls, aaj, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aamap)).fdbitmap)
		goto cg_1
	cg_1:
		;
		aai = aai + 1
...
func Xext2fs_get_generic_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bmap tnext2fs_generic_bitmap, aamagic tnerrcode_t, aastart tn__u32, aanum tn__u32, aaout ppuintptr) (cgr tnerrcode_t) {
	...
	if aastart < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart || aastart+aanum-ppuint32(1) > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdreal_end {
		return iqlibc.ppInt64FromInt64(2133571399)
	}

	Xmemcpy(cgtls, aaout, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdbitmap+ppuintptr((aastart-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart)>>iqlibc.ppInt32FromInt32(3)), ppuint64((aanum+ppuint32(7))>>ppint32(3)))
	return 0
}

func Xext2fs_set_generic_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bmap tnext2fs_generic_bitmap, aamagic tnerrcode_t, aastart tn__u32, aanum tn__u32, aain ppuintptr) (cgr tnerrcode_t) {
	...
	Xmemcpy(cgtls, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdbitmap+ppuintptr((aastart-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabmap)).fdstart)>>iqlibc.ppInt32FromInt32(3)), aain, ppuint64((aanum+ppuint32(7))>>ppint32(3)))
	return 0
}
...
//	 */
func Xext2fs_mem_is_zero(cgtls *iqlibc.ppTLS, aamem ppuintptr, aalen tnsize_t) (cgr ppint32) {

	var snzero_buf [256]ppint8

	for aalen >= ppuint64(256) {
		if Xmemcmp(cgtls, aamem, ppuintptr(iqunsafe.ppPointer(&snzero_buf)), ppuint64(256)) != 0 {
			return 0
		}
		aalen = aalen - ppuint64(256)
		aamem = aamem + ppuintptr(256)
	}
	/* Deal with leftover bytes. */
	if aalen != 0 {
		return iqlibc.ppBoolInt32(!(Xmemcmp(cgtls, aamem, ppuintptr(iqunsafe.ppPointer(&snzero_buf)), aalen) != 0))
	}
	return ppint32(1)
}
...
//	 */
func siext2fs_test_clear_generic_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_generic_bitmap, aastart ppuint32, aalen ppuint32) (cgr ppint32) {

	var aaADDR ppuintptr
	var aabitmap tnext2fs_generic_bitmap_32
	var aafirst_bit, aai, aalast_bit, aamark_bit, aamark_count ppint32
	var aalen_bit, aastart_bit ppuint32
	var aalen_byte, aastart_byte tnsize_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaADDR, aabitmap, aafirst_bit, aai, aalast_bit, aalen_bit, aalen_byte, aamark_bit, aamark_count, aastart_bit, aastart_byte
	aabitmap = aagen_bitmap
	...
	aamark_count = 0
	aamark_bit = 0
	aaADDR = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdbitmap

	aastart = aastart - (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart
	aastart_byte = ppuint64(aastart >> ppint32(3))
	aastart_bit = aastart % ppuint32(8)
	...
	if aastart_bit != ppuint32(0) {
		...
		for {
			...
			aafirst_bit = aafirst_bit | ppint32(1)<<aamark_bit
			goto cg_1
		cg_1:
			;
			aai = aai - 1
		 ...
		 */
		if aafirst_bit&ppint32(*(*ppint8)(iqunsafe.ppPointer(aaADDR + ppuintptr(aastart_byte)))) != 0 {
			return 0
		} else {
			if aalen <= ppuint32(8)-aastart_bit {
				return ppint32(1)
	...
	if aalen_bit != ppuint32(0) {
		...
		for {
			...
			aalast_bit = aalast_bit | ppint32(1)<<aamark_bit
			goto cg_2
		cg_2:
			;
			aamark_bit = aamark_bit - 1
		 ...
		 * If there is any marked bit, this function returns 0.
		 */
		if aalast_bit&ppint32(*(*ppint8)(iqunsafe.ppPointer(aaADDR + ppuintptr(aastart_byte+aalen_byte)))) != 0 {
			return 0
		} else {
	...
	return Xext2fs_mem_is_zero(cgtls, aaADDR+ppuintptr(aastart_byte), aalen_byte)
}

func Xext2fs_find_first_zero_generic_bitmap(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_generic_bitmap, aastart tn__u32, aaend tn__u32, aaout ppuintptr) (cgr tnerrcode_t) {

	var aab tnblk_t
	var aabitmap tnext2fs_generic_bitmap_32
	pp_, pp_ = aab, aabitmap
	aabitmap = aagen_bitmap

	if aastart < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart || aaend > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend || aastart > aaend {
		Xext2fs_warn_bitmap2(cgtls, aagen_bitmap, ppint32(mvEXT2FS_TEST_ERROR), ppuint64(aastart))
		return ppint64(mvEINVAL)
	}

	for aastart <= aaend {
		aab = iqlibc.ppUint32FromInt32(Xext2fs_test_bit(cgtls, aastart-(*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart, (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdbitmap))
		if !(aab != 0) {
			*(*tn__u32)(iqunsafe.ppPointer(aaout)) = aastart
			return 0
		}
		aastart = aastart + 1
	}
...
func Xext2fs_find_first_set_generic_bitmap(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_generic_bitmap, aastart tn__u32, aaend tn__u32, aaout ppuintptr) (cgr tnerrcode_t) {
...
func Xext2fs_test_block_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_block_bitmap, aablock tnblk_t, aanum ppint32) (cgr ppint32) {

	var aabitmap tnext2fs_generic_bitmap_32
	pp_ = aabitmap
	aabitmap = aagen_bitmap

	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdmagic != ppint64(2133571336) {
		return ppint32(iqlibc.ppInt64FromInt64(2133571336))
	}
	if aablock < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart || aablock > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdreal_end || aablock+iqlibc.ppUint32FromInt32(aanum)-ppuint32(1) > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdreal_end {
		Xext2fs_warn_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571375), ppuint64(aablock), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription)
		return 0
	}
	return siext2fs_test_clear_generic_bitmap_range(cgtls, aabitmap, aablock, iqlibc.ppUint32FromInt32(aanum))
}

func Xext2fs_test_inode_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_inode_bitmap, aainode tnext2_ino_t, aanum ppint32) (cgr ppint32) {

	var aabitmap tnext2fs_generic_bitmap_32
	pp_ = aabitmap
	aabitmap = aagen_bitmap

	if (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdmagic != ppint64(2133571337) {
		return ppint32(iqlibc.ppInt64FromInt64(2133571337))
	}
	if aainode < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart || aainode > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdreal_end || aainode+iqlibc.ppUint32FromInt32(aanum)-ppuint32(1) > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdreal_end {
		Xext2fs_warn_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571378), ppuint64(aainode), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription)
		return 0
	}
	return siext2fs_test_clear_generic_bitmap_range(cgtls, aabitmap, aainode, iqlibc.ppUint32FromInt32(aanum))
}

func Xext2fs_mark_block_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_block_bitmap, aablock tnblk_t, aanum ppint32) {

	var aaADDR, ccv3 ppuintptr
	var aabitmap tnext2fs_generic_bitmap_32
	var aai ppint32
	var ccv2 ppuint32
	pp_, pp_, pp_, pp_, pp_ = aaADDR, aabitmap, aai, ccv2, ccv3
	aabitmap = aagen_bitmap

	if aablock < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart || aablock > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend || aablock+iqlibc.ppUint32FromInt32(aanum)-ppuint32(1) > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend {
		Xext2fs_warn_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571373), ppuint64(aablock), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription)
		return
	}
	aai = 0
	for {
		...
		ccv2 = aablock + iqlibc.ppUint32FromInt32(aai) - (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart
		aaADDR = (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdbitmap
		aaADDR = aaADDR + ppuintptr(ccv2>>ppint32(3))
		ccv3 = aaADDR
		*(*ppuint8)(iqunsafe.ppPointer(ccv3)) = ppuint8(ppint32(*(*ppuint8)(iqunsafe.ppPointer(ccv3))) | iqlibc.ppInt32FromUint8(iqlibc.ppUint8FromInt32(iqlibc.ppInt32FromInt32(1)<<(ccv2&iqlibc.ppUint32FromInt32(0x07)))))
		goto cg_1
	cg_1:
		;
		aai = aai + 1
...
func Xext2fs_unmark_block_bitmap_range(cgtls *iqlibc.ppTLS, aagen_bitmap tnext2fs_block_bitmap, aablock tnblk_t, aanum ppint32) {
	...
	if aablock < (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdstart || aablock > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend || aablock+iqlibc.ppUint32FromInt32(aanum)-ppuint32(1) > (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fdend {
		Xext2fs_warn_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571374), ppuint64(aablock), (*tsext2fs_struct_generic_bitmap_32)(iqunsafe.ppPointer(aabitmap)).fddescription)
		return
	}
	aai = 0
	for {
...
func _ext2fs_clear_bit(*iqlibc.ppTLS, ppuint32, ppuintptr) ppint32

func _ext2fs_clear_generic_bmap(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_get_generic_bmap_end(*iqlibc.ppTLS, ppuintptr) ppuint64

func _ext2fs_get_generic_bmap_start(*iqlibc.ppTLS, ppuintptr) ppuint64
...
func _ext2fs_test_bit(*iqlibc.ppTLS, ppuint32, ppuintptr) ppint32
...
func _ext2fs_warn_bitmap32(*iqlibc.ppTLS, ppuintptr, ppuintptr)
