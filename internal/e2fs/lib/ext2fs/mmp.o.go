...
const mvEXT2_MIN_MMP_UPDATE_INTERVAL = 60
...
const mvEXT4_MMP_MAGIC = 5066064
const mvEXT4_MMP_MAX_UPDATE_INTERVAL = 300
const mvEXT4_MMP_MIN_CHECK_INTERVAL = 5
const mvEXT4_MMP_SEQ_CLEAN = 4283256144
const mvEXT4_MMP_SEQ_FSCK = 3796716880
const mvEXT4_MMP_SEQ_MAX = 3796716879
...
func Xext2fs_mmp_read(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aammp_blk tnblk64_t, aabuf ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(144)
	defer cgtls.ppFree(144)

	var aaalign, aaflags ppint32
	var aammp_cmp ppuintptr
	var aaretval tnerrcode_t
	var pp_ /* st at bp+0 */ tsstat
	pp_, pp_, pp_, pp_ = aaalign, aaflags, aammp_cmp, aaretval
	aaretval = 0

	if aammp_blk <= ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block) || aammp_blk >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
		return iqlibc.ppInt64FromInt64(2133571469)
	}
	...
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd <= 0 {
		aaflags = iqlibc.ppInt32FromInt32(mvO_RDONLY) | iqlibc.ppInt32FromInt32(mvO_DIRECT)
		 ...
		 */
		if Xstat(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name, cgbp) == 0 && iqlibc.ppInt32FromUint16((*(*tsstat)(iqunsafe.ppPointer(cgbp))).fdst_mode)&ppint32(mvS_IFMT) == ppint32(mvS_IFREG) {
			aaflags = aaflags & ^iqlibc.ppInt32FromInt32(mvO_DIRECT)
		}

		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd = Xopen(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name, aaflags, 0)
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd < 0 {
			aaretval = iqlibc.ppInt64FromInt64(2133571472)
			goto ppout
		}
	}

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp == iqlibc.ppUintptrFromInt32(0) {
		aaalign = Xext2fs_get_dio_alignment(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd)

		aaretval = Xext2fs_get_memalign(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), iqlibc.ppUint64FromInt32(aaalign), aafs+280)
		if aaretval != 0 {
			return aaretval
		}
	}

	if iqlibc.ppUint64FromInt64(Xext2fs_llseek(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd, iqlibc.ppInt64FromUint64(aammp_blk*ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)), mvSEEK_SET)) != aammp_blk*ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) {
		aaretval = iqlibc.ppInt64FromInt64(2133571397)
		goto ppout
	}

	if Xread(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)) != iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) {
		aaretval = iqlibc.ppInt64FromInt64(2133571364)
		goto ppout
	}

	aammp_cmp = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp

	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IGNORE_CSUM_ERRORS) != 0) && !(Xext2fs_mmp_csum_verify(cgtls, aafs, aammp_cmp) != 0) {
		aaretval = iqlibc.ppInt64FromInt64(2133571482)
	}

	if aabuf != iqlibc.ppUintptrFromInt32(0) && aabuf != (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp {
		Xmemcpy(cgtls, aabuf, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
	}

	if (*tsmmp_struct)(iqunsafe.ppPointer(aammp_cmp)).fdmmp_magic != ppuint32(0x004D4D50) {
		aaretval = iqlibc.ppInt64FromInt64(2133571466)
		goto ppout
	}
...
func Xext2fs_mmp_write(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aammp_blk tnblk64_t, aabuf ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aammp_s ppuintptr
	var aaretval tnerrcode_t
	var pp_ /* tv at bp+0 */ tstimeval
	pp_, pp_ = aammp_s, aaretval
	aammp_s = aabuf
	aaretval = 0

	Xgettimeofday(cgtls, cgbp, ppuintptr(0))
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_time = iqlibc.ppUint64FromInt64((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec)
	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_last_written = (*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec

	if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block < ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block) || (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block > Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
		return iqlibc.ppInt64FromInt64(2133571469)
	}

	aaretval = Xext2fs_mmp_csum_set(cgtls, aafs, aammp_s)
	if aaretval != 0 {
		return aaretval
	}
	...
	aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, aammp_blk, -iqlibc.ppInt32FromInt64(1024), aabuf)

	/* Make sure the block gets to disk quickly */
	(*(*func(*iqlibc.ppTLS, tnio_channel) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdflush})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)
	return aaretval
}

func Xext2fs_mmp_new_seq(cgtls *iqlibc.ppTLS) (cgr ppuint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aanew_seq ppuint32
	var aapid ppuint64
	var pp_ /* tv at bp+0 */ tstimeval
	pp_, pp_ = aanew_seq, aapid
	aapid = iqlibc.ppUint64FromInt32(Xgetpid(cgtls))

	Xgettimeofday(cgtls, cgbp, ppuintptr(0))
	aapid = aapid>>ppint32(16) | aapid&ppuint64(0xFFFF)<<ppint32(16)
	Xsrandom(cgtls, ppuint32(aapid^ppuint64(Xgetuid(cgtls))^iqlibc.ppUint64FromInt64((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec)^iqlibc.ppUint64FromInt32((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_usec)))

	Xgettimeofday(cgtls, cgbp, ppuintptr(0))
	/* Crank the random number generator a few times */
	aanew_seq = iqlibc.ppUint32FromInt64(((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec ^ ppint64((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_usec)) & ppint64(0x1F))
	for {
		if !(aanew_seq > ppuint32(0)) {
			break
		}
		Xrandom(cgtls)
		goto cg_1
	cg_1:
		;
		aanew_seq = aanew_seq - 1
	}

	for cgcond := true; cgcond; cgcond = aanew_seq > ppuint32(0xE24D4D4F) {
		aanew_seq = iqlibc.ppUint32FromInt64(Xrandom(cgtls))
	}

	return aanew_seq
}

func siext2fs_mmp_reset(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	pp_, pp_, pp_ = aammp_s, aaretval, ccv1
	aammp_s = iqlibc.ppUintptrFromInt32(0)
	aaretval = 0

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf == iqlibc.ppUintptrFromInt32(0) {
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		...
		Xmemcpy(cgtls, aafs+272, cgbp, ppuint64(8))
		ccv1 = 0
		goto cg_2
	cg_2:
		aaretval = ccv1
	...
	Xmemset(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf, 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
	aammp_s = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf

	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_magic = ppuint32(0x004D4D50)
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_seq = ppuint32(0xFF4D4D50)
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_time = ppuint64(0)
	Xgethostname(cgtls, aammp_s+16, ppuint64(64))
	Xstrncpy(cgtls, aammp_s+80, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name, ppuint64(32))

	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_check_interval = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_update_interval
	if iqlibc.ppInt32FromUint16((*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_check_interval) < ppint32(mvEXT4_MMP_MIN_CHECK_INTERVAL) {
		(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_check_interval = ppuint16(mvEXT4_MMP_MIN_CHECK_INTERVAL)
	}

	aaretval = Xext2fs_mmp_write(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf)
	goto ppout
ppout:
	;
	return aaretval
...
func Xext2fs_mmp_update(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return Xext2fs_mmp_update2(cgtls, aafs, 0)
}

func Xext2fs_mmp_clear(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	...
	aaretval = siext2fs_mmp_reset(cgtls, aafs)

	return aaretval
}

func Xext2fs_mmp_init(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval, ccv1 tnerrcode_t
	var aasb ppuintptr
	var pp_ /* mmp_block at bp+8 */ tnblk64_t
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_ = aaretval, aasb, ccv1
	aasb = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper

	if iqlibc.ppInt32FromUint16((*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_mmp_update_interval) == 0 {
		(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_mmp_update_interval = ppuint16(mvEXT4_MMP_UPDATE_INTERVAL)
	} else {
		if iqlibc.ppInt32FromUint16((*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_mmp_update_interval) > ppint32(mvEXT4_MMP_MAX_UPDATE_INTERVAL) {
	...
	aaretval = Xext2fs_alloc_block2(cgtls, aafs, ppuint64(0), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf, cgbp+8)
	if aaretval != 0 {
		goto ppout
	}

	(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_mmp_block = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8))
...
//	 */
func Xext2fs_mmp_start(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aammp_check_interval, aaseq, ccv3, ccv4, ccv5 ppuint32
	var aammp_s ppuintptr
	var aaretval, ccv1 tnerrcode_t
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aammp_check_interval, aammp_s, aaretval, aaseq, ccv1, ccv3, ccv4, ccv5
	aaretval = 0
	...
	aaretval = Xext2fs_mmp_read(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf)
	if aaretval != 0 {
		goto ppmmp_error
	}
	...
	aammp_check_interval = ppuint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_update_interval)
	if aammp_check_interval < ppuint32(mvEXT4_MMP_MIN_CHECK_INTERVAL) {
		aammp_check_interval = ppuint32(mvEXT4_MMP_MIN_CHECK_INTERVAL)
	}

	aaseq = (*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_seq
	if aaseq == ppuint32(0xFF4D4D50) {
		goto ppclean_seq
	}
	if aaseq == ppuint32(0xE24D4D50) {
		aaretval = iqlibc.ppInt64FromInt64(2133571468)
		goto ppmmp_error
	}

	if aaseq > ppuint32(0xE24D4D50) {
		aaretval = iqlibc.ppInt64FromInt64(2133571470)
		goto ppmmp_error
	}
	 ...
	 */
	if ppuint32((*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_check_interval) > aammp_check_interval {
		aammp_check_interval = ppuint32((*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_check_interval)
	}

	if aammp_check_interval*ppuint32(2)+ppuint32(1) < aammp_check_interval+ppuint32(60) {
		ccv3 = aammp_check_interval*ppuint32(2) + ppuint32(1)
	} else {
		ccv3 = aammp_check_interval + ppuint32(60)
	}
	Xsleep(cgtls, ccv3)
	...
	if aaseq != (*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_seq {
		aaretval = iqlibc.ppInt64FromInt64(2133571467)
		goto ppmmp_error
	}
...
ppclean_seq:
	...
	ccv3 = Xext2fs_mmp_new_seq(cgtls)
	aaseq = ccv3
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_seq = ccv3
	Xgethostname(cgtls, aammp_s+16, ppuint64(64))
	Xstrncpy(cgtls, aammp_s+80, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name, ppuint64(32))
	...
	if ppuint32(2)*aammp_check_interval+ppuint32(1) < aammp_check_interval+ppuint32(60) {
		ccv3 = ppuint32(2)*aammp_check_interval + ppuint32(1)
	} else {
		ccv3 = aammp_check_interval + ppuint32(60)
	}
	Xsleep(cgtls, ccv3)
	...
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_s)).fdmmp_seq = ppuint32(0xE24D4D50)
	aaretval = Xext2fs_mmp_write(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf)
	if aaretval != 0 {
		goto ppmmp_error
	}
...
//	 */
func Xext2fs_mmp_stop(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	var aammp, aammp_cmp ppuintptr
	var aaretval tnerrcode_t
	var ccv1 ppint32
	pp_, pp_, pp_, pp_ = aammp, aammp_cmp, aaretval, ccv1
	aaretval = 0

	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_MMP) != ppuint32(0))
	goto cg_2
cg_2:
	;
	if !(ccv1 != 0) || !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_RW) != 0) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_SKIP_MMP) != 0 || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf == iqlibc.ppUintptrFromInt32(0) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp == iqlibc.ppUintptrFromInt32(0) {
		goto ppmmp_error
	}

	aaretval = Xext2fs_mmp_read(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, iqlibc.ppUintptrFromInt32(0))
	if aaretval != 0 {
		goto ppmmp_error
	}

	/* Check if the MMP block is not changed. */
	aammp = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf
	aammp_cmp = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp
	if Xmemcmp(cgtls, aammp, aammp_cmp, ppuint64(1024)) != 0 {
		aaretval = iqlibc.ppInt64FromInt64(2133571471)
		goto ppmmp_error
	}

	(*tsmmp_struct)(iqunsafe.ppPointer(aammp_cmp)).fdmmp_seq = ppuint32(0xFF4D4D50)
	aaretval = Xext2fs_mmp_write(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_cmp)

	goto ppmmp_error
ppmmp_error:
	;
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd > 0 {
		Xclose(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd)
		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_fd = -ppint32(1)
	}
...
//	 */
func Xext2fs_mmp_update2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaimmediately ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
...
cg_2:
	;
	if !(ccv1 != 0) || !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_RW) != 0) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_SKIP_MMP) != 0 {
		return 0
	}

	Xgettimeofday(cgtls, cgbp, ppuintptr(0))
	if !(aaimmediately != 0) && (*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec-(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_last_written < ppint64(mvEXT2_MIN_MMP_UPDATE_INTERVAL) {
		return 0
	}
	...
	if Xmemcmp(cgtls, aammp, aammp_cmp, ppuint64(1024)) != 0 {
		return iqlibc.ppInt64FromInt64(2133571471)
	}

	(*tsmmp_struct)(iqunsafe.ppPointer(aammp)).fdmmp_time = iqlibc.ppUint64FromInt64((*(*tstimeval)(iqunsafe.ppPointer(cgbp))).fdtv_sec)
	(*tsmmp_struct)(iqunsafe.ppPointer(aammp)).fdmmp_seq = ppuint32(0xE24D4D50)
	aaretval = Xext2fs_mmp_write(cgtls, aafs, (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_mmp_block, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmmp_buf)
...
func _ext2fs_get_dio_alignment(*iqlibc.ppTLS, ppint32) ppint32

func _ext2fs_get_memalign(*iqlibc.ppTLS, ppuint64, ppuint64, ppuintptr) ppint64

func _ext2fs_llseek(*iqlibc.ppTLS, ppint32, ppint64, ppint32) ppint64

func _ext2fs_mmp_csum_set(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64

func _ext2fs_mmp_csum_verify(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32

func _gethostname(*iqlibc.ppTLS, ppuintptr, ppuint64) ppint32
...
func _sleep(*iqlibc.ppTLS, ppuint32) ppuint32
