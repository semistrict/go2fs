...
const mvEXT2_FL_USER_MODIFIABLE = 1615560959
...
func Xext2fs_mkdir2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaparent tnext2_ino_t, cg_ino tnext2_ino_t, aaflags ppuint64, aalink_flags ppint32, aaname ppuintptr, aaret_ino ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(304)
	defer cgtls.ppFree(304)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) = cg_ino

	var aadrop_refcount, aainline_data, ccv10, ccv3, ccv7 ppint32
	var aaretval tnerrcode_t
	var ccv1 ppuint32
	var ccv12, ccv9 ppuintptr
	var ccv2, ccv5 ppbool
	var ccv6 tn__u16
	var pp_ /* blk at bp+288 */ tnblk64_t
	var pp_ /* block at bp+296 */ ppuintptr
	var pp_ /* handle at bp+16 */ tnext2_extent_handle_t
	var pp_ /* inode at bp+152 */ tsext2_inode
	var pp_ /* p at bp+0 */ ppuintptr
	var pp_ /* parent_inode at bp+24 */ tsext2_inode
	var pp_ /* scratch_ino at bp+280 */ tnext2_ino_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadrop_refcount, aainline_data, aaretval, ccv1, ccv10, ccv12, ccv2, ccv3, ccv5, ccv6, ccv7, ccv9
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 296)) = ppuintptr(0)
	aainline_data = 0
	aadrop_refcount = 0
	...
	if ccv2 = !(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) != 0); !ccv2 {
	...
	if ccv5 = ccv2 || *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) >= ccv1; ccv5 {
	...
	if ccv5 && ccv3 != 0 {
		aainline_data = ppint32(1)
	}

	/*
	 * Allocate an inode, if necessary
	 */
	if !(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) != 0) {
		aaretval = Xext2fs_new_inode(cgtls, aafs, aaparent, iqlibc.ppInt32FromInt32(mvLINUX_S_IFDIR)|iqlibc.ppInt32FromInt32(0755), ppuintptr(0), cgbp+8)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	if aaret_ino != 0 {
		*(*tnext2_ino_t)(iqunsafe.ppPointer(aaret_ino)) = *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8))
	}

	/*
	 * Allocate a data block for the directory
	 */
	Xmemset(cgtls, cgbp+152, 0, ppuint64(128))
	if !(aainline_data != 0) {
		aaretval = Xext2fs_new_block2(cgtls, aafs, Xext2fs_find_inode_goal(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), cgbp+152, ppuint64(0)), iqlibc.ppUintptrFromInt32(0), cgbp+288)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	 ...
	 */
	if aainline_data != 0 {
		aaretval = Xext2fs_new_dir_inline_data(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), aaparent, cgbp+152+40)
	} else {
		aaretval = Xext2fs_new_dir_block(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), aaparent, cgbp+296)
	}
	if aaretval != 0 {
		goto ppcleanup
	}
	 ...
	 */
	if aaparent != *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) {
		aaretval = Xext2fs_read_inode(cgtls, aafs, aaparent, cgbp+24)
		if aaretval != 0 {
			goto ppcleanup
		}
	} else {
	 ...
	 */
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_mode = ppuint16(ppuint32(mvLINUX_S_IFDIR) | ppuint32(0777) & ^(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdumask)
	ccv6 = iqlibc.ppUint16FromInt32(0)
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_gid = ccv6
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_uid = ccv6
	if aainline_data != 0 {

		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_flags |= ppuint32(mvEXT4_INLINE_DATA_FL)
		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_size = ppuint32(iqlibc.ppUint64FromInt64(4) * iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
	} else {
		ccv3 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT3_FEATURE_INCOMPAT_EXTENTS) != ppuint32(0))
		goto cg_8
	cg_8:
		if ccv3 != 0 {

			(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_flags |= ppuint32(mvEXT4_EXTENTS_FL)
		} else {
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 152 + 40)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)))
		}
		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_size = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize
		Xext2fs_iblk_set(cgtls, aafs, cgbp+152, ppuint64(1))
	}

	ccv9 = cgbp + 152 + 32
	*(*tn__u32)(iqunsafe.ppPointer(ccv9)) = tn__u32(ppuint64(*(*tn__u32)(iqunsafe.ppPointer(ccv9))) | aaflags&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_FL_USER_MODIFIABLE) & ^iqlibc.ppInt32FromInt32(mvEXT4_EXTENTS_FL)))
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 152))).fdi_links_count = ppuint16(2)
	 ...
	 */
	aaretval = Xext2fs_write_new_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), cgbp+152)
	if aaretval != 0 {
		goto ppcleanup
	}
	if aainline_data != 0 {
		/* init "system.data" for new dir */
		aaretval = Xext2fs_inline_data_init(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)))
	} else {
		aaretval = Xext2fs_write_dir_block4(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 296)), 0, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)))
		if aaretval != 0 {
			goto ppcleanup
		}
	...
	cg_11:
		if ccv3 != 0 {
			aaretval = Xext2fs_extent_open2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), cgbp+152, cgbp+16)
			if aaretval != 0 {
				goto ppcleanup
			}
			aaretval = Xext2fs_extent_set_bmap(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), ppuint64(0), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)), 0)
	 ...
	 */
	if !(aainline_data != 0) {
		Xext2fs_block_alloc_stats2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)), +iqlibc.ppInt32FromInt32(1))
	}
	Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), +iqlibc.ppInt32FromInt32(1), ppint32(1))
	aadrop_refcount = ppint32(1)

	/*
	 * Link the directory into the filesystem hierarchy
	 */
	if aaname != 0 {
		aaretval = Xext2fs_lookup(cgtls, aafs, aaparent, aaname, iqlibc.ppInt32FromUint64(Xstrlen(cgtls, aaname)), ppuintptr(0), cgbp+280)
		if !(aaretval != 0) {
			aaretval = iqlibc.ppInt64FromInt64(2133571407)
			aaname = ppuintptr(0)
			goto ppcleanup
		}
		if aaretval != ppint64(2133571404) {
			goto ppcleanup
		}
		aaretval = Xext2fs_link(cgtls, aafs, aaparent, aaname, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), ppint32(mvEXT2_FT_DIR)|aalink_flags)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	...
	if aaparent != *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)) {
		...
		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 24))).fdi_links_count = (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 24))).fdi_links_count + 1
		aaretval = Xext2fs_write_inode(cgtls, aafs, aaparent, cgbp+24)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
...
ppcleanup:
	;
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 296)) != 0 {
		ccv9 = cgbp + 296
	...
	if aadrop_refcount != 0 {
		if !(aainline_data != 0) {
			Xext2fs_block_alloc_stats2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)), -ppint32(1))
		}
		Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 8)), -ppint32(1), ppint32(1))
	}
	return aaretval

}

func Xext2fs_mkdir(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaparent tnext2_ino_t, aaino tnext2_ino_t, aaname ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_mkdir2(cgtls, aafs, aaparent, aaino, ppuint64(0), 0, aaname, iqlibc.ppUintptrFromInt32(0))
}
...
func _ext2fs_inline_data_init(*iqlibc.ppTLS, ppuintptr, ppuint32) ppint64
...
func _ext2fs_new_dir_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint32, ppuintptr) ppint64

func _ext2fs_new_dir_inline_data(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuint32, ppuintptr) ppint64
