...
func Xext2fs_iblk_add_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aanum_blocks tnblk64_t) (cgr tnerrcode_t) {

	var aab ppuint64
	var ccv1, ccv3, ccv5 ppint32
	pp_, pp_, pp_, pp_ = aab, ccv1, ccv3, ccv5
	aab = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks)
...
cg_2:
	if ccv1 != 0 {
		aab = aab + iqlibc.ppUint64FromInt64(iqlibc.ppInt64FromUint16((*(*struct {
			fdl_i_blocks_hi     tn__u16
			fdl_i_file_acl_high tn__u16
			fdl_i_uid_high      tn__u16
			fdl_i_gid_high      tn__u16
...
cg_4:
	;
	if !(ccv1 != 0) || !((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_HUGE_FILE_FL) != 0) {
		aanum_blocks = aanum_blocks * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize/ppuint32(512))
	}
	aanum_blocks = aanum_blocks * iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)

	aab = aab + aanum_blocks
...
cg_6:
	if ccv1 != 0 {
		(*(*struct {
			...
			fdl_i_checksum_lo   tn__u16
			fdl_i_reserved      tn__u16
		})(iqunsafe.ppPointer(aainode + 116))).fdl_i_blocks_hi = ppuint16(aab >> ppint32(32))
	} else {
		if aab > ppuint64(0xFFFFFFFF) {
			return ppint64(mvEOVERFLOW)
		}
	}
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_blocks = ppuint32(aab & ppuint64(0xFFFFFFFF))
	return 0
}

func Xext2fs_iblk_sub_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aanum_blocks tnblk64_t) (cgr tnerrcode_t) {
...
func Xext2fs_iblk_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aab tnblk64_t) (cgr tnerrcode_t) {
...
cg_2:
	;
	if !(ccv1 != 0) || !((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_HUGE_FILE_FL) != 0) {
		aab = aab * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize/ppuint32(512))
	}
	aab = aab * iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)
