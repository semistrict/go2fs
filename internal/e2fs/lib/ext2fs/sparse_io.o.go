...
func sisparse_open(cgtls *iqlibc.ppTLS, aaname ppuintptr, aaflags ppint32, aachannel ppuintptr) (cgr tnerrcode_t) {

	return iqlibc.ppInt64FromInt64(2133571408)
}

func sisparse_close(cgtls *iqlibc.ppTLS, aachannel tnio_channel) (cgr tnerrcode_t) {

	return iqlibc.ppInt64FromInt64(2133571408)
}

var sistruct_sparse_manager = tsstruct_io_manager{
	fdmagic: iqlibc.ppInt64FromInt64(2133571335),
	fdname:  "Android sparse I/O Manager\x00",
}

func init() {
	p := iqunsafe.ppPointer(&sistruct_sparse_manager)
	*(*uintptr)(iqunsafe.ppAdd(p, 16)) = pp__ccgo_fp(sisparse_open)
	*(*uintptr)(iqunsafe.ppAdd(p, 24)) = pp__ccgo_fp(sisparse_close)
}

var sistruct_sparsefd_manager = tsstruct_io_manager{
	fdmagic: iqlibc.ppInt64FromInt64(2133571335),
	fdname:  "Android sparse fd I/O Manager\x00",
}

func init() {
	p := iqunsafe.ppPointer(&sistruct_sparsefd_manager)
	*(*uintptr)(iqunsafe.ppAdd(p, 16)) = pp__ccgo_fp(sisparse_open)
	*(*uintptr)(iqunsafe.ppAdd(p, 24)) = pp__ccgo_fp(sisparse_close)
}

var Xsparse_io_manager = ppuintptr(iqunsafe.ppPointer(&sistruct_sparse_manager))
var Xsparsefd_io_manager = ppuintptr(iqunsafe.ppPointer(&sistruct_sparsefd_manager))
