...
//	 */
func simake_u32_list(cgtls *iqlibc.ppTLS, aasize2 ppint32, aanum ppint32, aalist ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaretval, ccv1, ccv6, ccv8 tnerrcode_t
	var ccv10 ppuintptr
	var ccv3 ppint32
	var ccv4, ccv5 ppuint64
	var pp_ /* bb at bp+16 */ tnext2_u32_list
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaretval, ccv1, ccv10, ccv3, ccv4, ccv5, ccv6, ccv8
...
cg_2:
	...
	Xmemset(cgtls, *(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)), 0, ppuint64(32))
	(*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdmagic = ppint32(iqlibc.ppInt64FromInt64(2133571330))
	if aasize2 != 0 {
		ccv3 = aasize2
	} else {
		ccv3 = ppint32(10)
	}
	(*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdsize = ccv3
	(*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdnum = aanum
	ccv4 = iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdsize)
	ccv5 = ppuint64(4)
	if ccv4 != 0 && ^iqlibc.ppUint64FromUint64(0)/ccv4 < ccv5 {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_7
	}
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv4*ccv5)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv6 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_9
	}
	Xmemcpy(cgtls, *(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16))+16, cgbp, ppuint64(8))
	ccv6 = 0
	goto cg_9
cg_9:
	ccv1 = ccv6
...
cg_7:
	...
	if aalist != 0 {
		Xmemcpy(cgtls, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdlist, aalist, iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdsize)*ppuint64(4))
	} else {
		Xmemset(cgtls, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdlist, 0, iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16)))).fdsize)*ppuint64(4))
	}
	*(*tnext2_u32_list)(iqunsafe.ppPointer(aaret)) = *(*tnext2_u32_list)(iqunsafe.ppPointer(cgbp + 16))
	return 0
}
...
//	 */
func Xext2fs_u32_list_create(cgtls *iqlibc.ppTLS, aaret ppuintptr, aasize ppint32) (cgr tnerrcode_t) {

	return simake_u32_list(cgtls, aasize, 0, ppuintptr(0), aaret)
}
...
//	 */
func Xext2fs_badblocks_list_create(cgtls *iqlibc.ppTLS, aaret ppuintptr, aasize ppint32) (cgr tnerrcode_t) {
...
//	 */
func Xext2fs_u32_copy(cgtls *iqlibc.ppTLS, aasrc tnext2_u32_list, aadest ppuintptr) (cgr tnerrcode_t) {

	var aaretval tnerrcode_t
	pp_ = aaretval

	aaretval = simake_u32_list(cgtls, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aasrc)).fdsize, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aasrc)).fdnum, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aasrc)).fdlist, aadest)
	if aaretval != 0 {
		return aaretval
	}
	(*tsext2_struct_u32_list)(iqunsafe.ppPointer(*(*tnext2_u32_list)(iqunsafe.ppPointer(aadest)))).fdbadblocks_flags = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aasrc)).fdbadblocks_flags
	return 0
}

func Xext2fs_badblocks_copy(cgtls *iqlibc.ppTLS, aasrc tnext2_badblocks_list, aadest ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_u32_copy(cgtls, aasrc, aadest)
}
...
//	 */
func Xext2fs_u32_list_add(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aablk tn__u32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aai, aaj, ccv4 ppint32
	var aaold_size1 ppuint64
	var aaretval, ccv2 tnerrcode_t
	var ccv1, ccv5 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aai, aaj, aaold_size1, aaretval, ccv1, ccv2, ccv4, ccv5

	if ppint64((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdmagic) != ppint64(2133571330) {
		return iqlibc.ppInt64FromInt64(2133571330)
	}

	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum >= (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdsize {
		aaold_size1 = iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdsize) * ppuint64(4)

		*(*ppint32)(iqunsafe.ppPointer(aabb + 8)) += ppint32(100)
		pp_ = aaold_size1
		ccv1 = aabb + 16
		Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xrealloc(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdsize)*ppuint64(4))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
	 ...
	 */
	aai = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum - ppint32(1)
	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum != 0 && *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) == aablk {
		return 0
	}
	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum == 0 || *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) < aablk {
		ccv1 = aabb + 4
		ccv4 = *(*ppint32)(iqunsafe.ppPointer(ccv1))
		*(*ppint32)(iqunsafe.ppPointer(ccv1)) = *(*ppint32)(iqunsafe.ppPointer(ccv1)) + 1
		*(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(ccv4)*4)) = aablk
		return 0
	}

	aaj = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum
	aai = 0
	for {
		if !(aai < (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum) {
			break
		}
		if *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) == aablk {
			return 0
		}
		if *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) > aablk {
			aaj = aai
	...
	aai = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum
	for {
		if !(aai > aaj) {
			break
		}
		*(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) = *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai-ppint32(1))*4))
		goto cg_7
	cg_7:
		;
		aai = aai - 1
	}
	*(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aaj)*4)) = aablk
	(*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum + 1
	return 0
}

func Xext2fs_badblocks_list_add(cgtls *iqlibc.ppTLS, aabb tnext2_badblocks_list, aablk tnblk_t) (cgr tnerrcode_t) {

	return Xext2fs_u32_list_add(cgtls, aabb, aablk)
}
...
//	 * list.
//	 */
func Xext2fs_u32_list_find(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aablk tn__u32) (cgr ppint32) {
	...
	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum == 0 {
		return -ppint32(1)
	}

	aalow = 0
	aahigh = (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum - ppint32(1)
	if aablk == *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aalow)*4)) {
		return aalow
	}
	if aablk == *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aahigh)*4)) {
		return aahigh
	}

	for aalow < aahigh {
		aamid = iqlibc.ppInt32FromUint32((iqlibc.ppUint32FromInt32(aalow) + iqlibc.ppUint32FromInt32(aahigh)) / ppuint32(2))
		if aamid == aalow || aamid == aahigh {
			break
		}
		if aablk == *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aamid)*4)) {
			return aamid
		}
		if aablk < *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aamid)*4)) {
			aahigh = aamid
...
//	 * list.
//	 */
func Xext2fs_u32_list_test(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aablk tn__u32) (cgr ppint32) {

	if Xext2fs_u32_list_find(cgtls, aabb, aablk) < 0 {
		return 0
	} else {
		return ppint32(1)
	}
...
func Xext2fs_badblocks_list_test(cgtls *iqlibc.ppTLS, aabb tnext2_badblocks_list, aablk tnblk_t) (cgr ppint32) {

	return Xext2fs_u32_list_test(cgtls, aabb, aablk)
}
...
//	 */
func Xext2fs_u32_list_del(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aablk tn__u32) (cgr ppint32) {

	var aai, aaremloc ppint32
	pp_, pp_ = aai, aaremloc

	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum == 0 {
		return -ppint32(1)
	}

	aaremloc = Xext2fs_u32_list_find(cgtls, aabb, aablk)
	if aaremloc < 0 {
		return -ppint32(1)
	}
	...
	aai = aaremloc
	for {
		if !(aai < (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum-ppint32(1)) {
			break
		}
		*(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai)*4)) = *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(aai+ppint32(1))*4))
		goto cg_1
...
func Xext2fs_badblocks_list_del(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aablk tn__u32) {

	Xext2fs_u32_list_del(cgtls, aabb, aablk)
}

func Xext2fs_u32_list_iterate_begin(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval, ccv1 tnerrcode_t
	var pp_ /* iter at bp+8 */ tnext2_u32_iterate
	var pp_ /* pp at bp+0 */ ppuintptr
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(24))
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_2
	}
...
cg_2:
	...
	(*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic = ppint32(iqlibc.ppInt64FromInt64(2133571331))
	(*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)))).fdbb = aabb
	(*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)))).fdptr = 0
	*(*tnext2_u32_iterate)(iqunsafe.ppPointer(aaret)) = *(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8))
	return 0
}

func Xext2fs_badblocks_list_iterate_begin(cgtls *iqlibc.ppTLS, aabb tnext2_badblocks_list, aaret ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_u32_list_iterate_begin(cgtls, aabb, aaret)
}

func Xext2fs_u32_list_iterate(cgtls *iqlibc.ppTLS, aaiter tnext2_u32_iterate, aablk ppuintptr) (cgr ppint32) {

	var aabb tnext2_u32_list
	var ccv1 ppint32
	var ccv2 ppuintptr
	pp_, pp_, pp_ = aabb, ccv1, ccv2

	if ppint64((*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(aaiter)).fdmagic) != ppint64(2133571331) {
		return 0
	}

	aabb = (*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(aaiter)).fdbb

	if ppint64((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdmagic) != ppint64(2133571330) {
		return 0
	}

	if (*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(aaiter)).fdptr < (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum {
		ccv2 = aaiter + 16
		ccv1 = *(*ppint32)(iqunsafe.ppPointer(ccv2))
		*(*ppint32)(iqunsafe.ppPointer(ccv2)) = *(*ppint32)(iqunsafe.ppPointer(ccv2)) + 1
		*(*tn__u32)(iqunsafe.ppPointer(aablk)) = *(*tn__u32)(iqunsafe.ppPointer((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdlist + ppuintptr(ccv1)*4))
		return ppint32(1)
	}
	*(*tn__u32)(iqunsafe.ppPointer(aablk)) = ppuint32(0)
	return 0
}

func Xext2fs_badblocks_list_iterate(cgtls *iqlibc.ppTLS, aaiter tnext2_badblocks_iterate, aablk ppuintptr) (cgr ppint32) {

	return Xext2fs_u32_list_iterate(cgtls, aaiter, aablk)
}

func Xext2fs_u32_list_iterate_end(cgtls *iqlibc.ppTLS, cg_iter tnext2_u32_iterate) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)) = cg_iter

	var ccv1 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_ = ccv1
	if !(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)) != 0) || ppint64((*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic) != ppint64(2133571331) {
		return
	}

	(*tsext2_struct_u32_iterate)(iqunsafe.ppPointer(*(*tnext2_u32_iterate)(iqunsafe.ppPointer(cgbp + 8)))).fdbb = ppuintptr(0)
	ccv1 = cgbp + 8
	Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
...
func Xext2fs_badblocks_list_iterate_end(cgtls *iqlibc.ppTLS, aaiter tnext2_badblocks_iterate) {

	Xext2fs_u32_list_iterate_end(cgtls, aaiter)
}

func Xext2fs_u32_list_equal(cgtls *iqlibc.ppTLS, aabb1 tnext2_u32_list, aabb2 tnext2_u32_list) (cgr ppint32) {

	if ppint64((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb1)).fdmagic) != ppint64(2133571330) {
		return ppint32(iqlibc.ppInt64FromInt64(2133571330))
	}
	if ppint64((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb2)).fdmagic) != ppint64(2133571330) {
		return ppint32(iqlibc.ppInt64FromInt64(2133571330))
	}

	if (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb1)).fdnum != (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb2)).fdnum {
		return 0
	}

	if Xmemcmp(cgtls, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb1)).fdlist, (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb2)).fdlist, iqlibc.ppUint64FromInt32((*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb1)).fdnum)*ppuint64(4)) != 0 {
		return 0
	}
	return ppint32(1)
}

func Xext2fs_badblocks_equal(cgtls *iqlibc.ppTLS, aabb1 tnext2_badblocks_list, aabb2 tnext2_badblocks_list) (cgr ppint32) {

	return Xext2fs_u32_list_equal(cgtls, aabb1, aabb2)
}

func Xext2fs_u32_list_count(cgtls *iqlibc.ppTLS, aabb tnext2_u32_list) (cgr ppint32) {

	return (*tsext2_struct_u32_list)(iqunsafe.ppPointer(aabb)).fdnum
}
