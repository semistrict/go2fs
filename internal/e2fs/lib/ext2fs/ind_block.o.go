...
func Xext2fs_read_ind_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablk tnblk_t, aabuf ppuintptr) (cgr tnerrcode_t) {

	var aaretval tnerrcode_t
	pp_ = aaretval

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_IMAGE_FILE) != 0 && (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio != (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdimage_io {
		Xmemset(cgtls, aabuf, 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
	} else {
		aaretval = (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdread_blk})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(aablk), ppint32(1), aabuf)
		if aaretval != 0 {
			return aaretval
		}
	}
...
func Xext2fs_write_ind_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablk tnblk_t, aabuf ppuintptr) (cgr tnerrcode_t) {
