...
func Xext2fs_read_dir_block4(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk64_t, aabuf ppuintptr, aaflags ppint32, aaino tnext2_ino_t) (cgr tnerrcode_t) {

	var aacorrupt ppint32
	var aaretval tnerrcode_t
	pp_, pp_ = aacorrupt, aaretval
	aacorrupt = 0
	...
	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IGNORE_CSUM_ERRORS) != 0) && !(Xext2fs_dir_block_csum_verify(cgtls, aafs, aaino, aabuf) != 0) {
		aacorrupt = ppint32(1)
	}

	if !(aaretval != 0) && aacorrupt != 0 {
		aaretval = iqlibc.ppInt64FromInt64(2133571478)
	}
	return aaretval
}

func Xext2fs_read_dir_block3(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk64_t, aabuf ppuintptr, aaflags ppint32) (cgr tnerrcode_t) {

	return Xext2fs_read_dir_block4(cgtls, aafs, aablock, aabuf, aaflags, ppuint32(0))
}

func Xext2fs_read_dir_block2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk_t, aabuf ppuintptr, aaflags ppint32) (cgr tnerrcode_t) {

	return Xext2fs_read_dir_block3(cgtls, aafs, ppuint64(aablock), aabuf, aaflags)
}

func Xext2fs_read_dir_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk_t, aabuf ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_read_dir_block3(cgtls, aafs, ppuint64(aablock), aabuf, 0)
}

func Xext2fs_write_dir_block4(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk64_t, aainbuf ppuintptr, aaflags ppint32, aaino tnext2_ino_t) (cgr tnerrcode_t) {
	...
	aaretval = Xext2fs_dir_block_csum_set(cgtls, aafs, aaino, aabuf)
	if aaretval != 0 {
		goto ppout
	}

	aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, aablock, ppint32(1), aabuf)
...
func Xext2fs_write_dir_block3(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk64_t, aainbuf ppuintptr, aaflags ppint32) (cgr tnerrcode_t) {

	return Xext2fs_write_dir_block4(cgtls, aafs, aablock, aainbuf, aaflags, ppuint32(0))
}

func Xext2fs_write_dir_block2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk_t, aainbuf ppuintptr, aaflags ppint32) (cgr tnerrcode_t) {

	return Xext2fs_write_dir_block3(cgtls, aafs, ppuint64(aablock), aainbuf, aaflags)
}

func Xext2fs_write_dir_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablock tnblk_t, aainbuf ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_write_dir_block3(cgtls, aafs, ppuint64(aablock), aainbuf, 0)
}

func _ext2fs_dir_block_csum_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64

func _ext2fs_dir_block_csum_verify(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint32
