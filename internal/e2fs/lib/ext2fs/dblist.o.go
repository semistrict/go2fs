...
//	 * initialize and copy).
//	 */
func simake_dblist(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aasize2 tnext2_ino_t, aacount1 tnext2_ino_t, aalist ppuintptr, aaret_dblist ppuintptr) (cgr tnerrcode_t) {
	...
	var ccv9 ppuintptr
	var pp_ /* dblist at bp+16 */ tnext2_dblist
	var pp_ /* num_dirs at bp+24 */ tnext2_ino_t
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aalen, aaretval, ccv1, ccv3, ccv4, ccv5, ccv7, ccv9
	*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)) = iqlibc.ppUintptrFromInt32(0)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if aaret_dblist == ppuintptr(0) && (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddblist != 0 && ppint64((*tsext2_struct_dblist)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddblist)).fdmagic) == ppint64(2133571340) {
		return 0
	}

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(48))
...
cg_2:
	...
	Xmemset(cgtls, *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)), 0, ppuint64(48))

	(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdmagic = ppint32(iqlibc.ppInt64FromInt64(2133571340))
	(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdfs = aafs
	if aasize2 != 0 {
		(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdsize = ppuint64(aasize2)
	} else {
		aaretval = Xext2fs_get_num_dirs(cgtls, aafs, cgbp+24)
		if aaretval != 0 {
			goto ppcleanup
		}
		(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdsize = ppuint64(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 24))*ppuint32(2) + ppuint32(12))
	}
	aalen = ppuint64(ppuint64(iqlibc.ppUint64FromInt64(24)) * (*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdsize)
	(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdcount = ppuint64(aacount1)
	ccv3 = ppuint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdsize)
	ccv4 = ppuint64(24)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv3*ccv4)
	...
	Xmemcpy(cgtls, *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16))+40, cgbp, ppuint64(8))
	ccv5 = 0
	goto cg_8
cg_8:
	ccv1 = ccv5
...
cg_6:
	...
	if aalist != 0 {
		Xmemcpy(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdlist, aalist, aalen)
	} else {
		Xmemset(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)))).fdlist, 0, aalen)
	}
	if aaret_dblist != 0 {
		*(*tnext2_dblist)(iqunsafe.ppPointer(aaret_dblist)) = *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16))
	} else {
		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddblist = *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16))
	}
	return 0
	goto ppcleanup
ppcleanup:
	;
	if *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp + 16)) != 0 {
		ccv9 = cgbp + 16
...
//	 */
func Xext2fs_init_dblist(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaret_dblist ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var pp_ /* dblist at bp+0 */ tnext2_dblist
	pp_ = aaretval

	aaretval = simake_dblist(cgtls, aafs, ppuint32(0), ppuint32(0), ppuintptr(0), cgbp)
	if aaretval != 0 {
		return aaretval
	}

	(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp)))).fdsorted = ppint32(1)
	if aaret_dblist != 0 {
		*(*tnext2_dblist)(iqunsafe.ppPointer(aaret_dblist)) = *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp))
	} else {
		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddblist = *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp))
	}
...
//	 */
func Xext2fs_copy_dblist(cgtls *iqlibc.ppTLS, aasrc tnext2_dblist, aadest ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	aaretval = simake_dblist(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(aasrc)).fdfs, ppuint32((*tsext2_struct_dblist)(iqunsafe.ppPointer(aasrc)).fdsize), ppuint32((*tsext2_struct_dblist)(iqunsafe.ppPointer(aasrc)).fdcount), (*tsext2_struct_dblist)(iqunsafe.ppPointer(aasrc)).fdlist, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	(*tsext2_struct_dblist)(iqunsafe.ppPointer(*(*tnext2_dblist)(iqunsafe.ppPointer(cgbp)))).fdsorted = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aasrc)).fdsorted
	*(*tnext2_dblist)(iqunsafe.ppPointer(aadest)) = *(*tnext2_dblist)(iqunsafe.ppPointer(cgbp))
	return 0
}
...
//	 */
func Xext2fs_add_dir_block2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaino tnext2_ino_t, aablk tnblk64_t, aablockcnt tne2_blkcnt_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aanew_entry, ccv2, ccv6 ppuintptr
	var aaold_size1, ccv1, ccv5 ppuint64
	var aaretval, ccv3 tnerrcode_t
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aanew_entry, aaold_size1, aaretval, ccv1, ccv2, ccv3, ccv5, ccv6

	if ppint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdmagic) != ppint64(2133571340) {
		return iqlibc.ppInt64FromInt64(2133571340)
	}

	if (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount >= (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize {
		aaold_size1 = ppuint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize * ppuint64(24))
		if (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize > ppuint64(200) {
			ccv1 = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize / ppuint64(2)
		} else {
			ccv1 = ppuint64(100)
		}
		*(*ppuint64)(iqunsafe.ppPointer(aadblist + 16)) += ccv1
		pp_ = aaold_size1
		ccv2 = aadblist + 40
		Xmemcpy(cgtls, cgbp, ccv2, ppuint64(8))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xrealloc(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), ppuint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize)*ppuint64(24))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
	...
	cg_4:
		aaretval = ccv3
		if aaretval != 0 {
			(*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsize = ppuint64(aaold_size1 / ppuint64(24))
			return aaretval
		}
	}
	ccv2 = aadblist + 24
	...
	*(*ppuint64)(iqunsafe.ppPointer(ccv2)) = *(*ppuint64)(iqunsafe.ppPointer(ccv2)) + 1
	aanew_entry = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr(ccv1)*24
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aanew_entry)).fdblk = aablk
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aanew_entry)).fdino = aaino
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aanew_entry)).fdblockcnt = aablockcnt

	(*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsorted = 0
...
//	 */
func Xext2fs_set_dir_block2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaino tnext2_ino_t, aablk tnblk64_t, aablockcnt tne2_blkcnt_t) (cgr tnerrcode_t) {
	...
	aai = ppuint32(0)
	for {
		if !(ppuint64(aai) < (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount) {
			break
		}
		if (*(*tsext2_db_entry2)(iqunsafe.ppPointer((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr(aai)*24))).fdino != aaino || (*(*tsext2_db_entry2)(iqunsafe.ppPointer((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr(aai)*24))).fdblockcnt != aablockcnt {
			goto cg_1
		}
		(*(*tsext2_db_entry2)(iqunsafe.ppPointer((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr(aai)*24))).fdblk = aablk
		(*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsorted = 0
		return 0
...
type tn__ccgo_fp__Xext2fs_dblist_sort2_1 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32

func Xext2fs_dblist_sort2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aa__ccgo_fp_sortfunc ppuintptr) {

	if !(aa__ccgo_fp_sortfunc != 0) {
		aa__ccgo_fp_sortfunc = pp__ccgo_fp(sidir_block_cmp2)
	}
	Xqsort(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist, ppuint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount), ppuint64(24), aa__ccgo_fp_sortfunc)
	(*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsorted = ppint32(1)
}

type tn__ccgo_fp__Xext2fs_dblist_iterate3_1 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32
...
//	 */
func Xext2fs_dblist_iterate3(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aa__ccgo_fp_func ppuintptr, aastart ppuint64, aacount ppuint64, aapriv_data ppuintptr) (cgr tnerrcode_t) {

	var aaend, aai ppuint64
	var aaret ppint32
	pp_, pp_, pp_ = aaend, aai, aaret

	if ppint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdmagic) != ppint64(2133571340) {
		return iqlibc.ppInt64FromInt64(2133571340)
	}

	aaend = aastart + aacount
	if !((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdsorted != 0) {
		Xext2fs_dblist_sort2(cgtls, aadblist, ppuintptr(0))
	}
	if aaend > (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount {
		aaend = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount
	}
	aai = aastart
	for {
		if !(aai < aaend) {
		...
		aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{aa__ccgo_fp_func})))(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdfs, (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist+ppuintptr(aai)*24, aapriv_data)
		if aaret&ppint32(mvDBLIST_ABORT) != 0 {
			return 0
		}
...
type tn__ccgo_fp__Xext2fs_dblist_iterate2_1 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32

func Xext2fs_dblist_iterate2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_dblist_iterate3(cgtls, aadblist, aa__ccgo_fp_func, ppuint64(0), (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount, aapriv_data)
}

func sidir_block_cmp2(cgtls *iqlibc.ppTLS, aaa ppuintptr, aab ppuintptr) (cgr ppint32) {

	var aadb_a, aadb_b ppuintptr
	pp_, pp_ = aadb_a, aadb_b
	aadb_a = aaa
	aadb_b = aab

	if (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdblk != (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdblk {
		return iqlibc.ppInt32FromUint64((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdblk - (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdblk)
	}

	if (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdino != (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdino {
		return iqlibc.ppInt32FromUint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdino - (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdino)
	}

	return ppint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdblockcnt - (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdblockcnt)
}

func Xext2fs_dblist_count2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist) (cgr tnblk64_t) {

	return (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount
}

func Xext2fs_dblist_get_last2(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaentry ppuintptr) (cgr tnerrcode_t) {

	if ppint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdmagic) != ppint64(2133571340) {
		return iqlibc.ppInt64FromInt64(2133571340)
	}

	if (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount == ppuint64(0) {
		return iqlibc.ppInt64FromInt64(2133571434)
	}

	if aaentry != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aaentry)) = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount-iqlibc.ppUint64FromInt32(1))*24
	}
	return 0
}

func Xext2fs_dblist_drop_last(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist) (cgr tnerrcode_t) {
	...
	(*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount - 1
	return 0
}
...
//	 * Add a directory block to the directory block list
//	 */
func Xext2fs_add_dir_block(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaino tnext2_ino_t, aablk tnblk_t, aablockcnt ppint32) (cgr tnerrcode_t) {

	return Xext2fs_add_dir_block2(cgtls, aadblist, aaino, ppuint64(aablk), ppint64(aablockcnt))
}
...
//	 * Change the directory block to the directory block list
//	 */
func Xext2fs_set_dir_block(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaino tnext2_ino_t, aablk tnblk_t, aablockcnt ppint32) (cgr tnerrcode_t) {

	return Xext2fs_set_dir_block2(cgtls, aadblist, aaino, ppuint64(aablk), ppint64(aablockcnt))
}

type tn__ccgo_fp__Xext2fs_dblist_sort_1 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32

func Xext2fs_dblist_sort(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aa__ccgo_fp_sortfunc ppuintptr) {

	if aa__ccgo_fp_sortfunc != 0 {
		sisortfunc32 = aa__ccgo_fp_sortfunc
		aa__ccgo_fp_sortfunc = pp__ccgo_fp(sidir_block_cmp)
	} else {
		aa__ccgo_fp_sortfunc = pp__ccgo_fp(sidir_block_cmp2)
	}
	Xqsort(cgtls, (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist, ppuint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount), ppuint64(24), aa__ccgo_fp_sortfunc)
 ...
 * This function iterates over the directory block list
 */
type tsiterate_passthrough = struct {
	fdfunc1     ppuintptr
	fdpriv_data ppuintptr
}

func sipassthrough_func(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadb_info ppuintptr, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aap ppuintptr
	var aaret ppint32
	var pp_ /* db at bp+0 */ tsext2_db_entry
	pp_, pp_ = aap, aaret
	aap = aapriv_data

	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdino = (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdino
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblk = ppuint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdblk)
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblockcnt = ppint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdblockcnt)
	aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsiterate_passthrough)(iqunsafe.ppPointer(aap)).fdfunc1})))(cgtls, aafs, cgbp, (*tsiterate_passthrough)(iqunsafe.ppPointer(aap)).fdpriv_data)
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdino = (*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdino
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdblk = ppuint64((*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblk)
	(*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_info)).fdblockcnt = ppint64((*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblockcnt)
	return aaret
}

type tn__ccgo_fp__Xext2fs_dblist_iterate_1 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32

func Xext2fs_dblist_iterate(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var pp_ /* pass at bp+0 */ tsiterate_passthrough

	if ppint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdmagic) != ppint64(2133571340) {
		return iqlibc.ppInt64FromInt64(2133571340)
	}
	(*(*tsiterate_passthrough)(iqunsafe.ppPointer(cgbp))).fdfunc1 = aa__ccgo_fp_func
	(*(*tsiterate_passthrough)(iqunsafe.ppPointer(cgbp))).fdpriv_data = aapriv_data

	return Xext2fs_dblist_iterate2(cgtls, aadblist, pp__ccgo_fp(sipassthrough_func), cgbp)
}

func sidir_block_cmp(cgtls *iqlibc.ppTLS, aaa ppuintptr, aab ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aadb_a, aadb_b ppuintptr
	var pp_ /* a32 at bp+0 */ tsext2_db_entry
	var pp_ /* b32 at bp+12 */ tsext2_db_entry
	pp_, pp_ = aadb_a, aadb_b
	aadb_a = aaa
	aadb_b = aab

	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdino = (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdino
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblk = ppuint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdblk)
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp))).fdblockcnt = ppint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_a)).fdblockcnt)

	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp + 12))).fdino = (*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdino
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp + 12))).fdblk = ppuint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdblk)
	(*(*tsext2_db_entry)(iqunsafe.ppPointer(cgbp + 12))).fdblockcnt = ppint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aadb_b)).fdblockcnt)

	return (*(*func(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{sisortfunc32})))(cgtls, cgbp, cgbp+12)
}

func Xext2fs_dblist_count(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist) (cgr ppint32) {

	return iqlibc.ppInt32FromUint64((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount)
}

func Xext2fs_dblist_get_last(cgtls *iqlibc.ppTLS, aadblist tnext2_dblist, aaentry ppuintptr) (cgr tnerrcode_t) {

	var aalast ppuintptr
	pp_ = aalast
	var snret_entry tsext2_db_entry
	...
	aalast = (*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdlist + ppuintptr((*tsext2_struct_dblist)(iqunsafe.ppPointer(aadblist)).fdcount)*24 - ppuintptr(1)*24

	snret_entry.fdino = (*tsext2_db_entry2)(iqunsafe.ppPointer(aalast)).fdino
	snret_entry.fdblk = ppuint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aalast)).fdblk)
	snret_entry.fdblockcnt = ppint32((*tsext2_db_entry2)(iqunsafe.ppPointer(aalast)).fdblockcnt)
	*(*ppuintptr)(iqunsafe.ppPointer(aaentry)) = ppuintptr(iqunsafe.ppPointer(&snret_entry))
