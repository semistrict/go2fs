...
func sitest_root(cgtls *iqlibc.ppTLS, aaa ppuint32, aab ppuint32) (cgr ppint32) {
...
func Xext2fs_bg_has_super(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr ppint32) {
	...
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_compat&ppuint32(mvEXT4_FEATURE_COMPAT_SPARSE_SUPER2) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {
		if aagroup == *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588)) || aagroup == *(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 588 + 1*4)) {
			return ppint32(1)
		}
		return 0
	}

	if ccv5 = aagroup <= ppuint32(1); !ccv5 {
		ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT2_FEATURE_RO_COMPAT_SPARSE_SUPER) != ppuint32(0))
		goto cg_4
	cg_4:
	}
	if ccv5 || !(ccv1 != 0) {
	...
	if !(aagroup&iqlibc.ppUint32FromInt32(1) != 0) {
		return 0
	}
	if sitest_root(cgtls, aagroup, ppuint32(3)) != 0 || sitest_root(cgtls, aagroup, ppuint32(5)) != 0 || sitest_root(cgtls, aagroup, ppuint32(7)) != 0 {
		return ppint32(1)
	}
...
//	 */
func Xext2fs_super_and_bgd_loc2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aaret_super_blk ppuintptr, aaret_old_desc_blk ppuintptr, aaret_new_desc_blk ppuintptr, aaret_used_blks ppuintptr) (cgr tnerrcode_t) {

	var aagroup_block, aanew_desc_blk, aaold_desc_blk, aaold_desc_blocks, aasuper_blk tnblk64_t
	var aahas_super, ccv1, ccv3, ccv4, ccv6 ppint32
	var aameta_bg, aameta_bg_size ppuint32
	var aanumblocks tnblk_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aagroup_block, aahas_super, aameta_bg, aameta_bg_size, aanew_desc_blk, aanumblocks, aaold_desc_blk, aaold_desc_blocks, aasuper_blk, ccv1, ccv3, ccv4, ccv6
	aasuper_blk = ppuint64(0)
	aaold_desc_blk = ppuint64(0)
	aanew_desc_blk = ppuint64(0)
	aanumblocks = ppuint32(0)

	aagroup_block = Xext2fs_group_first_block2(cgtls, aafs, aagroup)
	if aagroup_block == ppuint64(0) && (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize == ppuint32(1024) {
		aagroup_block = ppuint64(1)
	} /* Deal with 1024 blocksize && bigalloc */
...
cg_2:
	if ccv1 != 0 {
		aaold_desc_blocks = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_meta_bg)
	} else {
		aaold_desc_blocks = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddesc_blocks + ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_reserved_gdt_blocks))
	}

	aahas_super = Xext2fs_bg_has_super(cgtls, aafs, aagroup)

	if aahas_super != 0 {
		aasuper_blk = aagroup_block
		aanumblocks = aanumblocks + 1
	}
...
cg_5:
	...
	aameta_bg_size = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1) << iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_block_size / ccv1)
	aameta_bg = aagroup / aameta_bg_size

	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT2_FEATURE_INCOMPAT_META_BG) != ppuint32(0))
	goto cg_7
cg_7:
	;
	if !(ccv1 != 0) || aameta_bg < (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_meta_bg {
		if aahas_super != 0 {
			aaold_desc_blk = aagroup_block + ppuint64(1)

			aanumblocks = ppuint32(ppuint64(aanumblocks) + aaold_desc_blocks)
		}
	} else {
		if aagroup%aameta_bg_size == ppuint32(0) || aagroup%aameta_bg_size == ppuint32(1) || aagroup%aameta_bg_size == aameta_bg_size-ppuint32(1) {
			if aahas_super != 0 {
				aahas_super = ppint32(1)
			}
			aanew_desc_blk = aagroup_block + iqlibc.ppUint64FromInt32(aahas_super)
			aanumblocks = aanumblocks + 1
		}
	}

	if aaret_super_blk != 0 {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaret_super_blk)) = aasuper_blk
	}
	if aaret_old_desc_blk != 0 {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaret_old_desc_blk)) = aaold_desc_blk
	}
	if aaret_new_desc_blk != 0 {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaret_new_desc_blk)) = aanew_desc_blk
	}
	if aaret_used_blks != 0 {
		*(*tnblk_t)(iqunsafe.ppPointer(aaret_used_blks)) = aanumblocks
	}
...
//	 * group descriptors.
//	 */
func Xext2fs_super_and_bgd_loc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aaret_super_blk ppuintptr, aaret_old_desc_blk ppuintptr, aaret_new_desc_blk ppuintptr, aaret_meta_bg ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aameta_bg_size ppuint32
	var aanumblocks tnblk_t
	var ccv1, ccv2 ppint32
	var pp_ /* ret_new_desc_blk2 at bp+16 */ tnblk64_t
	var pp_ /* ret_old_desc_blk2 at bp+8 */ tnblk64_t
	var pp_ /* ret_super_blk2 at bp+0 */ tnblk64_t
	var pp_ /* ret_used_blks at bp+24 */ tnblk_t
	pp_, pp_, pp_, pp_ = aameta_bg_size, aanumblocks, ccv1, ccv2

	Xext2fs_super_and_bgd_loc2(cgtls, aafs, aagroup, cgbp, cgbp+8, cgbp+16, cgbp+24)

	aanumblocks = iqlibc.ppUint32FromInt32(Xext2fs_group_blocks_count(cgtls, aafs, aagroup))

	if aaret_super_blk != 0 {
		*(*tnblk_t)(iqunsafe.ppPointer(aaret_super_blk)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	}
	if aaret_old_desc_blk != 0 {
		*(*tnblk_t)(iqunsafe.ppPointer(aaret_old_desc_blk)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
	}
	if aaret_new_desc_blk != 0 {
		*(*tnblk_t)(iqunsafe.ppPointer(aaret_new_desc_blk)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 16)))
	}
	if aaret_meta_bg != 0 {
	...
	cg_3:
		...
		aameta_bg_size = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1) << iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_block_size / ccv1)
		*(*ppint32)(iqunsafe.ppPointer(aaret_meta_bg)) = iqlibc.ppInt32FromUint32(aagroup / aameta_bg_size)
	}

	aanumblocks = aanumblocks - (ppuint32(2) + (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group + *(*tnblk_t)(iqunsafe.ppPointer(cgbp + 24)))

	return iqlibc.ppInt32FromUint32(aanumblocks)
}
...
//	 *
//	 */
func siwrite_primary_superblock(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aasuper ppuintptr) (cgr tnerrcode_t) {

	var aacheck_idx, aasize, aawrite_idx ppint32
	var aanew_super, aaold_super ppuintptr
	var aaretval tnerrcode_t
	pp_, pp_, pp_, pp_, pp_, pp_ = aacheck_idx, aanew_super, aaold_super, aaretval, aasize, aawrite_idx

	if !(!((*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdwrite_byte != 0) || !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdorig_super != 0)) {
		goto cg_1
	}
	goto ppfallback
ppfallback:
	;
	(*(*func(*iqlibc.ppTLS, tnio_channel, ppint32) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdset_blksize})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppint32(mvSUPERBLOCK_OFFSET))
	aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(1), -ppint32(mvSUPERBLOCK_SIZE), aasuper)
	(*(*func(*iqlibc.ppTLS, tnio_channel, ppint32) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdset_blksize})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
	return aaretval
cg_1:
	;

	aaold_super = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdorig_super
	aanew_super = aasuper

	aacheck_idx = 0
	for {
		if !(aacheck_idx < iqlibc.ppInt32FromInt32(mvSUPERBLOCK_SIZE)/iqlibc.ppInt32FromInt32(2)) {
			break
		}
		if iqlibc.ppInt32FromUint16(*(*tn__u16)(iqunsafe.ppPointer(aaold_super + ppuintptr(aacheck_idx)*2))) == iqlibc.ppInt32FromUint16(*(*tn__u16)(iqunsafe.ppPointer(aanew_super + ppuintptr(aacheck_idx)*2))) {
			goto cg_2
		}
		aawrite_idx = aacheck_idx
		aacheck_idx = aacheck_idx + 1
		for {
			if !(aacheck_idx < iqlibc.ppInt32FromInt32(mvSUPERBLOCK_SIZE)/iqlibc.ppInt32FromInt32(2)) {
				break
			}
		...
		aasize = ppint32(2) * (aacheck_idx - aawrite_idx)
		aaretval = Xio_channel_write_byte(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, iqlibc.ppUint64FromInt32(ppint32(mvSUPERBLOCK_OFFSET)+ppint32(2)*aawrite_idx), aasize, aanew_super+ppuintptr(aawrite_idx)*2)
		if aaretval == ppint64(2133571408) {
			goto ppfallback
		}
		if aaretval != 0 {
			return aaretval
	...
	Xmemcpy(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdorig_super, aasuper, ppuint64(mvSUPERBLOCK_SIZE))
	return 0
}
...
//	 */
func Xext2fs_update_dynamic_rev(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	var aasb ppuintptr
	pp_ = aasb
	aasb = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper

	if (*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_rev_level > ppuint32(mvEXT2_GOOD_OLD_REV) {
		return
	}

	(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_rev_level = ppuint32(mvEXT2_DYNAMIC_REV)
	(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_first_ino = ppuint32(mvEXT2_GOOD_OLD_FIRST_INO)
	(*tsext2_super_block)(iqunsafe.ppPointer(aasb)).fds_inode_size = ppuint16(mvEXT2_GOOD_OLD_INODE_SIZE)
	/* s_uuid is handled by e2fsck already */
	/* other fields should be left alone */
}

func siwrite_backup_super(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t, aagroup_block tnblk64_t, aasuper_shadow ppuintptr) (cgr tnerrcode_t) {

	var aaretval tnerrcode_t
	var aasgrp tndgrp_t
	pp_, pp_ = aaretval, aasgrp
	aasgrp = aagroup

	if aasgrp > iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(16)-iqlibc.ppInt32FromInt32(1)) {
		aasgrp = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(16) - iqlibc.ppInt32FromInt32(1))
	}

	(*tsext2_super_block)(iqunsafe.ppPointer(aasuper_shadow)).fds_block_group_nr = ppuint16(aasgrp)

	aaretval = Xext2fs_superblock_csum_set(cgtls, aafs, aasuper_shadow)
	if aaretval != 0 {
		return aaretval
	}

	return Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, aagroup_block, -ppint32(mvSUPERBLOCK_SIZE), aasuper_shadow)
}

func Xext2fs_flush(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return Xext2fs_flush2(cgtls, aafs, 0)
}

func Xext2fs_flush2(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aaflags ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(48)
	defer cgtls.ppFree(48)

	var aafeature_incompat tn__u32
	var aafs_state ppuint64
	var aagroup_ptr, aagroup_shadow, aasuper_shadow, ccv8 ppuintptr
	var aai tndgrp_t
	var aameta_bg, ccv1, ccv11, ccv14, ccv15, ccv9 ppint32
	var aaold_desc_blocks tnblk64_t
	var aaretval tnerrcode_t
	var ccv3 ppbool
	var ccv4 tnext2_filsys
	var ccv5, ccv7 tntime_t
	var pp_ /* new_desc_blk at bp+32 */ tnblk64_t
	var pp_ /* old_desc_blk at bp+24 */ tnblk64_t
	var pp_ /* progress at bp+0 */ tsext2fs_numeric_progress_struct
	var pp_ /* super_blk at bp+16 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aafeature_incompat, aafs_state, aagroup_ptr, aagroup_shadow, aai, aameta_bg, aaold_desc_blocks, aaretval, aasuper_shadow, ccv1, ccv11, ccv14, ccv15, ccv3, ccv4, ccv5, ccv7, ccv8, ccv9
	aasuper_shadow = ppuintptr(0)
	aagroup_shadow = ppuintptr(0)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if ccv3 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&ppint32(mvEXT2_FLAG_SUPER_ONLY) == 0; ccv3 {
	...
	if ccv3 && !(ccv1 != 0) && (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc == iqlibc.ppUintptrFromInt32(0) {
		return iqlibc.ppInt64FromInt64(2133571507)
	}

	aafs_state = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_state)
	aafeature_incompat = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_feature_incompat

	ccv4 = aafs1
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv4)).fdnow != 0 || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv4)).fdflags2&ppuint32(mvEXT2_FLAG2_USE_FAKE_TIME) != 0 {
		ccv5 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv4)).fdnow
		goto cg_6
	}
	ccv5 = Xtime(cgtls, iqlibc.ppUintptrFromInt32(0))
	goto cg_6
cg_6:
	ccv7 = ccv5
	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 48)) = iqlibc.ppUint32FromInt64(ccv7 & iqlibc.ppInt64FromUint32(0xffffffff))
	*(*tn__u8)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 628)) = iqlibc.ppUint8FromInt64(ccv7 >> iqlibc.ppInt32FromInt32(32) & ppint64(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)-iqlibc.ppInt32FromInt32(1)))
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_block_group_nr = ppuint16(0)
	 ...
	 */
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdwrite_bitmaps != 0 {
		aaretval = (*(*func(*iqlibc.ppTLS, tnext2_filsys) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdwrite_bitmaps})))(cgtls, aafs1)
		if aaretval != 0 {
			goto pperrout
		}
	}
	...
	ccv8 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 58
	*(*tn__u16)(iqunsafe.ppPointer(ccv8)) = tn__u16(ppint32(*(*tn__u16)(iqunsafe.ppPointer(ccv8))) & ^iqlibc.ppInt32FromInt32(mvEXT2_VALID_FS))

	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 96)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT3_FEATURE_INCOMPAT_RECOVER))

	/* Byte swap the superblock and the group descriptors if necessary */
	aasuper_shadow = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper
	aagroup_shadow = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc
...
cg_10:
	if ccv1 != 0 {
		goto ppwrite_primary_superblock_only
	}
	 ...
	 */
	aagroup_ptr = aagroup_shadow
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT2_FEATURE_INCOMPAT_META_BG) != ppuint32(0))
	goto cg_12
cg_12:
	if ccv1 != 0 {
		aaold_desc_blocks = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_first_meta_bg)
		if aaold_desc_blocks > ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks) {
			aaold_desc_blocks = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks)
		}
	} else {
		aaold_desc_blocks = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fddesc_blocks)
	}

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdinit1 != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr, tn__u64))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdinit1})))(cgtls, aafs1, cgbp, iqlibc.ppUintptrFromInt32(0), ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc_count))
	}
	...
	for {
		...
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdupdate != 0 {
			(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tn__u64))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdupdate})))(cgtls, aafs1, cgbp, ppuint64(aai))
		}
		Xext2fs_super_and_bgd_loc2(cgtls, aafs1, aai, cgbp+16, cgbp+24, cgbp+32, ppuintptr(0))

		if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_MASTER_SB_ONLY) != 0) && aai != 0 && *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 16)) != 0 {
			aaretval = siwrite_backup_super(cgtls, aafs1, aai, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 16)), aasuper_shadow)
			if aaretval != 0 {
				goto pperrout
			}
		}
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&ppint32(mvEXT2_FLAG_SUPER_ONLY) != 0 {
			goto cg_13
		}
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 24)) != 0 && (!((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_MASTER_SB_ONLY) != 0) || aai == ppuint32(0)) {
			aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 24)), iqlibc.ppInt32FromUint64(aaold_desc_blocks), aagroup_ptr)
			if aaretval != 0 {
				goto pperrout
			}
		}
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 32)) != 0 {
			ccv9 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_64BIT) != ppuint32(0))
			goto cg_16
		cg_16:
			if ccv9 != 0 {
				ccv1 = iqlibc.ppInt32FromUint16((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_desc_size)
			} else {
				ccv1 = ppint32(mvEXT2_MIN_DESC_SIZE)
			}
			aameta_bg = iqlibc.ppInt32FromUint32(aai / iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT2_MIN_BLOCK_LOG_SIZE)<<(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_log_block_size/ccv1))

			aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 32)), ppint32(1), aagroup_ptr+ppuintptr(iqlibc.ppUint32FromInt32(aameta_bg)*(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
			if aaretval != 0 {
				goto pperrout
			}
		}
	...
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops != 0 && (*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdclose1 != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppuintptr))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsext2fs_progress_ops)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdprogress_ops)).fdclose1})))(cgtls, aafs1, cgbp, iqlibc.ppUintptrFromInt32(0))
	}

	goto ppwrite_primary_superblock_only
ppwrite_primary_superblock_only:
	;
	/*
	...
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_block_group_nr = ppuint16(0)
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_state = ppuint16(aafs_state)
	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_feature_incompat = aafeature_incompat

	aaretval = Xext2fs_superblock_csum_set(cgtls, aafs1, aasuper_shadow)
	if aaretval != 0 {
		return aaretval
	}

	if !(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_FLUSH_NO_SYNC) != 0) {
		aaretval = (*(*func(*iqlibc.ppTLS, tnio_channel) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio)).fdmanager)).fdflush})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio)
		if aaretval != 0 {
			goto pperrout
		}
	}
	aaretval = siwrite_primary_superblock(cgtls, aafs1, aasuper_shadow)
	if aaretval != 0 {
		goto pperrout
	}

	*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_DIRTY)
...
func Xext2fs_close_free(cgtls *iqlibc.ppTLS, aafs_ptr ppuintptr) (cgr tnerrcode_t) {

	var aafs tnext2_filsys
	var aaret tnerrcode_t
	pp_, pp_ = aafs, aaret
	aafs = *(*tnext2_filsys)(iqunsafe.ppPointer(aafs_ptr))

	aaret = Xext2fs_close2(cgtls, aafs, 0)
	if aaret != 0 {
		Xext2fs_free(cgtls, aafs)
	}
	*(*tnext2_filsys)(iqunsafe.ppPointer(aafs_ptr)) = iqlibc.ppUintptrFromInt32(0)
	return aaret
}

func Xext2fs_close(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return Xext2fs_close2(cgtls, aafs, 0)
}

func Xext2fs_close2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aameta_blks ppint32
	var aaretval tnerrcode_t
	var pp_ /* stats at bp+0 */ tnio_stats
	pp_, pp_ = aameta_blks, aaretval
	*(*tnio_stats)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdwrite_bitmaps != 0 {
		aaretval = (*(*func(*iqlibc.ppTLS, tnext2_filsys) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdwrite_bitmaps})))(cgtls, aafs)
		if aaretval != 0 {
			return aaretval
		}
	}
	if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_kbytes_written != 0 && (*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdget_stats != 0 {
		(*(*func(*iqlibc.ppTLS, tnio_channel, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdget_stats})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, cgbp)
	}
	if *(*tnio_stats)(iqunsafe.ppPointer(cgbp)) != 0 && (*tsstruct_io_stats)(iqunsafe.ppPointer(*(*tnio_stats)(iqunsafe.ppPointer(cgbp)))).fdbytes_written != 0 && (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_RW) != 0 {

		*(*tn__u64)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 376)) += (*tsstruct_io_stats)(iqunsafe.ppPointer(*(*tnio_stats)(iqunsafe.ppPointer(cgbp)))).fdbytes_written >> ppint32(10)
		aameta_blks = iqlibc.ppInt32FromUint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddesc_blocks + ppuint64(1))
		if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_SUPER_ONLY) != 0) {

			*(*tn__u64)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper + 376)) += ppuint64(iqlibc.ppUint32FromInt32(aameta_blks) / ((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize / ppuint32(1024)))
		}
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_DIRTY) == 0 {

			*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_SUPER_ONLY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_DIRTY)
		}
	}
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_DIRTY) != 0 {
		aaretval = Xext2fs_flush2(cgtls, aafs, aaflags)
		if aaretval != 0 {
			return aaretval
		}
	}

	aaretval = Xext2fs_mmp_stop(cgtls, aafs)
	if aaretval != 0 {
		return aaretval
	}
...
func _ext2fs_superblock_csum_set(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64
