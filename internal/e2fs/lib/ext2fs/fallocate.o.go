...
const mvEXT2_FALLOCATE_ALL_FLAGS = 15
const mvEXT2_FALLOCATE_FORCE_INIT = 2
const mvEXT2_FALLOCATE_FORCE_UNINIT = 4
const mvEXT2_FALLOCATE_INIT_BEYOND_EOF = 8
...
const mvEXT2_NEWRANGE_FIXED_GOAL = 1
const mvEXT2_NEWRANGE_MIN_LENGTH = 2
...
func sidbg_print_extent(cgtls *iqlibc.ppTLS, aadesc ppuintptr, aaextent ppuintptr) {

}

func siclaim_range(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aablk tnblk64_t, aalen tnblk64_t) (cgr tnerrcode_t) {

	var aaclusters tnblk64_t
	pp_ = aaclusters

	aaclusters = (aalen + iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits) - ppuint64(1)) / iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)
	Xext2fs_block_alloc_stats_range(cgtls, aafs, aablk, ppuint32(aaclusters*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)), +iqlibc.ppInt32FromInt32(1))
	return Xext2fs_iblk_add_blocks(cgtls, aafs, aainode, aaclusters)
}

func siext_falloc_helper(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aaino tnext2_ino_t, aainode ppuintptr, aahandle tnext2_extent_handle_t, aaleft_ext ppuintptr, aaright_ext ppuintptr, aarange_start tnblk64_t, aarange_len tnblk64_t, aaalloc_goal tnblk64_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(64)
	defer cgtls.ppFree(64)

	var aacluster_fill, aaeof_blk, aafillable, aax, aay tnblk64_t
	var aaerr tnerrcode_t
	var aamax_extent_len, aamax_init_len, aamax_uninit_len tnblk_t
	var aaop, ccv6, ccv7 ppint32
	var ccv1, ccv2, ccv4, ccv5 ppuintptr
	var ccv3 ppuint32
	var ccv9 ppuint64
	var pp_ /* ex at bp+24 */ tsext2fs_extent
	var pp_ /* newex at bp+0 */ tsext2fs_extent
	var pp_ /* pblk at bp+48 */ tnblk64_t
	var pp_ /* plen at bp+56 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacluster_fill, aaeof_blk, aaerr, aafillable, aamax_extent_len, aamax_init_len, aamax_uninit_len, aaop, aax, aay, ccv1, ccv2, ccv3, ccv4, ccv5, ccv6, ccv7, ccv9
	aaeof_blk = ppuint64(0)
	aacluster_fill = ppuint64(0)

	/* Can't create initialized extents past EOF? */
	if !(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_INIT_BEYOND_EOF) != 0) {
		aaeof_blk = (ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32)) / ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)
	}

	/* The allocation goal must be as far into a cluster as range_start. */
	aaalloc_goal = aaalloc_goal&iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))) | aarange_start&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))

	aamax_uninit_len = ppuint32((iqlibc.ppUint64FromUint64(1)<<iqlibc.ppInt32FromInt32(15) - iqlibc.ppUint64FromInt32(1)) & iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1))))
	aamax_init_len = ppuint32(iqlibc.ppUint64FromUint64(1) << iqlibc.ppInt32FromInt32(15) & iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1))))

	/* We must lengthen the left extent to the end of the cluster */
	if aaleft_ext != 0 && ppint32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits > ppint32(1) {
		/* How many more blocks can be attached to left_ext? */
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {
			aafillable = ppuint64(aamax_uninit_len - (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)
		} else {
			aafillable = ppuint64(aamax_init_len - (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)
		}

		if aafillable > aarange_len {
			aafillable = aarange_len
		}
		if aafillable == ppuint64(0) {
			goto ppexpand_right
		}
		 ...
		 */
		aacluster_fill = iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits) - aarange_start&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		aacluster_fill = aacluster_fill & iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		if aacluster_fill == ppuint64(0) {
			goto ppexpand_right
		}

		if aacluster_fill > aafillable {
			aacluster_fill = aafillable
		}

		/* Don't expand an initialized left_ext beyond EOF */
		if !(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_INIT_BEYOND_EOF) != 0) {
			aax = (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_lblk + ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len) - ppuint64(1)

			if aaeof_blk >= aax && aaeof_blk <= aax+aacluster_fill {
				aacluster_fill = aaeof_blk - aax
			}
			if aacluster_fill == ppuint64(0) {
				goto ppexpand_right
			}
		...
		aaerr = Xext2fs_extent_goto(cgtls, aahandle, (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_lblk)
		if aaerr != 0 {
			goto ppexpand_right
		}

		ccv1 = aaleft_ext + 16
		*(*tn__u32)(iqunsafe.ppPointer(ccv1)) = tn__u32(ppuint64(*(*tn__u32)(iqunsafe.ppPointer(ccv1))) + aacluster_fill)
		aarange_start = aarange_start + aacluster_fill
		aarange_len = aarange_len - aacluster_fill
		aaalloc_goal = aaalloc_goal + aacluster_fill

		sidbg_print_extent(cgtls, "ext_falloc clus left+\x00", aaleft_ext)
		aaerr = Xext2fs_extent_replace(cgtls, aahandle, 0, aaleft_ext)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = Xext2fs_extent_fix_parents(cgtls, aahandle)
		if aaerr != 0 {
			goto ppout
		}

		/* Zero blocks */
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_pblk+ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)-aacluster_fill, iqlibc.ppInt32FromUint64(aacluster_fill), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
ppexpand_right:
	...
	if aaright_ext != 0 && ppint32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits > ppint32(1) {
		/* How much can we attach to right_ext? */
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {
			aafillable = ppuint64(aamax_uninit_len - (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_len)
		} else {
			aafillable = ppuint64(aamax_init_len - (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_len)
		}
		 ...
		 */
		aacluster_fill = (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_lblk & iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		if aacluster_fill == ppuint64(0) {
			goto pptry_merge
		}

		aaerr = Xext2fs_extent_goto(cgtls, aahandle, (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_lblk)
		if aaerr != 0 {
			goto ppout
		}
		...
		*(*tnblk64_t)(iqunsafe.ppPointer(aaright_ext + 8)) -= aacluster_fill

		*(*tnblk64_t)(iqunsafe.ppPointer(aaright_ext)) -= aacluster_fill

		ccv1 = aaright_ext + 16
		*(*tn__u32)(iqunsafe.ppPointer(ccv1)) = tn__u32(ppuint64(*(*tn__u32)(iqunsafe.ppPointer(ccv1))) + aacluster_fill)
		aarange_len = aarange_len - aacluster_fill

		sidbg_print_extent(cgtls, "ext_falloc clus right+\x00", aaright_ext)
		aaerr = Xext2fs_extent_replace(cgtls, aahandle, 0, aaright_ext)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = Xext2fs_extent_fix_parents(cgtls, aahandle)
		...
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_pblk, iqlibc.ppInt32FromUint64(aacluster_fill), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
pptry_merge:
	...
	if aaleft_ext != 0 && aaright_ext != 0 {
		/* Are the two extents mergeable? */
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) {
			goto pptry_left
		}

		/* User requires init/uninit but extent is uninit/init. */
		if aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_INIT) != 0 && (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 || aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_UNINIT) != 0 && !((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) {
			goto pptry_left
		}
		 ...
		 */
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) && (!(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0) || !(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_FORCE_INIT) != 0)) {
			goto pptry_left
		}

		/* Will it even fit? */
		aax = ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len) + aarange_len + ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_len)
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {
			ccv3 = aamax_uninit_len
		} else {
			ccv3 = aamax_init_len
		}
		if aax > ppuint64(ccv3) {
			goto pptry_left
		}

		/* Would they even be physically contiguous if merged? */
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_pblk+ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)+aarange_len != (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_pblk {
			goto pptry_left
		}
		...
		/* Allocate blocks */
		aay = (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_pblk + ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)
		aaerr = Xext2fs_new_range(cgtls, aafs, iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_FIXED_GOAL)|iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_MIN_LENGTH), aay, (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_pblk-aay+ppuint64(1), iqlibc.ppUintptrFromInt32(0), cgbp+48, cgbp+56)
		if aaerr != 0 {
			goto pptry_left
		}
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48))+*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) != (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_pblk {
			goto pptry_left
		}
		aaerr = siclaim_range(cgtls, aafs, aainode, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)))
		if aaerr != 0 {
			goto ppout
		}

		/* Modify extents */
		(*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len = ppuint32(aax)
		sidbg_print_extent(cgtls, "ext_falloc merge\x00", aaleft_ext)
		aaerr = Xext2fs_extent_replace(cgtls, aahandle, 0, aaleft_ext)
		if aaerr != 0 {
			goto ppout
		}
		...
		aaerr = Xext2fs_extent_get(cgtls, aahandle, ppint32(mvEXT2_EXTENT_NEXT_LEAF), cgbp)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = Xext2fs_extent_delete(cgtls, aahandle, 0)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = Xext2fs_extent_fix_parents(cgtls, aahandle)
		...
		*(*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)) = *(*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext))

		/* Zero blocks */
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) && aaflags&ppint32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0 {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, aarange_start, iqlibc.ppInt32FromUint64(aarange_len), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
pptry_left:
	...
	if aaleft_ext != 0 {
		...
		if (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {
			...
			if aaflags&ppint32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0 {
				aafillable = ppuint64(aamax_init_len - (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)
			} else {
				aafillable = ppuint64(0)
			}
		}
		...
		if !(aaflags&iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_INIT_BEYOND_EOF) != 0) {
			...
			if aaeof_blk >= aax && aaeof_blk <= aax+aafillable {
				aafillable = aaeof_blk - aax
			}
		}
		...
		if ppint32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits > ppint32(1) {
			aaerr = Xext2fs_map_cluster_block(cgtls, aafs, aaino, aainode, aax+aafillable, cgbp+48)
			if aaerr != 0 {
				goto ppout
			}
			if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) != 0 {
				aafillable = aafillable - (ppuint64(1) + (aax+aafillable)&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1)))
			}
			if aafillable == ppuint64(0) {
				goto pptry_right
			}
		...
		aax = (*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_pblk + ppuint64((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_len)
		aaerr = Xext2fs_new_range(cgtls, aafs, iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_FIXED_GOAL)|iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_MIN_LENGTH), aax, aafillable, iqlibc.ppUintptrFromInt32(0), cgbp+48, cgbp+56)
		if aaerr != 0 {
			goto pptry_right
		}
		aaerr = siclaim_range(cgtls, aafs, aainode, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)))
		...
		aarange_start = aarange_start + *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))
		aarange_len = aarange_len - *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))

		ccv1 = aaleft_ext + 16
		*(*tn__u32)(iqunsafe.ppPointer(ccv1)) = tn__u32(ppuint64(*(*tn__u32)(iqunsafe.ppPointer(ccv1))) + *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)))
		sidbg_print_extent(cgtls, "ext_falloc left+\x00", aaleft_ext)
		aaerr = Xext2fs_extent_replace(cgtls, aahandle, 0, aaleft_ext)
		if aaerr != 0 {
			goto ppout
		}
		...
		/* Zero blocks if necessary */
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaleft_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) && aaflags&ppint32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0 {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)), iqlibc.ppInt32FromUint64(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
pptry_right:
	...
	if aaright_ext != 0 {
		...
		/* User requires init/uninit but extent is uninit/init. */
		if aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_INIT) != 0 && (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 || aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_UNINIT) != 0 && !((*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) {
			goto pptry_anywhere
		}
		...
		if ppint32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits > ppint32(1) {
			aaerr = Xext2fs_map_cluster_block(cgtls, aafs, aaino, aainode, (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_lblk-aafillable, cgbp+48)
			if aaerr != 0 {
				goto ppout
			}
			if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) != 0 {
				aafillable = aafillable - (iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits) - ((*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_lblk-aafillable)&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1)))
			}
			if aafillable == ppuint64(0) {
				goto pptry_anywhere
			}
		 ...
		 * unavailable.
		 */
		aaerr = Xext2fs_new_range(cgtls, aafs, iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_FIXED_GOAL)|iqlibc.ppInt32FromInt32(mvEXT2_NEWRANGE_MIN_LENGTH), (*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_pblk-aafillable, aafillable, iqlibc.ppUintptrFromInt32(0), cgbp+48, cgbp+56)
		if aaerr != 0 {
			goto pptry_anywhere
		}
		aaerr = siclaim_range(cgtls, aafs, aainode, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48))&iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))+*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48))&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1)))
		if aaerr != 0 {
			goto ppout
		}
		...
		*(*tnblk64_t)(iqunsafe.ppPointer(aaright_ext + 8)) -= *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))

		*(*tnblk64_t)(iqunsafe.ppPointer(aaright_ext)) -= *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))

		ccv1 = aaright_ext + 16
		*(*tn__u32)(iqunsafe.ppPointer(ccv1)) = tn__u32(ppuint64(*(*tn__u32)(iqunsafe.ppPointer(ccv1))) + *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)))
		sidbg_print_extent(cgtls, "ext_falloc right+\x00", aaright_ext)
		aaerr = Xext2fs_extent_replace(cgtls, aahandle, 0, aaright_ext)
		if aaerr != 0 {
			goto ppout
		}
		...
		/* Zero blocks if necessary */
		if !((*tsext2fs_extent)(iqunsafe.ppPointer(aaright_ext)).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) && aaflags&ppint32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0 {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)), iqlibc.ppInt32FromUint64(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))+aacluster_fill), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
pptry_anywhere:
	...
	if aarange_len > ppuint64(0) && aarange_start&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1)) != 0 {
		aacluster_fill = iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits) - aarange_start&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		aacluster_fill = aacluster_fill & iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		if aacluster_fill > aarange_len {
			aacluster_fill = aarange_len
		}
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk = aarange_start
		aaerr = Xext2fs_map_cluster_block(cgtls, aafs, aaino, aainode, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk, cgbp+48)
		if aaerr != 0 {
			goto ppout
		}
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) == ppuint64(0) {
			goto pptry_right_implied
		}
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_pblk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48))
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_len = ppuint32(aacluster_fill)
		if aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_INIT) != 0 {
			ccv6 = 0
		} else {
			ccv6 = ppint32(mvEXT2_EXTENT_FLAGS_UNINIT)
		}
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_flags = iqlibc.ppUint32FromInt32(ccv6)
		sidbg_print_extent(cgtls, "ext_falloc iclus left+\x00", cgbp)
		Xext2fs_extent_goto(cgtls, aahandle, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk)
		aaerr = Xext2fs_extent_get(cgtls, aahandle, mvEXT2_EXTENT_CURRENT, cgbp+24)
		if aaerr == ppint64(2133571456) {
			(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk = ppuint64(0)
		} else {
			if aaerr != 0 {
				goto ppout
			}
		...
		if (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk > (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk {
			aaop = 0
		} else {
			aaop = ppint32(mvEXT2_EXTENT_INSERT_AFTER)
		}

		aaerr = Xext2fs_extent_insert(cgtls, aahandle, aaop, cgbp)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = Xext2fs_extent_fix_parents(cgtls, aahandle)
		...
		if !((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0) && aaflags&ppint32(mvEXT2_FALLOCATE_ZERO_BLOCKS) != 0 {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_pblk, iqlibc.ppInt32FromUint32((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_len), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			if aaerr != 0 {
				goto ppout
			}
		}
...
pptry_right_implied:
	;
	aay = aarange_start + aarange_len
	if aarange_len > ppuint64(0) && aay&iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1)) != 0 {
		aacluster_fill = aay & iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		if aacluster_fill > aarange_len {
			aacluster_fill = aarange_len
		}
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk = aay & iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1)))
		aaerr = Xext2fs_map_cluster_block(cgtls, aafs, aaino, aainode, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk, cgbp+48)
		if aaerr != 0 {
			goto ppout
		}
		...
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_flags = iqlibc.ppUint32FromInt32(ccv6)
		sidbg_print_extent(cgtls, "ext_falloc iclus right+\x00", cgbp)
		Xext2fs_extent_goto(cgtls, aahandle, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk)
		aaerr = Xext2fs_extent_get(cgtls, aahandle, mvEXT2_EXTENT_CURRENT, cgbp+24)
		if aaerr == ppint64(2133571456) {
			(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk = ppuint64(0)
...
ppno_implied:
	;
	if aarange_len == ppuint64(0) {
		return 0
	}

	(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk = aarange_start
	if aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_INIT) != 0 {
		aamax_extent_len = aamax_init_len
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_flags = ppuint32(0)
	} else {
		aamax_extent_len = aamax_uninit_len
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_flags = ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT)
	}
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) = aaalloc_goal
	aay = aarange_len
	aax = ppuint64(0)
	for {
		if !(aax < aay) {
		...
		aacluster_fill = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk & iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))
		if aarange_len+aacluster_fill < ppuint64(aamax_extent_len) {
			ccv9 = aarange_len + aacluster_fill
		} else {
			ccv9 = ppuint64(aamax_extent_len)
		}
		aafillable = ccv9
		aaerr = Xext2fs_new_range(cgtls, aafs, 0, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48))&iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))), aafillable, iqlibc.ppUintptrFromInt32(0), cgbp+48, cgbp+56)
		if aaerr != 0 {
			goto ppout
		}
		aaerr = siclaim_range(cgtls, aafs, aainode, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)))
		...
		/* Create extent */
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_pblk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) + aacluster_fill
		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_len = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) - aacluster_fill)
		sidbg_print_extent(cgtls, "ext_falloc create\x00", cgbp)
		Xext2fs_extent_goto(cgtls, aahandle, (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk)
		aaerr = Xext2fs_extent_get(cgtls, aahandle, mvEXT2_EXTENT_CURRENT, cgbp+24)
		if aaerr == ppint64(2133571456) {
			(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk = ppuint64(0)
		...
		aax = aax + (*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) - aacluster_fill)
		aarange_len = aarange_len - (*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) - aacluster_fill)

		(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp))).fde_lblk += *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) - aacluster_fill
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) + (*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) - aacluster_fill)
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 48)) = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block)
		}
...
func siextent_fallocate(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aaino tnext2_ino_t, aainode ppuintptr, cg_goal tnblk64_t, aastart1 tnblk64_t, aalen tnblk64_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(80)
	defer cgtls.ppFree(80)
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = cg_goal

	var aacount, aaend1, aagoal_distance, aamax_blocks, aanext, aarange_end, aarange_start tnblk64_t
	var aaerr, aarv, ccv1 tnerrcode_t
	var aaleft_adjacent, aaright_adjacent ppuintptr
	var ccv3 ppuint64
	var pp_ /* handle at bp+16 */ tnext2_extent_handle_t
	var pp_ /* left_extent at bp+24 */ tsext2fs_extent
	var pp_ /* o at bp+0 */ tn__u64
	var pp_ /* right_extent at bp+48 */ tsext2fs_extent
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacount, aaend1, aaerr, aagoal_distance, aaleft_adjacent, aamax_blocks, aanext, aarange_end, aarange_start, aaright_adjacent, aarv, ccv1, ccv3
	aarange_end = ppuint64(0)

	aaend1 = aastart1 + aalen - ppuint64(1)
	aaerr = Xext2fs_extent_open2(cgtls, aafs, aaino, aainode, cgbp+16)
	if aaerr != 0 {
		return aaerr
	}
...
ppstart_again:
	;
	Xext2fs_extent_goto(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), aastart1)
	aaerr = Xext2fs_extent_get(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), mvEXT2_EXTENT_CURRENT, cgbp+24)
	if aaerr == ppint64(2133571456) {
		aamax_blocks = Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)

		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) == ^iqlibc.ppUint64FromUint64(0) {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = Xext2fs_find_inode_goal(cgtls, aafs, aaino, aainode, aastart1)
		}
		aarv = Xext2fs_find_first_zero_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)), aamax_blocks-ppuint64(1), cgbp)
		if !(aarv != 0) {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = *(*tn__u64)(iqunsafe.ppPointer(cgbp))
		}
		ccv1 = aarv
		goto cg_2
	cg_2:
		aaerr = ccv1
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) + aastart1
		aaerr = siext_falloc_helper(cgtls, aafs, aaflags, aaino, aainode, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0), aastart1, aalen, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
		goto pperrout
	} else {
		if aaerr != 0 {
			goto pperrout
	...
	sidbg_print_extent(cgtls, "ext_falloc initial\x00", cgbp+24)
	aanext = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk + ppuint64((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_len)
	if (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk > aastart1 {
		/* The nearest extent we found was beyond start??? */
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_pblk - ((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk - aastart1)
		if aalen < (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk-aastart1 {
			ccv3 = aalen
		} else {
			ccv3 = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk - aastart1
		}
		aaerr = siext_falloc_helper(cgtls, aafs, aaflags, aaino, aainode, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), iqlibc.ppUintptrFromInt32(0), cgbp+24, aastart1, ccv3, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
		if aaerr != 0 {
			goto pperrout
		}
		...
		if aanext >= aastart1 {
			aarange_start = aanext
			aaleft_adjacent = cgbp + 24
		} else {
			aarange_start = aastart1
			aaleft_adjacent = iqlibc.ppUintptrFromInt32(0)
		}
	}
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_pblk + (aarange_start - (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk)

	for cgcond := true; cgcond; cgcond = aarange_end < aaend1 {
		aaerr = Xext2fs_extent_get(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), ppint32(mvEXT2_EXTENT_NEXT_LEAF), cgbp+48)

		sidbg_print_extent(cgtls, "ext_falloc next\x00", cgbp+48)
		/* Stop if we've seen this extent before */
		if !(aaerr != 0) && (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk <= (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk {
			aaerr = iqlibc.ppInt64FromInt64(2133571452)
		}

		if aaerr != 0 && aaerr != ppint64(2133571452) {
			goto pperrout
		}
		if aaerr == ppint64(2133571452) || (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk > aaend1+ppuint64(1) {
			aarange_end = aaend1
			aaright_adjacent = iqlibc.ppUintptrFromInt32(0)
		} else {
			/* Handle right_extent.e_lblk <= end */
			aarange_end = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk - ppuint64(1)
			aaright_adjacent = cgbp + 48
		}
		aagoal_distance = aarange_start - aanext
		if aaerr != ppint64(2133571452) && aagoal_distance > aarange_end-(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_pblk - ((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk - aarange_start)
		}

		aaerr = 0
		if aarange_start <= aarange_end {
			aacount = aarange_end - aarange_start + ppuint64(1)
			aaerr = siext_falloc_helper(cgtls, aafs, aaflags, aaino, aainode, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), aaleft_adjacent, aaright_adjacent, aarange_start, aacount, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)))
			if aaerr != 0 {
				goto pperrout
			}
		}

		if aarange_end == aaend1 {
			break
		}

		aaerr = Xext2fs_extent_goto(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 16)), (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk)
		if aaerr != 0 {
			goto pperrout
		}
		aanext = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_lblk + ppuint64((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))).fde_len)
		*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24)) = *(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 48))
		aaleft_adjacent = cgbp + 24
		aarange_start = aanext
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_pblk + (aarange_start - (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 24))).fde_lblk)
	}
...
//	 */
func Xext2fs_fallocate(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aaino tnext2_ino_t, aainode ppuintptr, aagoal tnblk64_t, aastart tnblk64_t, aalen tnblk64_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(144)
	defer cgtls.ppFree(144)

	var aablk, aalast, aazero_blk tnblk64_t
	var aaerr tnerrcode_t
	var aazero_len ppint32
	var pp_ /* inode_buf at bp+0 */ tsext2_inode
	var pp_ /* x at bp+128 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_ = aablk, aaerr, aalast, aazero_blk, aazero_len
	aalast = ppuint64(0)
	aazero_len = 0

	if aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_INIT) != 0 && aaflags&ppint32(mvEXT2_FALLOCATE_FORCE_UNINIT) != 0 || aaflags & ^iqlibc.ppInt32FromInt32(mvEXT2_FALLOCATE_ALL_FLAGS) != 0 {
		return iqlibc.ppInt64FromInt64(2133571399)
	}

	if aalen > Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
		return iqlibc.ppInt64FromInt64(2133571400)
	} else {
		if aalen == ppuint64(0) {
			return 0
		}
	...
	if !(aainode != 0) {
		aaerr = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp)
		if aaerr != 0 {
			return aaerr
		}
		aainode = cgbp
	...
	if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&ppuint32(mvEXT4_EXTENTS_FL) != 0 {
		aaerr = siextent_fallocate(cgtls, aafs, aaflags, aaino, aainode, aagoal, aastart, aalen)
		goto ppout
	}
	...
	aablk = aastart
	for {
		if !(aablk < aastart+aalen) {
			break
		}
		aaerr = Xext2fs_bmap2(cgtls, aafs, aaino, aainode, iqlibc.ppUintptrFromInt32(0), 0, aablk, ppuintptr(0), cgbp+128)
		if aaerr != 0 {
			return aaerr
		}
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 128)) != 0 {
			goto cg_1
		}

		aaerr = Xext2fs_bmap2(cgtls, aafs, aaino, aainode, iqlibc.ppUintptrFromInt32(0), ppint32(mvBMAP_ALLOC), aablk, ppuintptr(0), cgbp+128)
		if aaerr != 0 {
			goto pperrout
		}
		if aazero_len != 0 && *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 128)) != aalast+ppuint64(1) || aazero_len >= ppint32(65536) {
			aaerr = Xext2fs_zero_blocks2(cgtls, aafs, aazero_blk, aazero_len, iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
			aazero_len = 0
			if aaerr != 0 {
				goto pperrout
			}
		...
		if aazero_len == 0 {
			aazero_blk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 128))
			aazero_len = ppint32(1)
		} else {
			aazero_len = aazero_len + 1
		}
		aalast = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 128))
...
ppout:
	;
	if aainode == cgbp {
		Xext2fs_write_inode(cgtls, aafs, aaino, aainode)
	}
	goto pperrout
pperrout:
	;
	if aazero_len != 0 {
		Xext2fs_zero_blocks2(cgtls, aafs, aazero_blk, aazero_len, iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
	}
	return aaerr
}

func _ext2fs_block_alloc_stats_range(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32, ppint32)
...
func _ext2fs_extent_delete(*iqlibc.ppTLS, ppuintptr, ppint32) ppint64

func _ext2fs_extent_fix_parents(*iqlibc.ppTLS, ppuintptr) ppint64

func _ext2fs_extent_free(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_extent_get(*iqlibc.ppTLS, ppuintptr, ppint32, ppuintptr) ppint64

func _ext2fs_extent_goto(*iqlibc.ppTLS, ppuintptr, ppuint64) ppint64

func _ext2fs_extent_insert(*iqlibc.ppTLS, ppuintptr, ppint32, ppuintptr) ppint64

func _ext2fs_extent_open2(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuintptr) ppint64

func _ext2fs_extent_replace(*iqlibc.ppTLS, ppuintptr, ppint32, ppuintptr) ppint64

func _ext2fs_find_first_zero_generic_bmap(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppuintptr) ppint64
...
func _ext2fs_map_cluster_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuint64, ppuintptr) ppint64

func _ext2fs_new_range(*iqlibc.ppTLS, ppuintptr, ppint32, ppuint64, ppuint64, ppuintptr, ppuintptr, ppuintptr) ppint64
...
func _ext2fs_zero_blocks2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppint32, ppuintptr, ppuintptr) ppint64
