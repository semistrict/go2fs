...
const mvEXT2_ICOUNT_OPT_FULLMAP = 2
const mvEXT2_ICOUNT_OPT_INCREMENT = 1
...
type tsext2_icount = struct {
	fdmagic       tnerrcode_t
	fdsingle      tnext2fs_inode_bitmap
	fdmultiple    tnext2fs_inode_bitmap
	fdcount       tnext2_ino_t
	fdsize        tnext2_ino_t
	fdnum_inodes  tnext2_ino_t
	fdcursor      tnext2_ino_t
	fdlist        ppuintptr
	fdlast_lookup ppuintptr
	fdtdb_fn      ppuintptr
	fdtdb         ppuintptr
	fdfullmap     ppuintptr
}
...
func Xext2fs_free_icount(cgtls *iqlibc.ppTLS, cg_icount tnext2_icount_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)) = cg_icount

	var ccv1, ccv3, ccv5 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_ = ccv1, ccv3, ccv5
	if !(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)) != 0) {
		return
	}

	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic = 0
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdlist != 0 {
		ccv1 = *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)) + 40
	...
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdsingle != 0 {
		Xext2fs_free_inode_bitmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdsingle)
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmultiple != 0 {
		Xext2fs_free_inode_bitmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmultiple)
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdtdb != 0 {
		Xext2fs_tdb_close(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdtdb)
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdtdb_fn != 0 {
		Xunlink(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdtdb_fn)
		Xfree(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdtdb_fn)
	}

	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdfullmap != 0 {
		ccv1 = *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)) + 72
		Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
		Xmemcpy(cgtls, ccv1, cgbp, ppuint64(8))
...
func sialloc_icount(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval, ccv1, ccv3 tnerrcode_t
	var aasz ppuint32
	var pp_ /* icount at bp+8 */ tnext2_icount_t
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_ = aaretval, aasz, ccv1, ccv3

	*(*tnext2_icount_t)(iqunsafe.ppPointer(aaret)) = ppuintptr(0)

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(80))
...
cg_2:
	...
	Xmemset(cgtls, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)), 0, ppuint64(80))
	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic = iqlibc.ppInt64FromInt64(2133571341)
	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdnum_inodes = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_count

	if aaflags&ppint32(mvEXT2_ICOUNT_OPT_FULLMAP) != 0 && aaflags&ppint32(mvEXT2_ICOUNT_OPT_INCREMENT) != 0 {
		aasz = ppuint32(ppuint64(2) * ppuint64((*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdnum_inodes))

		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(aasz))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
			ccv1 = iqlibc.ppInt64FromInt64(2133571398)
			goto cg_4
		}
		Xmemcpy(cgtls, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))+72, cgbp, ppuint64(8))
		ccv1 = 0
		goto cg_4
	cg_4:
		aaretval = ccv1
		...
		if !(aaretval != 0) {
			Xmemset(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdfullmap, 0, ppuint64(aasz))
			*(*tnext2_icount_t)(iqunsafe.ppPointer(aaret)) = *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))
			return 0
		}
	}

	aaretval = Xext2fs_allocate_inode_bitmap(cgtls, aafs, "icount\x00", *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))+8)
	if aaretval != 0 {
		goto pperrout
	}

	if aaflags&ppint32(mvEXT2_ICOUNT_OPT_INCREMENT) != 0 {
		aaretval = Xext2fs_allocate_inode_bitmap(cgtls, aafs, "icount_inc\x00", *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))+16)
		if aaretval != 0 {
			goto pperrout
		}
	} else {
		(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmultiple = ppuintptr(0)
	}
...
pperrout:
	;
	Xext2fs_free_icount(cgtls, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))
	return aaretval
}
...
type tsuuid = struct {
	fdtime_low            tn__u32
	fdtime_mid            tn__u16
	fdtime_hi_and_version tn__u16
	fdclock_seq           tn__u16
	fdnode                [6]tn__u8
}

func siunpack_uuid(cgtls *iqlibc.ppTLS, aain ppuintptr, aauu ppuintptr) {
	...
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = ppuint32(*(*tn__u8)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tn__u8)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
	aaptr = aaptr + 1
	aatmp = aatmp<<iqlibc.ppInt32FromInt32(8) | ppuint32(*(*tn__u8)(iqunsafe.ppPointer(ccv1)))
	ccv1 = aaptr
...
func siuuid_unparse(cgtls *iqlibc.ppTLS, aauu ppuintptr, aaout ppuintptr) {
	cgbp := cgtls.ppAlloc(112)
	defer cgtls.ppFree(112)

	var pp_ /* uuid at bp+0 */ tsuuid

	siunpack_uuid(cgtls, aauu, cgbp)
	Xsprintf(cgtls, aaout, "%08x-%04x-%04x-%02x%02x-%02x%02x%02x%02x%02x%02x\x00", iqlibc.ppVaList(cgbp+24, (*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_low, iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_mid), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdtime_hi_and_version), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdclock_seq)>>ppint32(8), iqlibc.ppInt32FromUint16((*(*tsuuid)(iqunsafe.ppPointer(cgbp))).fdclock_seq)&ppint32(0xFF), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10))), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10 + 1))), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10 + 2))), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10 + 3))), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10 + 4))), iqlibc.ppInt32FromUint8(*(*tn__u8)(iqunsafe.ppPointer(cgbp + 10 + 5)))))
}

func Xext2fs_create_icount_tdb(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aatdb_dir ppuintptr, aaflags ppint32, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(96)
	defer cgtls.ppFree(96)

	var aafd ppint32
	var aanum_inodes tnext2_ino_t
	var aaretval, ccv1 tnerrcode_t
	var aasave_umask tnmode_t
	var ccv3 ppuintptr
	var pp_ /* fn at bp+24 */ ppuintptr
	var pp_ /* icount at bp+16 */ tnext2_icount_t
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* uuid at bp+32 */ [40]ppint8
	pp_, pp_, pp_, pp_, pp_, pp_ = aafd, aanum_inodes, aaretval, aasave_umask, ccv1, ccv3

	aaretval = sialloc_icount(cgtls, aafs, aaflags, cgbp+16)
	if aaretval != 0 {
		return aaretval
	}

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, Xstrlen(cgtls, aatdb_dir)+ppuint64(64))
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_2
	}
...
cg_2:
	...
	siuuid_unparse(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper+104, cgbp+32)
	Xsprintf(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)), "%s/%s-icount-XXXXXX\x00", iqlibc.ppVaList(cgbp+80, aatdb_dir, cgbp+32))
	aasave_umask = Xumask(cgtls, ppuint16(077))
	aafd = Xmkstemp(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)))
	if aafd < 0 {
	...
	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 16)))).fdtdb_fn = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24))
	 ...
	 * value.
	 */
	aanum_inodes = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_count - (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_free_inodes_count

	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 16)))).fdtdb = Xext2fs_tdb_open(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)), iqlibc.ppInt32FromUint32(aanum_inodes), iqlibc.ppInt32FromInt32(mvTDB_NOLOCK)|iqlibc.ppInt32FromInt32(mvTDB_NOSYNC), iqlibc.ppInt32FromInt32(mvO_RDWR)|iqlibc.ppInt32FromInt32(mvO_CREAT)|iqlibc.ppInt32FromInt32(mvO_TRUNC), ppuint16(0600))
	Xclose(cgtls, aafd)
	if (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 16)))).fdtdb == iqlibc.ppUintptrFromInt32(0) {
		aaretval = ppint64(*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))))
		goto pperrout
	}
	*(*tnext2_icount_t)(iqunsafe.ppPointer(aaret)) = *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 16))
	return 0
	goto pperrout
pperrout:
	;
	Xext2fs_free_icount(cgtls, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 16)))
	return aaretval
}

func Xext2fs_create_icount2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aasize2 ppuint32, aahint tnext2_icount_t, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabytes tnsize_t
	var aai tnext2_ino_t
	var aaretval, ccv3, ccv5 tnerrcode_t
	var ccv1, ccv2 ppuint64
	var pp_ /* icount at bp+8 */ tnext2_icount_t
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabytes, aai, aaretval, ccv1, ccv2, ccv3, ccv5

	if aahint != 0 {
		if (*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdmagic != ppint64(2133571341) {
			return iqlibc.ppInt64FromInt64(2133571341)
		}
		if (*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdsize > aasize2 {
			aasize2 = ppuint32(ppuint64((*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdsize))
		}
	}

	aaretval = sialloc_icount(cgtls, aafs, aaflags, cgbp+8)
	if aaretval != 0 {
		return aaretval
	}
	...
	if aasize2 != 0 {
		(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdsize = aasize2
	} else {
		/*
		 ...
		 */
		aaretval = Xext2fs_get_num_dirs(cgtls, aafs, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))+28)
		if aaretval != 0 {
			goto pperrout
		}

		*(*tnext2_ino_t)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)) + 28)) += (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_count / ppuint32(50)
	}

	aabytes = ppuint64((*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdsize) * iqlibc.ppUint64FromInt64(8)
	ccv1 = ppuint64((*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdsize)
	ccv2 = ppuint64(8)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv1*ccv2)
	...
	Xmemcpy(cgtls, *(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8))+40, cgbp, ppuint64(8))
	ccv5 = 0
	goto cg_6
cg_6:
	ccv3 = ccv5
...
cg_4:
	...
	Xmemset(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdlist, 0, aabytes)

	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdcount = ppuint32(0)
	(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdcursor = ppuint32(0)
	...
	if aahint != 0 {
		aai = ppuint32(0)
		for {
			if !(aai < (*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdcount) {
				break
			}
			(*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdlist + ppuintptr(aai)*8))).fdino = (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdlist + ppuintptr(aai)*8))).fdino
			goto cg_7
		cg_7:
			;
			aai = aai + 1
		}
		(*tsext2_icount)(iqunsafe.ppPointer(*(*tnext2_icount_t)(iqunsafe.ppPointer(cgbp + 8)))).fdcount = (*tsext2_icount)(iqunsafe.ppPointer(aahint)).fdcount
	}
...
func Xext2fs_create_icount(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aasize ppuint32, aaret ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_create_icount2(cgtls, aafs, aaflags, aasize, ppuintptr(0), aaret)
}
...
//	 * 	specified position.
//	 */
func siinsert_icount_el(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aapos ppint32) (cgr ppuintptr) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aael, ccv1 ppuintptr
	var aanew_size tnext2_ino_t
	var aanum ppint32
	var aaretval, ccv2 tnerrcode_t
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_ = aael, aanew_size, aanum, aaretval, ccv1, ccv2
	aanew_size = ppuint32(0)

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlast_lookup != 0 && (*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlast_lookup)).fdino == aaino {
		return (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlast_lookup
	}

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount >= (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize {
		if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount != 0 {
			aanew_size = (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount-ppuint32(1))*8))).fdino
			aanew_size = ppuint32(ppfloat32(ppfloat32((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount) * (ppfloat32((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdnum_inodes) / ppfloat32(aanew_size))))
		}
		if aanew_size < (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize+ppuint32(100) {
			aanew_size = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize + ppuint32(100)
		}
		pp_ = ppuint64((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize) * ppuint64(8)
		ccv1 = aaicount + 40
		Xmemcpy(cgtls, cgbp, ccv1, ppuint64(8))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xrealloc(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), ppuint64(aanew_size)*ppuint64(8))
		if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
	...
	cg_3:
		...
		(*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize = aanew_size
	}
	aanum = iqlibc.ppInt32FromUint32((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount) - aapos
	if aanum < 0 {
		return ppuintptr(0)
	} /* should never happen */
	if aanum != 0 {
		Xmemmove(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist+ppuintptr(aapos+ppint32(1))*8, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist+ppuintptr(aapos)*8, ppuint64(8)*iqlibc.ppUint64FromInt32(aanum))
	}
	(*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount + 1
	aael = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aapos)*8
	(*tsext2_icount_el)(iqunsafe.ppPointer(aael)).fdcount = ppuint32(0)
	(*tsext2_icount_el)(iqunsafe.ppPointer(aael)).fdino = aaino
	(*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlast_lookup = aael
	return aael
}
...
//	 */
func siget_icount_el(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aacreate ppint32) (cgr ppuintptr) {

	var aahigh, aalow, aamid ppint32
	var ccv1 tnext2_ino_t
	var ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aahigh, aalow, aamid, ccv1, ccv2

	if !(aaicount != 0) || !((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist != 0) {
		return ppuintptr(0)
	}

	if aacreate != 0 && ((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount == ppuint32(0) || aaino > (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount-ppuint32(1))*8))).fdino) {
		return siinsert_icount_el(cgtls, aaicount, aaino, iqlibc.ppInt32FromUint32((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount))
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount == ppuint32(0) {
		return ppuintptr(0)
	}

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcursor >= (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount {
		(*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcursor = ppuint32(0)
	}
	if aaino == (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcursor)*8))).fdino {
		ccv2 = aaicount + 36
		ccv1 = *(*tnext2_ino_t)(iqunsafe.ppPointer(ccv2))
		*(*tnext2_ino_t)(iqunsafe.ppPointer(ccv2)) = *(*tnext2_ino_t)(iqunsafe.ppPointer(ccv2)) + 1
		return (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(ccv1)*8
	}
	aalow = 0
	aahigh = iqlibc.ppInt32FromUint32((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount) - ppint32(1)
	for aalow <= aahigh {
		aamid = iqlibc.ppInt32FromUint32((iqlibc.ppUint32FromInt32(aalow) + iqlibc.ppUint32FromInt32(aahigh)) >> ppint32(1))
		if aaino == (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aamid)*8))).fdino {
			(*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcursor = iqlibc.ppUint32FromInt32(aamid + ppint32(1))
			return (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aamid)*8
		}
		if aaino < (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aamid)*8))).fdino {
			aahigh = aamid - ppint32(1)
		} else {
			aalow = aamid + ppint32(1)
		}
	}
	/*
	 ...
	 */
	if aacreate != 0 {
		return siinsert_icount_el(cgtls, aaicount, aaino, aalow)
	}
	return ppuintptr(0)
}

func siset_inode_count(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, cg_ino tnext2_ino_t, cg_count tn__u32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)) = cg_ino
	*(*tn__u32)(iqunsafe.ppPointer(cgbp + 4)) = cg_count

	var aadata, aakey tnTDB_DATA
	var aael ppuintptr
	var ccv1 ppuint32
	pp_, pp_, pp_, pp_ = aadata, aael, aakey, ccv1

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb != 0 {
		aakey.fddptr = cgbp
		aakey.fddsize = ppuint64(4)
		aadata.fddptr = cgbp + 4
		aadata.fddsize = ppuint64(4)
		if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 4)) != 0 {
			if Xext2fs_tdb_store(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb, aakey, aadata, ppint32(mvTDB_REPLACE)) != 0 {
				return ppint64(Xext2fs_tdb_error(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb)) + ppint64(2133571424)
			}
		} else {
			if Xext2fs_tdb_delete(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb, aakey) != 0 {
				return ppint64(Xext2fs_tdb_error(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb)) + ppint64(2133571424)
			}
		}
		return 0
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0 {
		if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 4)) > ppuint32(65500) {
			ccv1 = ppuint32(65500)
		} else {
			ccv1 = *(*tn__u32)(iqunsafe.ppPointer(cgbp + 4))
		}
		*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)))*2)) = ppuint16(ccv1)
		return 0
	}

	aael = siget_icount_el(cgtls, aaicount, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), ppint32(1))
	if !(aael != 0) {
		return iqlibc.ppInt64FromInt64(2133571398)
	}

	(*tsext2_icount_el)(iqunsafe.ppPointer(aael)).fdcount = *(*tn__u32)(iqunsafe.ppPointer(cgbp + 4))
	return 0
}

func siget_inode_count(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, cg_ino tnext2_ino_t, aacount ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)) = cg_ino
	...
	var aadata, aakey tnTDB_DATA
	var aael ppuintptr
	pp_, pp_, pp_ = aadata, aael, aakey

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb != 0 {
		aakey.fddptr = cgbp
		aakey.fddsize = ppuint64(4)

		aadata = Xext2fs_tdb_fetch(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb, aakey)
		if aadata.fddptr == iqlibc.ppUintptrFromInt32(0) {
			*(*tn__u32)(iqunsafe.ppPointer(aacount)) = ppuint32(0)
			return ppint64(Xext2fs_tdb_error(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdtdb)) + ppint64(2133571424)
		}

		*(*tn__u32)(iqunsafe.ppPointer(aacount)) = *(*tn__u32)(iqunsafe.ppPointer(aadata.fddptr))
		Xfree(cgtls, aadata.fddptr)
		return 0
	}
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0 {
		*(*tn__u32)(iqunsafe.ppPointer(aacount)) = ppuint32(*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)))*2)))
		return 0
	}

	aael = siget_icount_el(cgtls, aaicount, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)), 0)
	if !(aael != 0) {
		*(*tn__u32)(iqunsafe.ppPointer(aacount)) = ppuint32(0)
		return ppint64(mvENOENT)
	}

	*(*tn__u32)(iqunsafe.ppPointer(aacount)) = (*tsext2_icount_el)(iqunsafe.ppPointer(aael)).fdcount
	return 0
}

func Xext2fs_icount_validate(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaout ppuintptr) (cgr tnerrcode_t) {
	...
	pp_, pp_, pp_ = aabad, aai, aaret
	aaret = 0
	aabad = "bad icount\x00"

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmagic != ppint64(2133571341) {
		return iqlibc.ppInt64FromInt64(2133571341)
	}

	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount > (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize {
		Xfprintf(cgtls, aaout, "%s: count > size\n\x00", iqlibc.ppVaList(cgbp+8, aabad))
		return iqlibc.ppInt64FromInt64(2133571399)
	}
	aai = ppuint32(1)
	for {
		if !(aai < (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdcount) {
			break
		}
		if (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aai-ppuint32(1))*8))).fdino >= (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aai)*8))).fdino {
			Xfprintf(cgtls, aaout, "%s: list[%d].ino=%u, list[%d].ino=%u\n\x00", iqlibc.ppVaList(cgbp+8, aabad, aai-ppuint32(1), (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aai-ppuint32(1))*8))).fdino, aai, (*(*tsext2_icount_el)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdlist + ppuintptr(aai)*8))).fdino))
			aaret = iqlibc.ppInt64FromInt64(2133571399)
		}
...
func Xext2fs_icount_fetch(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	var ccv5 ppbool
	var ccv6 ppuint32
	var pp_ /* val at bp+0 */ tn__u32
	pp_, pp_, pp_, pp_ = ccv1, ccv3, ccv5, ccv6
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmagic != ppint64(2133571341) {
		return iqlibc.ppInt64FromInt64(2133571341)
	}

	if !(aaino != 0) || aaino > (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdnum_inodes {
		return iqlibc.ppInt64FromInt64(2133571399)
	}

	if !((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0) {
		ccv1 = Xext2fs_test_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
		goto cg_2
	cg_2:
		if ccv1 != 0 {
			*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(1)
			return 0
		}

		if ccv5 = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0; ccv5 {
			ccv1 = Xext2fs_test_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple, ppuint64(aaino))
			goto cg_4
		cg_4:
		}
		if ccv5 && !(ccv1 != 0) {
			*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(0)
			return 0
		}
	}
	siget_inode_count(cgtls, aaicount, aaino, cgbp)
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp)) > ppuint32(65500) {
		ccv6 = ppuint32(65500)
	} else {
		ccv6 = *(*tn__u32)(iqunsafe.ppPointer(cgbp))
	}
	*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(ccv6)
	return 0
}

func Xext2fs_icount_increment(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var ccv1, ccv2, ccv5 ppint32
	var ccv9 ppuint32
	var pp_ /* curr_value at bp+0 */ tn__u32
	pp_, pp_, pp_, pp_ = ccv1, ccv2, ccv5, ccv9
	...
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0 {
		if iqlibc.ppInt32FromUint16(*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(aaino)*2)))+ppint32(1) > ppint32(65500) {
			ccv1 = ppint32(65500)
		} else {
			ccv1 = iqlibc.ppInt32FromUint16(*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(aaino)*2))) + ppint32(1)
		}
		*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = iqlibc.ppUint32FromInt32(ccv1)
		*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(aaino)*2)) = ppuint16(*(*tn__u32)(iqunsafe.ppPointer(cgbp)))
	} else {
		ccv1 = Xext2fs_test_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
		goto cg_3
	cg_3:
		if ccv1 != 0 {
			 ...
			 */
			if siset_inode_count(cgtls, aaicount, aaino, ppuint32(2)) != 0 {
				return iqlibc.ppInt64FromInt64(2133571398)
			}
			*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = ppuint32(2)
			pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
			goto cg_4
		cg_4:
			;
		} else {
			if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0 {
				/*
			...
			cg_6:
				if ccv1 != 0 {
					siget_inode_count(cgtls, aaicount, aaino, cgbp)
					*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = *(*tn__u32)(iqunsafe.ppPointer(cgbp)) + 1
					if siset_inode_count(cgtls, aaicount, aaino, *(*tn__u32)(iqunsafe.ppPointer(cgbp))) != 0 {
						return iqlibc.ppInt64FromInt64(2133571398)
					}
				} else {
					/*
					 ...
					 * and return.
					 */
					pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
					goto cg_7
				cg_7:
					;
					if aaret != 0 {
	...
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0 {
		pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple, ppuint64(aaino))
		goto cg_8
	cg_8:
	}
	if aaret != 0 {
		if *(*tn__u32)(iqunsafe.ppPointer(cgbp)) > ppuint32(65500) {
			...
			ccv9 = *(*tn__u32)(iqunsafe.ppPointer(cgbp))
		}
		*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(ccv9)
	}
	return 0
}

func Xext2fs_icount_decrement(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var ccv1 tn__u16
	var ccv10 ppbool
	var ccv13, ccv3 ppuint32
	var ccv2 ppuintptr
	var ccv4, ccv8 ppint32
	var pp_ /* curr_value at bp+0 */ tn__u32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = ccv1, ccv10, ccv13, ccv2, ccv3, ccv4, ccv8
	...
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0 {
		if !(*(*tn__u16)(iqunsafe.ppPointer((*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(aaino)*2)) != 0) {
			return iqlibc.ppInt64FromInt64(2133571399)
		}

		ccv2 = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap + ppuintptr(aaino)*2
		*(*tn__u16)(iqunsafe.ppPointer(ccv2)) = *(*tn__u16)(iqunsafe.ppPointer(ccv2)) - 1
		ccv1 = *(*tn__u16)(iqunsafe.ppPointer(ccv2))
		*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = ppuint32(ccv1)
		if aaret != 0 {
			if *(*tn__u32)(iqunsafe.ppPointer(cgbp)) > ppuint32(65500) {
				ccv3 = ppuint32(65500)
			} else {
				ccv3 = *(*tn__u32)(iqunsafe.ppPointer(cgbp))
			}
			*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(ccv3)
		}
		return 0
	}

	ccv4 = Xext2fs_test_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
	goto cg_5
cg_5:
	if ccv4 != 0 {
		pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
	...
	cg_6:
		;
		if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0 {
			pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple, ppuint64(aaino))
			goto cg_7
		cg_7:
		} else {
			siset_inode_count(cgtls, aaicount, aaino, ppuint32(0))
		}
		if aaret != 0 {
			*(*tn__u16)(iqunsafe.ppPointer(aaret)) = ppuint16(0)
		}
	...
	if ccv10 = (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0; ccv10 {
		ccv4 = Xext2fs_test_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple, ppuint64(aaino))
		goto cg_9
	cg_9:
	}
	if ccv10 && !(ccv4 != 0) {
	...
	siget_inode_count(cgtls, aaicount, aaino, cgbp)
	if !(*(*tn__u32)(iqunsafe.ppPointer(cgbp)) != 0) {
		return iqlibc.ppInt64FromInt64(2133571399)
	}
	*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = *(*tn__u32)(iqunsafe.ppPointer(cgbp)) - 1
	if siset_inode_count(cgtls, aaicount, aaino, *(*tn__u32)(iqunsafe.ppPointer(cgbp))) != 0 {
	...
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp)) == ppuint32(1) {
		pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
		goto cg_11
	cg_11:
	}
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp)) == ppuint32(0) && (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple != 0 {
		pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmultiple, ppuint64(aaino))
		goto cg_12
	cg_12:
	}
...
func Xext2fs_icount_store(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t, aaino tnext2_ino_t, aacount tn__u16) (cgr tnerrcode_t) {
	...
	if (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdfullmap != 0 {
		return siset_inode_count(cgtls, aaicount, aaino, ppuint32(aacount))
	}

	if iqlibc.ppInt32FromUint16(aacount) == ppint32(1) {
		pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
		goto cg_1
	cg_1:
		;
	...
	if iqlibc.ppInt32FromUint16(aacount) == 0 {
		pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
		goto cg_3
	cg_3:
		;
	...
	if siset_inode_count(cgtls, aaicount, aaino, ppuint32(aacount)) != 0 {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsingle, ppuint64(aaino))
	goto cg_5
...
func Xext2fs_get_icount_size(cgtls *iqlibc.ppTLS, aaicount tnext2_icount_t) (cgr tnext2_ino_t) {

	if !(aaicount != 0) || (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdmagic != ppint64(2133571341) {
		return ppuint32(0)
	}

	return (*tsext2_icount)(iqunsafe.ppPointer(aaicount)).fdsize
}
...
func _ext2fs_tdb_close(*iqlibc.ppTLS, ppuintptr) ppint32

func _ext2fs_tdb_delete(*iqlibc.ppTLS, ppuintptr, struct {
	fddptr  ppuintptr
	fddsize tnsize_t
}) ppint32

func _ext2fs_tdb_error(*iqlibc.ppTLS, ppuintptr) ppint32

func _ext2fs_tdb_fetch(*iqlibc.ppTLS, ppuintptr, struct {
	fddptr  ppuintptr
	fddsize tnsize_t
}) struct {
	fddptr  ppuintptr
...
func _ext2fs_tdb_open(*iqlibc.ppTLS, ppuintptr, ppint32, ppint32, ppint32, ppuint16) ppuintptr

func _ext2fs_tdb_store(*iqlibc.ppTLS, ppuintptr, struct {
	fddptr  ppuintptr
	fddsize tnsize_t
}, struct {
	fddptr  ppuintptr
...
func _ext2fs_unmark_generic_bmap(*iqlibc.ppTLS, ppuintptr, ppuint64) ppint32
...
func _mkstemp(*iqlibc.ppTLS, ppuintptr) ppint32
