...
const mvQCOW_COMPRESSED = 1
const mvQCOW_CORRUPTED = 3
const mvQCOW_ENCRYPTED = 2
const mvQCOW_VERSION = 2
...
type tsext2_qcow2_hdr = struct {
	fdmagic                   tn__u32
	fdversion                 tn__u32
	fdbacking_file_offset     tn__u64
	fdbacking_file_size       tn__u32
	fdcluster_bits            tn__u32
	fdsize                    tn__u64
	fdcrypt_method            tn__u32
	fdl1_size                 tn__u32
	fdl1_table_offset         tn__u64
	fdrefcount_table_offset   tn__u64
	fdrefcount_table_clusters tn__u32
	fdnb_snapshots            tn__u32
	fdsnapshots_offset        tn__u64
}

type tnL2_CACHE_HEAD = struct {
	fdl1_index tn__u32
	fdoffset   tn__u64
	fddata     ppuintptr
	fdnext     ppuintptr
...
type tsext2_qcow2_l2_table = tnL2_CACHE_HEAD

type tsext2_qcow2_l2_cache = struct {
	fdused_head   ppuintptr
	fdused_tail   ppuintptr
	fdfree_head   ppuintptr
	fdfree        tn__u32
	fdcount       tn__u32
	fdnext_offset tn__u64
}

type tsext2_qcow2_refcount = struct {
	fdrefcount_table          ppuintptr
	fdrefcount_table_offset   tn__u64
	fdrefcount_block_offset   tn__u64
	fdrefcount_table_clusters tn__u32
	fdrefcount_table_index    tn__u32
	fdrefcount_block_index    tn__u32
	fdrefcount_block          ppuintptr
}

type tsext2_qcow2_image = struct {
	fdfd           ppint32
	fdhdr          ppuintptr
	fdl2_cache     ppuintptr
	fdrefcount     tsext2_qcow2_refcount
	fdcluster_size tn__u32
	fdcluster_bits tn__u32
	fdl1_size      tn__u32
	fdl2_size      tn__u32
	fdl1_table     ppuintptr
	fdl2_offset    tn__u64
	fdl1_offset    tn__u64
	fdimage_size   tn__u64
}

/* Functions for converting qcow2 image into raw image */

func Xqcow2_read_header(cgtls *iqlibc.ppTLS, aafd ppint32) (cgr ppuintptr) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaret, ccv1 tnerrcode_t
	var aasize1 tnsize_t
	var ccv10, ccv11, ccv7, ccv8 tn__u32
	var ccv13 ppbool
	var ccv14, ccv3, ccv5 ppuintptr
	var pp_ /* buffer at bp+16 */ ppuintptr
	var pp_ /* hdr at bp+24 */ ppuintptr
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaret, aasize1, ccv1, ccv10, ccv11, ccv13, ccv14, ccv3, ccv5, ccv7, ccv8
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64(72))
...
cg_2:
	...
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), 0, ppuint64(72))

	if Xext2fs_llseek(cgtls, aafd, 0, iqlibc.ppBoolInt32(mvSEEK_SET < 0)) != 0 {
		ccv3 = cgbp + 16
	...
	aasize1 = iqlibc.ppUint64FromInt64(Xread(cgtls, aafd, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), ppuint64(72)))
	if aasize1 != ppuint64(72) {
		ccv3 = cgbp + 16
		Xmemcpy(cgtls, cgbp+8, ccv3, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)) = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16))

	ccv7 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)))).fdmagic
	ccv8 = ccv7>>iqlibc.ppInt32FromInt32(24) | ccv7>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv7<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv7<<iqlibc.ppInt32FromInt32(24)
	goto cg_9
cg_9:
	;
	if ccv13 = ccv8 != iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromUint8('Q')<<iqlibc.ppInt32FromInt32(24)|iqlibc.ppInt32FromUint8('F')<<iqlibc.ppInt32FromInt32(16)|iqlibc.ppInt32FromUint8('I')<<iqlibc.ppInt32FromInt32(8)|iqlibc.ppInt32FromInt32(0xfb)); !ccv13 {
		ccv10 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)))).fdversion
		ccv11 = ccv10>>iqlibc.ppInt32FromInt32(24) | ccv10>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv10<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv10<<iqlibc.ppInt32FromInt32(24)
		goto cg_12
	cg_12:
	}
	if ccv13 || ccv11 != ppuint32(2) {
		ccv3 = cgbp + 24
		Xmemcpy(cgtls, cgbp+8, ccv3, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
	...
	return *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24))
}

func siqcow2_read_l1_table(cgtls *iqlibc.ppTLS, aaimg ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aafd ppint32
	var aal1_size, aasize1 tnsize_t
	var aaret, ccv2 tnerrcode_t
	var ccv1 ppuint64
	var ccv4, ccv6 ppuintptr
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* table at bp+16 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aafd, aal1_size, aaret, aasize1, ccv1, ccv2, ccv4, ccv6
	aafd = (*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdfd
	aal1_size = ppuint64((*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdl1_size) * ppuint64(8)
...
cg_3:
	aaret = ccv2
	if aaret != 0 {
		return ppint32(aaret)
	}

	if Xext2fs_llseek(cgtls, aafd, iqlibc.ppInt64FromUint64((*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdl1_offset), mvSEEK_SET) < 0 {
		ccv4 = cgbp + 16
	...
	cg_5:
		;
		return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
	}

	aasize1 = iqlibc.ppUint64FromInt64(Xread(cgtls, aafd, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aal1_size))
	if aasize1 != aal1_size {
		ccv4 = cgbp + 16
		Xmemcpy(cgtls, cgbp+8, ccv4, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
	...
	(*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdl1_table = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16))

	return 0
}

func siqcow2_read_l2_table(cgtls *iqlibc.ppTLS, aaimg ppuintptr, aaoffset tn__u64, aal2_table ppuintptr) (cgr ppint32) {

	var aafd ppint32
	var aasize tnsize_t
	pp_, pp_ = aafd, aasize
	var sn__func__ = [20]ppint8{'q', 'c', 'o', 'w', '2', '_', 'r', 'e', 'a', 'd', '_', 'l', '2', '_', 't', 'a', 'b', 'l', 'e'}
	aafd = (*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdfd

	if iqlibc.ppBoolInt64(!(*(*ppuintptr)(iqunsafe.ppPointer(aal2_table)) != 0)) != 0 {
		X__assert_rtn(cgtls, ppuintptr(iqunsafe.ppPointer(&sn__func__)), "third_party/e2fsprogs/lib/ext2fs/qcow2.c\x00", ppint32(122), "*l2_table\x00")
	}

	if Xext2fs_llseek(cgtls, aafd, iqlibc.ppInt64FromUint64(aaoffset), mvSEEK_SET) < 0 {
		return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
	}

	aasize = iqlibc.ppUint64FromInt64(Xread(cgtls, aafd, *(*ppuintptr)(iqunsafe.ppPointer(aal2_table)), ppuint64((*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdcluster_size)))
	if aasize != ppuint64((*tsext2_qcow2_image)(iqunsafe.ppPointer(aaimg)).fdcluster_size) {
		return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
	}
...
func siqcow2_copy_data(cgtls *iqlibc.ppTLS, aafdin ppint32, aafdout ppint32, aaoff_in tn__u64, aaoff_out tn__u64, aabuf ppuintptr, aacount tnsize_t) (cgr ppint32) {

	var aac, aac1, aac2 tnssize_t
	var aaptr ppuintptr
	var aaretries, ccv2 ppint32
	var ccv3 ppbool
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aac, aac1, aac2, aaptr, aaretries, ccv2, ccv3
	var sn__func__ = [16]ppint8{'q', 'c', 'o', 'w', '2', '_', 'c', 'o', 'p', 'y', '_', 'd', 'a', 't', 'a'}
	aaretries = ppint32(10)

	if iqlibc.ppBoolInt64(!(aabuf != 0)) != 0 {
		X__assert_rtn(cgtls, ppuintptr(iqunsafe.ppPointer(&sn__func__)), "third_party/e2fsprogs/lib/ext2fs/qcow2.c\x00", ppint32(141), "buf\x00")
	}

	if Xext2fs_llseek(cgtls, aafdout, iqlibc.ppInt64FromUint64(aaoff_out), mvSEEK_SET) < 0 {
		return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
	}

	if Xext2fs_llseek(cgtls, aafdin, iqlibc.ppInt64FromUint64(aaoff_in), mvSEEK_SET) < 0 {
		return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
	}

	for aacount > ppuint64(0) {
		*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) = 0
		aac1 = Xread(cgtls, aafdin, aabuf, aacount)
		if aac1 < 0 || aac1 == 0 && *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) != 0 {
			return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
		}
		if aac1 == 0 {
			break
		...
		for {
			...
			*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) = 0
			aac2 = Xwrite(cgtls, aafdout, aaptr, iqlibc.ppUint64FromInt64(aac1))
			if aac2 < 0 || aac2 == 0 && *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))) != 0 {
				return *(*ppint32)(iqunsafe.ppPointer(X__error(cgtls)))
			}

			if ccv3 = aac2 == 0; ccv3 {
				aaretries = aaretries - 1
				ccv2 = aaretries
			}
			if ccv3 && ccv2 <= 0 {
				break
		...
		cg_1:
			;
			aaptr = aaptr + ppuintptr(aac2)
			aac = aac - aac2
		}
		aacount = aacount - iqlibc.ppUint64FromInt64(aac1)
	}
	return 0
}

func Xqcow2_write_raw_image(cgtls *iqlibc.ppTLS, aaqcow2_fd ppint32, aaraw_fd ppint32, aahdr ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(160)
	defer cgtls.ppFree(160)

	var aal1_index, aal2_index, aamax_l1_size ppuint32
	var aal1_table, ccv51, ccv53, ccv55 ppuintptr
	var aaoff_out, aaoffset, ccv16, ccv17, ccv32, ccv33, ccv42, ccv43, ccv7, ccv8 tn__u64
	var aaret, ccv26, ccv29 tnerrcode_t
	var aasize1 tnsize_t
	var ccv1, ccv10, ccv11, ccv13, ccv14, ccv19, ccv2, ccv20, ccv22, ccv23, ccv35, ccv36, ccv38, ccv39, ccv4, ccv45, ccv46, ccv48, ccv49, ccv5 tn__u32
	var ccv25, ccv28 ppuint64
	var pp_ /* copy_buf at bp+144 */ ppuintptr
	var pp_ /* img at bp+16 */ tsext2_qcow2_image
	var pp_ /* l2_table at bp+136 */ ppuintptr
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aal1_index, aal1_table, aal2_index, aamax_l1_size, aaoff_out, aaoffset, aaret, aasize1, ccv1, ccv10, ccv11, ccv13, ccv14, ccv16, ccv17, ccv19, ccv2, ccv20, ccv22, ccv23, ccv25, ccv26, ccv28, ccv29, ccv32, ccv33, ccv35, ccv36, ccv38, ccv39, ccv4, ccv42, ccv43, ccv45, ccv46, ccv48, ccv49, ccv5, ccv51, ccv53, ccv55, ccv7, ccv8
	aaret = 0
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 136)) = iqlibc.ppUintptrFromInt32(0)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) = iqlibc.ppUintptrFromInt32(0)

	if (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(aahdr)).fdcrypt_method != 0 {
		return -ppint32(mvQCOW_ENCRYPTED)
	}

	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdfd = aaqcow2_fd
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdhdr = aahdr
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl2_cache = iqlibc.ppUintptrFromInt32(0)
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_table = iqlibc.ppUintptrFromInt32(0)
	ccv1 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(aahdr)).fdcluster_bits
	...
	goto cg_3
cg_3:
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits = ccv2
	if (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits < ppuint32(9) || (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits > ppuint32(31) {
		return -ppint32(mvQCOW_CORRUPTED)
	}
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_size = iqlibc.ppUint32FromInt32(ppint32(1) << (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits)
	ccv1 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(aahdr)).fdl1_size
	ccv2 = ccv1>>iqlibc.ppInt32FromInt32(24) | ccv1>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv1<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv1<<iqlibc.ppInt32FromInt32(24)
	goto cg_6
cg_6:
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_size = ccv2
	ccv7 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(aahdr)).fdl1_table_offset
...
cg_15:
	...
	goto cg_9
cg_9:
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_offset = ccv8
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl2_size = iqlibc.ppUint32FromInt32(ppint32(1) << ((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits - ppuint32(3)))
	ccv7 = (*tsext2_qcow2_hdr)(iqunsafe.ppPointer(aahdr)).fdsize
	ccv1 = ppuint32(ccv7 >> iqlibc.ppInt32FromInt32(32))
	ccv2 = ccv1>>iqlibc.ppInt32FromInt32(24) | ccv1>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv1<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv1<<iqlibc.ppInt32FromInt32(24)
	goto cg_21
cg_21:
...
cg_24:
	...
	goto cg_18
cg_18:
	(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdimage_size = ccv8

	if (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_offset&ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_size-iqlibc.ppUint32FromInt32(1)) != 0 {
		return -ppint32(mvQCOW_CORRUPTED)
	}

	aamax_l1_size = ppuint32((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdimage_size>>(iqlibc.ppUint32FromInt32(2)*(*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits-iqlibc.ppUint32FromInt32(3)) + ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_size))
	if (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_size > aamax_l1_size {
		return -ppint32(mvQCOW_CORRUPTED)
	}

	ccv25 = ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_size)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv25)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv26 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_27
	}
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), 0, ccv25)
	Xmemcpy(cgtls, cgbp+136, cgbp, ppuint64(8))
	ccv26 = 0
	goto cg_27
cg_27:
	aaret = ccv26
	...
	ccv25 = iqlibc.ppUint64FromInt32(ppint32(1) << (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv25)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv26 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_30
	...
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), 0, ccv25)
	Xmemcpy(cgtls, cgbp+144, cgbp, ppuint64(8))
	ccv26 = 0
	goto cg_30
cg_30:
	aaret = ccv26
	...
	if Xext2fs_llseek(cgtls, aaraw_fd, 0, mvSEEK_SET) < 0 {
		aaret = ppint64(*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))))
		goto ppout
	}

	aaret = ppint64(siqcow2_read_l1_table(cgtls, cgbp+16))
	if aaret != 0 {
		goto ppout
	}

	aal1_table = (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_table
	/* Walk through l1 table */
	aal1_index = ppuint32(0)
	for {
		if !(aal1_index < (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_size) {
			break
		}

		ccv7 = *(*tnblk64_t)(iqunsafe.ppPointer(aal1_table + ppuintptr(aal1_index)*8))
		ccv1 = ppuint32(ccv7 >> iqlibc.ppInt32FromInt32(32))
		ccv2 = ccv1>>iqlibc.ppInt32FromInt32(24) | ccv1>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv1<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv1<<iqlibc.ppInt32FromInt32(24)
		goto cg_37
	cg_37:
	...
	cg_40:
		...
		goto cg_34
	cg_34:
		aaoffset = ccv8 & ^(iqlibc.ppUint64FromUint64(1) << iqlibc.ppInt32FromInt32(63))

		if aaoffset > (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdimage_size || aaoffset <= ppuint64(0) {
			goto cg_31
		}

		if aaoffset&(iqlibc.ppUint64FromUint64(1)<<iqlibc.ppInt32FromInt32(62)) != 0 {
			aaret = ppint64(-ppint32(mvQCOW_COMPRESSED))
			goto ppout
		}

		aaret = ppint64(siqcow2_read_l2_table(cgtls, cgbp+16, aaoffset, cgbp+136))
		if aaret != 0 {
			break
		}

		/* Walk through l2 table and copy data blocks into raw image */
		aal2_index = ppuint32(0)
		for {
			if !(aal2_index < (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl2_size) {
				break
			}
			ccv7 = *(*tnblk64_t)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 136)) + ppuintptr(aal2_index)*8))
			ccv1 = ppuint32(ccv7 >> iqlibc.ppInt32FromInt32(32))
			ccv2 = ccv1>>iqlibc.ppInt32FromInt32(24) | ccv1>>iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF00) | ccv1<<iqlibc.ppInt32FromInt32(8)&iqlibc.ppUint32FromInt32(0xFF0000) | ccv1<<iqlibc.ppInt32FromInt32(24)
			goto cg_47
		cg_47:
		...
		cg_44:
			...
			if aaoffset == ppuint64(0) {
				goto cg_41
			}

			aaoff_out = ppuint64(aal1_index)*ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl2_size) + ppuint64(aal2_index)
			aaoff_out = aaoff_out << ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_bits)
			aaret = ppint64(siqcow2_copy_data(cgtls, aaqcow2_fd, aaraw_fd, aaoffset, aaoff_out, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)), ppuint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdcluster_size)))
			if aaret != 0 {
				goto ppout
			}
		...
		cg_41:
			;
			aal2_index = aal2_index + 1
		}

		goto cg_31
	cg_31:
		;
		aal1_index = aal1_index + 1
	}

	/* Resize the output image to the filesystem size */
	if Xext2fs_llseek(cgtls, aaraw_fd, iqlibc.ppInt64FromUint64((*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdimage_size-ppuint64(1)), mvSEEK_SET) < 0 {
		aaret = ppint64(*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))))
		goto ppout
	}

	*(*ppint8)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)))) = 0
	aasize1 = iqlibc.ppUint64FromInt64(Xwrite(cgtls, aaraw_fd, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)), ppuint64(1)))
	if aasize1 != ppuint64(1) {
		aaret = ppint64(*(*ppint32)(iqunsafe.ppPointer(X__error(cgtls))))
		goto ppout
	}
...
ppout:
	;
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 144)) != 0 {
		ccv51 = cgbp + 144
		Xmemcpy(cgtls, cgbp+8, ccv51, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
		Xmemcpy(cgtls, ccv51, cgbp+8, ppuint64(8))
		pp_ = 0
		goto cg_52
	cg_52:
		;
	}
	if (*(*tsext2_qcow2_image)(iqunsafe.ppPointer(cgbp + 16))).fdl1_table != 0 {
		ccv51 = cgbp + 16 + 88
		Xmemcpy(cgtls, cgbp+8, ccv51, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
	...
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 136)) != 0 {
		ccv51 = cgbp + 136
		Xmemcpy(cgtls, cgbp+8, ccv51, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
...
func ___assert_rtn(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppint32, ppuintptr)
