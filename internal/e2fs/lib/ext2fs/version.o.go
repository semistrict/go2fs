...
const mvE2BIG = 7
const mvE2FSPROGS_DATE = "6-Mar-2025"
const mvE2FSPROGS_VERSION = "1.47.4"
const mvEACCES = 13
...
var silib_version = "1.47.4\x00"
var silib_date = "6-Mar-2025\x00"

func Xext2fs_parse_version_string(cgtls *iqlibc.ppTLS, aaver_string ppuintptr) (cgr ppint32) {

	var aacp ppuintptr
	var aadot_count, aaversion, ccv2, ccv3, ccv8 ppint32
	var ccv5, ccv6 tn__darwin_ct_rune_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacp, aadot_count, aaversion, ccv2, ccv3, ccv5, ccv6, ccv8
	aaversion = 0
	aadot_count = 0
	...
	for {
		...
		if ccv5 < 0 || ccv5 >= iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(8) {
			ccv3 = 0
		} else {
			ccv3 = iqlibc.ppBoolInt32(!!(ppuint64(*(*tn__uint32_t)(iqunsafe.ppPointer(ppuintptr(iqunsafe.ppPointer(&X_DefaultRuneLocale)) + 60 + ppuintptr(ccv5)*4)))&ppuint64(0x00000400) != 0))
		}
		ccv6 = ccv3
		goto cg_7
	cg_7:
	...
	cg_4:
		...
		aaversion = aaversion*ppint32(10) + (ppint32(*(*ppint8)(iqunsafe.ppPointer(aacp))) - ppint32('0'))
...
func Xext2fs_get_library_version(cgtls *iqlibc.ppTLS, aaver_string ppuintptr, aadate_string ppuintptr) (cgr ppint32) {

	if aaver_string != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aaver_string)) = silib_version
	}
	if aadate_string != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aadate_string)) = silib_date
	}

	return Xext2fs_parse_version_string(cgtls, silib_version)
}
