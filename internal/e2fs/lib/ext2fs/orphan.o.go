...
const mvEXT4_ORPHAN_BLOCK_MAGIC = 185649668
...
func Xext2fs_truncate_orphan_file(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys) (cgr tnerrcode_t) {
	...
	pp_, pp_ = aaerr, aaino
	aaino = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_orphan_file_inum

	aaerr = Xext2fs_read_inode(cgtls, aafs1, aaino, cgbp)
	if aaerr != 0 {
		return aaerr
	}

	aaerr = Xext2fs_punch(cgtls, aafs1, aaino, cgbp, iqlibc.ppUintptrFromInt32(0), ppuint64(0), ^iqlibc.ppUint64FromUint64(0))
	if aaerr != 0 {
		return aaerr
	}

	*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_SUPER_ONLY)
	Xmemset(cgtls, cgbp, 0, ppuint64(128))
	aaerr = Xext2fs_write_inode(cgtls, aafs1, aaino, cgbp)

	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 92)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_FEATURE_COMPAT_ORPHAN_FILE))

	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper + 100)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_FEATURE_RO_COMPAT_ORPHAN_PRESENT))
...
func Xext2fs_do_orphan_file_block_csum(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, cg_ino tnext2_ino_t, cg_gen tn__u32, cg_blk tnblk64_t, aabuf ppuintptr) (cgr tn__u32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)) = cg_ino
	*(*tn__u32)(iqunsafe.ppPointer(cgbp + 4)) = cg_gen
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = cg_blk

	var aacrc tn__u32
	var aainodes_per_ob, ccv1 ppint32
	pp_, pp_, pp_ = aacrc, aainodes_per_ob, ccv1
	ccv1 = iqlibc.ppInt32FromUint64((ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize) - ppuint64(8)) / ppuint64(4))
	goto cg_2
cg_2:
	aainodes_per_ob = ccv1

	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp)) = *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp))
	*(*tn__u32)(iqunsafe.ppPointer(cgbp + 4)) = *(*tn__u32)(iqunsafe.ppPointer(cgbp + 4))
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 8))
	aacrc = Xext2fs_crc32c_le(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcsum_seed, cgbp, ppuint64(4))
	aacrc = Xext2fs_crc32c_le(cgtls, aacrc, cgbp+4, ppuint64(4))
	aacrc = Xext2fs_crc32c_le(cgtls, aacrc, cgbp+8, ppuint64(8))
	aacrc = Xext2fs_crc32c_le(cgtls, aacrc, aabuf, iqlibc.ppUint64FromInt32(aainodes_per_ob)*ppuint64(4))

	return aacrc
}

type tsmkorphan_info = struct {
	fdbuf          ppuintptr
	fdzerobuf      ppuintptr
	fdnum_blocks   tnblk_t
	fdalloc_blocks tnblk_t
	fdlast_blk     tnblk64_t
	fderr          tnerrcode_t
	fdino          tnext2_ino_t
	fdgeneration   tn__u32
}

func simkorphan_proc(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aablocknr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_block tnblk64_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaerr tnerrcode_t
	var aaoi, aatail, ccv3, ccv6 ppuintptr
	var ccv1 ppint32
	var ccv5 tnblk_t
	var ccv7 ppbool
	var pp_ /* new_blk at bp+0 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaerr, aaoi, aatail, ccv1, ccv3, ccv5, ccv6, ccv7
	aaoi = aapriv_data

	/* Can we just continue in currently allocated cluster? */
	if aablockcnt != 0 && (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdlast_blk>>(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits == ((*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdlast_blk+ppuint64(1))>>(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdlast_blk + ppuint64(1)
	} else {
		aaerr = Xext2fs_new_block2(cgtls, aafs1, (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdlast_blk, ppuintptr(0), cgbp)
		if aaerr != 0 {
			(*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fderr = aaerr
			return ppint32(mvBLOCK_ABORT)
		}
		Xext2fs_block_alloc_stats2(cgtls, aafs1, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), +iqlibc.ppInt32FromInt32(1))
		(*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdalloc_blocks = (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdalloc_blocks + 1
	}
	if aablockcnt >= 0 {
	...
	cg_2:
		if ccv1 != 0 {
			...
			ccv3 = (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdbuf + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize) - iqlibc.ppUintptrFromInt64(8)
			goto cg_4
		cg_4:
			aatail = ccv3
			(*tsext4_orphan_block_tail)(iqunsafe.ppPointer(aatail)).fdob_checksum = Xext2fs_do_orphan_file_block_csum(cgtls, aafs1, (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdino, (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdgeneration, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdbuf)
		}
		aaerr = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), ppint32(1), (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdbuf)
	} else { /* zerobuf is used to initialize new indirect blocks... */
		aaerr = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)), ppint32(1), (*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdzerobuf)
	}
	if aaerr != 0 {
		(*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fderr = aaerr
		return ppint32(mvBLOCK_ABORT)
	}
	(*tsmkorphan_info)(iqunsafe.ppPointer(aaoi)).fdlast_blk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))
	*(*tnblk64_t)(iqunsafe.ppPointer(aablocknr)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp))

	if ccv7 = aablockcnt >= 0; ccv7 {
		ccv3 = aaoi + 16
		*(*tnblk_t)(iqunsafe.ppPointer(ccv3)) = *(*tnblk_t)(iqunsafe.ppPointer(ccv3)) - 1
		ccv5 = *(*tnblk_t)(iqunsafe.ppPointer(ccv3))
	}
	if ccv7 && ccv5 == ppuint32(0) {
		return iqlibc.ppInt32FromInt32(mvBLOCK_CHANGED) | iqlibc.ppInt32FromInt32(mvBLOCK_ABORT)
	}
	return ppint32(mvBLOCK_CHANGED)
}

func Xext2fs_create_orphan_file(cgtls *iqlibc.ppTLS, aafs3 tnext2_filsys, aanum_blocks tnblk_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(224)
	defer cgtls.ppFree(224)

	var aaerr, ccv3, ccv5 tnerrcode_t
	var aaextra, ccv13, ccv18, ccv23 tn__u32
	var aanow, ccv10, ccv12, ccv17, ccv22 tntime_t
	var aaob_tail, ccv27, ccv29, ccv7 ppuintptr
	var ccv1 ppint32
	var ccv15, ccv16, ccv20, ccv21, ccv25, ccv26 ppint64
	var ccv9 tnext2_filsys
	var pp_ /* buf at bp+152 */ ppuintptr
	var pp_ /* ino at bp+144 */ tnext2_ino_t
	var pp_ /* inode at bp+16 */ tsext2_inode
	var pp_ /* oi at bp+168 */ tsmkorphan_info
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* zerobuf at bp+160 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaerr, aaextra, aanow, aaob_tail, ccv1, ccv10, ccv12, ccv13, ccv15, ccv16, ccv17, ccv18, ccv20, ccv21, ccv22, ccv23, ccv25, ccv26, ccv27, ccv29, ccv3, ccv5, ccv7, ccv9
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)) = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdsuper)).fds_orphan_file_inum
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 152)) = iqlibc.ppUintptrFromInt32(0)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)) = iqlibc.ppUintptrFromInt32(0)

	if *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)) != 0 {
		aaerr = Xext2fs_read_inode(cgtls, aafs3, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)), cgbp+16)
		if aaerr != 0 {
			return aaerr
		}
		if ppuint64((*tsext2_inode)(iqunsafe.ppPointer(cgbp+16)).fdi_size)|ppuint64((*tsext2_inode)(iqunsafe.ppPointer(cgbp+16)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) != 0 {
			aaerr = Xext2fs_truncate_orphan_file(cgtls, aafs3)
			if aaerr != 0 {
				return aaerr
			}
		}
	} else {
		aaerr = Xext2fs_new_inode(cgtls, aafs3, ppuint32(mvEXT2_ROOT_INO), iqlibc.ppInt32FromInt32(mvLINUX_S_IFREG)|iqlibc.ppInt32FromInt32(0600), ppuintptr(0), cgbp+144)
		if aaerr != 0 {
			return aaerr
		}
		Xext2fs_inode_alloc_stats2(cgtls, aafs3, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)), +iqlibc.ppInt32FromInt32(1), 0)
	}

	Xmemset(cgtls, cgbp+16, 0, ppuint64(128))
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT3_FEATURE_INCOMPAT_EXTENTS) != ppuint32(0))
	goto cg_2
cg_2:
	if ccv1 != 0 {

		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_flags |= ppuint32(mvEXT4_EXTENTS_FL)
		aaerr = Xext2fs_write_inode(cgtls, aafs3, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)), cgbp+16)
		if aaerr != 0 {
			return aaerr
		}
	}

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize))
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv3 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_4
	}
	Xmemcpy(cgtls, cgbp+152, cgbp, ppuint64(8))
	ccv3 = 0
	goto cg_4
cg_4:
	aaerr = ccv3
...
cg_6:
	...
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 152)), 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize))
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)), 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize))
	ccv7 = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 152)) + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize) - iqlibc.ppUintptrFromInt64(8)
	goto cg_8
cg_8:
	aaob_tail = ccv7
	(*tsext4_orphan_block_tail)(iqunsafe.ppPointer(aaob_tail)).fdob_magic = iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(mvEXT4_ORPHAN_BLOCK_MAGIC))
	if aanum_blocks*(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize > iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(8)<<iqlibc.ppInt32FromInt32(20)) {
		aanum_blocks = iqlibc.ppUint32FromInt32(ppint32(8) << (ppuint32(20) / (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize))
	}
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdnum_blocks = aanum_blocks
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdalloc_blocks = ppuint32(0)
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdlast_blk = ppuint64(0)
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdgeneration = (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_generation
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdino = *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144))
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdbuf = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 152))
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdzerobuf = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160))
	(*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fderr = 0
	aaerr = Xext2fs_block_iterate3(cgtls, aafs3, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)), ppint32(mvBLOCK_FLAG_APPEND), ppuintptr(0), pp__ccgo_fp(simkorphan_proc), cgbp+168)
	if aaerr != 0 {
		goto ppout
	}
	if (*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fderr != 0 {
		aaerr = (*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fderr
		goto ppout
	}
	...
	Xext2fs_iblk_set(cgtls, aafs3, cgbp+16, ppuint64(0))
	ccv9 = aafs3
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv9)).fdnow != 0 || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv9)).fdflags2&ppuint32(mvEXT2_FLAG2_USE_FAKE_TIME) != 0 {
		ccv10 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv9)).fdnow
		goto cg_11
	}
	ccv10 = Xtime(cgtls, iqlibc.ppUintptrFromInt32(0))
	goto cg_11
cg_11:
	aanow = ccv10
	if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+140) {
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_atime = iqlibc.ppUint32FromInt64(aanow & iqlibc.ppInt64FromInt32(0xfffffff))
		ccv10 = aanow
		aaextra = ppuint32(0)
		aaextra = iqlibc.ppUint32FromInt64((ccv10 - ppint64(ppint32(ccv10&iqlibc.ppInt64FromUint32(0xffffffff)))) >> ppint32(32) & ppint64(iqlibc.ppInt32FromInt32(1)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)-iqlibc.ppInt32FromInt32(1)))
		ccv13 = aaextra | ppuint32(0)<<iqlibc.ppInt32FromInt32(mvEXT4_EPOCH_BITS)
		goto cg_14
	cg_14:
		(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 16)).fdi_atime_extra = ccv13
	} else {
		if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
			ccv15 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
		} else {
			if aanow > ppint64(iqlibc.ppInt32FromInt32(2147483647)) {
				ccv16 = ppint64(iqlibc.ppInt32FromInt32(2147483647))
			} else {
				ccv16 = aanow
			}
			ccv15 = ccv16
		}
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_atime = iqlibc.ppUint32FromInt64(ccv15)
	}
	if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+132) {
		...
		goto cg_19
	cg_19:
		(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 16)).fdi_ctime_extra = ccv13
	} else {
		if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
			ccv15 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
		} else {
		...
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_ctime = iqlibc.ppUint32FromInt64(ccv15)
	}
	if iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_GOOD_OLD_INODE_SIZE)+iqlibc.ppInt32FromInt32(0)) >= iqlibc.ppUint64FromInt64(4)+ppuint64(iqlibc.ppUintptrFromInt32(0)+136) {
		...
		goto cg_24
	cg_24:
		(*tsext2_inode_large)(iqunsafe.ppPointer(cgbp + 16)).fdi_mtime_extra = ccv13
	} else {
		if aanow < ppint64(-iqlibc.ppInt32FromInt32(2147483647)-iqlibc.ppInt32FromInt32(1)) {
			ccv15 = ppint64(-iqlibc.ppInt32FromInt32(2147483647) - iqlibc.ppInt32FromInt32(1))
		} else {
		...
		(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16)).fdi_mtime = iqlibc.ppUint32FromInt64(ccv15)
	}
	...
	Xext2fs_iblk_add_blocks(cgtls, aafs3, cgbp+16, ppuint64((*(*tsmkorphan_info)(iqunsafe.ppPointer(cgbp + 168))).fdalloc_blocks))
	aaerr = Xext2fs_inode_size_set(cgtls, aafs3, cgbp+16, iqlibc.ppInt64FromUint64(ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdblocksize)*ppuint64(aanum_blocks)))
	if aaerr != 0 {
		goto ppout
	}
	aaerr = Xext2fs_write_new_inode(cgtls, aafs3, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144)), cgbp+16)
	if aaerr != 0 {
		goto ppout
	}

	(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdsuper)).fds_orphan_file_inum = *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 144))

	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs3)).fdsuper + 92)) |= ppuint32(mvEXT4_FEATURE_COMPAT_ORPHAN_FILE)
	...
	*(*ppint32)(iqunsafe.ppPointer(aafs3 + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_SUPER_ONLY)
	goto ppout
ppout:
	;
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 152)) != 0 {
		ccv7 = cgbp + 152
	...
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)) != 0 {
		ccv7 = cgbp + 160
		Xmemcpy(cgtls, cgbp+8, ccv7, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
...
//	 */
func Xext2fs_default_orphan_file_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tne2_blkcnt_t) {

	var aablks tne2_blkcnt_t
	var aanum_blocks tn__u64
	pp_, pp_ = aablks, aanum_blocks
	aanum_blocks = Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)
	aablks = ppint64(ppint32(2) << (ppuint32(20) / (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))

	if aanum_blocks < iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(128)*iqlibc.ppInt32FromInt32(1024)) {
		aablks = ppint64(32)
	} else {
		if aanum_blocks < iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(2)<<iqlibc.ppInt32FromInt32(20)) {
			aablks = iqlibc.ppInt64FromUint64(aanum_blocks / ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		}
	}
	return (aablks + ppint64(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))) & ppint64(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1)))
}

func siext2fs_orphan_file_block_csum(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aablk tnblk64_t, aabuf ppuintptr, aacrcp ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(128)
	defer cgtls.ppFree(128)
	...
	*(*tn__u32)(iqunsafe.ppPointer(aacrcp)) = Xext2fs_do_orphan_file_block_csum(cgtls, aafs, aaino, (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp))).fdi_generation, aablk, aabuf)
	return 0
}

func Xext2fs_orphan_file_block_csum_set(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aaino tnext2_ino_t, aablk tnblk64_t, aabuf1 ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaret tnerrcode_t
	var aatail, ccv3 ppuintptr
	var ccv1 ppint32
	var pp_ /* crc at bp+0 */ tn__u32
	pp_, pp_, pp_, pp_ = aaret, aatail, ccv1, ccv3
	*(*tn__u32)(iqunsafe.ppPointer(cgbp)) = ppuint32(0)
...
cg_2:
	...
	ccv3 = aabuf1 + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize) - iqlibc.ppUintptrFromInt64(8)
	goto cg_4
cg_4:
	aatail = ccv3
	aaret = siext2fs_orphan_file_block_csum(cgtls, aafs1, aaino, aablk, aabuf1, cgbp)
	if aaret != 0 {
		return 0
	}
	(*tsext4_orphan_block_tail)(iqunsafe.ppPointer(aatail)).fdob_checksum = *(*tn__u32)(iqunsafe.ppPointer(cgbp))
	return aaret
}

func Xext2fs_orphan_file_block_csum_verify(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aaino tnext2_ino_t, aablk tnblk64_t, aabuf1 ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	var ccv1 ppint32
	var pp_ /* crc at bp+0 */ tn__u32
	pp_, pp_, pp_, pp_ = aaretval, aatail, ccv1, ccv3
...
cg_2:
	...
	aaretval = siext2fs_orphan_file_block_csum(cgtls, aafs1, aaino, aablk, aabuf1, cgbp)
	if aaretval != 0 {
		return 0
	}
	ccv3 = aabuf1 + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize) - iqlibc.ppUintptrFromInt64(8)
...
cg_4:
	aatail = ccv3
	return iqlibc.ppBoolInt32((*tsext4_orphan_block_tail)(iqunsafe.ppPointer(aatail)).fdob_checksum == *(*tn__u32)(iqunsafe.ppPointer(cgbp)))
}

func _ext2fs_block_alloc_stats2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppint32)

func _ext2fs_block_iterate3(*iqlibc.ppTLS, ppuintptr, ppuint32, ppint32, ppuintptr, ppuintptr, ppuintptr) ppint64
