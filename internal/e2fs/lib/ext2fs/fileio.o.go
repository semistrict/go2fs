...
const mvEXT2_FILE_BUF_DIRTY = 16384
const mvEXT2_FILE_BUF_VALID = 8192
const mvEXT2_FILE_CREATE = 2
const mvEXT2_FILE_MASK = 255
...
type tsext2_file = struct {
	fdmagic     tnerrcode_t
	fdfs        tnext2_filsys
	fdino       tnext2_ino_t
	fdinode     tsext2_inode
	fdflags     ppint32
	fdpos       tn__u64
	fdblockno   tnblk64_t
	fdphysblock tnblk64_t
	fdbuf       ppuintptr
}
...
type tsblock_entry = struct {
	fdphysblock tnblk64_t
	fdsha       [64]ppuint8
}

type tnblock_entry_t = ppuintptr

func Xext2fs_file_open2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aaflags ppint32, aaret ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaretval, ccv1, ccv5, ccv7 tnerrcode_t
	var ccv11, ccv9 ppuintptr
	var ccv3, ccv4 ppuint64
	var pp_ /* file at bp+16 */ tnext2_file_t
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaretval, ccv1, ccv11, ccv3, ccv4, ccv5, ccv7, ccv9

	/*
	 * Don't let caller create or open a file for writing if the
	 * filesystem is read-only.
	 */
	if aaflags&(iqlibc.ppInt32FromInt32(mvEXT2_FILE_WRITE)|iqlibc.ppInt32FromInt32(mvEXT2_FILE_CREATE)) != 0 && !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_RW) != 0) {
...
cg_2:
	...
	Xmemset(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)), 0, ppuint64(184))
	(*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)))).fdmagic = iqlibc.ppInt64FromInt64(2133571343)
	(*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)))).fdfs = aafs
	(*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)))).fdino = aaino
	(*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)))).fdflags = aaflags & ppint32(mvEXT2_FILE_MASK)

	if aainode != 0 {
		Xmemcpy(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16))+20, aainode, ppuint64(128))
	} else {
		aaretval = Xext2fs_read_inode(cgtls, aafs, aaino, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16))+20)
		if aaretval != 0 {
			goto ppfail
		}
	}
	...
	ccv3 = ppuint64(3)
	ccv4 = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv3*ccv4)
	...
	Xmemcpy(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16))+176, cgbp, ppuint64(8))
	ccv5 = 0
	goto cg_8
cg_8:
	ccv1 = ccv5
...
cg_6:
	...
	*(*tnext2_file_t)(iqunsafe.ppPointer(aaret)) = *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16))
	return 0

	goto ppfail
ppfail:
	;
	if (*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)))).fdbuf != 0 {
		ccv9 = *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 16)) + 176
...
func Xext2fs_file_open(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aaflags ppint32, aaret ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_file_open2(cgtls, aafs, aaino, iqlibc.ppUintptrFromInt32(0), aaflags, aaret)
}
...
//	 */
func Xext2fs_file_get_fs(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr tnext2_filsys) {

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return ppuintptr(0)
	}
	return (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs
}
...
//	 */
func Xext2fs_file_get_inode(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr ppuintptr) {
...
func Xext2fs_file_get_inode_num(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr tnext2_ino_t) {

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return ppuint32(0)
	}
	return (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino
}
...
//	 * necessary.
//	 */
func Xext2fs_file_flush(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr tnerrcode_t) {
	...
	var ccv1 ppint32
	var pp_ /* dontcare at bp+8 */ tnblk64_t
	var pp_ /* ret_flags at bp+0 */ ppint32
	pp_, pp_, pp_ = aafs, aaretval, ccv1

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return iqlibc.ppInt64FromInt64(2133571343)
	}
	aafs = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs

	if !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FILE_BUF_VALID) != 0) || !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FILE_BUF_DIRTY) != 0) {
		return 0
	}

	/* Is this an uninit block? */
	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock != 0 && (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdinode.fdi_flags&ppuint32(mvEXT4_EXTENTS_FL) != 0 {
		aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), 0, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno, cgbp, cgbp+8)
		if aaretval != 0 {
			return aaretval
		}
		if *(*ppint32)(iqunsafe.ppPointer(cgbp))&ppint32(mvBMAP_RET_UNINIT) != 0 {
			aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), ppint32(mvBMAP_SET), (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno, ppuintptr(0), aafile+168)
			if aaretval != 0 {
				return aaretval
			}
		}
	 ...
	 * Allocate it.
	 */
	if !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock != 0) {
		if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino != 0 {
			ccv1 = ppint32(mvBMAP_ALLOC)
		} else {
			ccv1 = 0
		}
		aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), ccv1, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno, ppuintptr(0), aafile+168)
		if aaretval != 0 {
			return aaretval
		}
	}

	aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock, ppint32(1), (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf)
	if aaretval != 0 {
		return aaretval
	}

	*(*ppint32)(iqunsafe.ppPointer(aafile + 148)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FILE_BUF_DIRTY)
...
//	 */
func sisync_buffer_position(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr tnerrcode_t) {

	var aab tnblk64_t
	var aaretval tnerrcode_t
	pp_, pp_ = aab, aaretval

	aab = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos / ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdblocksize)
	if aab != (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno {
		aaretval = Xext2fs_file_flush(cgtls, aafile)
		if aaretval != 0 {
			return aaretval
		}

		*(*ppint32)(iqunsafe.ppPointer(aafile + 148)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FILE_BUF_VALID)
	}
	(*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno = aab
	return 0
}
...
//	 */
func siload_buffer(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aadontfill ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	var aaretval tnerrcode_t
	var pp_ /* ret_flags at bp+0 */ ppint32
	pp_, pp_ = aafs, aaretval
	aafs = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs

	if !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FILE_BUF_VALID) != 0) {
		aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), 0, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno, cgbp, aafile+168)
		if aaretval != 0 {
			return aaretval
		}
		if !(aadontfill != 0) {
			if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock != 0 && !(*(*ppint32)(iqunsafe.ppPointer(cgbp))&iqlibc.ppInt32FromInt32(mvBMAP_RET_UNINIT) != 0) {
				aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock, ppint32(1), (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf)
				if aaretval != 0 {
					return aaretval
				}
			} else {
				Xmemset(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf, 0, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
			}
		}

		*(*ppint32)(iqunsafe.ppPointer(aafile + 148)) |= ppint32(mvEXT2_FILE_BUF_VALID)
	}
	return 0
}

func Xext2fs_file_close(cgtls *iqlibc.ppTLS, cg_file tnext2_file_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 8)) = cg_file

	var aaretval tnerrcode_t
	var ccv1, ccv3 ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_ = aaretval, ccv1, ccv3

	if (*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 8)))).fdmagic != ppint64(2133571343) {
		return iqlibc.ppInt64FromInt64(2133571343)
	}

	aaretval = Xext2fs_file_flush(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 8)))

	if (*tsext2_file)(iqunsafe.ppPointer(*(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 8)))).fdbuf != 0 {
		ccv1 = *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp + 8)) + 176
...
func siext2fs_file_read_inline_data(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aabuf ppuintptr, aawanted ppuint32, aagot ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aacount ppuint32
	var aafs tnext2_filsys
	var aaisize tnuint64_t
	var aaretval tnerrcode_t
	var pp_ /* size at bp+0 */ tnsize_t
	pp_, pp_, pp_, pp_ = aacount, aafs, aaisize, aaretval
	aaretval = 0
	aacount = ppuint32(0)
	aaisize = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32)

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos >= aaisize {
		goto ppout
	}

	aafs = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs
	aaretval = Xext2fs_inline_data_get(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	 ...
	 */
	if ppuint64(*(*tnsize_t)(iqunsafe.ppPointer(cgbp))) > aaisize {
		*(*tnsize_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(aaisize)
	}

	aacount = ppuint32(ppuint64(*(*tnsize_t)(iqunsafe.ppPointer(cgbp))) - (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos)
	if aacount > aawanted {
		aacount = aawanted
	}
	Xmemcpy(cgtls, aabuf, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos), ppuint64(aacount))

	*(*tn__u64)(iqunsafe.ppPointer(aafile + 152)) += ppuint64(aacount)
	aabuf = aabuf + ppuintptr(aacount)

	/* zero-fill the rest of the buffer */
	aawanted = aawanted - aacount
	if aawanted > ppuint32(0) {
		Xmemset(cgtls, aabuf, 0, ppuint64(aawanted))

		*(*tn__u64)(iqunsafe.ppPointer(aafile + 152)) += ppuint64(aawanted)
		aacount = aacount + aawanted
	}
...
ppout:
	;
	if aagot != 0 {
		*(*ppuint32)(iqunsafe.ppPointer(aagot)) = aacount
	}
	return aaretval
}

func Xext2fs_file_read(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aabuf ppuintptr, aawanted ppuint32, aagot ppuintptr) (cgr tnerrcode_t) {

	var aac, aacount, aastart ppuint32
	var aafs tnext2_filsys
	var aaleft tn__u64
	var aaptr ppuintptr
	var aaretval tnerrcode_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aac, aacount, aafs, aaleft, aaptr, aaretval, aastart
	aaretval = 0
	aacount = ppuint32(0)
	aaptr = aabuf
	...
	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdinode.fdi_flags&ppuint32(mvEXT4_INLINE_DATA_FL) != 0 {
		return siext2fs_file_read_inline_data(cgtls, aafile, aabuf, aawanted, aagot)
	}

	for (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos < ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size)|ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) && aawanted > ppuint32(0) {
		aaretval = sisync_buffer_position(cgtls, aafile)
		if aaretval != 0 {
			goto ppfail
		}
		aaretval = siload_buffer(cgtls, aafile, 0)
		if aaretval != 0 {
			goto ppfail
		}

		aastart = ppuint32((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos % ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		aac = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize - aastart
		if aac > aawanted {
			aac = aawanted
		}
		aaleft = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) - (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos
		if ppuint64(aac) > aaleft {
			aac = ppuint32(aaleft)
		}

		Xmemcpy(cgtls, aaptr, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr(aastart), ppuint64(aac))

		*(*tn__u64)(iqunsafe.ppPointer(aafile + 152)) += ppuint64(aac)
		aaptr = aaptr + ppuintptr(aac)
		aacount = aacount + aac
		aawanted = aawanted - aac
	}
...
func siext2fs_file_write_inline_data(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aabuf ppuintptr, aanbytes ppuint32, aawritten ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aafs tnext2_filsys
	var aanew_isize, aaold_isize tnuint64_t
	var aarc, aaretval tnerrcode_t
	var pp_ /* size at bp+0 */ tnsize_t
	pp_, pp_, pp_, pp_, pp_ = aafs, aanew_isize, aaold_isize, aarc, aaretval
	aaold_isize = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32)
	aanew_isize = aaold_isize

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos+ppuint64(aanbytes) > aaold_isize {
		aanew_isize = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos + ppuint64(aanbytes)
	}
	 ...
	 */
	if aanew_isize < ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) {
		if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos > aaold_isize {
			Xmemset(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr(aaold_isize), 0, ppuint64((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos-aaold_isize))
		}

		Xmemcpy(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos), aabuf, ppuint64(aanbytes))

		aaretval = Xext2fs_inline_data_set(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf, ppuint64(aanew_isize))
		if aaretval == ppint64(2133571495) {
			goto ppexpand
		}
		if aaretval != 0 {
			return aaretval
		...
		*(*tn__u64)(iqunsafe.ppPointer(aafile + 152)) += ppuint64(aanbytes)

		/* Update inode size */
		if aaold_isize < aanew_isize {

			aarc = Xext2fs_file_set_size2(cgtls, aafile, iqlibc.ppInt64FromUint64((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos))
			if aaretval == 0 {
				aaretval = aarc
			}
		}
		...
		if aawritten != 0 {
			*(*ppuint32)(iqunsafe.ppPointer(aawritten)) = aanbytes
		}
		return 0
	}
...
ppexpand:
	;
	aaretval = Xext2fs_inline_data_expand(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino)
	if aaretval != 0 {
		return aaretval
	}
	/*
	 ...
	 * the outside inode.
	 */
	aaretval = Xext2fs_read_inode(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20)
	if aaretval != 0 {
		return aaretval
	}
...
func Xext2fs_file_write(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aabuf ppuintptr, aanbytes ppuint32, aawritten ppuintptr) (cgr tnerrcode_t) {

	var aabmap_flags, aaret, ccv1 ppint32
	var aac, aacount, aastart ppuint32
	var aafs tnext2_filsys
	var aanew_block, aaold_block tnblock_entry_t
	var aaptr ppuintptr
	var aarc, aaretval tnerrcode_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aabmap_flags, aac, aacount, aafs, aanew_block, aaold_block, aaptr, aarc, aaret, aaretval, aastart, ccv1
	aaretval = 0
	aacount = ppuint32(0)
	aaptr = aabuf
	aanew_block = iqlibc.ppUintptrFromInt32(0)
	aaold_block = iqlibc.ppUintptrFromInt32(0)
	aabmap_flags = 0
	...
	if !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FILE_WRITE) != 0) {
		return iqlibc.ppInt64FromInt64(2133571405)
	}

	/* If an inode has inline data, things get complicated. */
	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdinode.fdi_flags&ppuint32(mvEXT4_INLINE_DATA_FL) != 0 {
		aaretval = siext2fs_file_write_inline_data(cgtls, aafile, aabuf, aanbytes, aawritten)
		if aaretval != ppint64(2133571495) {
			return aaretval
		}
	...
	for aanbytes > ppuint32(0) {
		 ...
		 */
		aaretval = siload_buffer(cgtls, aafile, iqlibc.ppBoolInt32(aac == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize))
		if aaretval != 0 {
			goto ppfail
		}

		*(*ppint32)(iqunsafe.ppPointer(aafile + 148)) |= ppint32(mvEXT2_FILE_BUF_DIRTY)
		Xmemcpy(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr(aastart), aaptr, ppuint64(aac))
		...
		if !((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock != 0) {
			...
			aabmap_flags = ccv1
			if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_SHARE_DUP) != 0 {
				aanew_block = Xcalloc(cgtls, ppuint64(1), ppuint64(72))
				if !(aanew_block != 0) {
					aaretval = iqlibc.ppInt64FromInt64(2133571398)
					goto ppfail
				}
				Xext2fs_sha512(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), aanew_block+8)
				aaold_block = Xext2fs_hashmap_lookup(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_sha_map, aanew_block+8, ppuint64(64))
			}

			if aaold_block != 0 {
				(*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock = (*tsblock_entry)(iqunsafe.ppPointer(aaold_block)).fdphysblock
				aabmap_flags = aabmap_flags | ppint32(mvBMAP_SET)
				Xfree(cgtls, aanew_block)
				aanew_block = iqlibc.ppUintptrFromInt32(0)
			}

			aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdbuf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), aabmap_flags, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdblockno, ppuintptr(0), aafile+168)
			if aaretval != 0 {
				Xfree(cgtls, aanew_block)
				aanew_block = iqlibc.ppUintptrFromInt32(0)
				goto ppfail
			...
			if aanew_block != 0 {
				(*tsblock_entry)(iqunsafe.ppPointer(aanew_block)).fdphysblock = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdphysblock
				aaret = Xext2fs_hashmap_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_sha_map, aanew_block, aanew_block+8, ppuint64(64))
				if aaret != 0 {
					aaretval = iqlibc.ppInt64FromInt64(2133571398)
					Xfree(cgtls, aanew_block)
					goto ppfail
			...
			if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
				Xext2fs_iblk_add_blocks(cgtls, aafs, aafile+20, ppuint64(1))
				Xext2fs_write_inode(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20)
			}
		}
...
ppfail:
	;
	/* Update inode size */
	if aacount != ppuint32(0) && ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size)|ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) < (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos {
	...
	if aawritten != 0 {
		*(*ppuint32)(iqunsafe.ppPointer(aawritten)) = aacount
	}
	return aaretval
}

func Xext2fs_file_llseek(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aaoffset tn__u64, aawhence ppint32, aaret_pos ppuintptr) (cgr tnerrcode_t) {

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return iqlibc.ppInt64FromInt64(2133571343)
	}

	if aawhence == mvEXT2_SEEK_SET {
		(*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos = aaoffset
	} else {
		if aawhence == ppint32(mvEXT2_SEEK_CUR) {

			*(*tn__u64)(iqunsafe.ppPointer(aafile + 152)) += aaoffset
		} else {
			if aawhence == ppint32(mvEXT2_SEEK_END) {
				(*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) + aaoffset
			} else {
	...
	if aaret_pos != 0 {
		*(*tn__u64)(iqunsafe.ppPointer(aaret_pos)) = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdpos
	}

	return 0
}

func Xext2fs_file_lseek(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aaoffset tnext2_off_t, aawhence ppint32, aaret_pos ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaloffset tn__u64
	var aaretval tnerrcode_t
	var pp_ /* ret_loffset at bp+0 */ tn__u64
	pp_, pp_ = aaloffset, aaretval
	*(*tn__u64)(iqunsafe.ppPointer(cgbp)) = ppuint64(0)

	aaloffset = iqlibc.ppUint64FromInt32(aaoffset)
	aaretval = Xext2fs_file_llseek(cgtls, aafile, aaloffset, aawhence, cgbp)
	if aaret_pos != 0 {
		*(*tnext2_off_t)(iqunsafe.ppPointer(aaret_pos)) = iqlibc.ppInt32FromUint64(*(*tn__u64)(iqunsafe.ppPointer(cgbp)))
	}
	return aaretval
}
...
//	 */
func Xext2fs_file_get_lsize(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aaret_size ppuintptr) (cgr tnerrcode_t) {

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return iqlibc.ppInt64FromInt64(2133571343)
	}
	*(*tn__u64)(iqunsafe.ppPointer(aaret_size)) = ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32)
	return 0
}
...
//	 * This function returns the size of the file, according to the inode
//	 */
func Xext2fs_file_get_size(cgtls *iqlibc.ppTLS, aafile tnext2_file_t) (cgr tnext2_off_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var pp_ /* size at bp+0 */ tn__u64

	if Xext2fs_file_get_lsize(cgtls, aafile, cgbp) != 0 {
		return 0
	}
	if *(*tn__u64)(iqunsafe.ppPointer(cgbp))>>iqlibc.ppInt32FromInt32(32) != ppuint64(0) {
		return 0
	}
	return iqlibc.ppInt32FromUint64(*(*tn__u64)(iqunsafe.ppPointer(cgbp)))
}

// C documentation
//
//	/* Zero the parts of the last block that are past EOF. */
func siext2fs_file_zero_past_offset(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aaoffset tnext2_off64_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(48)
	defer cgtls.ppFree(48)

	var aafs tnext2_filsys
	var aaoff tnext2_off64_t
	var aaretval, ccv1 tnerrcode_t
	var ccv3 ppuintptr
	var pp_ /* b at bp+16 */ ppuintptr
	var pp_ /* blk at bp+24 */ tnblk64_t
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* ret_flags at bp+32 */ ppint32
	pp_, pp_, pp_, pp_, pp_ = aafs, aaoff, aaretval, ccv1, ccv3
	aafs = (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) = iqlibc.ppUintptrFromInt32(0)
	aaoff = aaoffset % iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)
	...
	aaretval = Xext2fs_bmap2(cgtls, aafs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0), 0, iqlibc.ppUint64FromInt64(aaoffset/iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)), cgbp+32, cgbp+24)
	if aaretval != 0 {
		return aaretval
	}
	if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 24)) == ppuint64(0) || *(*ppint32)(iqunsafe.ppPointer(cgbp + 32))&ppint32(mvBMAP_RET_UNINIT) != 0 {
		return 0
	}
...
cg_2:
	...
	aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 24)), ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
	if aaretval != 0 {
		goto ppout
	}

	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16))+ppuintptr(aaoff), 0, iqlibc.ppUint64FromInt64(iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)-aaoff))

	aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 24)), ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
	if aaretval != 0 {
		goto ppout
	}
...
//	 *
//	 */
func Xext2fs_file_set_size2(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aasize tnext2_off64_t) (cgr tnerrcode_t) {

	var aaold_size tnext2_off64_t
	var aaold_truncate, aatruncate_block tnblk64_t
	var aaretval tnerrcode_t
	pp_, pp_, pp_, pp_ = aaold_size, aaold_truncate, aaretval, aatruncate_block

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdmagic != ppint64(2133571343) {
		return iqlibc.ppInt64FromInt64(2133571343)
	}

	if aasize != 0 && Xext2fs_file_block_offset_too_big(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs, aafile+20, iqlibc.ppUint64FromInt64((aasize-ppint64(1))/iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdblocksize))) != 0 {
		return iqlibc.ppInt64FromInt64(2133571410)
	}
	aatruncate_block = iqlibc.ppUint64FromInt64((aasize + iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdblocksize) - iqlibc.ppInt64FromInt32(1)) >> ((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdsuper)).fds_log_block_size + iqlibc.ppUint32FromInt32(10)))
	aaold_size = iqlibc.ppInt64FromUint64(ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size) | ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aafile+20)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32))
	aaold_truncate = iqlibc.ppUint64FromInt64((aaold_size + iqlibc.ppInt64FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdblocksize) - iqlibc.ppInt64FromInt32(1)) >> ((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs)).fdsuper)).fds_log_block_size + iqlibc.ppUint32FromInt32(10)))

	aaretval = Xext2fs_inode_size_set(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs, aafile+20, aasize)
	if aaretval != 0 {
		return aaretval
	}

	if (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino != 0 {
		aaretval = Xext2fs_write_inode(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20)
		if aaretval != 0 {
			return aaretval
		}
	}

	aaretval = siext2fs_file_zero_past_offset(cgtls, aafile, aasize)
	if aaretval != 0 {
		return aaretval
	}

	if aatruncate_block >= aaold_truncate {
		return 0
	}

	return Xext2fs_punch(cgtls, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdfs, (*tsext2_file)(iqunsafe.ppPointer(aafile)).fdino, aafile+20, ppuintptr(0), aatruncate_block, ^iqlibc.ppUint64FromUint64(0))
}

func Xext2fs_file_set_size(cgtls *iqlibc.ppTLS, aafile tnext2_file_t, aasize tnext2_off_t) (cgr tnerrcode_t) {

	return Xext2fs_file_set_size2(cgtls, aafile, ppint64(aasize))
}
...
func _ext2fs_file_block_offset_too_big(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuint64) ppint32

func _ext2fs_hashmap_add(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr, ppuint64) ppint32

func _ext2fs_hashmap_lookup(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuint64) ppuintptr

func _ext2fs_iblk_add_blocks(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuint64) ppint64

func _ext2fs_inline_data_expand(*iqlibc.ppTLS, ppuintptr, ppuint32) ppint64

func _ext2fs_inline_data_get(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuintptr, ppuintptr) ppint64

func _ext2fs_inline_data_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuintptr, ppuint64) ppint64
...
func _ext2fs_sha512(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuintptr)
