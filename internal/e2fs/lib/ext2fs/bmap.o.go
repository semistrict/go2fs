...
const mv_BMAP_INLINE_ = "__inline__"
...
func siblock_ind_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aaind tnblk_t, aablock_buf ppuintptr, aablocks_alloc ppuintptr, aanr tnblk_t, aaret_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var ccv1 ppuint32
	var pp_ /* b at bp+0 */ tnblk_t
	pp_, pp_ = aaretval, ccv1

	if !(aaind != 0) {
		if aaflags&ppint32(mvBMAP_SET) != 0 {
			return iqlibc.ppInt64FromInt64(2133571423)
		}
		*(*tnblk_t)(iqunsafe.ppPointer(aaret_blk)) = ppuint32(0)
		return 0
	}
	aaretval = (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdread_blk})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(aaind), ppint32(1), aablock_buf)
	if aaretval != 0 {
		return aaretval
	}

	if aaflags&ppint32(mvBMAP_SET) != 0 {
		*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = *(*tnblk_t)(iqunsafe.ppPointer(aaret_blk))
		*(*tnblk_t)(iqunsafe.ppPointer(aablock_buf + ppuintptr(aanr)*4)) = *(*tnblk_t)(iqunsafe.ppPointer(cgbp))
		return (*(*func(*iqlibc.ppTLS, tnio_channel, ppuint64, ppint32, ppuintptr) tnerrcode_t)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_io_manager)(iqunsafe.ppPointer((*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdmanager)).fdwrite_blk})))(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, ppuint64(aaind), ppint32(1), aablock_buf)
	}

	*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = *(*tnblk_t)(iqunsafe.ppPointer(aablock_buf + ppuintptr(aanr)*4))

	if !(*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) != 0) && aaflags&ppint32(mvBMAP_ALLOC) != 0 {
		if aanr != 0 {
			ccv1 = *(*tnblk_t)(iqunsafe.ppPointer(aablock_buf + ppuintptr(aanr-ppuint32(1))*4))
		} else {
			ccv1 = aaind
		}
		*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = ccv1
		aaretval = Xext2fs_alloc_block(cgtls, aafs, *(*tnblk_t)(iqunsafe.ppPointer(cgbp)), aablock_buf+ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize), cgbp)
		if aaretval != 0 {
			return aaretval
		}
		...
		*(*ppint32)(iqunsafe.ppPointer(aablocks_alloc)) = *(*ppint32)(iqunsafe.ppPointer(aablocks_alloc)) + 1
	}

	*(*tnblk_t)(iqunsafe.ppPointer(aaret_blk)) = *(*tnblk_t)(iqunsafe.ppPointer(cgbp))
	return 0
}

func siblock_dind_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aadind tnblk_t, aablock_buf ppuintptr, aablocks_alloc ppuintptr, aanr tnblk_t, aaret_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaaddr_per_block tnblk_t
	var aaretval tnerrcode_t
	var pp_ /* b at bp+0 */ tnblk_t
	pp_, pp_ = aaaddr_per_block, aaretval
	*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = ppuint32(0)

	aaaddr_per_block = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize >> ppint32(2)

	aaretval = siblock_ind_bmap(cgtls, aafs, aaflags & ^iqlibc.ppInt32FromInt32(mvBMAP_SET), aadind, aablock_buf, aablocks_alloc, aanr/aaaddr_per_block, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	aaretval = siblock_ind_bmap(cgtls, aafs, aaflags, *(*tnblk_t)(iqunsafe.ppPointer(cgbp)), aablock_buf, aablocks_alloc, aanr%aaaddr_per_block, aaret_blk)
	return aaretval
}

func siblock_tind_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aatind tnblk_t, aablock_buf ppuintptr, aablocks_alloc ppuintptr, aanr tnblk_t, aaret_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = ppuint32(0)
	...
	aaretval = siblock_dind_bmap(cgtls, aafs, aaflags & ^iqlibc.ppInt32FromInt32(mvBMAP_SET), aatind, aablock_buf, aablocks_alloc, aanr/aaaddr_per_block, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	aaretval = siblock_ind_bmap(cgtls, aafs, aaflags, *(*tnblk_t)(iqunsafe.ppPointer(cgbp)), aablock_buf, aablocks_alloc, aanr%aaaddr_per_block, aaret_blk)
...
func siimplied_cluster_alloc(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aahandle tnext2_extent_handle_t, aalblk tnblk64_t, aaphys_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aabase_block tnblk64_t
	var aai, ccv1 ppint32
	var pp_ /* pblock at bp+0 */ tnblk64_t
	pp_, pp_, pp_ = aabase_block, aai, ccv1
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(0)

	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_BIGALLOC) != ppuint32(0))
	goto cg_2
cg_2:
	if !(ccv1 != 0) {
		return 0
	...
	aabase_block = aalblk & iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1)))
	/*
	...
	aai = 0
	for {
		if !(aai < ppint32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits) {
			break
		}
		if aabase_block+iqlibc.ppUint64FromInt32(aai) == aalblk {
			goto cg_3
		}
		siextent_bmap(cgtls, aafs, aaino, aainode, aahandle, ppuintptr(0), 0, aabase_block+iqlibc.ppUint64FromInt32(aai), ppuintptr(0), ppuintptr(0), cgbp)
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) != 0 {
			break
		}
	...
	if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) == ppuint64(0) {
		return 0
	}
	*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) - iqlibc.ppUint64FromInt32(aai) + (aalblk - aabase_block)
	return 0
}
...
func Xext2fs_map_cluster_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aalblk tnblk64_t, aapblk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	*(*tnblk64_t)(iqunsafe.ppPointer(aapblk)) = ppuint64(0)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_BIGALLOC) != ppuint32(0))
	goto cg_2
cg_2:
	;
	if !(ccv1 != 0) || !((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_EXTENTS_FL) != 0) {
		return 0
	}

	aaretval = Xext2fs_extent_open2(cgtls, aafs, aaino, aainode, cgbp)
	if aaretval != 0 {
		goto ppout
	}

	aaretval = siimplied_cluster_alloc(cgtls, aafs, aaino, aainode, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp)), aalblk, aapblk)
	if aaretval != 0 {
		goto ppout2
	}
...
func siextent_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aahandle tnext2_extent_handle_t, aablock_buf ppuintptr, aabmap_flags ppint32, aablock tnblk64_t, aaret_flags ppuintptr, aablocks_alloc ppuintptr, aaphys_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(64)
	defer cgtls.ppFree(64)

	var aaalloc, aaset_flags, ccv1 ppint32
	var aaoffset ppuint32
	var aaretval tnerrcode_t
	var pp_ /* alloc_ctx at bp+0 */ tsblk_alloc_ctx
	var pp_ /* blk64 at bp+56 */ tnblk64_t
	var pp_ /* extent at bp+32 */ tsext2fs_extent
	pp_, pp_, pp_, pp_, pp_ = aaalloc, aaoffset, aaretval, aaset_flags, ccv1
	aaretval = 0
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) = ppuint64(0)
	aaalloc = 0

	if aabmap_flags&ppint32(mvBMAP_UNINIT) != 0 {
		ccv1 = ppint32(mvEXT2_EXTENT_SET_BMAP_UNINIT)
	} else {
		ccv1 = 0
	}
	aaset_flags = ccv1
	...
	if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
		aaretval = Xext2fs_extent_set_bmap(cgtls, aahandle, aablock, *(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)), aaset_flags)
		return aaretval
	}
	aaretval = Xext2fs_extent_goto(cgtls, aahandle, aablock)
	if aaretval != 0 {
		/* If the extent is not found, return phys_blk = 0 */
		if aaretval == ppint64(2133571460) {
			(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_lblk = aablock
			goto ppgot_block
		}
		return aaretval
	}
	aaretval = Xext2fs_extent_get(cgtls, aahandle, mvEXT2_EXTENT_CURRENT, cgbp+32)
	if aaretval != 0 {
		return aaretval
	}
	aaoffset = ppuint32(aablock - (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_lblk)
	if aablock >= (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_lblk && aaoffset <= (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_len {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_pblk + ppuint64(aaoffset)
		if aaret_flags != 0 && (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {

			*(*ppint32)(iqunsafe.ppPointer(aaret_flags)) |= ppint32(mvBMAP_RET_UNINIT)
		}
	}
	goto ppgot_block
ppgot_block:
	;
	if *(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) == ppuint64(0) && aabmap_flags&ppint32(mvBMAP_ALLOC) != 0 {
		siimplied_cluster_alloc(cgtls, aafs, aaino, aainode, aahandle, aablock, cgbp+56)
		if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) != 0 {
			goto ppset_extent
		}
		aaretval = siextent_bmap(cgtls, aafs, aaino, aainode, aahandle, aablock_buf, 0, aablock-ppuint64(1), ppuintptr(0), aablocks_alloc, cgbp+56)
		if aaretval != 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) = Xext2fs_find_inode_goal(cgtls, aafs, aaino, aainode, aablock)
		}
		(*(*tsblk_alloc_ctx)(iqunsafe.ppPointer(cgbp))).fdino = aaino
		(*(*tsblk_alloc_ctx)(iqunsafe.ppPointer(cgbp))).fdinode = aainode
		(*(*tsblk_alloc_ctx)(iqunsafe.ppPointer(cgbp))).fdlblk = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 32))).fde_lblk
		(*(*tsblk_alloc_ctx)(iqunsafe.ppPointer(cgbp))).fdflags = ppint32(mvBLOCK_ALLOC_DATA)
		aaretval = Xext2fs_alloc_block3(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)), aablock_buf, cgbp+56, cgbp)
		if aaretval != 0 {
			return aaretval
		}
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) & iqlibc.ppUint64FromInt32(^(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits - iqlibc.ppInt32FromInt32(1)))
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)) + iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))&aablock
		aaalloc = aaalloc + 1
		goto ppset_extent
	ppset_extent:
		;
		aaretval = Xext2fs_extent_set_bmap(cgtls, aahandle, aablock, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)), aaset_flags)
		if aaretval != 0 {
			Xext2fs_block_alloc_stats2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56)), -ppint32(1))
			return aaretval
		}
		/* Update inode after setting extent */
		aaretval = Xext2fs_read_inode(cgtls, aafs, aaino, aainode)
		if aaretval != 0 {
			return aaretval
		}

		*(*ppint32)(iqunsafe.ppPointer(aablocks_alloc)) += aaalloc
		*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 56))
	}
	return 0
}

func Xext2fs_file_block_offset_too_big(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr, aaoffset tnblk64_t) (cgr ppint32) {

	var aaaddr_per_block, aamax_map_block tnblk64_t
	pp_, pp_ = aaaddr_per_block, aamax_map_block

	/* Kernel seems to cut us off at 4294967294 blocks */
	if aaoffset >= iqlibc.ppUint64FromUint64(1)<<iqlibc.ppInt32FromInt32(32)-iqlibc.ppUint64FromInt32(1) {
		return ppint32(1)
	}
	...
	aaaddr_per_block = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize >> ppint32(2))
	aamax_map_block = aaaddr_per_block
	aamax_map_block = aamax_map_block + aaaddr_per_block*aaaddr_per_block
	aamax_map_block = aamax_map_block + aaaddr_per_block*aaaddr_per_block*aaaddr_per_block
	aamax_map_block = aamax_map_block + ppuint64(12)

	return iqlibc.ppBoolInt32(aaoffset >= aamax_map_block)
}

func Xext2fs_bmap2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aablock_buf ppuintptr, aabmap_flags ppint32, aablock tnblk64_t, aaret_flags ppuintptr, aaphys_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(224)
	defer cgtls.ppFree(224)

	var aaaddr_per_block, aab tnblk_t
	var aainode_dirty ppint32
	var aaretval, ccv3, ccv5 tnerrcode_t
	var ccv1, ccv2, ccv7 ppuint64
	var ccv8 ppuintptr
	var pp_ /* alloc_ctx at bp+184 */ tsblk_alloc_ctx
	var pp_ /* b64 at bp+160 */ tnblk64_t
	var pp_ /* blk32 at bp+152 */ tnblk_t
	var pp_ /* blocks_alloc at bp+176 */ ppint32
	var pp_ /* buf at bp+168 */ ppuintptr
	var pp_ /* handle at bp+144 */ tnext2_extent_handle_t
	var pp_ /* inode_buf at bp+16 */ tsext2_inode
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaaddr_per_block, aab, aainode_dirty, aaretval, ccv1, ccv2, ccv3, ccv5, ccv7, ccv8
	*(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 144)) = ppuintptr(0)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 168)) = ppuintptr(0)
	aaretval = 0
	*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) = 0
	aainode_dirty = 0
	*(*tsblk_alloc_ctx)(iqunsafe.ppPointer(cgbp + 184)) = tsblk_alloc_ctx{
		fdino:   aaino,
		fdinode: aainode,
		fdflags: ppint32(mvBLOCK_ALLOC_DATA),
	}

	if !(aabmap_flags&iqlibc.ppInt32FromInt32(mvBMAP_SET) != 0) {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(0)
	}

	if aaret_flags != 0 {
		*(*ppint32)(iqunsafe.ppPointer(aaret_flags)) = 0
	}
	...
	if Xext2fs_file_block_offset_too_big(cgtls, aafs, aainode, aablock) != 0 {
	 ...
	 */
	if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&ppuint32(mvEXT4_INLINE_DATA_FL) != 0 {
		return iqlibc.ppInt64FromInt64(2133571494)
	}
	...
	if !(aablock_buf != 0) {
		...
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv1*ccv2)
		...
		Xmemcpy(cgtls, cgbp+168, cgbp, ppuint64(8))
		ccv5 = 0
		goto cg_6
	cg_6:
		ccv3 = ccv5
	...
	cg_4:
		...
		aablock_buf = *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 168))
	}

	if (*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_flags&ppuint32(mvEXT4_EXTENTS_FL) != 0 {
		aaretval = Xext2fs_extent_open2(cgtls, aafs, aaino, aainode, cgbp+144)
		if aaretval != 0 {
			goto ppdone
		}
		aaretval = siextent_bmap(cgtls, aafs, aaino, aainode, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 144)), aablock_buf, aabmap_flags, aablock, aaret_flags, cgbp+176, aaphys_blk)
		goto ppdone
	}

	if aablock < ppuint64(mvEXT2_NDIR_BLOCKS) {
		if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
			aab = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)))
			*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(aablock)*4)) = aab
			aainode_dirty = aainode_dirty + 1
			goto ppdone
		}

		*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(aablock)*4)))
		if aablock != 0 {
			ccv1 = ppuint64(*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(aablock-iqlibc.ppUint64FromInt32(1))*4)))
		} else {
			ccv1 = Xext2fs_find_inode_goal(cgtls, aafs, aaino, aainode, aablock)
		}
		aab = ppuint32(ccv1)

		if *(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) == ppuint64(0) && aabmap_flags&ppint32(mvBMAP_ALLOC) != 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)) = ppuint64(aab)
			aaretval = Xext2fs_alloc_block3(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)), aablock_buf, cgbp+160, cgbp+184)
			aab = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)))
			if aaretval != 0 {
				goto ppdone
			}
			*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(aablock)*4)) = aab
			*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) = *(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) + 1
			*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(aab)
		}
		goto ppdone
	}

	/* Indirect block */
	aablock = aablock - ppuint64(mvEXT2_NDIR_BLOCKS)
	*(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)))
	if aablock < ppuint64(aaaddr_per_block) {
		aab = *(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + 12*4))
		if !(aab != 0) {
			if !(aabmap_flags&iqlibc.ppInt32FromInt32(mvBMAP_ALLOC) != 0) {
				if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
					aaretval = iqlibc.ppInt64FromInt64(2133571423)
				}
				goto ppdone
			}

			aab = *(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)-iqlibc.ppInt32FromInt32(1))*4))
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)) = ppuint64(aab)
			aaretval = Xext2fs_alloc_block3(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)), aablock_buf, cgbp+160, cgbp+184)
			aab = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 160)))
			if aaretval != 0 {
			...
			*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + 12*4)) = aab
			*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) = *(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) + 1
		}
		aaretval = siblock_ind_bmap(cgtls, aafs, aabmap_flags, aab, aablock_buf, cgbp+176, ppuint32(aablock), cgbp+152)
		if aaretval == 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)))
		}
		goto ppdone
	}

	/* Doubly indirect block  */
	aablock = aablock - ppuint64(aaaddr_per_block)
	if aablock < ppuint64(aaaddr_per_block*aaaddr_per_block) {
		aab = *(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4))
		if !(aab != 0) {
			if !(aabmap_flags&iqlibc.ppInt32FromInt32(mvBMAP_ALLOC) != 0) {
				if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
			...
			*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4)) = aab
			*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) = *(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) + 1
		}
		aaretval = siblock_dind_bmap(cgtls, aafs, aabmap_flags, aab, aablock_buf, cgbp+176, ppuint32(aablock), cgbp+152)
		if aaretval == 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)))
		}
		goto ppdone
	...
	aablock = aablock - ppuint64(aaaddr_per_block*aaaddr_per_block)
	aab = *(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))*4))
	if !(aab != 0) {
		if !(aabmap_flags&iqlibc.ppInt32FromInt32(mvBMAP_ALLOC) != 0) {
			if aabmap_flags&ppint32(mvBMAP_SET) != 0 {
				aaretval = iqlibc.ppInt64FromInt64(2133571423)
		...
		*(*tn__u32)(iqunsafe.ppPointer(aainode + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))*4)) = aab
		*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) = *(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) + 1
	}
	aaretval = siblock_tind_bmap(cgtls, aafs, aabmap_flags, aab, aablock_buf, cgbp+176, ppuint32(aablock), cgbp+152)
	if aaretval == 0 {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp + 152)))
	}
	goto ppdone
ppdone:
	;
	if *(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)) != 0 && aaretval == 0 && aabmap_flags&ppint32(mvBMAP_ZERO) != 0 {
		aaretval = Xext2fs_zero_blocks2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(aaphys_blk)), ppint32(1), iqlibc.ppUintptrFromInt32(0), iqlibc.ppUintptrFromInt32(0))
	}
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 168)) != 0 {
		ccv8 = cgbp + 168
	...
	if *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 144)) != 0 {
		Xext2fs_extent_free(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 144)))
	}
	if aaretval == 0 && (*(*ppint32)(iqunsafe.ppPointer(cgbp + 176)) != 0 || aainode_dirty != 0) {
		Xext2fs_iblk_add_blocks(cgtls, aafs, aainode, iqlibc.ppUint64FromInt32(*(*ppint32)(iqunsafe.ppPointer(cgbp + 176))))
		aaretval = Xext2fs_write_inode(cgtls, aafs, aaino, aainode)
	}
	return aaretval
}

func Xext2fs_bmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aablock_buf ppuintptr, aabmap_flags ppint32, aablock tnblk_t, aaphys_blk ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaret tnerrcode_t
	var pp_ /* ret_blk at bp+0 */ tnblk64_t
	pp_ = aaret
	*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaphys_blk)))

	aaret = Xext2fs_bmap2(cgtls, aafs, aaino, aainode, aablock_buf, aabmap_flags, ppuint64(aablock), ppuintptr(0), cgbp)
	if aaret != 0 {
		return aaret
	}
	if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) >= iqlibc.ppUint64FromInt64(iqlibc.ppInt64FromInt32(1)<<iqlibc.ppInt32FromInt32(32)) {
		return ppint64(mvEOVERFLOW)
	}
	*(*tnblk_t)(iqunsafe.ppPointer(aaphys_blk)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	return 0
}

func _ext2fs_alloc_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppuintptr) ppint64

func _ext2fs_alloc_block3(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuintptr, ppuintptr, ppuintptr) ppint64
