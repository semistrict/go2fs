...
const mvBLOCK_FLAG_NO_LARGE = 4096
...
type tsblock_context = struct {
	fdfs        tnext2_filsys
	fdfunc1     ppuintptr
	fdbcount    tne2_blkcnt_t
	fdbsize     ppint32
	fdflags     ppint32
	fderrcode   tnerrcode_t
	fdind_buf   ppuintptr
	fddind_buf  ppuintptr
	fdtind_buf  ppuintptr
	fdpriv_data ppuintptr
}

func siblock_iterate_ind(cgtls *iqlibc.ppTLS, aaind_block ppuintptr, aaref_block tnblk_t, aaref_offset ppint32, aactx ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aablock_nr ppuintptr
	var aachanged, aaflags, aai, aalimit, aaoffset, aaret ppint32
	var pp_ /* blk64 at bp+0 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablock_nr, aachanged, aaflags, aai, aalimit, aaoffset, aaret
	aaret = 0
	aachanged = 0

	aalimit = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdblocksize >> ppint32(2))
	if !((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DEPTH_TRAVERSE) != 0) && !((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DATA_ONLY) != 0) {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block)))
		aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, ppint64(-iqlibc.ppInt32FromInt32(1)), ppuint64(aaref_block), aaref_offset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
		*(*tnblk_t)(iqunsafe.ppPointer(aaind_block)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	}
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
		aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
		return aaret
	}
	if !(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block)) != 0) || aaret&ppint32(mvBLOCK_ABORT) != 0 {

		*(*tne2_blkcnt_t)(iqunsafe.ppPointer(aactx + 16)) += ppint64(aalimit)
		return aaret
	}
	if ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block))) >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper) || *(*tnblk_t)(iqunsafe.ppPointer(aaind_block)) < (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper)).fds_first_data_block {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571381)
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}
	(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_read_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aaind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdind_buf)
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}

	aablock_nr = (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdind_buf
	aaoffset = 0
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aai = 0
		for {
			if !(aai < aalimit) {
				break
			}
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)))
			aaflags = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdbcount, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block))), aaoffset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
			*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
			aachanged = aachanged | aaflags
			if aaflags&ppint32(mvBLOCK_ABORT) != 0 {
				aaret = aaret | ppint32(mvBLOCK_ABORT)
				break
			}

			aaoffset = iqlibc.ppInt32FromUint64(ppuint64(aaoffset) + iqlibc.ppUint64FromInt64(4))

			goto cg_1
		cg_1:
			;
			aai = aai + 1
			(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdbcount = (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdbcount + 1
			aablock_nr += 4
		}
	} else {
		aai = 0
		for {
			...
			if *(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)) == ppuint32(0) {
				goto ppskip_sparse
			}
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aablock_nr)))
			aaflags = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdbcount, ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block))), aaoffset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
	...
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aachanged&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
		aachanged = aachanged | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
		return aachanged
	}
	if aachanged&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_write_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aaind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdind_buf)
		if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
			aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ERROR) | iqlibc.ppInt32FromInt32(mvBLOCK_ABORT))
		}
	}
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_DEPTH_TRAVERSE) != 0 && !((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DATA_ONLY) != 0) && !(aaret&iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) != 0) {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aaind_block)))
		aaret = aaret | (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, ppint64(-iqlibc.ppInt32FromInt32(1)), ppuint64(aaref_block), aaref_offset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
		*(*tnblk_t)(iqunsafe.ppPointer(aaind_block)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	}
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
...
func siblock_iterate_dind(cgtls *iqlibc.ppTLS, aadind_block ppuintptr, aaref_block tnblk_t, aaref_offset ppint32, aactx ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	aalimit = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdblocksize >> ppint32(2))
	if !((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&(iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DEPTH_TRAVERSE)|iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DATA_ONLY)) != 0) {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aadind_block)))
		aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, ppint64(-iqlibc.ppInt32FromInt32(2)), ppuint64(aaref_block), aaref_offset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
		*(*tnblk_t)(iqunsafe.ppPointer(aadind_block)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	}
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
		aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
	...
	if !(*(*tnblk_t)(iqunsafe.ppPointer(aadind_block)) != 0) || aaret&ppint32(mvBLOCK_ABORT) != 0 {

		*(*tne2_blkcnt_t)(iqunsafe.ppPointer(aactx + 16)) += ppint64(aalimit * aalimit)
		return aaret
	}
	if ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aadind_block))) >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper) || *(*tnblk_t)(iqunsafe.ppPointer(aadind_block)) < (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper)).fds_first_data_block {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571382)
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}
	(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_read_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aadind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fddind_buf)
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}

	aablock_nr = (*tsblock_context)(iqunsafe.ppPointer(aactx)).fddind_buf
	aaoffset = 0
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aai = 0
		for {
			...
			aaflags = siblock_iterate_ind(cgtls, aablock_nr, *(*tnblk_t)(iqunsafe.ppPointer(aadind_block)), aaoffset, aactx)
			aachanged = aachanged | aaflags
			if aaflags&(iqlibc.ppInt32FromInt32(mvBLOCK_ABORT)|iqlibc.ppInt32FromInt32(mvBLOCK_ERROR)) != 0 {
				aaret = aaret | aaflags&(iqlibc.ppInt32FromInt32(mvBLOCK_ABORT)|iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
				break
			}
	...
	if aachanged&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_write_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aadind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fddind_buf)
		if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
			aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ERROR) | iqlibc.ppInt32FromInt32(mvBLOCK_ABORT))
		}
	}
...
func siblock_iterate_tind(cgtls *iqlibc.ppTLS, aatind_block ppuintptr, aaref_block tnblk_t, aaref_offset ppint32, aactx ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aablock_nr, ccv1 ppuintptr
	var aachanged, aaflags, aai, aalimit, aaoffset, aaret ppint32
	var pp_ /* blk64 at bp+0 */ tnblk64_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablock_nr, aachanged, aaflags, aai, aalimit, aaoffset, aaret, ccv1
	aaret = 0
	aachanged = 0

	aalimit = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdblocksize >> ppint32(2))
	if !((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&(iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DEPTH_TRAVERSE)|iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DATA_ONLY)) != 0) {
		*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aatind_block)))
		aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfunc1})))(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, cgbp, ppint64(-iqlibc.ppInt32FromInt32(3)), ppuint64(aaref_block), aaref_offset, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdpriv_data)
		*(*tnblk_t)(iqunsafe.ppPointer(aatind_block)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	}
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
		aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
	...
	if !(*(*tnblk_t)(iqunsafe.ppPointer(aatind_block)) != 0) || aaret&ppint32(mvBLOCK_ABORT) != 0 {

		ccv1 = aactx + 16
		*(*tne2_blkcnt_t)(iqunsafe.ppPointer(ccv1)) = tne2_blkcnt_t(ppuint64(*(*tne2_blkcnt_t)(iqunsafe.ppPointer(ccv1))) + iqlibc.ppUint64FromInt32(aalimit)*iqlibc.ppUint64FromInt32(aalimit)*iqlibc.ppUint64FromInt32(aalimit))
		return aaret
	}
	if ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(aatind_block))) >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper) || *(*tnblk_t)(iqunsafe.ppPointer(aatind_block)) < (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer((*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs)).fdsuper)).fds_first_data_block {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571383)
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}
	(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_read_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aatind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdtind_buf)
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
		aaret = aaret | ppint32(mvBLOCK_ERROR)
		return aaret
	}

	aablock_nr = (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdtind_buf
	aaoffset = 0
	if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aai = 0
		for {
			...
			aaflags = siblock_iterate_dind(cgtls, aablock_nr, *(*tnblk_t)(iqunsafe.ppPointer(aatind_block)), aaoffset, aactx)
			aachanged = aachanged | aaflags
			if aaflags&(iqlibc.ppInt32FromInt32(mvBLOCK_ABORT)|iqlibc.ppInt32FromInt32(mvBLOCK_ERROR)) != 0 {
				aaret = aaret | aaflags&(iqlibc.ppInt32FromInt32(mvBLOCK_ABORT)|iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
				break
	...
	if aachanged&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_write_ind_block(cgtls, (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdfs, *(*tnblk_t)(iqunsafe.ppPointer(aatind_block)), (*tsblock_context)(iqunsafe.ppPointer(aactx)).fdtind_buf)
		if (*tsblock_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
			aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ERROR) | iqlibc.ppInt32FromInt32(mvBLOCK_ABORT))
		}
	}
...
type tn__ccgo_fp__Xext2fs_block_iterate3_4 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppint64, ppuint64, ppint32, ppuintptr) ppint32

func Xext2fs_block_iterate3(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aaflags ppint32, aablock_buf ppuintptr, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(304)
	defer cgtls.ppFree(304)

	var aablockcnt, ccv7 tne2_blkcnt_t
	var aai, aalimit, aaop, aar, aaret, aauninit ppint32
	var aaj ppuint32
	var aaretval, ccv3, ccv5 tnerrcode_t
	var ccv1, ccv2 ppuint64
	var ccv10 ppuintptr
	var ccv12 ppint64
	var pp_ /* blk at bp+280 */ tnblk64_t
	var pp_ /* blk64 at bp+216 */ tnblk64_t
	var pp_ /* ctx at bp+144 */ tsblock_context
	var pp_ /* extent at bp+232 */ tsext2fs_extent
	var pp_ /* handle at bp+224 */ tnext2_extent_handle_t
	var pp_ /* inode at bp+16 */ tsext2_inode
	var pp_ /* new_blk at bp+288 */ tnblk64_t
	var pp_ /* next at bp+256 */ tsext2fs_extent
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablockcnt, aai, aaj, aalimit, aaop, aar, aaret, aaretval, aauninit, ccv1, ccv10, ccv12, ccv2, ccv3, ccv5, ccv7
	aaret = 0
	...
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp+16)
	if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 {
		return (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode
	}
	 ...
	 */
	if (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_flags&ppuint32(mvEXT4_INLINE_DATA_FL) != 0 {
		return iqlibc.ppInt64FromInt64(2133571485)
	}

	/*
	 * Check to see if we need to limit large files
	 */
	if aaflags&ppint32(mvBLOCK_FLAG_NO_LARGE) != 0 {
		if !(iqlibc.ppInt32FromUint16((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_mode)&iqlibc.ppInt32FromInt32(mvLINUX_S_IFMT) == iqlibc.ppInt32FromInt32(mvLINUX_S_IFDIR)) && (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_size_high != ppuint32(0) {
			return iqlibc.ppInt64FromInt64(2133571410)
		}
	}

	aalimit = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize >> ppint32(2))

	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfs = aafs
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1 = aa__ccgo_fp_func
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdpriv_data = aapriv_data
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdflags = aaflags
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount = 0
	if aablock_buf != 0 {
		(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdind_buf = aablock_buf
	} else {
		ccv1 = ppuint64(3)
		...
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv1*ccv2)
		...
		Xmemcpy(cgtls, cgbp+144+40, cgbp, ppuint64(8))
		ccv5 = 0
		goto cg_6
	cg_6:
		ccv3 = ccv5
	...
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fddind_buf = (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdind_buf + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)
	(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdtind_buf = (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fddind_buf + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)

	/*
	 * Iterate over the HURD translator block (if present)
	 */
	if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_creator_os == ppuint32(mvEXT2_OS_HURD) && !(aaflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DATA_ONLY) != 0) {
		if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 36)) != 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 216)) = ppuint64(*(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 36)))
			aaret = aaret | (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1})))(cgtls, aafs, cgbp+216, ppint64(-iqlibc.ppInt32FromInt32(4)), ppuint64(0), 0, aapriv_data)
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 36)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 216)))
			if aaret&ppint32(mvBLOCK_ABORT) != 0 {
				goto ppabort_exit
			}
			if (*tsblock_context)(iqunsafe.ppPointer(cgbp+144)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
				(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
				aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
				goto ppabort_exit
			}
		}
	...
	if (*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_flags&ppuint32(mvEXT4_EXTENTS_FL) != 0 {
		aablockcnt = 0
		aaop = ppint32(mvEXT2_EXTENT_ROOT)

		(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_extent_open2(cgtls, aafs, aaino, cgbp+16, cgbp+224)
		if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 {
			goto ppabort_exit
		}

		for ppint32(1) != 0 {
			if aaop == mvEXT2_EXTENT_CURRENT {
				(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = 0
			} else {
				(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_extent_get(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)), aaop, cgbp+232)
			}
			if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 {
				if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != ppint64(2133571452) {
					break
				}
				(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = 0
				if !(aaflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_APPEND) != 0) {
					break
				}
				goto ppnext_block_set
			ppnext_block_set:
				;
				*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) = ppuint64(0)
				aar = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1})))(cgtls, aafs, cgbp+280, aablockcnt, ppuint64(0), 0, aapriv_data)
				aaret = aaret | aar
				if (*tsblock_context)(iqunsafe.ppPointer(cgbp+144)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
					(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
					aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
				...
				if aar&ppint32(mvBLOCK_CHANGED) != 0 {
					ccv7 = aablockcnt
					aablockcnt = aablockcnt + 1
					(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_extent_set_bmap(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)), iqlibc.ppUint64FromInt64(ccv7), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)), 0)
					if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 || aaret&ppint32(mvBLOCK_ABORT) != 0 {
						break
					}
					if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) != 0 {
						goto ppnext_block_set
					}
				}
				break
			...
			aaop = ppint32(mvEXT2_EXTENT_NEXT)
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) = (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_pblk
			if !((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_LEAF) != 0) {
				if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdflags&ppint32(mvBLOCK_FLAG_DATA_ONLY) != 0 {
					continue
				}
				if !((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_flags&iqlibc.ppUint32FromInt32(mvEXT2_EXTENT_FLAGS_SECOND_VISIT) != 0) && !((*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdflags&iqlibc.ppInt32FromInt32(mvBLOCK_FLAG_DEPTH_TRAVERSE) != 0) || (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_SECOND_VISIT) != 0 && (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdflags&ppint32(mvBLOCK_FLAG_DEPTH_TRAVERSE) != 0 {
					aaret = aaret | (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1})))(cgtls, aafs, cgbp+280, ppint64(-ppint32(1)), ppuint64(0), 0, aapriv_data)
					if aaret&ppint32(mvBLOCK_CHANGED) != 0 {
						(*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_pblk = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280))
						(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_extent_replace(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)), 0, cgbp+232)
						if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 {
							break
						}
					}
			...
			aauninit = 0
			if (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_flags&ppuint32(mvEXT2_EXTENT_FLAGS_UNINIT) != 0 {
				aauninit = ppint32(mvEXT2_EXTENT_SET_BMAP_UNINIT)
			}
			 ...
			 */
			aaretval = Xext2fs_extent_get(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)), aaop, cgbp+256)

			if (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_lblk+ppuint64((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_len) <= iqlibc.ppUint64FromInt64(aablockcnt) {
				continue
			}
			if (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_lblk > iqlibc.ppUint64FromInt64(aablockcnt) {
				aablockcnt = iqlibc.ppInt64FromUint64((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_lblk)
			}
			aaj = ppuint32(iqlibc.ppUint64FromInt64(aablockcnt) - (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_lblk)
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) + ppuint64(aaj)
			aablockcnt = iqlibc.ppInt64FromUint64((*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_lblk)
			aaj = iqlibc.ppUint32FromInt32(0)
			for {
				if !(aaj < (*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232))).fde_len) {
					break
				}
				*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280))
				aar = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1})))(cgtls, aafs, cgbp+288, aablockcnt, ppuint64(0), 0, aapriv_data)
				aaret = aaret | aar
				if (*tsblock_context)(iqunsafe.ppPointer(cgbp+144)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
					(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
					aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
				...
				if aar&ppint32(mvBLOCK_CHANGED) != 0 {
					(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = Xext2fs_extent_set_bmap(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)), iqlibc.ppUint64FromInt64(aablockcnt), *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 288)), aauninit)
					if (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode != 0 {
						goto ppextent_done
					}
				}
			...
			cg_8:
				;
				*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) = *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 280)) + 1
				aablockcnt = aablockcnt + 1
				aaj = aaj + 1
			}
			if aaretval == 0 {
				*(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 232)) = *(*tsext2fs_extent)(iqunsafe.ppPointer(cgbp + 256))
				aaop = mvEXT2_EXTENT_CURRENT
			}
		}
	...
	ppextent_done:
		;
		Xext2fs_extent_free(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 224)))
		aaret = aaret | ppint32(mvBLOCK_ERROR) /* ctx.errcode is always valid here */
		goto pperrout
	}
	...
	aai = 0
	for {
		if !(aai < ppint32(mvEXT2_NDIR_BLOCKS)) {
			break
		}
		if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(aai)*4)) != 0 || aaflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
			*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 216)) = ppuint64(*(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(aai)*4)))
			aaret = aaret | (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk64_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdfunc1})))(cgtls, aafs, cgbp+216, (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount, ppuint64(0), aai, aapriv_data)
			*(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(aai)*4)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 216)))
			if aaret&ppint32(mvBLOCK_ABORT) != 0 {
				goto ppabort_exit
			}
		}
	...
	cg_9:
		;
		aai = aai + 1
		(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount = (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount + 1
	}
	if (*tsblock_context)(iqunsafe.ppPointer(cgbp+144)).fdflags&ppint32(mvBLOCK_FLAG_READ_ONLY) != 0 && aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144)).fderrcode = iqlibc.ppInt64FromInt64(2133571435)
		aaret = aaret | (iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_ERROR))
	...
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + 12*4)) != 0 || aaflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aaret = aaret | siblock_iterate_ind(cgtls, cgbp+16+40+12*4, ppuint32(0), ppint32(mvEXT2_NDIR_BLOCKS), cgbp+144)
		if aaret&ppint32(mvBLOCK_ABORT) != 0 {
			goto ppabort_exit
		}
	} else {

		(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount += ppint64(aalimit)
	}
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4)) != 0 || aaflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aaret = aaret | siblock_iterate_dind(cgtls, cgbp+16+40+ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1))*4, ppuint32(0), iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1), cgbp+144)
		if aaret&ppint32(mvBLOCK_ABORT) != 0 {
			goto ppabort_exit
		}
	} else {

		(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fdbcount += ppint64(aalimit * aalimit)
	}
	if *(*tn__u32)(iqunsafe.ppPointer(cgbp + 16 + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))*4)) != 0 || aaflags&ppint32(mvBLOCK_FLAG_APPEND) != 0 {
		aaret = aaret | siblock_iterate_tind(cgtls, cgbp+16+40+ppuintptr(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))*4, ppuint32(0), iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1), cgbp+144)
		if aaret&ppint32(mvBLOCK_ABORT) != 0 {
			goto ppabort_exit
		}
	}
...
ppabort_exit:
	;
	if aaret&ppint32(mvBLOCK_CHANGED) != 0 {
		aaretval = Xext2fs_write_inode(cgtls, aafs, aaino, cgbp+16)
		if aaretval != 0 {
			aaret = aaret | ppint32(mvBLOCK_ERROR)
			(*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode = aaretval
		}
	}
	goto pperrout
pperrout:
	...
	if aaret&ppint32(mvBLOCK_ERROR) != 0 {
		ccv12 = (*(*tsblock_context)(iqunsafe.ppPointer(cgbp + 144))).fderrcode
	} else {
		ccv12 = 0
	}
	return ccv12
...
type tsxlate64 = struct {
	fdfunc1        ppuintptr
	fdreal_private ppuintptr
}

func sixlate64_func(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablocknr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_blk tnblk64_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaret ppint32
	var aaxl ppuintptr
	var pp_ /* block32 at bp+0 */ tnblk_t
	pp_, pp_ = aaret, aaxl
	aaxl = aapriv_data
	*(*tnblk_t)(iqunsafe.ppPointer(cgbp)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(aablocknr)))

	aaret = (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, tne2_blkcnt_t, tnblk_t, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsxlate64)(iqunsafe.ppPointer(aaxl)).fdfunc1})))(cgtls, aafs, cgbp, aablockcnt, ppuint32(aaref_blk), aaref_offset, (*tsxlate64)(iqunsafe.ppPointer(aaxl)).fdreal_private)
	*(*tnblk64_t)(iqunsafe.ppPointer(aablocknr)) = ppuint64(*(*tnblk_t)(iqunsafe.ppPointer(cgbp)))
	return aaret
}

type tn__ccgo_fp__Xext2fs_block_iterate2_4 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppint64, ppuint32, ppint32, ppuintptr) ppint32

func Xext2fs_block_iterate2(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aaflags ppint32, aablock_buf ppuintptr, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var pp_ /* xl at bp+0 */ tsxlate64

	(*(*tsxlate64)(iqunsafe.ppPointer(cgbp))).fdreal_private = aapriv_data
	(*(*tsxlate64)(iqunsafe.ppPointer(cgbp))).fdfunc1 = aa__ccgo_fp_func

	return Xext2fs_block_iterate3(cgtls, aafs, aaino, aaflags, aablock_buf, pp__ccgo_fp(sixlate64_func), cgbp)
}
...
func sixlate_func(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablocknr ppuintptr, aablockcnt tne2_blkcnt_t, aaref_block tnblk_t, aaref_offset ppint32, aapriv_data ppuintptr) (cgr ppint32) {

	var aaxl ppuintptr
	pp_ = aaxl
	aaxl = aapriv_data

	return (*(*func(*iqlibc.ppTLS, tnext2_filsys, ppuintptr, ppint32, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsxlate)(iqunsafe.ppPointer(aaxl)).fdfunc1})))(cgtls, aafs, aablocknr, ppint32(aablockcnt), (*tsxlate)(iqunsafe.ppPointer(aaxl)).fdreal_private)
}

type tn__ccgo_fp__Xext2fs_block_iterate_4 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppint32, ppuintptr) ppint32

func Xext2fs_block_iterate(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aaflags ppint32, aablock_buf ppuintptr, aa__ccgo_fp_func ppuintptr, aapriv_data ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var pp_ /* xl at bp+0 */ tsxlate

	(*(*tsxlate)(iqunsafe.ppPointer(cgbp))).fdreal_private = aapriv_data
	(*(*tsxlate)(iqunsafe.ppPointer(cgbp))).fdfunc1 = aa__ccgo_fp_func

	return Xext2fs_block_iterate2(cgtls, aafs, aaino, ppint32(mvBLOCK_FLAG_NO_LARGE)|aaflags, aablock_buf, pp__ccgo_fp(sixlate_func), cgbp)
}
...
func _ext2fs_extent_set_bmap(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppint32) ppint64

func _ext2fs_read_ind_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64

func _ext2fs_read_inode(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64

func _ext2fs_write_ind_block(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64
