...
func Xext2fs_symlink(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaparent tnext2_ino_t, cg_ino tnext2_ino_t, aaname ppuintptr, aatarget ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)
	*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)) = cg_ino

	var aadrop_refcount, aafastlink, aainlinelink, ccv4, ccv9 ppint32
	...
	var pp_ /* inode at bp+20 */ tsext2_inode
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	var pp_ /* scratch_ino at bp+148 */ tnext2_ino_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aadrop_refcount, aafastlink, aainlinelink, aaretval, aatarget_len, ccv1, ccv11, ccv3, ccv4, ccv6, ccv9
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)) = ppuintptr(0)
	aadrop_refcount = 0
	 ...
	 */
	aatarget_len = ppuint32(Xstrnlen(cgtls, aatarget, ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize+ppuint32(1))))
	if aatarget_len >= (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize {
...
cg_2:
	...
	Xmemset(cgtls, cgbp+20, 0, ppuint64(128))
	aafastlink = iqlibc.ppBoolInt32(ppuint64(aatarget_len) < ppuint64(60))
	if !(aafastlink != 0) {
		aaretval = Xext2fs_new_block2(cgtls, aafs, Xext2fs_find_inode_goal(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20, ppuint64(0)), iqlibc.ppUintptrFromInt32(0), cgbp+152)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	...
	if !(*(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)) != 0) {
		aaretval = Xext2fs_new_inode(cgtls, aafs, aaparent, iqlibc.ppInt32FromInt32(mvLINUX_S_IFLNK)|iqlibc.ppInt32FromInt32(0755), ppuintptr(0), cgbp+16)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	 ...
	 */
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_mode = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromInt32(mvLINUX_S_IFLNK) | iqlibc.ppInt32FromInt32(0777))
	ccv3 = iqlibc.ppUint16FromInt32(0)
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_gid = ccv3
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_uid = ccv3
	(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_links_count = ppuint16(1)
	Xext2fs_inode_size_set(cgtls, aafs, cgbp+20, iqlibc.ppInt64FromUint32(aatarget_len))
	/* The time fields are set by ext2fs_write_new_inode() */

	if ccv6 = !(aafastlink != 0); ccv6 {
		ccv4 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_INLINE_DATA) != ppuint32(0))
		goto cg_5
	cg_5:
	}
	aainlinelink = iqlibc.ppBoolInt32(ccv6 && ccv4 != 0)
	if aafastlink != 0 {
		/* Fast symlinks, target stored in inode */
		Xstrcpy(cgtls, cgbp+20+40, aatarget)
	} else {
		if !(aainlinelink != 0) {
			goto cg_7
		}
		...
		(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_flags |= ppuint32(mvEXT4_INLINE_DATA_FL)
		aaretval = Xext2fs_write_new_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20)
		if aaretval != 0 {
			goto ppcleanup
		}
		aaretval = Xext2fs_inline_data_set(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)), ppuint64(aatarget_len))
		if aaretval != 0 {

			(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_flags &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_FL))
			aainlinelink = 0
			goto ppneed_block
		}
		aaretval = Xext2fs_read_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20)
		if aaretval != 0 {
			goto ppcleanup
		}
		goto cg_8
	...
	ppneed_block:
		...
		Xext2fs_iblk_set(cgtls, aafs, cgbp+20, ppuint64(1))
	...
	cg_10:
		if ccv4 != 0 {
			...
			(*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 20))).fdi_flags |= ppuint32(mvEXT4_EXTENTS_FL)
		}
	cg_8:
		;
	}
	 ...
	 */
	if aainlinelink != 0 {
		aaretval = Xext2fs_write_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20)
	} else {
		aaretval = Xext2fs_write_new_inode(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20)
	}
	if aaretval != 0 {
	...
	if !(aafastlink != 0) && !(aainlinelink != 0) {
		aaretval = Xext2fs_bmap2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), cgbp+20, iqlibc.ppUintptrFromInt32(0), ppint32(mvBMAP_SET), ppuint64(0), iqlibc.ppUintptrFromInt32(0), cgbp+152)
		if aaretval != 0 {
			goto ppcleanup
		}

		aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 152)), ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 160)))
		if aaretval != 0 {
			goto ppcleanup
		}
	}
	...
	Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), +iqlibc.ppInt32FromInt32(1), 0)
	 ...
	 */
	if aaname != 0 {
		aaretval = Xext2fs_lookup(cgtls, aafs, aaparent, aaname, iqlibc.ppInt32FromUint64(Xstrlen(cgtls, aaname)), ppuintptr(0), cgbp+148)
		if !(aaretval != 0) {
			aaretval = iqlibc.ppInt64FromInt64(2133571483)
			goto ppcleanup
		}
		if aaretval != ppint64(2133571404) {
			goto ppcleanup
		}
		aaretval = Xext2fs_link(cgtls, aafs, aaparent, aaname, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), ppint32(mvEXT2_FT_SYMLINK))
		if aaretval != 0 {
			goto ppcleanup
		}
	}
...
ppcleanup:
	...
	if aadrop_refcount != 0 {
		if !(aafastlink != 0) && !(aainlinelink != 0) {
			Xext2fs_block_alloc_stats2(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 152)), -ppint32(1))
		}
		Xext2fs_inode_alloc_stats2(cgtls, aafs, *(*tnext2_ino_t)(iqunsafe.ppPointer(cgbp + 16)), -ppint32(1), 0)
	}
	return aaretval
}
...
//	 */
func Xext2fs_is_fast_symlink(cgtls *iqlibc.ppTLS, aainode ppuintptr) (cgr ppint32) {

	return iqlibc.ppBoolInt32(iqlibc.ppInt32FromUint16((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_mode)&ppint32(mvLINUX_S_IFMT) == ppint32(mvLINUX_S_IFLNK) && ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size)|ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) != 0 && ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size)|ppuint64((*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size_high)<<iqlibc.ppInt32FromInt32(32) < ppuint64(60))
}
...
func _strnlen(*iqlibc.ppTLS, ppuintptr, ppuint64) ppuint64
