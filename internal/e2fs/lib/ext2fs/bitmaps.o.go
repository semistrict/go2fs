...
func Xext2fs_free_inode_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_inode_bitmap) {

	Xext2fs_free_generic_bmap(cgtls, aabitmap)
}

func Xext2fs_free_block_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_block_bitmap) {

	Xext2fs_free_generic_bmap(cgtls, aabitmap)
}

func Xext2fs_copy_bitmap(cgtls *iqlibc.ppTLS, aasrc tnext2fs_generic_bitmap, aadest ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_copy_generic_bmap(cgtls, aasrc, aadest)
}

func Xext2fs_set_bitmap_padding(cgtls *iqlibc.ppTLS, aamap tnext2fs_generic_bitmap) {

	Xext2fs_set_generic_bmap_padding(cgtls, aamap)
}

func Xext2fs_allocate_inode_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadescr ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {

	var aaend, aareal_end, aastart tn__u64
	var ccv1 ppint32
	pp_, pp_, pp_, pp_ = aaend, aareal_end, aastart, ccv1
...
cg_2:
	...
	aastart = ppuint64(1)
	aaend = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_count)
	aareal_end = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_per_group) * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count)

	/* Are we permitted to use new-style bitmaps? */
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_64BITS) != 0 {
		return Xext2fs_alloc_generic_bmap(cgtls, aafs, iqlibc.ppInt64FromInt64(2133571439), iqlibc.ppInt32FromUint16((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddefault_bitmap_type), aastart, aaend, aareal_end, aadescr, aaret)
	}

	/* Otherwise, check to see if the file system is small enough
	 * to use old-style 32-bit bitmaps */
	if aaend > ppuint64(^iqlibc.ppUint32FromUint32(0)) || aareal_end > ppuint64(^iqlibc.ppUint32FromUint32(0)) {
		return iqlibc.ppInt64FromInt64(2133571465)
	}

	return Xext2fs_make_generic_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571337), aafs, ppuint32(aastart), ppuint32(aaend), ppuint32(aareal_end), aadescr, ppuintptr(0), aaret)
}

func Xext2fs_allocate_block_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadescr ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {
...
cg_2:
	...
	aastart = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block >> (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits)
	aaend = (Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) - iqlibc.ppUint64FromInt32(1)) >> (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits
	aareal_end = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_clusters_per_group)*ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count) - ppuint64(1) + aastart

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_64BITS) != 0 {
		return Xext2fs_alloc_generic_bmap(cgtls, aafs, iqlibc.ppInt64FromInt64(2133571438), iqlibc.ppInt32FromUint16((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddefault_bitmap_type), aastart, aaend, aareal_end, aadescr, aaret)
	}
	...
	return Xext2fs_make_generic_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571336), aafs, ppuint32(aastart), ppuint32(aaend), ppuint32(aareal_end), aadescr, ppuintptr(0), aaret)
}
...
//	 */
func Xext2fs_allocate_subcluster_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aadescr ppuintptr, aaret ppuintptr) (cgr tnerrcode_t) {
	...
	var ccv1 ppint32
	var pp_ /* bmap at bp+0 */ tnext2fs_generic_bitmap
	pp_, pp_, pp_, pp_, pp_, pp_ = aabmap64, aaend, aareal_end, aaretval, aastart, ccv1
...
cg_2:
	...
	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdcluster_ratio_bits != 0) {
		return Xext2fs_allocate_block_bitmap(cgtls, aafs, aadescr, aaret)
	}
	...
	aastart = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_first_data_block)
	aaend = Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) - ppuint64(1)
	aareal_end = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_blocks_per_group)*ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count) - ppuint64(1) + aastart

	aaretval = Xext2fs_alloc_generic_bmap(cgtls, aafs, iqlibc.ppInt64FromInt64(2133571438), iqlibc.ppInt32FromUint16((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddefault_bitmap_type), aastart, aaend, aareal_end, aadescr, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	aabmap64 = *(*tnext2fs_generic_bitmap)(iqunsafe.ppPointer(cgbp))
	(*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap64)).fdcluster_bits = 0
	*(*tnext2fs_block_bitmap)(iqunsafe.ppPointer(aaret)) = *(*tnext2fs_generic_bitmap)(iqunsafe.ppPointer(cgbp))
	return 0
}

func Xext2fs_get_bitmap_granularity(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_block_bitmap) (cgr ppint32) {
	...
	return (*tsext2fs_struct_generic_bitmap_64)(iqunsafe.ppPointer(aabmap)).fdcluster_bits
}

func Xext2fs_fudge_inode_bitmap_end(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_inode_bitmap, aaend tnext2_ino_t, aaoend ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval ppint32
	var pp_ /* tmp_oend at bp+0 */ tn__u64
	pp_ = aaretval

	aaretval = ppint32(Xext2fs_fudge_generic_bmap_end(cgtls, aabitmap, iqlibc.ppInt64FromInt64(2133571380), ppuint64(aaend), cgbp))
	if aaoend != 0 {
		*(*tnext2_ino_t)(iqunsafe.ppPointer(aaoend)) = ppuint32(*(*tn__u64)(iqunsafe.ppPointer(cgbp)))
	}
	return ppint64(aaretval)
}

func Xext2fs_fudge_block_bitmap_end(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_block_bitmap, aaend tnblk_t, aaoend ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_fudge_generic_bitmap_end(cgtls, aabitmap, iqlibc.ppInt64FromInt64(2133571336), iqlibc.ppInt64FromInt64(2133571379), aaend, aaoend)
}

func Xext2fs_fudge_block_bitmap_end2(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_block_bitmap, aaend tnblk64_t, aaoend ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_fudge_generic_bmap_end(cgtls, aabitmap, iqlibc.ppInt64FromInt64(2133571379), aaend, aaoend)
}

func Xext2fs_clear_inode_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_inode_bitmap) {

	Xext2fs_clear_generic_bmap(cgtls, aabitmap)
}

func Xext2fs_clear_block_bitmap(cgtls *iqlibc.ppTLS, aabitmap tnext2fs_block_bitmap) {

	Xext2fs_clear_generic_bmap(cgtls, aabitmap)
}

func Xext2fs_resize_inode_bitmap(cgtls *iqlibc.ppTLS, aanew_end tn__u32, aanew_real_end tn__u32, aabmap tnext2fs_inode_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_resize_generic_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571337), aanew_end, aanew_real_end, aabmap)
}

func Xext2fs_resize_inode_bitmap2(cgtls *iqlibc.ppTLS, aanew_end tn__u64, aanew_real_end tn__u64, aabmap tnext2fs_inode_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_resize_generic_bmap(cgtls, aabmap, aanew_end, aanew_real_end)
}

func Xext2fs_resize_block_bitmap(cgtls *iqlibc.ppTLS, aanew_end tn__u32, aanew_real_end tn__u32, aabmap tnext2fs_block_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_resize_generic_bitmap(cgtls, iqlibc.ppInt64FromInt64(2133571336), aanew_end, aanew_real_end, aabmap)
}

func Xext2fs_resize_block_bitmap2(cgtls *iqlibc.ppTLS, aanew_end tn__u64, aanew_real_end tn__u64, aabmap tnext2fs_block_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_resize_generic_bmap(cgtls, aabmap, aanew_end, aanew_real_end)
}

func Xext2fs_compare_block_bitmap(cgtls *iqlibc.ppTLS, aabm1 tnext2fs_block_bitmap, aabm2 tnext2fs_block_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_compare_generic_bmap(cgtls, iqlibc.ppInt64FromInt64(2133571384), aabm1, aabm2)
}

func Xext2fs_compare_inode_bitmap(cgtls *iqlibc.ppTLS, aabm1 tnext2fs_inode_bitmap, aabm2 tnext2fs_inode_bitmap) (cgr tnerrcode_t) {

	return Xext2fs_compare_generic_bmap(cgtls, iqlibc.ppInt64FromInt64(2133571385), aabm1, aabm2)
}

func Xext2fs_set_inode_bitmap_range(cgtls *iqlibc.ppTLS, aabmap tnext2fs_inode_bitmap, aastart tnext2_ino_t, aanum ppuint32, aain ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_set_generic_bitmap_range(cgtls, aabmap, iqlibc.ppInt64FromInt64(2133571337), aastart, aanum, aain)
}

func Xext2fs_set_inode_bitmap_range2(cgtls *iqlibc.ppTLS, aabmap tnext2fs_inode_bitmap, aastart tn__u64, aanum tnsize_t, aain ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_set_generic_bmap_range(cgtls, aabmap, aastart, ppuint32(aanum), aain)
}

func Xext2fs_get_inode_bitmap_range(cgtls *iqlibc.ppTLS, aabmap tnext2fs_inode_bitmap, aastart tnext2_ino_t, aanum ppuint32, aaout ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_get_generic_bitmap_range(cgtls, aabmap, iqlibc.ppInt64FromInt64(2133571337), aastart, aanum, aaout)
}

func Xext2fs_get_inode_bitmap_range2(cgtls *iqlibc.ppTLS, aabmap tnext2fs_inode_bitmap, aastart tn__u64, aanum tnsize_t, aaout ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_get_generic_bmap_range(cgtls, aabmap, aastart, ppuint32(aanum), aaout)
}

func Xext2fs_set_block_bitmap_range(cgtls *iqlibc.ppTLS, aabmap tnext2fs_block_bitmap, aastart tnblk_t, aanum ppuint32, aain ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_set_generic_bitmap_range(cgtls, aabmap, iqlibc.ppInt64FromInt64(2133571336), aastart, aanum, aain)
}

func Xext2fs_set_block_bitmap_range2(cgtls *iqlibc.ppTLS, aabmap tnext2fs_block_bitmap, aastart tnblk64_t, aanum tnsize_t, aain ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_set_generic_bmap_range(cgtls, aabmap, aastart, ppuint32(aanum), aain)
}

func Xext2fs_get_block_bitmap_range(cgtls *iqlibc.ppTLS, aabmap tnext2fs_block_bitmap, aastart tnblk_t, aanum ppuint32, aaout ppuintptr) (cgr tnerrcode_t) {

	return Xext2fs_get_generic_bitmap_range(cgtls, aabmap, iqlibc.ppInt64FromInt64(2133571336), aastart, aanum, aaout)
}

func Xext2fs_get_block_bitmap_range2(cgtls *iqlibc.ppTLS, aabmap tnext2fs_block_bitmap, aastart tnblk64_t, aanum tnsize_t, aaout ppuintptr) (cgr tnerrcode_t) {
...
func _ext2fs_compare_generic_bmap(*iqlibc.ppTLS, ppint64, ppuintptr, ppuintptr) ppint64

func _ext2fs_copy_generic_bmap(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64

func _ext2fs_free_generic_bmap(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_fudge_generic_bitmap_end(*iqlibc.ppTLS, ppuintptr, ppint64, ppint64, ppuint32, ppuintptr) ppint64

func _ext2fs_fudge_generic_bmap_end(*iqlibc.ppTLS, ppuintptr, ppint64, ppuint64, ppuintptr) ppint64

func _ext2fs_get_generic_bitmap_range(*iqlibc.ppTLS, ppuintptr, ppint64, ppuint32, ppuint32, ppuintptr) ppint64

func _ext2fs_get_generic_bmap_range(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32, ppuintptr) ppint64

func _ext2fs_make_generic_bitmap(*iqlibc.ppTLS, ppint64, ppuintptr, ppuint32, ppuint32, ppuint32, ppuintptr, ppuintptr, ppuintptr) ppint64

func _ext2fs_resize_generic_bitmap(*iqlibc.ppTLS, ppint64, ppuint32, ppuint32, ppuintptr) ppint64

func _ext2fs_resize_generic_bmap(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64) ppint64

func _ext2fs_set_generic_bitmap_range(*iqlibc.ppTLS, ppuintptr, ppint64, ppuint32, ppuint32, ppuintptr) ppint64

func _ext2fs_set_generic_bmap_padding(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_set_generic_bmap_range(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32, ppuintptr) ppint64

func _ext2fs_write_bitmaps(*iqlibc.ppTLS, ppuintptr) ppint64
