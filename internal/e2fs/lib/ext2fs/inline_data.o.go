...
type tsext2_inline_data = struct {
	fdfs      tnext2_filsys
	fdino     tnext2_ino_t
	fdea_size tnsize_t
	fdea_data ppuintptr
...
func siext2fs_inline_data_ea_set(cgtls *iqlibc.ppTLS, aadata ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var pp_ /* handle at bp+0 */ ppuintptr
	pp_ = aaretval

	aaretval = Xext2fs_xattrs_open(cgtls, (*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdfs, (*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdino, cgbp)
	if aaretval != 0 {
		return aaretval
	}

	aaretval = Xext2fs_xattrs_read(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
	if aaretval != 0 {
		goto pperr
	}

	aaretval = Xext2fs_xattr_set(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), "system.data\x00", (*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_data, (*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_size)
	goto pperr
pperr:
	;
	Xext2fs_xattrs_close(cgtls, cgbp)
	return aaretval
}

func siext2fs_inline_data_ea_get(cgtls *iqlibc.ppTLS, aadata ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	(*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_size = ppuint64(0)
	(*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_data = ppuintptr(0)
	...
	aaretval = Xext2fs_xattr_get(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), "system.data\x00", aadata+24, aadata+16)
	if aaretval == ppint64(2133571490) {
		(*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_size = ppuint64(0)
		(*tsext2_inline_data)(iqunsafe.ppPointer(aadata)).fdea_data = iqlibc.ppUintptrFromInt32(0)
		aaretval = 0
	} else {
		if aaretval != 0 {
			goto pperr
...
func Xext2fs_inline_data_init(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(48)
	defer cgtls.ppFree(48)

	var pp_ /* data at bp+0 */ tsext2_inline_data
	var pp_ /* empty at bp+32 */ [1]ppint8
	*(*[1]ppint8)(iqunsafe.ppPointer(cgbp + 32)) = [1]ppint8{}

	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp))).fdfs = aafs
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp))).fdino = aaino
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp))).fdea_size = ppuint64(0)
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp))).fdea_data = cgbp + 32
	return siext2fs_inline_data_ea_set(cgtls, cgbp)
}

func Xext2fs_inline_data_size(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aasize ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)

	var aaretval, ccv2 tnerrcode_t
	var ccv1 ppuintptr
	var pp_ /* data at bp+136 */ tsext2_inline_data
	var pp_ /* inode at bp+8 */ tsext2_inode
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_ = aaretval, ccv1, ccv2

	aaretval = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp+8)
	if aaretval != 0 {
		return aaretval
	}

	if !((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_INLINE_DATA_FL) != 0) {
		return iqlibc.ppInt64FromInt64(2133571493)
	}

	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdfs = aafs
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdino = aaino
	aaretval = siext2fs_inline_data_ea_get(cgtls, cgbp+136)
	if aaretval != 0 {
		return aaretval
	}

	*(*tnsize_t)(iqunsafe.ppPointer(aasize)) = iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) + (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdea_size
	ccv1 = cgbp + 136 + 24
...
func Xext2fs_inline_data_dir_iterate(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aapriv_data ppuintptr) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(432)
	defer cgtls.ppFree(432)

	var aablockcnt, ccv3, ccv6, ccv7, ccv8 tne2_blkcnt_t
	var aactx, aaold_buf, ccv9 ppuintptr
	var aaerr tnerrcode_t
	var aaold_buflen, ccv1, ccv4 ppuint32
	var aaold_flags, aarec_len, aaret ppint32
	var pp_ /* data at bp+400 */ tsext2_inline_data
	var pp_ /* dirent at bp+136 */ tsext2_dir_entry
	var pp_ /* inode at bp+8 */ tsext2_inode
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablockcnt, aactx, aaerr, aaold_buf, aaold_buflen, aaold_flags, aarec_len, aaret, ccv1, ccv3, ccv4, ccv6, ccv7, ccv8, ccv9
	aaret = ppint32(mvBLOCK_ABORT)
	aablockcnt = 0

	aactx = aapriv_data
	aaold_buf = (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf
	aaold_buflen = (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuflen
	aaold_flags = (*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags

	*(*ppint32)(iqunsafe.ppPointer(aactx + 4)) |= ppint32(mvDIRENT_FLAG_INCLUDE_INLINE_DATA)

	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp+8)
	if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
		goto ppout
	}

	if !((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_INLINE_DATA_FL) != 0) {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571493)
		goto ppout
	}

	if !(iqlibc.ppInt32FromUint16((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 8))).fdi_mode)&iqlibc.ppInt32FromInt32(mvLINUX_S_IFMT) == iqlibc.ppInt32FromInt32(mvLINUX_S_IFDIR)) {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = iqlibc.ppInt64FromInt64(2133571402)
		goto ppout
	}
	aaret = 0

	/* we first check '.' and '..' dir */
	(*(*tsext2_dir_entry)(iqunsafe.ppPointer(cgbp + 136))).fdinode = aaino
	(*(*tsext2_dir_entry)(iqunsafe.ppPointer(cgbp + 136))).fdname_len = ppuint16(1)
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(2)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	...
	goto cg_2
cg_2:
	Xext2fs_set_rec_len(cgtls, aafs, ccv1, cgbp+136)
	*(*ppint8)(iqunsafe.ppPointer(cgbp + 136 + 8)) = ppint8('.')
	*(*ppint8)(iqunsafe.ppPointer(cgbp + 136 + 8 + 1)) = ppint8('\000')
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf = cgbp + 136
	Xext2fs_get_rec_len(cgtls, aafs, cgbp+136, aactx+16)
	ccv3 = aablockcnt
	aablockcnt = aablockcnt + 1
	aaret = aaret | Xext2fs_process_dir_block(cgtls, aafs, ppuintptr(0), ccv3, ppuint64(0), 0, aapriv_data)
	if aaret&ppint32(mvBLOCK_ABORT) != 0 {
		goto ppout
	}

	(*(*tsext2_dir_entry)(iqunsafe.ppPointer(cgbp + 136))).fdinode = *(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40))
	(*(*tsext2_dir_entry)(iqunsafe.ppPointer(cgbp + 136))).fdname_len = ppuint16(2)
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(3)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	if 0 != 0 {
		aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
	}
...
cg_5:
	Xext2fs_set_rec_len(cgtls, aafs, ccv1, cgbp+136)
	*(*ppint8)(iqunsafe.ppPointer(cgbp + 136 + 8)) = ppint8('.')
	*(*ppint8)(iqunsafe.ppPointer(cgbp + 136 + 8 + 1)) = ppint8('.')
	*(*ppint8)(iqunsafe.ppPointer(cgbp + 136 + 8 + 2)) = ppint8('\000')
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf = cgbp + 136
	Xext2fs_get_rec_len(cgtls, aafs, cgbp+136, aactx+16)
	ccv3 = aablockcnt
	aablockcnt = aablockcnt + 1
	aaret = aaret | Xext2fs_process_dir_block(cgtls, aafs, ppuintptr(0), ccv3, ppuint64(0), 0, aapriv_data)
	if aaret&ppint32(mvBLOCK_INLINE_DATA_CHANGED) != 0 {

		*(*tn__u32)(iqunsafe.ppPointer(cgbp + 8 + 40)) = (*(*tsext2_dir_entry)(iqunsafe.ppPointer(cgbp + 136))).fdinode
		aaerr = Xext2fs_write_inode(cgtls, aafs, aaino, cgbp+8)
		if aaerr != 0 {
			goto ppout
		}
		aaret = aaret & ^iqlibc.ppInt32FromInt32(mvBLOCK_INLINE_DATA_CHANGED)
	}
	if aaret&ppint32(mvBLOCK_ABORT) != 0 {
		goto ppout
	}

	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf = cgbp + 8 + 40 + ppuintptr(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE))
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuflen = ppuint32(iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) - iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE)))
	ccv3 = aablockcnt
	aablockcnt = aablockcnt + 1
	aaret = aaret | Xext2fs_process_dir_block(cgtls, aafs, ppuintptr(0), ccv3, ppuint64(0), 0, aapriv_data)
	if aaret&ppint32(mvBLOCK_INLINE_DATA_CHANGED) != 0 {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = Xext2fs_write_inode(cgtls, aafs, aaino, cgbp+8)
		if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
	...
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 400))).fdfs = aafs
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 400))).fdino = aaino
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = siext2fs_inline_data_ea_get(cgtls, cgbp+400)
	if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
		aaret = aaret | ppint32(mvBLOCK_ABORT)
		goto ppout
	}
	if (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 400))).fdea_size <= ppuint64(0) {
		goto ppout1
	}

	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf = (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 400))).fdea_data
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuflen = ppuint32((*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 400))).fdea_size)

	ccv3 = aablockcnt
	aablockcnt = aablockcnt + 1
	aaret = aaret | Xext2fs_process_dir_block(cgtls, aafs, ppuintptr(0), ccv3, ppuint64(0), 0, aapriv_data)
	if aaret&ppint32(mvBLOCK_INLINE_DATA_CHANGED) != 0 {
		(*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode = siext2fs_inline_data_ea_set(cgtls, cgbp+400)
		if (*tsdir_context)(iqunsafe.ppPointer(aactx)).fderrcode != 0 {
			aaret = aaret | ppint32(mvBLOCK_ABORT)
		}
	}
...
ppout1:
	;
	ccv9 = cgbp + 400 + 24
	Xmemcpy(cgtls, cgbp, ccv9, ppuint64(8))
	Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
	Xmemcpy(cgtls, ccv9, cgbp, ppuint64(8))
	pp_ = 0
	goto cg_10
cg_10:
	;
...
ppout:
	;
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuf = aaold_buf
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdbuflen = aaold_buflen
	(*tsdir_context)(iqunsafe.ppPointer(aactx)).fdflags = aaold_flags
	aaret = aaret & ^(iqlibc.ppInt32FromInt32(mvBLOCK_ABORT) | iqlibc.ppInt32FromInt32(mvBLOCK_INLINE_DATA_CHANGED))
	return aaret
}

func Xext2fs_inline_data_ea_remove(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	...
	aaretval = Xext2fs_xattrs_open(cgtls, aafs, aaino, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	...
	aaretval = Xext2fs_xattr_remove(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), "system.data\x00")
	goto pperr
pperr:
	;
	Xext2fs_xattrs_close(cgtls, cgbp)
...
func siext2fs_inline_data_convert_dir(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aabbuf ppuintptr, aaibuf ppuintptr, aasize ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aacsum_size, aafiletype, aaoffset, aarec_len, ccv1, ccv3 ppint32
	var aadir, aadir2, aat, ccv13, ccv14, ccv5, ccv6 ppuintptr
	var aaretval tnerrcode_t
	var ccv11, ccv15, ccv17, ccv19, ccv21, ccv7, ccv9 ppuint32
	var pp_ /* rec_len at bp+0 */ ppuint32
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aacsum_size, aadir, aadir2, aafiletype, aaoffset, aarec_len, aaretval, aat, ccv1, ccv11, ccv13, ccv14, ccv15, ccv17, ccv19, ccv21, ccv3, ccv5, ccv6, ccv7, ccv9
	aacsum_size = 0
	aafiletype = 0
...
cg_2:
	...
	/* Create '.' and '..' */
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT2_FEATURE_INCOMPAT_FILETYPE) != ppuint32(0))
	goto cg_4
cg_4:
	if ccv1 != 0 {
		aafiletype = ppint32(mvEXT2_FT_DIR)
	}
	 ...
	 */
	aadir = aabbuf
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdinode = aaino
	ccv5 = aadir
	(*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len)&ppint32(0xff00) | ppint32(1)&ppint32(0xff))
	ccv5 = aadir
	(*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len)&ppint32(0xff) | aafiletype<<ppint32(8))
	*(*ppint8)(iqunsafe.ppPointer(aadir + 8)) = ppint8('.')
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(1)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	if 0 != 0 {
		aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
	}
	ccv7 = iqlibc.ppUint32FromInt32(aarec_len)
	goto cg_8
cg_8:
	*(*ppuint32)(iqunsafe.ppPointer(cgbp)) = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize - iqlibc.ppUint32FromInt32(aacsum_size) - ccv7
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(1)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	if 0 != 0 {
		aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
	...
	goto cg_10
cg_10:
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdrec_len = ppuint16(ccv7)

	/*
	 * Set up entry for '..'
	 */
	aadir = aabbuf + ppuintptr((*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdrec_len)
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(2)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	if 0 != 0 {
		aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
...
cg_12:
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdrec_len = ppuint16(ccv7)
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aadir)).fdinode = *(*tn__u32)(iqunsafe.ppPointer(aaibuf))
	ccv5 = aadir
	(*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len)&ppint32(0xff00) | ppint32(2)&ppint32(0xff))
	ccv5 = aadir
	(*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(ccv5)).fdname_len)&ppint32(0xff) | aafiletype<<ppint32(8))
	*(*ppint8)(iqunsafe.ppPointer(aadir + 8)) = ppint8('.')
	*(*ppint8)(iqunsafe.ppPointer(aadir + 8 + 1)) = ppint8('.')
...
cg_16:
	...
	ccv9 = iqlibc.ppUint32FromInt32(aarec_len)
	goto cg_18
cg_18:
	aaoffset = iqlibc.ppInt32FromUint32(ccv7 + ccv9)
	aadir = aabbuf + ppuintptr(aaoffset)
	Xmemcpy(cgtls, aabbuf+ppuintptr(aaoffset), aaibuf+ppuintptr(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE)), iqlibc.ppUint64FromInt32(aasize-ppint32(mvEXT4_INLINE_DATA_DOTDOT_SIZE)))
	aarec_len = iqlibc.ppInt32FromUint8(ppuint8(1)) + ppint32(mvEXT2_DIR_ENTRY_HEADER_LEN) + (iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	aarec_len = aarec_len & ^(iqlibc.ppInt32FromInt32(mvEXT2_DIR_PAD) - iqlibc.ppInt32FromInt32(1))
	if 0 != 0 {
		aarec_len = aarec_len + ppint32(mvEXT2_DIR_ENTRY_HASH_LEN)
...
cg_20:
	...
	goto cg_22
cg_22:
	aasize = iqlibc.ppInt32FromUint32(ppuint32(aasize) + (ccv7 + ccv9 - iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_DOTDOT_SIZE))))

	for cgcond := true; cgcond; cgcond = aaoffset < aasize {
		aadir2 = aadir
		aaretval = Xext2fs_get_rec_len(cgtls, aafs, aadir, cgbp)
		if aaretval != 0 {
			goto pperr
		}

		aaoffset = iqlibc.ppInt32FromUint32(ppuint32(aaoffset) + *(*ppuint32)(iqunsafe.ppPointer(cgbp)))
		aadir = aabbuf + ppuintptr(aaoffset)
	}
	*(*ppuint32)(iqunsafe.ppPointer(cgbp)) = *(*ppuint32)(iqunsafe.ppPointer(cgbp)) + ((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize - iqlibc.ppUint32FromInt32(aacsum_size) - iqlibc.ppUint32FromInt32(aaoffset))
	aaretval = Xext2fs_set_rec_len(cgtls, aafs, *(*ppuint32)(iqunsafe.ppPointer(cgbp)), aadir2)
	if aaretval != 0 {
		goto pperr
	}

	if aacsum_size != 0 {
		aat = aabbuf + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) - iqlibc.ppUintptrFromInt64(12)
		Xext2fs_initialize_dirent_tail(cgtls, aafs, aat)
	}
...
func siext2fs_inline_data_dir_expand(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aabuf ppuintptr, aasize1 tnsize_t) (cgr tnerrcode_t) {
	...
	var ccv4 ppint32
	var ccv6 ppuintptr
	var pp_ /* blk at bp+16 */ tnblk64_t
	var pp_ /* blk_buf at bp+24 */ ppuintptr
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aaretval, ccv1, ccv2, ccv4, ccv6

	ccv1 = ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, ccv1)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv2 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_3
	}
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), 0, ccv1)
...
cg_3:
	...
	/* Adjust the rec_len */
	aaretval = siext2fs_inline_data_convert_dir(cgtls, aafs, aaino, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)), aabuf, iqlibc.ppInt32FromUint64(aasize1))
	if aaretval != 0 {
		goto pperrout
	}
	/* Allocate a new block */
	aaretval = Xext2fs_new_block2(cgtls, aafs, ppuint64(0), ppuintptr(0), cgbp+16)
	if aaretval != 0 {
		goto pperrout
	}
	aaretval = Xext2fs_write_dir_block4(cgtls, aafs, *(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 16)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 24)), 0, aaino)
	if aaretval != 0 {
		goto pperrout
	}

	/* Update inode */
	ccv4 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT3_FEATURE_INCOMPAT_EXTENTS) != ppuint32(0))
	goto cg_5
cg_5:
	if ccv4 != 0 {

		*(*tn__u32)(iqunsafe.ppPointer(aainode + 32)) |= ppuint32(mvEXT4_EXTENTS_FL)
	}

	*(*tn__u32)(iqunsafe.ppPointer(aainode + 32)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_FL))
	aaretval = Xext2fs_iblk_add_blocks(cgtls, aafs, aainode, ppuint64(1))
	if aaretval != 0 {
		goto pperrout
	}
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize
	aaretval = Xext2fs_bmap2(cgtls, aafs, aaino, aainode, ppuintptr(0), ppint32(mvBMAP_SET), ppuint64(0), ppuintptr(0), cgbp+16)
	if aaretval != 0 {
		goto pperrout
	}
	aaretval = Xext2fs_write_inode(cgtls, aafs, aaino, aainode)
	if aaretval != 0 {
		goto pperrout
	}
	Xext2fs_block_alloc_stats(cgtls, aafs, ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp + 16))), +iqlibc.ppInt32FromInt32(1))
...
func siext2fs_inline_data_file_expand(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aabuf ppuintptr, aasize tnsize_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var ccv1 ppint32
	var pp_ /* e2_file at bp+0 */ tnext2_file_t
	var pp_ /* handle at bp+8 */ tnext2_extent_handle_t
	pp_, pp_ = aaretval, ccv1

	/* Update inode */
	Xmemset(cgtls, aainode+40, 0, ppuint64(60))
...
cg_2:
	if ccv1 != 0 {
		...
		*(*tn__u32)(iqunsafe.ppPointer(aainode + 32)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_EXTENTS_FL))
		aaretval = Xext2fs_extent_open2(cgtls, aafs, aaino, aainode, cgbp+8)
		if aaretval != 0 {
			return aaretval
		}
		Xext2fs_extent_free(cgtls, *(*tnext2_extent_handle_t)(iqunsafe.ppPointer(cgbp + 8)))
	}

	*(*tn__u32)(iqunsafe.ppPointer(aainode + 32)) &= iqlibc.ppUint32FromInt32(^iqlibc.ppInt32FromInt32(mvEXT4_INLINE_DATA_FL))
	(*tsext2_inode)(iqunsafe.ppPointer(aainode)).fdi_size = ppuint32(0)
	aaretval = Xext2fs_write_inode(cgtls, aafs, aaino, aainode)
	if aaretval != 0 {
		return aaretval
	}
	...
	aaretval = Xext2fs_file_open(cgtls, aafs, aaino, ppint32(mvEXT2_FILE_WRITE), cgbp)
	if aaretval != 0 {
		return aaretval
	}
	aaretval = Xext2fs_file_write(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp)), aabuf, ppuint32(aasize), ppuintptr(0))
	Xext2fs_file_close(cgtls, *(*tnext2_file_t)(iqunsafe.ppPointer(cgbp)))
	return aaretval
}

func Xext2fs_inline_data_expand(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(192)
	defer cgtls.ppFree(192)

	var aainline_size tnsize_t
	var aaretval, ccv1 tnerrcode_t
	var ccv3, ccv5 ppuintptr
	var pp_ /* data at bp+144 */ tsext2_inline_data
	var pp_ /* inline_buf at bp+176 */ ppuintptr
	var pp_ /* inode at bp+16 */ tsext2_inode
	var pp_ /* p at bp+8 */ ppuintptr
	var pp_ /* pp at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aainline_size, aaretval, ccv1, ccv3, ccv5
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176)) = ppuintptr(0)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	aaretval = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp+16)
	if aaretval != 0 {
		return aaretval
	}

	if !((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_flags&iqlibc.ppUint32FromInt32(mvEXT4_INLINE_DATA_FL) != 0) {
		return iqlibc.ppInt64FromInt64(2133571493)
	}

	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdfs = aafs
	(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdino = aaino
	aaretval = siext2fs_inline_data_ea_get(cgtls, cgbp+144)
	if aaretval != 0 {
		return aaretval
	}
	aainline_size = (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdea_size + iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, aainline_size)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		ccv1 = iqlibc.ppInt64FromInt64(2133571398)
		goto cg_2
	}
	Xmemcpy(cgtls, cgbp+176, cgbp, ppuint64(8))
	ccv1 = 0
	goto cg_2
cg_2:
	aaretval = ccv1
	...
	Xmemcpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176)), cgbp+16+40, iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
	if (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdea_size > ppuint64(0) {
		Xmemcpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176))+ppuintptr(iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))), (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdea_data, (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 144))).fdea_size)
	}

	Xmemset(cgtls, cgbp+16+40, 0, iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
	/*
	...
	aaretval = Xext2fs_inline_data_ea_remove(cgtls, aafs, aaino)
	if aaretval != 0 {
		goto pperrout
	}
	aaretval = Xext2fs_read_inode(cgtls, aafs, aaino, cgbp+16)
	...
	if iqlibc.ppInt32FromUint16((*(*tsext2_inode)(iqunsafe.ppPointer(cgbp + 16))).fdi_mode)&ppint32(mvLINUX_S_IFMT) == ppint32(mvLINUX_S_IFDIR) {
		aaretval = siext2fs_inline_data_dir_expand(cgtls, aafs, aaino, cgbp+16, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176)), aainline_size)
	} else {
		aaretval = siext2fs_inline_data_file_expand(cgtls, aafs, aaino, cgbp+16, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176)), aainline_size)
	}

	goto pperrout
pperrout:
	;
	if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 176)) != 0 {
		ccv3 = cgbp + 176
...
//	 */
func Xext2fs_inline_data_get(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aabuf ppuintptr, aasize ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)
	...
	var ccv1 ppuintptr
	var pp_ /* data at bp+136 */ tsext2_inline_data
	var pp_ /* inode_buf at bp+8 */ tsext2_inode
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_ = aaretval, ccv1
	...
	Xmemcpy(cgtls, aabuf, aainode+40, iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
	if (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdea_size > ppuint64(0) {
		Xmemcpy(cgtls, aabuf+ppuintptr(iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))), (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdea_data, (*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 136))).fdea_size)
	}
...
func Xext2fs_inline_data_set(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainode ppuintptr, aabuf ppuintptr, aasize tnsize_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)

	var aafree_inode_size tnsize_t
	var aaretval tnerrcode_t
	var pp_ /* data at bp+128 */ tsext2_inline_data
	var pp_ /* existing_size at bp+168 */ tnsize_t
	var pp_ /* free_ea_size at bp+160 */ tnsize_t
	var pp_ /* inode_buf at bp+0 */ tsext2_inode
	pp_, pp_ = aafree_inode_size, aaretval
	*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 128)) = tsext2_inline_data{
		fdfs:  aafs,
		fdino: aaino,
	}
	...
	if aasize <= iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) {
		Xmemcpy(cgtls, aainode+40, aabuf, aasize)
	} else {
		aaretval = Xext2fs_xattr_inode_max_size(cgtls, aafs, aaino, cgbp+160)
		if aaretval != 0 {
			return aaretval
		}

		aaretval = Xext2fs_inline_data_size(cgtls, aafs, aaino, cgbp+168)
		if aaretval != 0 {
			return aaretval
		}

		if *(*tnsize_t)(iqunsafe.ppPointer(cgbp + 168)) < iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) {
			aafree_inode_size = iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) - *(*tnsize_t)(iqunsafe.ppPointer(cgbp + 168))
		} else {
			aafree_inode_size = ppuint64(0)
		}

		if aasize != *(*tnsize_t)(iqunsafe.ppPointer(cgbp + 168)) && aasize > *(*tnsize_t)(iqunsafe.ppPointer(cgbp + 168))+*(*tnsize_t)(iqunsafe.ppPointer(cgbp + 160))+aafree_inode_size {
			return iqlibc.ppInt64FromInt64(2133571495)
		}

		Xmemcpy(cgtls, aainode+40, aabuf, iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
		if aasize > iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)) {
			(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 128))).fdea_size = aasize - iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1))
		}
		(*(*tsext2_inline_data)(iqunsafe.ppPointer(cgbp + 128))).fdea_data = aabuf + ppuintptr(iqlibc.ppUint64FromInt64(4)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(mvEXT2_NDIR_BLOCKS)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)+iqlibc.ppInt32FromInt32(1)))
	}
	aaretval = Xext2fs_write_inode(cgtls, aafs, aaino, aainode)
	if aaretval != 0 {
		return aaretval
	}
	return siext2fs_inline_data_ea_set(cgtls, cgbp+128)
}

func _ext2fs_block_alloc_stats(*iqlibc.ppTLS, ppuintptr, ppuint32, ppint32)
...
func _ext2fs_xattr_get(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr, ppuintptr) ppint64

func _ext2fs_xattr_inode_max_size(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64

func _ext2fs_xattr_remove(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64

func _ext2fs_xattr_set(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr, ppuint64) ppint64

func _ext2fs_xattrs_close(*iqlibc.ppTLS, ppuintptr) ppint64

func _ext2fs_xattrs_open(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint64

func _ext2fs_xattrs_read(*iqlibc.ppTLS, ppuintptr) ppint64
