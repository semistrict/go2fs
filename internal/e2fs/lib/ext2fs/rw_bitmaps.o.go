...
const mvEXT2FS_BITMAPS_BLOCK = 2
const mvEXT2FS_BITMAPS_INODE = 4
const mvEXT2FS_BITMAPS_VALID_FLAGS = 7
const mvEXT2FS_BITMAPS_WRITE = 1
...
const mvEXT2_FLAG_BBITMAP_TAIL_PROBLEM = 16777216
...
const mvEXT2_FLAG_IBITMAP_TAIL_PROBLEM = 33554432
...
const mv_PTHREAD_MUTEX_SIG_init = 850045863
...
type tnmutex_t = struct {
	fd__sig    ppint64
	fd__opaque [56]ppint8
}

func siunix_pthread_mutex_lock(cgtls *iqlibc.ppTLS, aamutex ppuintptr) {

	if aamutex != 0 {
		Xpthread_mutex_lock(cgtls, aamutex)
	}
}

func siunix_pthread_mutex_unlock(cgtls *iqlibc.ppTLS, aamutex ppuintptr) {

	if aamutex != 0 {
		Xpthread_mutex_unlock(cgtls, aamutex)
	}
}

func siwrite_bitmaps(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aado_inode ppint32, aado_block ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aablk, aablk_itr tnblk64_t
	var aablock_nbytes, aacsum_flag, aainode_nbytes, ccv2, ccv4, ccv6, ccv9 ppint32
	var aai tndgrp_t
	var aaino_itr tnext2_ino_t
	var aaj, aanbits ppuint32
	var aaretval tnerrcode_t
	var ccv1 tnext2_filsys
	var ccv12, ccv14, ccv16, ccv18 ppuintptr
	var ccv8 ppbool
	var pp_ /* block_buf at bp+8 */ ppuintptr
	var pp_ /* inode_buf at bp+16 */ ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablk, aablk_itr, aablock_nbytes, aacsum_flag, aai, aaino_itr, aainode_nbytes, aaj, aanbits, aaretval, ccv1, ccv12, ccv14, ccv16, ccv18, ccv2, ccv4, ccv6, ccv8, ccv9
	...
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) = iqlibc.ppUintptrFromInt32(0)
	aablk_itr = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_first_data_block >> (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits)
	aaino_itr = ppuint32(1)

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_RW) != 0) {
...
cg_3:
	...
	aainode_nbytes = ccv2
	if aado_block != 0 {
		aablock_nbytes = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_clusters_per_group / ppuint32(8))
		aaretval = Xio_channel_alloc_buf(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, 0, cgbp+8)
		if aaretval != 0 {
			goto pperrout
		}
		Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), ppint32(0xff), ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
	}
	if aado_inode != 0 {
		aainode_nbytes = iqlibc.ppInt32FromUint64(ppuint64(((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_inodes_per_group + iqlibc.ppUint32FromInt32(7)) / iqlibc.ppUint32FromInt32(8)))
		aaretval = Xio_channel_alloc_buf(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, 0, cgbp+16)
		if aaretval != 0 {
			goto pperrout
		}
		Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), ppint32(0xff), ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize))
	}

	aai = ppuint32(0)
	for {
		if !(aai < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc_count) {
			break
		}
		if !(aado_block != 0) {
			goto ppskip_block_bitmap
		}

		if aacsum_flag != 0 && Xext2fs_bg_flags_test(cgtls, aafs1, aai, ppuint16(mvEXT2_BG_BLOCK_UNINIT)) != 0 {
			goto ppskip_this_block_bitmap
		}

		aaretval = Xext2fs_get_block_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblock_map, aablk_itr, iqlibc.ppUint64FromInt32(aablock_nbytes<<ppint32(3)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		if aaretval != 0 {
			goto pperrout
		}

		if aai == (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc_count-ppuint32(1) {
			/* Force bitmap padding for the last group */
			aanbits = ppuint32(((Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)-ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_first_data_block))%ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_blocks_per_group) + iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits-iqlibc.ppInt32FromInt32(1))) >> (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits)
			if aanbits != 0 {
				aaj = aanbits
				for {
					if !(aaj < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize*ppuint32(8)) {
						break
					}
					Xext2fs_set_bit(cgtls, aaj, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
					goto cg_11
				cg_11:
					;
					aaj = aaj + 1
		...
		aaretval = Xext2fs_block_bitmap_csum_set(cgtls, aafs1, aai, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), aablock_nbytes)
		if aaretval != 0 {
			return aaretval
		}
		Xext2fs_group_desc_csum_set(cgtls, aafs1, aai)

		*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) |= ppint32(mvEXT2_FLAG_DIRTY)

		aablk = Xext2fs_block_bitmap_loc(cgtls, aafs1, aai)
		if aablk != 0 && aablk < Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper) {
			aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, aablk, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
			if aaretval != 0 {
				aaretval = iqlibc.ppInt64FromInt64(2133571357)
				goto pperrout
			}
		}
		goto ppskip_this_block_bitmap
	ppskip_this_block_bitmap:
		;
		aablk_itr = aablk_itr + iqlibc.ppUint64FromInt32(aablock_nbytes<<ppint32(3))
		goto ppskip_block_bitmap
	ppskip_block_bitmap:
		;
		...
		if aacsum_flag != 0 && Xext2fs_bg_flags_test(cgtls, aafs1, aai, ppuint16(mvEXT2_BG_INODE_UNINIT)) != 0 {
			goto ppskip_this_inode_bitmap
		}

		aaretval = Xext2fs_get_inode_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdinode_map, ppuint64(aaino_itr), iqlibc.ppUint64FromInt32(aainode_nbytes<<ppint32(3)), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
		if aaretval != 0 {
			goto pperrout
		}

		aaretval = Xext2fs_inode_bitmap_csum_set(cgtls, aafs1, aai, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aainode_nbytes)
		if aaretval != 0 {
			goto pperrout
		}
		Xext2fs_group_desc_csum_set(cgtls, aafs1, aai)
		...
		*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) |= ppint32(mvEXT2_FLAG_DIRTY)
		...
		aablk = Xext2fs_inode_bitmap_loc(cgtls, aafs1, aai)
		if aablk != 0 && aablk < Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper) {
			aaretval = Xio_channel_write_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, aablk, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
			if aaretval != 0 {
				aaretval = iqlibc.ppInt64FromInt64(2133571355)
				goto pperrout
			}
		}
		goto ppskip_this_inode_bitmap
	ppskip_this_inode_bitmap:
		;
		aaino_itr = aaino_itr + iqlibc.ppUint32FromInt32(aainode_nbytes<<ppint32(3))
	...
	if aado_block != 0 {
		...
		*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_BB_DIRTY)
		ccv12 = cgbp + 8
		Xmemcpy(cgtls, cgbp, ccv12, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
		Xmemcpy(cgtls, ccv12, cgbp, ppuint64(8))
		pp_ = 0
		goto cg_13
	cg_13:
		;
	...
	if aado_inode != 0 {
		...
		*(*ppint32)(iqunsafe.ppPointer(aafs1 + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IB_DIRTY)
		ccv12 = cgbp + 16
		Xmemcpy(cgtls, cgbp, ccv12, ppuint64(8))
		Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)))
		*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = ppuintptr(0)
...
func simark_uninit_bg_group_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	var aablk tnblk64_t
	var aabmap tnext2fs_block_bitmap
	var aai tndgrp_t
	pp_, pp_, pp_ = aablk, aabmap, aai
	aabmap = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map

	aai = ppuint32(0)
	for {
		if !(aai < (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count) {
			break
		}
		if !(Xext2fs_bg_flags_test(cgtls, aafs, aai, ppuint16(mvEXT2_BG_BLOCK_UNINIT)) != 0) {
			goto cg_1
		}

		Xext2fs_reserve_super_and_bgd(cgtls, aafs, aai, aabmap)

		/*
		 * Mark the blocks used for the inode table
		 */
		aablk = Xext2fs_inode_table_loc(cgtls, aafs, aai)
		if aablk != 0 {
			Xext2fs_mark_block_bitmap_range2(cgtls, aabmap, aablk, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_blocks_per_group)
		}

		/*
		 * Mark block used for the block bitmap
		 */
		aablk = Xext2fs_block_bitmap_loc(cgtls, aafs, aai)
		if aablk != 0 && aablk < Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
			pp_ = Xext2fs_mark_generic_bmap(cgtls, aabmap, aablk)
			goto cg_2
		cg_2:
		}
		 ...
		 */
		aablk = Xext2fs_inode_bitmap_loc(cgtls, aafs, aai)
		if aablk != 0 && aablk < Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper) {
			pp_ = Xext2fs_mark_generic_bmap(cgtls, aabmap, aablk)
			goto cg_3
		cg_3:
...
func sibitmap_tail_verify(cgtls *iqlibc.ppTLS, aabitmap ppuintptr, aafirst ppint32, aalast ppint32) (cgr ppint32) {
	...
	for {
		...
		if iqlibc.ppInt32FromUint8(*(*ppuint8)(iqunsafe.ppPointer(aabitmap + ppuintptr(aai)))) != ppint32(0xff) {
			return 0
		}
		goto cg_1
	cg_1:
...
func siread_bitmaps_range_prepare(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aablock_nbytes, aainode_nbytes ppint32
	...
	pp_, pp_, pp_, pp_, pp_, pp_ = aablock_nbytes, aainode_nbytes, aaretval, ccv1, ccv3, ccv5
	aablock_nbytes = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_clusters_per_group / ppuint32(8))
	aainode_nbytes = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_per_group / ppuint32(8))

	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return iqlibc.ppInt64FromInt64(2133571329)
	}

	if aablock_nbytes > iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) || aainode_nbytes > iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) {
		return iqlibc.ppInt64FromInt64(2133571388)
	}

	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdwrite_bitmaps = pp__ccgo_fp(Xext2fs_write_bitmaps)

	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, Xstrlen(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name)+ppuint64(80))
...
cg_2:
	...
	if aaflags&ppint32(mvEXT2FS_BITMAPS_BLOCK) != 0 {
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map != 0 {
			Xext2fs_free_block_bitmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map)
		}
		Xstrcpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), "block bitmap for \x00")
		Xstrcat(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name)
		aaretval = Xext2fs_allocate_block_bitmap(cgtls, aafs, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aafs+88)
		if aaretval != 0 {
			goto ppcleanup
		}
	}

	if aaflags&ppint32(mvEXT2FS_BITMAPS_INODE) != 0 {
		if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_map != 0 {
			Xext2fs_free_inode_bitmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_map)
		}
		Xstrcpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), "inode bitmap for \x00")
		Xstrcat(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fddevice_name)
		aaretval = Xext2fs_allocate_inode_bitmap(cgtls, aafs, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aafs+80)
		if aaretval != 0 {
			goto ppcleanup
		}
	}
...
ppcleanup:
	...
	if aaflags&ppint32(mvEXT2FS_BITMAPS_BLOCK) != 0 {
		Xext2fs_free_block_bitmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map)
		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map = ppuintptr(0)
	}
	if aaflags&ppint32(mvEXT2FS_BITMAPS_INODE) != 0 {
		Xext2fs_free_inode_bitmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_map)
		(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_map = ppuintptr(0)
	}
	ccv3 = cgbp + 16
	Xmemcpy(cgtls, cgbp+8, ccv3, ppuint64(8))
	Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
...
func siread_bitmaps_range_start(cgtls *iqlibc.ppTLS, aafs1 tnext2_filsys, aaflags ppint32, aastart tndgrp_t, aaend tndgrp_t, aamutex ppuintptr, aatail_flags ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aablk, aablk_cnt, aablk_itr, ccv10, ccv9 tnblk64_t
	var aablock_nbytes, aacsum_flag, aainode_nbytes, ccv2, ccv4, ccv6 ppint32
	var aacnt ppuint32
	var aai tndgrp_t
	var aaino_cnt, aaino_itr tnext2_ino_t
	var aaretval tnerrcode_t
	var ccv1 tnext2_filsys
	var ccv12, ccv14 ppuintptr
	var ccv8 ppbool
	var pp_ /* block_bitmap at bp+8 */ ppuintptr
	var pp_ /* inode_bitmap at bp+16 */ ppuintptr
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aablk, aablk_cnt, aablk_itr, aablock_nbytes, aacnt, aacsum_flag, aai, aaino_cnt, aaino_itr, aainode_nbytes, aaretval, ccv1, ccv10, ccv12, ccv14, ccv2, ccv4, ccv6, ccv8, ccv9
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) = ppuintptr(0)
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) = ppuintptr(0)
	aaretval = 0
	aablock_nbytes = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_clusters_per_group / ppuint32(8))
	aainode_nbytes = iqlibc.ppInt32FromUint32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_inodes_per_group / ppuint32(8))
	aablk_itr = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_first_data_block >> (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdcluster_ratio_bits)
	aaino_itr = ppuint32(1)
...
cg_3:
	...
	/* io should be null */
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&ppint32(mvEXT2_FLAG_IMAGE_FILE) != 0 {
		aablk = ppuint64((*tsext2_image_hdr)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdimage_header)).fdoffset_inodemap / (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize)
		aaino_cnt = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_inodes_count
		for *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) != 0 && aaino_cnt > ppuint32(0) {
			ccv9 = aablk
			aablk = aablk + 1
			aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdimage_io, ccv9, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
			if aaretval != 0 {
				goto ppcleanup
			}
			aacnt = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize << ppint32(3)
			if aacnt > aaino_cnt {
				aacnt = aaino_cnt
			}
			aaretval = Xext2fs_set_inode_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdinode_map, ppuint64(aaino_itr), ppuint64(aacnt), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
			if aaretval != 0 {
				goto ppcleanup
			}
			aaino_itr = aaino_itr + aacnt
			aaino_cnt = aaino_cnt - aacnt
		}
		aablk = ppuint64((*tsext2_image_hdr)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdimage_header)).fdoffset_blockmap / (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize)
		aablk_cnt = ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper)).fds_clusters_per_group) * ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdgroup_desc_count)
		for *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) != 0 && aablk_cnt > ppuint64(0) {
			ccv9 = aablk
			aablk = aablk + 1
			aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdimage_io, ccv9, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
			if aaretval != 0 {
				goto ppcleanup
			}
			aacnt = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize << ppint32(3)
			if ppuint64(aacnt) > aablk_cnt {
				aacnt = ppuint32(aablk_cnt)
			}
			aaretval = Xext2fs_set_block_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblock_map, aablk_itr, ppuint64(aacnt), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
			if aaretval != 0 {
				goto ppcleanup
			}
			aablk_itr = aablk_itr + ppuint64(aacnt)
			aablk_cnt = aablk_cnt - ppuint64(aacnt)
		}
		goto ppcleanup
	}

	aablk_itr = aablk_itr + ppuint64(aastart)*iqlibc.ppUint64FromInt32(aablock_nbytes<<iqlibc.ppInt32FromInt32(3))

	aaino_itr = ppuint32(ppuint64(aaino_itr) + ppuint64(aastart)*iqlibc.ppUint64FromInt32(aainode_nbytes<<iqlibc.ppInt32FromInt32(3)))
	aai = aastart
	for {
		if !(aai <= aaend) {
			break
		...
		if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) != 0 {
			aablk = Xext2fs_block_bitmap_loc(cgtls, aafs1, aai)
			if aacsum_flag != 0 && Xext2fs_bg_flags_test(cgtls, aafs1, aai, ppuint16(mvEXT2_BG_BLOCK_UNINIT)) != 0 && Xext2fs_group_desc_csum_verify(cgtls, aafs1, aai) != 0 || aablk >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper) {
				aablk = ppuint64(0)
			}
			if aablk != 0 {
				aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, aablk, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
				if aaretval != 0 {
					aaretval = iqlibc.ppInt64FromInt64(2133571358)
					goto ppcleanup
				}
				/* verify block bitmap checksum */
				if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IGNORE_CSUM_ERRORS) != 0) && !(Xext2fs_block_bitmap_csum_verify(cgtls, aafs1, aai, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), aablock_nbytes) != 0) {
					aaretval = iqlibc.ppInt64FromInt64(2133571484)
					goto ppcleanup
				}
				if !(sibitmap_tail_verify(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), aablock_nbytes, iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize-ppuint32(1))) != 0) {

					*(*ppint32)(iqunsafe.ppPointer(aatail_flags)) |= ppint32(mvEXT2_FLAG_BBITMAP_TAIL_PROBLEM)
				}
			} else {
				Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)), 0, iqlibc.ppUint64FromInt32(aablock_nbytes))
			}
			aacnt = iqlibc.ppUint32FromInt32(aablock_nbytes << ppint32(3))
			siunix_pthread_mutex_lock(cgtls, aamutex)
			aaretval = Xext2fs_set_block_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblock_map, aablk_itr, ppuint64(aacnt), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
			siunix_pthread_mutex_unlock(cgtls, aamutex)
			if aaretval != 0 {
				goto ppcleanup
			}
			aablk_itr = aablk_itr + iqlibc.ppUint64FromInt32(aablock_nbytes<<ppint32(3))
		...
		if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)) != 0 {
			aablk = Xext2fs_inode_bitmap_loc(cgtls, aafs1, aai)
			if aacsum_flag != 0 && Xext2fs_bg_flags_test(cgtls, aafs1, aai, ppuint16(mvEXT2_BG_INODE_UNINIT)) != 0 && Xext2fs_group_desc_csum_verify(cgtls, aafs1, aai) != 0 || aablk >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdsuper) {
				aablk = ppuint64(0)
			}
			if aablk != 0 {
				aaretval = Xio_channel_read_blk64(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdio, aablk, ppint32(1), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
				if aaretval != 0 {
					aaretval = iqlibc.ppInt64FromInt64(2133571356)
					goto ppcleanup
				}

				/* verify inode bitmap checksum */
				if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdflags&iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IGNORE_CSUM_ERRORS) != 0) && !(Xext2fs_inode_bitmap_csum_verify(cgtls, aafs1, aai, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aainode_nbytes) != 0) {
					aaretval = iqlibc.ppInt64FromInt64(2133571475)
					goto ppcleanup
				}
				if !(sibitmap_tail_verify(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), aainode_nbytes, iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdblocksize-ppuint32(1))) != 0) {

					*(*ppint32)(iqunsafe.ppPointer(aatail_flags)) |= ppint32(mvEXT2_FLAG_IBITMAP_TAIL_PROBLEM)
				}
			} else {
				Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)), 0, iqlibc.ppUint64FromInt32(aainode_nbytes))
			}
			aacnt = iqlibc.ppUint32FromInt32(aainode_nbytes << ppint32(3))
			siunix_pthread_mutex_lock(cgtls, aamutex)
			aaretval = Xext2fs_set_inode_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs1)).fdinode_map, ppuint64(aaino_itr), ppuint64(aacnt), *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 16)))
			siunix_pthread_mutex_unlock(cgtls, aamutex)
			if aaretval != 0 {
...
func siread_bitmaps_range_end(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aatail_flags ppint32) (cgr tnerrcode_t) {
	...
	if aaflags&ppint32(mvEXT2FS_BITMAPS_BLOCK) != 0 {
		aaretval = simark_uninit_bg_group_blocks(cgtls, aafs)
		if aaretval != 0 {
			return aaretval
		}

		*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_BBITMAP_TAIL_PROBLEM)
	}
	if aaflags&ppint32(mvEXT2FS_BITMAPS_INODE) != 0 {

		*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IBITMAP_TAIL_PROBLEM)
	}

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= aatail_flags

	return 0
}

func siread_bitmaps_cleanup_on_error(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32) {
...
func siread_bitmaps_range(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aastart tndgrp_t, aaend tndgrp_t) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var pp_ /* tail_flags at bp+0 */ ppint32
	pp_ = aaretval
	*(*ppint32)(iqunsafe.ppPointer(cgbp)) = 0

	aaretval = siread_bitmaps_range_prepare(cgtls, aafs, aaflags)
	if aaretval != 0 {
		return aaretval
	}

	aaretval = siread_bitmaps_range_start(cgtls, aafs, aaflags, aastart, aaend, iqlibc.ppUintptrFromInt32(0), cgbp)
	if aaretval == 0 {
		aaretval = siread_bitmaps_range_end(cgtls, aafs, aaflags, *(*ppint32)(iqunsafe.ppPointer(cgbp)))
	}
	if aaretval != 0 {
		siread_bitmaps_cleanup_on_error(cgtls, aafs, aaflags)
	}
	return aaretval
}

type tsread_bitmaps_thread_info = struct {
	fdrbt_fs         tnext2_filsys
	fdrbt_flags      ppint32
	fdrbt_grp_start  tndgrp_t
	fdrbt_grp_end    tndgrp_t
	fdrbt_retval     tnerrcode_t
	fdrbt_mutex      ppuintptr
	fdrbt_tail_flags ppint32
}

func siread_bitmaps_thread(cgtls *iqlibc.ppTLS, aadata ppuintptr) (cgr ppuintptr) {

	var aarbt ppuintptr
	pp_ = aarbt
	aarbt = aadata

	(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_retval = siread_bitmaps_range_start(cgtls, (*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_fs, (*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_flags, (*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_grp_start, (*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_grp_end, (*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aarbt)).fdrbt_mutex, aarbt+40)
	return iqlibc.ppUintptrFromInt32(0)
}

func Xext2fs_rw_bitmaps(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaflags ppint32, aanum_threads ppint32) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(128)
	defer cgtls.ppFree(128)

	var aaaverage_group tndgrp_t
	var aaflexbg_size ppuint32
	var aai, aatail_flags, ccv1, ccv3 ppint32
	var aarc, aaretval tnerrcode_t
	var aathread_ids, aathread_infos ppuintptr
	var pp_ /* attr at bp+0 */ tnpthread_attr_t
	var pp_ /* rbt_mutex at bp+64 */ tnpthread_mutex_t
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaaverage_group, aaflexbg_size, aai, aarc, aaretval, aatail_flags, aathread_ids, aathread_infos, ccv1, ccv3
	aathread_ids = iqlibc.ppUintptrFromInt32(0)
	aathread_infos = iqlibc.ppUintptrFromInt32(0)
	*(*tnpthread_mutex_t)(iqunsafe.ppPointer(cgbp + 64)) = tnpthread_mutex_t{
		fd__sig: ppint64(mv_PTHREAD_MUTEX_SIG_init),
	}
	aaflexbg_size = ppuint32(1) << (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_log_groups_per_flex
	aatail_flags = 0

	if aaflags & ^iqlibc.ppInt32FromInt32(mvEXT2FS_BITMAPS_VALID_FLAGS) != 0 {
...
cg_2:
	...
	if aaflags&ppint32(mvEXT2FS_BITMAPS_WRITE) != 0 {
		return siwrite_bitmaps(cgtls, aafs, aaflags&ppint32(mvEXT2FS_BITMAPS_INODE), aaflags&ppint32(mvEXT2FS_BITMAPS_BLOCK))
	}

	if (*tsstruct_io_channel)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio)).fdflags&ppuint32(mvCHANNEL_FLAGS_THREADS) == ppuint32(0) || aanum_threads == ppint32(1) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags&ppint32(mvEXT2_FLAG_IMAGE_FILE) != 0 {
		goto ppfallback
	}

	if aanum_threads < 0 {
		aanum_threads = ppint32(Xsysconf(cgtls, ppint32(mv_SC_NPROCESSORS_CONF)))
	}
	/*
	 ...
	 */
	if aanum_threads <= 0 {
		aanum_threads = ppint32(4)
	}

	if iqlibc.ppUint32FromInt32(aanum_threads) > (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count {
		aanum_threads = iqlibc.ppInt32FromUint32((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count)
	}
	aaaverage_group = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count / iqlibc.ppUint32FromInt32(aanum_threads)
	ccv1 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_incompat&ppuint32(mvEXT4_FEATURE_INCOMPAT_FLEX_BG) != ppuint32(0))
	goto cg_4
cg_4:
	if ccv1 != 0 {
		aaaverage_group = aaaverage_group / aaflexbg_size * aaflexbg_size
	}
	if aanum_threads <= ppint32(1) || aaaverage_group == ppuint32(0) {
		goto ppfallback
	}

	Xio_channel_set_options(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, "cache=off\x00")
	aaretval = ppint64(Xpthread_attr_init(cgtls, cgbp))
	if aaretval != 0 {
		return aaretval
	}

	aathread_ids = Xcalloc(cgtls, ppuint64(8), iqlibc.ppUint64FromInt32(aanum_threads))
	if !(aathread_ids != 0) {
		return ppint64(mvENOMEM)
	}

	aathread_infos = Xcalloc(cgtls, ppuint64(48), iqlibc.ppUint64FromInt32(aanum_threads))
	if !(aathread_infos != 0) {
		goto ppout
	}
	...
	aai = 0
	for {
		if !(aai < aanum_threads) {
			break
		}
		(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_fs = aafs
		(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_flags = aaflags
		(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_mutex = cgbp + 64
		(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_tail_flags = 0
		if aai == 0 {
			(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_grp_start = ppuint32(0)
		} else {
			(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_grp_start = aaaverage_group*iqlibc.ppUint32FromInt32(aai) + ppuint32(1)
		}

		if aai == aanum_threads-ppint32(1) {
			(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_grp_end = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count - ppuint32(1)
		} else {
			(*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_grp_end = aaaverage_group * iqlibc.ppUint32FromInt32(aai+iqlibc.ppInt32FromInt32(1))
		}
		aaretval = ppint64(Xpthread_create(cgtls, aathread_ids+ppuintptr(aai)*8, cgbp, pp__ccgo_fp(siread_bitmaps_thread), aathread_infos+ppuintptr(aai)*48))
		if aaretval != 0 {
			break
		}
	...
	for {
		...
		if !(*(*tnpthread_t)(iqunsafe.ppPointer(aathread_ids + ppuintptr(aai)*8)) != 0) {
			break
		}
		aarc = ppint64(Xpthread_join(cgtls, *(*tnpthread_t)(iqunsafe.ppPointer(aathread_ids + ppuintptr(aai)*8)), iqlibc.ppUintptrFromInt32(0)))
		if aarc != 0 && !(aaretval != 0) {
			aaretval = aarc
		}
		aarc = (*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_retval
		if aarc != 0 && !(aaretval != 0) {
			aaretval = aarc
		}
		aatail_flags = aatail_flags | (*(*tsread_bitmaps_thread_info)(iqunsafe.ppPointer(aathread_infos + ppuintptr(aai)*48))).fdrbt_tail_flags
...
ppout:
	;
	aarc = ppint64(Xpthread_attr_destroy(cgtls, cgbp))
	if aarc != 0 && !(aaretval != 0) {
		aaretval = aarc
	}
	Xfree(cgtls, aathread_infos)
	Xfree(cgtls, aathread_ids)

	if aaretval == 0 {
		aaretval = siread_bitmaps_range_end(cgtls, aafs, aaflags, aatail_flags)
	}
	if aaretval != 0 {
		siread_bitmaps_cleanup_on_error(cgtls, aafs, aaflags)
	}
	/* XXX should save and restore cache setting */
	Xio_channel_set_options(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdio, "cache=on\x00")
	return aaretval
	goto ppfallback
ppfallback:
	;
	return siread_bitmaps_range(cgtls, aafs, aaflags, ppuint32(0), (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdgroup_desc_count-ppuint32(1))
	return cgr
}

func Xext2fs_read_inode_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return Xext2fs_rw_bitmaps(cgtls, aafs, ppint32(mvEXT2FS_BITMAPS_INODE), -ppint32(1))
}

func Xext2fs_read_block_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return Xext2fs_rw_bitmaps(cgtls, aafs, ppint32(mvEXT2FS_BITMAPS_BLOCK), -ppint32(1))
}

func Xext2fs_write_inode_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return siwrite_bitmaps(cgtls, aafs, ppint32(1), 0)
}

func Xext2fs_write_block_bitmap(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {

	return siwrite_bitmaps(cgtls, aafs, 0, ppint32(1))
}

func Xext2fs_read_bitmaps(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr tnerrcode_t) {
	...
	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdinode_map != 0) {
		aaflags = aaflags | ppint32(mvEXT2FS_BITMAPS_INODE)
	}
	if !((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_map != 0) {
		aaflags = aaflags | ppint32(mvEXT2FS_BITMAPS_BLOCK)
	}
	if aaflags == 0 {
		return 0
	}
	return Xext2fs_rw_bitmaps(cgtls, aafs, aaflags, -ppint32(1))
}

func Xext2fs_write_bitmaps(cgtls *iqlibc.ppTLS, aafs2 tnext2_filsys) (cgr tnerrcode_t) {

	var aado_block, aado_inode, ccv1, ccv4 ppint32
	var ccv3, ccv6 ppbool
	pp_, pp_, pp_, pp_, pp_, pp_ = aado_block, aado_inode, ccv1, ccv3, ccv4, ccv6
	if ccv3 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdinode_map != 0; ccv3 {
		ccv1 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdflags & ppint32(mvEXT2_FLAG_IB_DIRTY)
		goto cg_2
	cg_2:
	}
	aado_inode = iqlibc.ppBoolInt32(ccv3 && ccv1 != 0)
	if ccv6 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_map != 0; ccv6 {
		ccv4 = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdflags & ppint32(mvEXT2_FLAG_BB_DIRTY)
		goto cg_5
	cg_5:
	}
	aado_block = iqlibc.ppBoolInt32(ccv6 && ccv4 != 0)

	if !(aado_inode != 0) && !(aado_block != 0) {
		return 0
	}

	return siwrite_bitmaps(cgtls, aafs2, aado_inode, aado_block)
}
...
func _ext2fs_block_bitmap_csum_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppint32) ppint64

func _ext2fs_block_bitmap_csum_verify(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppint32) ppint32

func _ext2fs_block_bitmap_loc(*iqlibc.ppTLS, ppuintptr, ppuint32) ppuint64

func _ext2fs_blocks_count(*iqlibc.ppTLS, ppuintptr) ppuint64

func _ext2fs_free_block_bitmap(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_free_inode_bitmap(*iqlibc.ppTLS, ppuintptr)

func _ext2fs_get_block_bitmap_range2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppuintptr) ppint64

func _ext2fs_get_inode_bitmap_range2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppuintptr) ppint64

func _ext2fs_group_desc_csum_set(*iqlibc.ppTLS, ppuintptr, ppuint32)

func _ext2fs_group_desc_csum_verify(*iqlibc.ppTLS, ppuintptr, ppuint32) ppint32

func _ext2fs_inode_bitmap_csum_set(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppint32) ppint64

func _ext2fs_inode_bitmap_csum_verify(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr, ppint32) ppint32

func _ext2fs_inode_bitmap_loc(*iqlibc.ppTLS, ppuintptr, ppuint32) ppuint64
...
func _ext2fs_reserve_super_and_bgd(*iqlibc.ppTLS, ppuintptr, ppuint32, ppuintptr) ppint32

func _ext2fs_set_bit(*iqlibc.ppTLS, ppuint32, ppuintptr) ppint32

func _ext2fs_set_block_bitmap_range2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppuintptr) ppint64

func _ext2fs_set_inode_bitmap_range2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64, ppuintptr) ppint64
...
func _pthread_attr_destroy(*iqlibc.ppTLS, ppuintptr) ppint32

func _pthread_attr_init(*iqlibc.ppTLS, ppuintptr) ppint32

func _pthread_create(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr, ppuintptr) ppint32

func _pthread_join(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32
