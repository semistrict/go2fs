...
func Xext2fs_get_mem(cgtls *iqlibc.ppTLS, aasize ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	var pp_ /* pp at bp+0 */ ppuintptr
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, aasize)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	Xmemcpy(cgtls, aaptr, cgbp, ppuint64(8))
	return 0
}

func Xext2fs_get_memzero(cgtls *iqlibc.ppTLS, aasize ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	var pp_ /* pp at bp+0 */ ppuintptr
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xmalloc(cgtls, aasize)
	...
	Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), 0, aasize)
	Xmemcpy(cgtls, aaptr, cgbp, ppuint64(8))
	return 0
}

func Xext2fs_get_array(cgtls *iqlibc.ppTLS, aacount ppuint64, aasize ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	if aacount != 0 && ^iqlibc.ppUint64FromUint64(0)/aacount < aasize {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	return Xext2fs_get_mem(cgtls, aacount*aasize, aaptr)
}

func Xext2fs_get_arrayzero(cgtls *iqlibc.ppTLS, aacount ppuint64, aasize ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	if aacount != 0 && ^iqlibc.ppUint64FromUint64(0)/aacount < aasize {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	return Xext2fs_get_memzero(cgtls, aacount*aasize, aaptr)
}

func Xext2fs_free_mem(cgtls *iqlibc.ppTLS, aaptr ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	var pp_ /* p at bp+0 */ ppuintptr
	Xmemcpy(cgtls, cgbp, aaptr, ppuint64(8))
...
func Xext2fs_resize_mem(cgtls *iqlibc.ppTLS, aaold_size ppuint64, aasize ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	var pp_ /* p at bp+0 */ ppuintptr
	Xmemcpy(cgtls, cgbp, aaptr, ppuint64(8))
	*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) = Xrealloc(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp)), aasize)
	if !(*(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0) {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	Xmemcpy(cgtls, aaptr, cgbp, ppuint64(8))
...
func Xext2fs_resize_array(cgtls *iqlibc.ppTLS, aasize ppuint64, aaold_count ppuint64, aacount ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)
	var aaold_size ppuint64
	var aaretval tnerrcode_t
	var pp_ /* p at bp+0 */ ppuintptr
	pp_, pp_ = aaold_size, aaretval
	if aacount != 0 && ^iqlibc.ppUint64FromUint64(0)/aacount < aasize {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	aasize = aasize * aacount
	aaold_size = aasize * aaold_count
	aaretval = Xext2fs_resize_mem(cgtls, aaold_size, aasize, aaptr)
	if aaretval != 0 {
		return aaretval
	}
	if aasize > aaold_size {
		Xmemcpy(cgtls, cgbp, aaptr, ppuint64(8))
		Xmemset(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(cgbp))+ppuintptr(aaold_size), 0, aasize-aaold_size)
		Xmemcpy(cgtls, aaptr, cgbp, ppuint64(8))
	}
	return 0
}

func Xext2fs_mark_super_dirty(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_mark_changed(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= ppint32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_test_changed(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr ppint32) {
	return (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags & ppint32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_mark_valid(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= ppint32(mvEXT2_FLAG_VALID)
}

func Xext2fs_unmark_valid(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) &= ^iqlibc.ppInt32FromInt32(mvEXT2_FLAG_VALID)
}

func Xext2fs_test_valid(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr ppint32) {
	return (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags & ppint32(mvEXT2_FLAG_VALID)
}

func Xext2fs_mark_ib_dirty(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_mark_bb_dirty(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) {

	*(*ppint32)(iqunsafe.ppPointer(aafs + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_BB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_test_ib_dirty(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr ppint32) {
	return (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags & ppint32(mvEXT2_FLAG_IB_DIRTY)
}

func Xext2fs_test_bb_dirty(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr ppint32) {
	return (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdflags & ppint32(mvEXT2_FLAG_BB_DIRTY)
}

func Xext2fs_group_of_blk(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablk tnblk_t) (cgr tndgrp_t) {
	return Xext2fs_group_of_blk2(cgtls, aafs, ppuint64(aablk))
}

func Xext2fs_group_of_ino(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t) (cgr tndgrp_t) {
	return (aaino - ppuint32(1)) / (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_inodes_per_group
}

func Xext2fs_group_first_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk_t) {
	return ppuint32(Xext2fs_group_first_block2(cgtls, aafs, aagroup))
}

func Xext2fs_group_last_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aagroup tndgrp_t) (cgr tnblk_t) {
	return ppuint32(Xext2fs_group_last_block2(cgtls, aafs, aagroup))
}

func Xext2fs_inode_data_blocks(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aainode ppuintptr) (cgr tnblk_t) {
	return ppuint32(Xext2fs_inode_data_blocks2(cgtls, aafs, aainode))
}

func Xext2fs_htree_intnode_maxrecs(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablocks ppint32) (cgr ppint32) {

	var aacsum_size ppint32
	pp_ = aacsum_size
	aacsum_size = 0
	if (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_METADATA_CSUM) != ppuint32(0) {
		aacsum_size = ppint32(8)
	}
	return iqlibc.ppInt32FromUint64(iqlibc.ppUint64FromInt32(aablocks) * (ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize-iqlibc.ppUint32FromInt32(iqlibc.ppInt32FromInt32(8)+aacsum_size)) / ppuint64(8)))
}

func Xext2fs_log2_u32(cgtls *iqlibc.ppTLS, aaarg tn__u32) (cgr ppint32) {

	var aal ppint32
	pp_ = aal
	aal = 0
	aaarg = aaarg >> ppuint32(1)
	for aaarg != 0 {
		aal = aal + 1
		aaarg = aaarg >> ppuint32(1)
	}
...
func Xext2fs_log2_u64(cgtls *iqlibc.ppTLS, aaarg tn__u64) (cgr ppint32) {

	var aal ppint32
	pp_ = aal
	aal = 0
	aaarg = aaarg >> ppuint64(1)
	for aaarg != 0 {
		aal = aal + 1
		aaarg = aaarg >> ppuint64(1)
	}
...
func Xext2fs_log10_u32(cgtls *iqlibc.ppTLS, aaarg tn__u32) (cgr ppint32) {

	var aal ppint32
	pp_ = aal
	aal = 0
	aaarg = aaarg / ppuint32(10)
	for aaarg != 0 {
		aal = aal + 1
		aaarg = aaarg / ppuint32(10)
	}
...
func Xext2fs_log10_u64(cgtls *iqlibc.ppTLS, aaarg tn__u64) (cgr ppint32) {

	var aal ppint32
	pp_ = aal
	aal = 0
	aaarg = aaarg / ppuint64(10)
	for aaarg != 0 {
		aal = aal + 1
		aaarg = aaarg / ppuint64(10)
	}
...
func Xext2fs_div_ceil(cgtls *iqlibc.ppTLS, aaa ppuint32, aab ppuint32) (cgr ppuint32) {
	if !(aaa != 0) {
		return ppuint32(0)
	}
	return (aaa-ppuint32(1))/aab + ppuint32(1)
}

func Xext2fs_div64_ceil(cgtls *iqlibc.ppTLS, aaa tn__u64, aab tn__u64) (cgr tn__u64) {
	if !(aaa != 0) {
		return ppuint64(0)
	}
	return (aaa-ppuint64(1))/aab + ppuint64(1)
}

func Xext2fs_dirent_name_len(cgtls *iqlibc.ppTLS, aaentry ppuintptr) (cgr ppint32) {
	return iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len) & ppint32(0xff)
}

func Xext2fs_dirent_set_name_len(cgtls *iqlibc.ppTLS, aaentry ppuintptr, aalen ppint32) {
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len)&ppint32(0xff00) | aalen&ppint32(0xff))
}

func Xext2fs_dirent_file_type(cgtls *iqlibc.ppTLS, aaentry ppuintptr) (cgr ppint32) {
	return iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len) >> ppint32(8)
}

func Xext2fs_dirent_set_file_type(cgtls *iqlibc.ppTLS, aaentry ppuintptr, aatype ppint32) {
	(*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len = iqlibc.ppUint16FromInt32(iqlibc.ppInt32FromUint16((*tsext2_dir_entry)(iqunsafe.ppPointer(aaentry)).fdname_len)&ppint32(0xff) | aatype<<ppint32(8))
}

func Xext2fs_inode(cgtls *iqlibc.ppTLS, aalarge_inode ppuintptr) (cgr ppuintptr) {
	return aalarge_inode
}

func Xext2fs_const_inode(cgtls *iqlibc.ppTLS, aalarge_inode ppuintptr) (cgr ppuintptr) {
	return aalarge_inode
}

func Xext2fs_inodes_per_orphan_block(cgtls *iqlibc.ppTLS, aafs tnext2_filsys) (cgr ppint32) {
	return iqlibc.ppInt32FromUint64((ppuint64((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) - ppuint64(8)) / ppuint64(4))
}

func Xext2fs_orphan_block_tail(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aabuf ppuintptr) (cgr ppuintptr) {
	return aabuf + ppuintptr((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblocksize) - iqlibc.ppUintptrFromInt64(8)
}
...
//	 */
func Xext2fs_get_memalign(cgtls *iqlibc.ppTLS, aasize ppuint64, aaalign ppuint64, aaptr ppuintptr) (cgr tnerrcode_t) {

	var aap ppuintptr
	var aaretval tnerrcode_t
	pp_, pp_ = aap, aaretval
	aaretval = 0
	aap = aaptr

	if aaalign < ppuint64(8) {
		aaalign = ppuint64(8)
	}
	aaretval = ppint64(Xposix_memalign(cgtls, aap, aaalign, aasize))
	if aaretval == ppint64(mvENOMEM) {
		return iqlibc.ppInt64FromInt64(2133571398)
	}
	return aaretval
}
...
func _ext2fs_inode_data_blocks2(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppuint64
...
func _posix_memalign(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint64) ppint32
