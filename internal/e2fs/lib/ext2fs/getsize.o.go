...
func sivalid_offset(cgtls *iqlibc.ppTLS, aafd ppint32, aaoffset tnext2_loff_t) (cgr ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var pp_ /* ch at bp+0 */ ppint8

	if Xext2fs_llseek(cgtls, aafd, aaoffset, 0) < 0 {
		return 0
	}
...
//	 */
func Xext2fs_get_device_size2(cgtls *iqlibc.ppTLS, aafile ppuintptr, aablocksize ppint32, aaretblocks ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(176)
	defer cgtls.ppFree(176)

	var aafd, aarc ppint32
	var aahigh, aalow, aamid tnext2_loff_t
	var pp_ /* size at bp+8 */ ppuint32
	var pp_ /* size64 at bp+0 */ ppuint64
	var pp_ /* st at bp+16 */ tnext2fs_struct_stat
	pp_, pp_, pp_, pp_, pp_ = aafd, aahigh, aalow, aamid, aarc
	aarc = 0

	aafd = Xext2fs_open_file(cgtls, aafile, mvO_RDONLY, ppuint16(0))
	if aafd < 0 {
	...
	if Xioctl(cgtls, aafd, ppuint64(iqlibc.ppUint32FromInt32(0x40000000))|iqlibc.ppUint64FromInt64(8)&iqlibc.ppUint64FromInt32(mvIOCPARM_MASK)<<iqlibc.ppInt32FromInt32(16)|iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromUint8('d')<<iqlibc.ppInt32FromInt32(8))|iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(25)), iqlibc.ppVaList(cgbp+168, cgbp)) >= 0 && Xioctl(cgtls, aafd, ppuint64(iqlibc.ppUint32FromInt32(0x40000000))|iqlibc.ppUint64FromInt64(4)&iqlibc.ppUint64FromInt32(mvIOCPARM_MASK)<<iqlibc.ppInt32FromInt32(16)|iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromUint8('d')<<iqlibc.ppInt32FromInt32(8))|iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(24)), iqlibc.ppVaList(cgbp+168, cgbp+8)) >= 0 {
		*(*tnblk64_t)(iqunsafe.ppPointer(aaretblocks)) = *(*ppuint64)(iqunsafe.ppPointer(cgbp)) * ppuint64(*(*ppuint32)(iqunsafe.ppPointer(cgbp + 8))) / iqlibc.ppUint64FromInt32(aablocksize)
		goto ppout
	}

	if Xext2fs_fstat(cgtls, aafd, cgbp+16) == 0 {
		if iqlibc.ppInt32FromUint16((*(*tnext2fs_struct_stat)(iqunsafe.ppPointer(cgbp + 16))).fdst_mode)&ppint32(mvS_IFMT) == ppint32(mvS_IFREG) {
			*(*tnblk64_t)(iqunsafe.ppPointer(aaretblocks)) = iqlibc.ppUint64FromInt64((*(*tnext2fs_struct_stat)(iqunsafe.ppPointer(cgbp + 16))).fdst_size / ppint64(aablocksize))
			goto ppout
		}
	}
	...
	sivalid_offset(cgtls, aafd, 0)
	*(*ppuint64)(iqunsafe.ppPointer(cgbp)) = iqlibc.ppUint64FromInt64(aalow + ppint64(1))
	*(*tnblk64_t)(iqunsafe.ppPointer(aaretblocks)) = *(*ppuint64)(iqunsafe.ppPointer(cgbp)) / iqlibc.ppUint64FromInt32(aablocksize)
	goto ppout
ppout:
	;
	Xclose(cgtls, aafd)
...
func Xext2fs_get_device_size(cgtls *iqlibc.ppTLS, aafile ppuintptr, aablocksize ppint32, aaretblocks ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aaretval tnerrcode_t
	var pp_ /* blocks at bp+0 */ tnblk64_t
	pp_ = aaretval

	aaretval = Xext2fs_get_device_size2(cgtls, aafile, aablocksize, cgbp)
	if aaretval != 0 {
		return aaretval
	}
	if *(*tnblk64_t)(iqunsafe.ppPointer(cgbp)) >= iqlibc.ppUint64FromUint64(1)<<iqlibc.ppInt32FromInt32(32) {
		return ppint64(mvEFBIG)
	}
	*(*tnblk_t)(iqunsafe.ppPointer(aaretblocks)) = ppuint32(*(*tnblk64_t)(iqunsafe.ppPointer(cgbp)))
	return 0
}
