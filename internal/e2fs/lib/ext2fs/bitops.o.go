...
func Xext2fs_set_bit(cgtls *iqlibc.ppTLS, aanr ppuint32, aaaddr ppuintptr) (cgr ppint32) {

	var aaADDR, ccv1 ppuintptr
	var aamask, aaretval ppint32
	pp_, pp_, pp_, pp_ = aaADDR, aamask, aaretval, ccv1
	aaADDR = aaaddr

	aaADDR = aaADDR + ppuintptr(aanr>>ppint32(3))
	aamask = ppint32(1) << (aanr & ppuint32(0x07))
	aaretval = aamask & iqlibc.ppInt32FromUint8(*(*ppuint8)(iqunsafe.ppPointer(aaADDR)))

	ccv1 = aaADDR
	*(*ppuint8)(iqunsafe.ppPointer(ccv1)) = ppuint8(ppint32(*(*ppuint8)(iqunsafe.ppPointer(ccv1))) | aamask)
	return aaretval
}

func Xext2fs_clear_bit(cgtls *iqlibc.ppTLS, aanr ppuint32, aaaddr ppuintptr) (cgr ppint32) {
...
func Xext2fs_test_bit(cgtls *iqlibc.ppTLS, aanr ppuint32, aaaddr ppuintptr) (cgr ppint32) {

	var aaADDR ppuintptr
	var aamask ppint32
	pp_, pp_ = aaADDR, aamask
	aaADDR = aaaddr

	aaADDR = aaADDR + ppuintptr(aanr>>ppint32(3))
	aamask = ppint32(1) << (aanr & ppuint32(0x07))
	return aamask & iqlibc.ppInt32FromUint8(*(*ppuint8)(iqunsafe.ppPointer(aaADDR)))
}

func Xext2fs_warn_bitmap(cgtls *iqlibc.ppTLS, aaerrcode tnerrcode_t, aaarg ppuint64, aadescription ppuintptr) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	if aadescription != 0 {
		Xcom_err(cgtls, ppuintptr(0), aaerrcode, "#%lu for %s\x00", iqlibc.ppVaList(cgbp+8, aaarg, aadescription))
	} else {
		Xcom_err(cgtls, ppuintptr(0), aaerrcode, "#%lu\x00", iqlibc.ppVaList(cgbp+8, aaarg))
	}
}

/* Bitmap functions that take a 64-bit offset */

func Xext2fs_set_bit64(cgtls *iqlibc.ppTLS, aanr tn__u64, aaaddr ppuintptr) (cgr ppint32) {
	...
	aaADDR = aaADDR + ppuintptr(aanr>>ppint32(3))
	aamask = ppint32(1) << (aanr & ppuint64(0x07))
	aaretval = aamask & iqlibc.ppInt32FromUint8(*(*ppuint8)(iqunsafe.ppPointer(aaADDR)))
...
func Xext2fs_clear_bit64(cgtls *iqlibc.ppTLS, aanr tn__u64, aaaddr ppuintptr) (cgr ppint32) {
...
func Xext2fs_test_bit64(cgtls *iqlibc.ppTLS, aanr tn__u64, aaaddr ppuintptr) (cgr ppint32) {
...
func sipopcount8(cgtls *iqlibc.ppTLS, aaw ppuint32) (cgr ppuint32) {

	var aares ppuint32
	pp_ = aares
	aares = aaw - aaw>>ppint32(1)&ppuint32(0x55)
	aares = aares&ppuint32(0x33) + aares>>ppint32(2)&ppuint32(0x33)
	return (aares + aares>>ppint32(4)) & ppuint32(0x0F)
}

func sipopcount32(cgtls *iqlibc.ppTLS, aaw ppuint32) (cgr ppuint32) {

	var aares ppuint32
	pp_ = aares
	aares = aaw - aaw>>ppint32(1)&ppuint32(0x55555555)
	aares = aares&ppuint32(0x33333333) + aares>>ppint32(2)&ppuint32(0x33333333)
	aares = (aares + aares>>ppint32(4)) & ppuint32(0x0F0F0F0F)
	aares = aares + aares>>ppint32(8)
	return (aares + aares>>ppint32(16)) & ppuint32(0x000000FF)
}

func Xext2fs_bitcount(cgtls *iqlibc.ppTLS, aaaddr ppuintptr, aanbytes ppuint32) (cgr ppuint32) {

	var aacp, aap, ccv1, ccv2, ccv3 ppuintptr
	var aares ppuint32
	pp_, pp_, pp_, pp_, pp_, pp_ = aacp, aap, aares, ccv1, ccv2, ccv3
	aacp = aaaddr
	aares = ppuint32(0)

	for ppuint64(aacp)&ppuint64(3) != ppuint64(0) && aanbytes > ppuint32(0) {
		ccv1 = aacp
		aacp = aacp + 1
		aares = aares + sipopcount8(cgtls, ppuint32(*(*ppuint8)(iqunsafe.ppPointer(ccv1))))
		aanbytes = aanbytes - 1
	}
	aap = aacp

	for aanbytes > ppuint32(4) {
		ccv1 = aap
		aap += 4
		aares = aares + sipopcount32(cgtls, *(*tn__u32)(iqunsafe.ppPointer(ccv1)))
		aanbytes = aanbytes - ppuint32(4)
	}
	aacp = aap
