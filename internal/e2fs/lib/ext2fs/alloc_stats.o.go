...
func Xext2fs_inode_alloc_stats2(cgtls *iqlibc.ppTLS, aafs4 tnext2_filsys, aaino1 tnext2_ino_t, aainuse ppint32, aaisdir ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aafirst_unused_inode tnext2_ino_t
	var aagroup, ccv10, ccv6, ccv8 ppint32
	var ccv1 tndgrp_t
	var ccv12 ppbool
	var ccv5 tnext2_filsys
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aafirst_unused_inode, aagroup, ccv1, ccv10, ccv12, ccv5, ccv6, ccv8
	ccv1 = (aaino1 - ppuint32(1)) / (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_per_group
	goto cg_2
cg_2:
	aagroup = iqlibc.ppInt32FromUint32(ccv1)

	if aaino1 > (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_count {
		Xcom_err(cgtls, "ext2fs_inode_alloc_stats2\x00", 0, "Illegal inode number: %lu\x00", iqlibc.ppVaList(cgbp+8, ppuint64(aaino1)))
		return
	}
	if aainuse > 0 {
		pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdinode_map, ppuint64(aaino1))
		goto cg_3
	cg_3:
	} else {
		pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdinode_map, ppuint64(aaino1))
		goto cg_4
	cg_4:
	}
	Xext2fs_bg_free_inodes_count_set(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup), Xext2fs_bg_free_inodes_count(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup))-iqlibc.ppUint32FromInt32(aainuse))
	if aaisdir != 0 {
		Xext2fs_bg_used_dirs_count_set(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup), Xext2fs_bg_used_dirs_count(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup))+iqlibc.ppUint32FromInt32(aainuse))
	}

	/* We don't strictly need to be clearing the uninit flag if inuse < 0
	 * (i.e. freeing inodes) but it also means something is bad. */
	Xext2fs_bg_flags_clear(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup), ppuint16(mvEXT2_BG_INODE_UNINIT))
	ccv5 = aafs4
	ccv8 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv5)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_METADATA_CSUM) != ppuint32(0))
	goto cg_9
cg_9:
	;
	if ccv12 = ccv8 != 0; !ccv12 {
		ccv10 = iqlibc.ppBoolInt32((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(ccv5)).fdsuper)).fds_feature_ro_compat&ppuint32(mvEXT4_FEATURE_RO_COMPAT_GDT_CSUM) != ppuint32(0))
		goto cg_11
	cg_11:
	}
	ccv6 = iqlibc.ppBoolInt32(ccv12 || ccv10 != 0)
	goto cg_7
cg_7:
	if ccv6 != 0 {
		aafirst_unused_inode = (*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_per_group - Xext2fs_bg_itable_unused(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup)) + iqlibc.ppUint32FromInt32(aagroup)*(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_per_group + ppuint32(1)

		if aaino1 >= aafirst_unused_inode {
			Xext2fs_bg_itable_unused_set(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup), iqlibc.ppUint32FromInt32(aagroup)*(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_per_group+(*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper)).fds_inodes_per_group-aaino1)
		}
		Xext2fs_group_desc_csum_set(cgtls, aafs4, iqlibc.ppUint32FromInt32(aagroup))
	}

	*(*tn__u32)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs4)).fdsuper + 16)) -= iqlibc.ppUint32FromInt32(aainuse)

	*(*ppint32)(iqunsafe.ppPointer(aafs4 + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)

	*(*ppint32)(iqunsafe.ppPointer(aafs4 + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_IB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
}

func Xext2fs_inode_alloc_stats(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aaino tnext2_ino_t, aainuse ppint32) {

	Xext2fs_inode_alloc_stats2(cgtls, aafs, aaino, aainuse, 0)
}

func Xext2fs_block_alloc_stats2(cgtls *iqlibc.ppTLS, aafs2 tnext2_filsys, aablk tnblk64_t, aainuse ppint32) {
	cgbp := cgtls.ppAlloc(16)
	defer cgtls.ppFree(16)

	var aagroup ppint32
	pp_ = aagroup
	aagroup = iqlibc.ppInt32FromUint32(Xext2fs_group_of_blk2(cgtls, aafs2, aablk))

	if aablk < ppuint64((*tsext2_super_block)(iqunsafe.ppPointer((*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdsuper)).fds_first_data_block) || aablk >= Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdsuper) {
		Xcom_err(cgtls, "ext2fs_block_alloc_stats\x00", 0, "Illegal block number: %lu\x00", iqlibc.ppVaList(cgbp+8, ppuint64(aablk)))
		return
	}
	if aainuse > 0 {
		pp_ = Xext2fs_mark_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_map, aablk)
		goto cg_1
	cg_1:
	} else {
		pp_ = Xext2fs_unmark_generic_bmap(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_map, aablk)
		goto cg_2
	cg_2:
	}
	Xext2fs_bg_free_blocks_count_set(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup), Xext2fs_bg_free_blocks_count(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup))-iqlibc.ppUint32FromInt32(aainuse))
	Xext2fs_bg_flags_clear(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup), ppuint16(mvEXT2_BG_BLOCK_UNINIT))
	Xext2fs_group_desc_csum_set(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup))

	Xext2fs_free_blocks_count_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdsuper, iqlibc.ppUint64FromInt32(-aainuse)*iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdcluster_ratio_bits))
	...
	*(*ppint32)(iqunsafe.ppPointer(aafs2 + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_BB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_alloc_stats != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, tnblk64_t, ppint32))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_alloc_stats})))(cgtls, aafs2, aablk, aainuse)
	}
}

func Xext2fs_block_alloc_stats(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aablk tnblk_t, aainuse ppint32) {

	Xext2fs_block_alloc_stats2(cgtls, aafs, ppuint64(aablk), aainuse)
}

type tn__ccgo_fp__Xext2fs_set_block_alloc_stats_callback_1 = func(*iqlibc.ppTLS, ppuintptr, ppuint64, ppint32)

type tn__ccgo_fp__Xext2fs_set_block_alloc_stats_callback_2 = func(*iqlibc.ppTLS, ppuintptr, ppuint64, ppint32)

func Xext2fs_set_block_alloc_stats_callback(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aa__ccgo_fp_func ppuintptr, aa__ccgo_fp_old ppuintptr) {

	if !(aafs != 0) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return
	}
	if aa__ccgo_fp_old != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aa__ccgo_fp_old)) = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_alloc_stats
	}

	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_alloc_stats = aa__ccgo_fp_func
}

func Xext2fs_block_alloc_stats_range(cgtls *iqlibc.ppTLS, aafs2 tnext2_filsys, aablk tnblk64_t, aanum tnblk_t, aainuse ppint32) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aagroup ppint32
	var aalast_blk, aan, aaorig_blk tnblk64_t
	var aaorig_num tnblk_t
	pp_, pp_, pp_, pp_, pp_ = aagroup, aalast_blk, aan, aaorig_blk, aaorig_num
	aaorig_blk = aablk
	aaorig_num = aanum

	if aablk+ppuint64(aanum) > Xext2fs_blocks_count(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdsuper) {
		Xcom_err(cgtls, "ext2fs_block_alloc_stats_range\x00", 0, "Illegal block range: %llu (%u) \x00", iqlibc.ppVaList(cgbp+8, aablk, aanum))
		return
	}
	if aainuse == 0 {
		return
	...
	if aainuse > 0 {
		Xext2fs_mark_block_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_map, aablk, aanum)
		aainuse = ppint32(1)
	} else {
		Xext2fs_unmark_block_bitmap_range2(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_map, aablk, aanum)
		aainuse = -ppint32(1)
	}
	for aanum != 0 {
		aagroup = iqlibc.ppInt32FromUint32(Xext2fs_group_of_blk2(cgtls, aafs2, aablk))
		aalast_blk = Xext2fs_group_last_block2(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup))
		aan = ppuint64(aanum)

		if aablk+ppuint64(aanum) > aalast_blk {
			aan = aalast_blk - aablk + ppuint64(1)
		}

		Xext2fs_bg_free_blocks_count_set(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup), ppuint32(ppuint64(Xext2fs_bg_free_blocks_count(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup)))-iqlibc.ppUint64FromInt32(aainuse)*aan/iqlibc.ppUint64FromInt32(iqlibc.ppInt32FromInt32(1)<<(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdcluster_ratio_bits)))
		Xext2fs_bg_flags_clear(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup), ppuint16(mvEXT2_BG_BLOCK_UNINIT))
		Xext2fs_group_desc_csum_set(cgtls, aafs2, iqlibc.ppUint32FromInt32(aagroup))
		Xext2fs_free_blocks_count_add(cgtls, (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdsuper, iqlibc.ppUint64FromInt32(-aainuse)*aan)
		aablk = aablk + aan

		aanum = ppuint32(ppuint64(aanum) - aan)
	}

	*(*ppint32)(iqunsafe.ppPointer(aafs2 + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)

	*(*ppint32)(iqunsafe.ppPointer(aafs2 + 16)) |= iqlibc.ppInt32FromInt32(mvEXT2_FLAG_BB_DIRTY) | iqlibc.ppInt32FromInt32(mvEXT2_FLAG_CHANGED)
	if (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_alloc_stats_range != 0 {
		(*(*func(*iqlibc.ppTLS, tnext2_filsys, tnblk64_t, tnblk_t, ppint32))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs2)).fdblock_alloc_stats_range})))(cgtls, aafs2, aaorig_blk, aaorig_num, aainuse)
	}
}

type tn__ccgo_fp__Xext2fs_set_block_alloc_stats_range_callback_1 = func(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32, ppint32)

type tn__ccgo_fp__Xext2fs_set_block_alloc_stats_range_callback_2 = func(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32, ppint32)

func Xext2fs_set_block_alloc_stats_range_callback(cgtls *iqlibc.ppTLS, aafs tnext2_filsys, aa__ccgo_fp_func ppuintptr, aa__ccgo_fp_old ppuintptr) {

	if !(aafs != 0) || (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdmagic != ppint64(2133571329) {
		return
	}
	if aa__ccgo_fp_old != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aa__ccgo_fp_old)) = (*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_alloc_stats_range
	}

	(*tsstruct_ext2_filsys)(iqunsafe.ppPointer(aafs)).fdblock_alloc_stats_range = aa__ccgo_fp_func
}
...
func _ext2fs_bg_used_dirs_count(*iqlibc.ppTLS, ppuintptr, ppuint32) ppuint32
...
func _ext2fs_unmark_block_bitmap_range2(*iqlibc.ppTLS, ppuintptr, ppuint64, ppuint32)
