...
type tnmode_t = ppuint16 /* getsubopt(3) external variable */
/* valloc is now declared in _malloc.h */

/* Poison the following routines if -fshort-wchar is set */

var sitext = [184]ppuintptr{
	0:   "EXT2FS Library version 1.47.4\x00",
	1:   "Wrong magic number for ext2_filsys structure\x00",
	2:   "Wrong magic number for badblocks_list structure\x00",
	3:   "Wrong magic number for badblocks_iterate structure\x00",
	4:   "Wrong magic number for inode_scan structure\x00",
	5:   "Wrong magic number for io_channel structure\x00",
	6:   "Wrong magic number for unix io_channel structure\x00",
	7:   "Wrong magic number for io_manager structure\x00",
	8:   "Wrong magic number for block_bitmap structure\x00",
	9:   "Wrong magic number for inode_bitmap structure\x00",
	10:  "Wrong magic number for generic_bitmap structure\x00",
	11:  "Wrong magic number for test io_channel structure\x00",
	12:  "Wrong magic number for directory block list structure\x00",
	13:  "Wrong magic number for icount structure\x00",
	14:  "Wrong magic number for Powerquest io_channel structure\x00",
	15:  "Wrong magic number for ext2 file structure\x00",
	16:  "Wrong magic number for Ext2 Image Header\x00",
	17:  "Wrong magic number for inode io_channel structure\x00",
	18:  "Wrong magic number for ext4 extent handle\x00",
	19:  "Bad magic number in super-block\x00",
	20:  "Filesystem revision too high\x00",
	21:  "Attempt to write to filesystem opened read-only\x00",
	22:  "Can't read group descriptors\x00",
	23:  "Can't write group descriptors\x00",
	24:  "Corrupt group descriptor: bad block for block bitmap\x00",
	25:  "Corrupt group descriptor: bad block for inode bitmap\x00",
	26:  "Corrupt group descriptor: bad block for inode table\x00",
	27:  "Can't write an inode bitmap\x00",
	28:  "Can't read an inode bitmap\x00",
	29:  "Can't write a block bitmap\x00",
	30:  "Can't read a block bitmap\x00",
	31:  "Can't write an inode table\x00",
	32:  "Can't read an inode table\x00",
	33:  "Can't read next inode\x00",
	34:  "Filesystem has unexpected block size\x00",
	35:  "EXT2 directory corrupted\x00",
	36:  "Attempt to read block from filesystem resulted in short read\x00",
	37:  "Attempt to write block to filesystem resulted in short write\x00",
	38:  "No free space in the directory\x00",
	39:  "Inode bitmap not loaded\x00",
	40:  "Block bitmap not loaded\x00",
	41:  "Illegal inode number\x00",
	42:  "Illegal block number\x00",
	43:  "Internal error in ext2fs_expand_dir\x00",
	44:  "Not enough space to build proposed filesystem\x00",
	45:  "Illegal block number passed to ext2fs_mark_block_bitmap\x00",
	46:  "Illegal block number passed to ext2fs_unmark_block_bitmap\x00",
	47:  "Illegal block number passed to ext2fs_test_block_bitmap\x00",
	48:  "Illegal inode number passed to ext2fs_mark_inode_bitmap\x00",
	49:  "Illegal inode number passed to ext2fs_unmark_inode_bitmap\x00",
	50:  "Illegal inode number passed to ext2fs_test_inode_bitmap\x00",
	51:  "Attempt to fudge end of block bitmap past the real end\x00",
	52:  "Attempt to fudge end of inode bitmap past the real end\x00",
	53:  "Illegal indirect block found\x00",
	54:  "Illegal doubly indirect block found\x00",
	55:  "Illegal triply indirect block found\x00",
	56:  "Block bitmaps are not the same\x00",
	57:  "Inode bitmaps are not the same\x00",
	58:  "Illegal or malformed device name\x00",
	59:  "A block group is missing an inode table\x00",
	60:  "The ext2 superblock is corrupt\x00",
	61:  "Illegal generic bit number passed to ext2fs_mark_generic_bitmap\x00",
	62:  "Illegal generic bit number passed to ext2fs_unmark_generic_bitmap\x00",
	63:  "Illegal generic bit number passed to ext2fs_test_generic_bitmap\x00",
	64:  "Too many symbolic links encountered.\x00",
	65:  "The callback function will not handle this case\x00",
	66:  "The inode is from a bad block in the inode table\x00",
	67:  "Filesystem has unsupported feature(s)\x00",
	68:  "Filesystem has unsupported read-only feature(s)\x00",
	69:  "IO Channel failed to seek on read or write\x00",
	70:  "Memory allocation failed\x00",
	71:  "Invalid argument passed to ext2 library\x00",
	72:  "Could not allocate block in ext2 filesystem\x00",
	73:  "Could not allocate inode in ext2 filesystem\x00",
	74:  "Ext2 inode is not a directory\x00",
	75:  "Too many references in table\x00",
	76:  "File not found by ext2_lookup\x00",
	77:  "File open read-only\x00",
	78:  "Ext2 directory block not found\x00",
	79:  "Ext2 directory already exists\x00",
	80:  "Unimplemented ext2 library function\x00",
	81:  "User cancel requested\x00",
	82:  "Ext2 file too big\x00",
	83:  "Supplied journal device not a block device\x00",
	84:  "Journal superblock not found\x00",
	85:  "Journal must be at least 1024 blocks\x00",
	86:  "Unsupported journal version\x00",
	87:  "Error loading external journal\x00",
	88:  "Journal not found\x00",
	89:  "Directory hash unsupported\x00",
	90:  "Illegal extended attribute block number\x00",
	91:  "Cannot create filesystem with requested number of inodes\x00",
	92:  "E2image snapshot not in use\x00",
	93:  "Too many reserved group descriptor blocks\x00",
	94:  "Resize inode is corrupt\x00",
	95:  "Tried to set block bmap with missing indirect block\x00",
	96:  "TDB: Success\x00",
	97:  "TDB: Corrupt database\x00",
	98:  "TDB: IO Error\x00",
	99:  "TDB: Locking error\x00",
	100: "TDB: Out of memory\x00",
	101: "TDB: Record exists\x00",
	102: "TDB: Lock exists on other keys\x00",
	103: "TDB: Invalid parameter\x00",
	104: "TDB: Record does not exist\x00",
	105: "TDB: Write not permitted\x00",
	106: "Ext2fs directory block list is empty\x00",
	107: "Attempt to modify a block mapping via a read-only block iterator\x00",
	108: "Wrong magic number for ext4 extent saved path\x00",
	109: "Wrong magic number for 64-bit generic bitmap\x00",
	110: "Wrong magic number for 64-bit block bitmap\x00",
	111: "Wrong magic number for 64-bit inode bitmap\x00",
	112: "Wrong magic number --- RESERVED_13\x00",
	113: "Wrong magic number --- RESERVED_14\x00",
	114: "Wrong magic number --- RESERVED_15\x00",
	115: "Wrong magic number --- RESERVED_16\x00",
	116: "Wrong magic number --- RESERVED_17\x00",
	117: "Wrong magic number --- RESERVED_18\x00",
	118: "Wrong magic number --- RESERVED_19\x00",
	119: "Corrupt extent header\x00",
	120: "Corrupt extent index\x00",
	121: "Corrupt extent\x00",
	122: "No free space in extent map\x00",
	123: "Inode does not use extents\x00",
	124: "No 'next' extent\x00",
	125: "No 'previous' extent\x00",
	126: "No 'up' extent\x00",
	127: "No 'down' extent\x00",
	128: "No current node\x00",
	129: "Ext2fs operation not supported\x00",
	130: "No room to insert extent in node\x00",
	131: "Splitting would result in empty node\x00",
	132: "Extent not found\x00",
	133: "Operation not supported for inodes containing extents\x00",
	134: "Extent length is invalid\x00",
	135: "I/O Channel does not support 64-bit block numbers\x00",
	136: "Can't check if filesystem is mounted due to missing mtab file\x00",
	137: "Filesystem too large to use legacy bitmaps\x00",
	138: "MMP: invalid magic number\x00",
	139: "MMP: device currently active\x00",
	140: "MMP: e2fsck being run\x00",
	141: "MMP: block number beyond filesystem range\x00",
	142: "MMP: undergoing an unknown operation\x00",
	143: "MMP: filesystem still in use\x00",
	144: "MMP: open with O_DIRECT failed\x00",
	145: "Block group descriptor size incorrect\x00",
	146: "Inode checksum does not match inode\x00",
	147: "Inode bitmap checksum does not match bitmap\x00",
	148: "Extent block checksum does not match extent block\x00",
	149: "Directory block does not have space for checksum\x00",
	150: "Directory block checksum does not match directory block\x00",
	151: "Extended attribute block checksum does not match block\x00",
	152: "Superblock checksum does not match superblock\x00",
	153: "Unknown checksum algorithm\x00",
	154: "MMP block checksum does not match\x00",
	155: "Ext2 file already exists\x00",
	156: "Block bitmap checksum does not match bitmap\x00",
	157: "Cannot iterate data blocks of an inode containing inline data\x00",
	158: "Extended attribute has an invalid name length\x00",
	159: "Extended attribute has an invalid value length\x00",
	160: "Extended attribute has an incorrect hash\x00",
	161: "Extended attribute block has a bad header\x00",
	162: "Extended attribute key not found\x00",
	163: "Insufficient space to store extended attribute data\x00",
	164: "Filesystem is missing ext_attr or inline_data feature\x00",
	165: "Inode doesn't have inline data\x00",
	166: "No block for an inode with inline data\x00",
	167: "No free space in inline data\x00",
	168: "Wrong magic number for extended attribute structure\x00",
	169: "Inode seems to contain garbage\x00",
	170: "Extended attribute has an invalid value offset\x00",
	171: "Journal flags inconsistent\x00",
	172: "Undo file corrupt\x00",
	173: "Wrong undo file for this filesystem\x00",
	174: "File system is corrupted\x00",
	175: "Bad CRC detected in file system\x00",
	176: "The journal superblock is corrupt\x00",
	177: "Inode is corrupted\x00",
	178: "Inode containing extended attribute value is corrupted\x00",
	179: "Group descriptors not loaded\x00",
	180: "The internal ext2_filsys data structure appears to be corrupted\x00",
	181: "Found cyclic loop in extent tree\x00",
	182: "Operation not supported on an external journal\x00",
}
...
var Xet_ext2_error_table = tserror_table{
	fdmsgs:   ppuintptr(iqunsafe.ppPointer(&sitext)),
	fdbase:   ppint64(2133571328),
	fdn_msgs: ppint32(183),
}

var silink = tset_list{}

func Xinitialize_ext2_error_table(cgtls *iqlibc.ppTLS) {

	Xinitialize_ext2_error_table_r(cgtls, ppuintptr(iqunsafe.ppPointer(&X_et_list)))
}

// C documentation
//
//	/* For Heimdal compatibility */
func Xinitialize_ext2_error_table_r(cgtls *iqlibc.ppTLS, aalist ppuintptr) {

	var aaend, aaet ppuintptr
	pp_, pp_ = aaend, aaet

	aaend = aalist
	aaet = *(*ppuintptr)(iqunsafe.ppPointer(aalist))
	for {
		if !(aaet != 0) {
			break
		}
		if (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aaet)).fdtable)).fdmsgs == ppuintptr(iqunsafe.ppPointer(&sitext)) {
			return
		}
		goto cg_1
	cg_1:
	...
	aaet = Xmalloc(cgtls, ppuint64(16))
	if aaet == ppuintptr(0) {
		if !(silink.fdtable != 0) {
			aaet = ppuintptr(iqunsafe.ppPointer(&silink))
		} else {
			return
		}
	}
	(*tset_list)(iqunsafe.ppPointer(aaet)).fdtable = ppuintptr(iqunsafe.ppPointer(&Xet_ext2_error_table))
	(*tset_list)(iqunsafe.ppPointer(aaet)).fdnext = ppuintptr(0)
	*(*ppuintptr)(iqunsafe.ppPointer(aaend)) = aaet
}

var __et_list ppuintptr
