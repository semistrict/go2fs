...
const mvEXT2_FLAG_SWAP_BYTES_READ = 128
const mvEXT2_FLAG_SWAP_BYTES_WRITE = 256
...
type tsflags_name = struct {
	fdflag ppuint64
	fdname ppuintptr
}

var siflags_array = [28]tsflags_name{
	0: {
		fdflag: ppuint64(mvEXT2_FLAG_RW),
		fdname: "EXT2_FLAG_RW\x00",
	},
	1: {
		fdflag: ppuint64(mvEXT2_FLAG_CHANGED),
		fdname: "EXT2_FLAG_CHANGED\x00",
	},
	2: {
		fdflag: ppuint64(mvEXT2_FLAG_DIRTY),
		fdname: "EXT2_FLAG_DIRTY\x00",
	},
	3: {
		fdflag: ppuint64(mvEXT2_FLAG_VALID),
		fdname: "EXT2_FLAG_VALID\x00",
	},
	4: {
		fdflag: ppuint64(mvEXT2_FLAG_IB_DIRTY),
		fdname: "EXT2_FLAG_IB_DIRTY\x00",
	},
	5: {
		fdflag: ppuint64(mvEXT2_FLAG_BB_DIRTY),
		fdname: "EXT2_FLAG_BB_DIRTY\x00",
	},
	6: {
		fdflag: ppuint64(mvEXT2_FLAG_SWAP_BYTES),
		fdname: "EXT2_FLAG_SWAP_BYTES\x00",
	},
	7: {
		fdflag: ppuint64(mvEXT2_FLAG_SWAP_BYTES_READ),
		fdname: "EXT2_FLAG_SWAP_BYTES_READ\x00",
	},
	8: {
		fdflag: ppuint64(mvEXT2_FLAG_SWAP_BYTES_WRITE),
		fdname: "EXT2_FLAG_SWAP_BYTES_WRITE\x00",
	},
	9: {
		fdflag: ppuint64(mvEXT2_FLAG_MASTER_SB_ONLY),
		fdname: "EXT2_FLAG_MASTER_SB_ONLY\x00",
	},
	10: {
		fdflag: ppuint64(mvEXT2_FLAG_FORCE),
		fdname: "EXT2_FLAG_FORCE\x00",
	},
	11: {
		fdflag: ppuint64(mvEXT2_FLAG_SUPER_ONLY),
		fdname: "EXT2_FLAG_SUPER_ONLY\x00",
	},
	12: {
		fdflag: ppuint64(mvEXT2_FLAG_JOURNAL_DEV_OK),
		fdname: "EXT2_FLAG_JOURNAL_DEV_OK\x00",
	},
	13: {
		fdflag: ppuint64(mvEXT2_FLAG_IMAGE_FILE),
		fdname: "EXT2_FLAG_IMAGE_FILE\x00",
	},
	14: {
		fdflag: ppuint64(mvEXT2_FLAG_EXCLUSIVE),
		fdname: "EXT2_FLAG_EXCLUSIVE\x00",
	},
	15: {
		fdflag: ppuint64(mvEXT2_FLAG_SOFTSUPP_FEATURES),
		fdname: "EXT2_FLAG_SOFTSUPP_FEATURES\x00",
	},
	16: {
		fdflag: ppuint64(mvEXT2_FLAG_NOFREE_ON_ERROR),
		fdname: "EXT2_FLAG_NOFREE_ON_ERROR\x00",
	},
	17: {
		fdflag: ppuint64(mvEXT2_FLAG_64BITS),
		fdname: "EXT2_FLAG_64BITS\x00",
	},
	18: {
		fdflag: ppuint64(mvEXT2_FLAG_PRINT_PROGRESS),
		fdname: "EXT2_FLAG_PRINT_PROGRESS\x00",
	},
	19: {
		fdflag: ppuint64(mvEXT2_FLAG_DIRECT_IO),
		fdname: "EXT2_FLAG_DIRECT_IO\x00",
	},
	20: {
		fdflag: ppuint64(mvEXT2_FLAG_SKIP_MMP),
		fdname: "EXT2_FLAG_SKIP_MMP\x00",
	},
	21: {
		fdflag: ppuint64(mvEXT2_FLAG_IGNORE_CSUM_ERRORS),
		fdname: "EXT2_FLAG_IGNORE_CSUM_ERRORS\x00",
	},
	22: {
		fdflag: ppuint64(mvEXT2_FLAG_SHARE_DUP),
		fdname: "EXT2_FLAG_SHARE_DUP\x00",
	},
	23: {
		fdflag: ppuint64(mvEXT2_FLAG_IGNORE_SB_ERRORS),
		fdname: "EXT2_FLAG_IGNORE_SB_ERRORS\x00",
	},
	24: {
		fdflag: ppuint64(mvEXT2_FLAG_BBITMAP_TAIL_PROBLEM),
		fdname: "EXT2_FLAG_BBITMAP_TAIL_PROBLEM\x00",
	},
	25: {
		fdflag: ppuint64(mvEXT2_FLAG_IBITMAP_TAIL_PROBLEM),
		fdname: "EXT2_FLAG_IBITMAP_TAIL_PROBLEM\x00",
	},
	26: {
		fdflag: ppuint64(mvEXT2_FLAG_THREADS),
		fdname: "EXT2_FLAG_THREADS\x00",
	},
	27: {},
}

func Xprint_fs_flags(cgtls *iqlibc.ppTLS, aaf ppuintptr, aaflags ppuint64) {

	var aafirst, aapos ppint32
	var aafp ppuintptr
	pp_, pp_, pp_ = aafirst, aafp, aapos
	aafirst = ppint32(1)
	aapos = ppint32(16)

	aafp = ppuintptr(iqunsafe.ppPointer(&siflags_array))
	for {
		if !((*tsflags_name)(iqunsafe.ppPointer(aafp)).fdflag != ppuint64(0)) {
			break
		}
		if aaflags&(*tsflags_name)(iqunsafe.ppPointer(aafp)).fdflag == ppuint64(0) {
			goto cg_1
		}

		aapos = iqlibc.ppInt32FromUint64(ppuint64(aapos) + (Xstrlen(cgtls, (*tsflags_name)(iqunsafe.ppPointer(aafp)).fdname) + iqlibc.ppUint64FromInt32(1)))
		if aapos > ppint32(72) {
			Xfputs(cgtls, "\n\t\x00", aaf)
			aapos = iqlibc.ppInt32FromUint64(ppuint64(9) + Xstrlen(cgtls, (*tsflags_name)(iqunsafe.ppPointer(aafp)).fdname))
		}
		if aafirst != 0 {
			aafirst = 0
		} else {
			Xfputc(cgtls, ppint32(' '), aaf)
		}
		Xfputs(cgtls, (*tsflags_name)(iqunsafe.ppPointer(aafp)).fdname, aaf)
