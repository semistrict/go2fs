...
var sitext = [32]ppuintptr{
	0:  "Profile version 0.0\x00",
	1:  "Bad magic value in profile_node\x00",
	2:  "Profile section not found\x00",
	3:  "Profile relation not found\x00",
	4:  "Attempt to add a relation to node which is not a section\x00",
	5:  "A profile section header has a non-zero value\x00",
	6:  "Bad linked list in profile structures\x00",
	7:  "Bad group level in profile structures\x00",
	8:  "Bad parent pointer in profile structures\x00",
	9:  "Bad magic value in profile iterator\x00",
	10: "Can't set value on section node\x00",
	11: "Invalid argument passed to profile library\x00",
	12: "Attempt to modify read-only profile\x00",
	13: "Profile section header not at top level\x00",
	14: "Syntax error in profile section header\x00",
	15: "Syntax error in profile relation\x00",
	16: "Extra closing brace in profile\x00",
	17: "Missing open brace in profile\x00",
	18: "Bad magic value in profile_t\x00",
	19: "Bad magic value in profile_section_t\x00",
	20: "Iteration through all top level section not supported\x00",
	21: "Invalid profile_section object\x00",
	22: "No more sections\x00",
	23: "Bad nameset passed to query routine\x00",
	24: "No profile file open\x00",
	25: "Bad magic value in profile_file_t\x00",
	26: "Couldn't open profile file\x00",
	27: "Section already exists\x00",
	28: "Invalid boolean value\x00",
	29: "Invalid integer value\x00",
	30: "Bad magic value in profile_file_data_t\x00",
}
...
var Xet_prof_error_table = tserror_table{
	fdmsgs:   ppuintptr(iqunsafe.ppPointer(&sitext)),
	fdbase:   -ppint64(1429577728),
	fdn_msgs: ppint32(31),
}

var silink = tset_list{}

func Xinitialize_prof_error_table(cgtls *iqlibc.ppTLS) {

	Xinitialize_prof_error_table_r(cgtls, ppuintptr(iqunsafe.ppPointer(&X_et_list)))
}

// C documentation
//
//	/* For Heimdal compatibility */
func Xinitialize_prof_error_table_r(cgtls *iqlibc.ppTLS, aalist ppuintptr) {
	...
	(*tset_list)(iqunsafe.ppPointer(aaet)).fdtable = ppuintptr(iqunsafe.ppPointer(&Xet_prof_error_table))
