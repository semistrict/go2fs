...
type tsprofile_string_list = struct {
	fdlist ppuintptr
	fdnum  ppint32
	fdmax  ppint32
}
...
//	 */
func siinit_list(cgtls *iqlibc.ppTLS, aalist ppuintptr) (cgr tnerrcode_t) {

	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdnum = 0
	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax = ppint32(10)
	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist = Xmalloc(cgtls, iqlibc.ppUint64FromInt32((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax)*ppuint64(8))
	if (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist == ppuintptr(0) {
		return ppint64(mvENOMEM)
	}
	*(*ppuintptr)(iqunsafe.ppPointer((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist)) = ppuintptr(0)
	return 0
}
...
//	 */
func siend_list(cgtls *iqlibc.ppTLS, aalist ppuintptr, aaret_list ppuintptr) {
	...
	if aaret_list != 0 {
		*(*ppuintptr)(iqunsafe.ppPointer(aaret_list)) = (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist
		return
	} else {
		aacp = (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist
		for {
		...
		Xfree(cgtls, (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist)
	}
	ccv2 = iqlibc.ppInt32FromInt32(0)
	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax = ccv2
	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdnum = ccv2
	(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist = ppuintptr(0)
}
...
//	 */
func siadd_to_list(cgtls *iqlibc.ppTLS, aalist ppuintptr, aastr ppuintptr) (cgr tnerrcode_t) {

	var aanewlist, ccv2 ppuintptr
	var aanewmax, ccv1 ppint32
	pp_, pp_, pp_, pp_ = aanewlist, aanewmax, ccv1, ccv2

	if (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdnum+ppint32(1) >= (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax {
		aanewmax = (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax + ppint32(10)
		aanewlist = Xrealloc(cgtls, (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist, iqlibc.ppUint64FromInt32(aanewmax)*ppuint64(8))
		if aanewlist == ppuintptr(0) {
			return ppint64(mvENOMEM)
		}
		(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdmax = aanewmax
		(*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist = aanewlist
	}

	ccv2 = aalist + 8
	ccv1 = *(*ppint32)(iqunsafe.ppPointer(ccv2))
	*(*ppint32)(iqunsafe.ppPointer(ccv2)) = *(*ppint32)(iqunsafe.ppPointer(ccv2)) + 1
	*(*ppuintptr)(iqunsafe.ppPointer((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist + ppuintptr(ccv1)*8)) = aastr
	*(*ppuintptr)(iqunsafe.ppPointer((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist + ppuintptr((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdnum)*8)) = ppuintptr(0)
	return 0
}
...
//	 */
func siis_list_member(cgtls *iqlibc.ppTLS, aalist ppuintptr, aastr ppuintptr) (cgr ppint32) {

	var aacpp ppuintptr
	pp_ = aacpp

	if !((*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist != 0) {
		return 0
	}

	aacpp = (*tsprofile_string_list)(iqunsafe.ppPointer(aalist)).fdlist
	for {
		if !(*(*ppuintptr)(iqunsafe.ppPointer(aacpp)) != 0) {
			break
		}
		if !(Xstrcmp(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(aacpp)), aastr) != 0) {
			return ppint32(1)
		}
...
//	 * profile_get_values.
//	 */
func Xprofile_free_list(cgtls *iqlibc.ppTLS, aalist ppuintptr) {
...
func Xprofile_get_values(cgtls *iqlibc.ppTLS, aaprofile tnprofile_t, aanames ppuintptr, aaret_values ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaretval, ccv1, ccv2, ccv3 tnerrcode_t
	var pp_ /* state at bp+0 */ ppuintptr
	var pp_ /* value at bp+8 */ ppuintptr
	var pp_ /* values at bp+16 */ tsprofile_string_list
	pp_, pp_, pp_, pp_ = aaretval, ccv1, ccv2, ccv3

	ccv1 = Xprofile_iterator_create(cgtls, aaprofile, aanames, ppint32(mvPROFILE_ITER_RELATIONS_ONLY), cgbp)
	aaretval = ccv1
	if ccv1 != 0 {
		return aaretval
	}

	ccv1 = siinit_list(cgtls, cgbp+16)
	aaretval = ccv1
	if ccv1 != 0 {
		goto ppcleanup_iterator
	}

	for cgcond := true; cgcond; cgcond = *(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0 {
		ccv1 = Xprofile_iterator(cgtls, cgbp, ppuintptr(0), cgbp+8)
		aaretval = ccv1
		if ccv1 != 0 {
			goto ppcleanup
		}
		if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) != 0 {
			siadd_to_list(cgtls, cgbp+16, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)))
		}
	}

	if (*(*tsprofile_string_list)(iqunsafe.ppPointer(cgbp + 16))).fdnum == 0 {
		aaretval = -iqlibc.ppInt64FromInt64(1429577725)
		goto ppcleanup
	}

	siend_list(cgtls, cgbp+16, aaret_values)
	return 0

	goto ppcleanup
ppcleanup:
	;
	siend_list(cgtls, cgbp+16, ppuintptr(0))
	goto ppcleanup_iterator
ppcleanup_iterator:
	;
...
//	 */
func Xprofile_get_subsection_names(cgtls *iqlibc.ppTLS, aaprofile tnprofile_t, aanames ppuintptr, aaret_names ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)

	var aaretval, ccv1, ccv2, ccv3 tnerrcode_t
	var pp_ /* name at bp+8 */ ppuintptr
	var pp_ /* state at bp+0 */ ppuintptr
	var pp_ /* values at bp+16 */ tsprofile_string_list
	pp_, pp_, pp_, pp_ = aaretval, ccv1, ccv2, ccv3

	ccv1 = Xprofile_iterator_create(cgtls, aaprofile, aanames, iqlibc.ppInt32FromInt32(mvPROFILE_ITER_LIST_SECTION)|iqlibc.ppInt32FromInt32(mvPROFILE_ITER_SECTIONS_ONLY), cgbp)
	aaretval = ccv1
	if ccv1 != 0 {
		return aaretval
	}
	...
	for cgcond := true; cgcond; cgcond = *(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0 {
		ccv1 = Xprofile_iterator(cgtls, cgbp, cgbp+8, ppuintptr(0))
		aaretval = ccv1
		if ccv1 != 0 {
			goto ppcleanup
		}
	...
	siend_list(cgtls, cgbp+16, aaret_names)
	return 0
...
//	 * under the specified section name.
//	 */
func Xprofile_get_relation_names(cgtls *iqlibc.ppTLS, aaprofile tnprofile_t, aanames ppuintptr, aaret_names ppuintptr) (cgr tnerrcode_t) {
	cgbp := cgtls.ppAlloc(32)
	defer cgtls.ppFree(32)
	...
	ccv1 = Xprofile_iterator_create(cgtls, aaprofile, aanames, iqlibc.ppInt32FromInt32(mvPROFILE_ITER_LIST_SECTION)|iqlibc.ppInt32FromInt32(mvPROFILE_ITER_RELATIONS_ONLY), cgbp)
	aaretval = ccv1
	if ccv1 != 0 {
		return aaretval
	}
	...
	for cgcond := true; cgcond; cgcond = *(*ppuintptr)(iqunsafe.ppPointer(cgbp)) != 0 {
		...
		if *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8)) != 0 {
			if siis_list_member(cgtls, cgbp+16, *(*ppuintptr)(iqunsafe.ppPointer(cgbp + 8))) != 0 {
...
func Xprofile_release_string(cgtls *iqlibc.ppTLS, aastr ppuintptr) {

	Xfree(cgtls, aastr)
}

func Xprofile_init_path(cgtls *iqlibc.ppTLS, aafilepath ppuintptr, aaret_profile ppuintptr) (cgr tnerrcode_t) {

	var aaent_len ppuint32
	var aafilenames, aas, aat, ccv3, ccv4 ppuintptr
	var aai, aan_entries, ccv6, ccv7 ppint32
	var aaretval tnerrcode_t
	var ccv5 ppbool
	pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_, pp_ = aaent_len, aafilenames, aai, aan_entries, aaretval, aas, aat, ccv3, ccv4, ccv5, ccv6, ccv7

	/* count the distinct filename components */
	aas = aafilepath
	aan_entries = iqlibc.ppInt32FromInt32(1)
	for {
		if !(*(*ppint8)(iqunsafe.ppPointer(aas)) != 0) {
			break
		}
		if ppint32(*(*ppint8)(iqunsafe.ppPointer(aas))) == ppint32(':') {
			aan_entries = aan_entries + 1
		}
	...
	aafilenames = Xmalloc(cgtls, iqlibc.ppUint64FromInt32(aan_entries+iqlibc.ppInt32FromInt32(1))*ppuint64(8))
	if aafilenames == ppuintptr(0) {
		return ppint64(mvENOMEM)
	}
	...
	for {
		ccv3 = Xstrchr(cgtls, aas, ppint32(':'))
		aat = ccv3
		if ccv5 = ccv3 != 0; !ccv5 {
			ccv4 = aas + ppuintptr(Xstrlen(cgtls, aas))
			aat = ccv4
		}
		if !(ccv5 || ccv4 != 0) {
			break
		}
		aaent_len = iqlibc.ppUint32FromInt64(ppint64(aat) - ppint64(aas))
		*(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)) = Xmalloc(cgtls, ppuint64(aaent_len+ppuint32(1)))
		if *(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)) == ppuintptr(0) {
			...
			for {
				...
				Xfree(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)))
			}
			Xfree(cgtls, aafilenames)
			return ppint64(mvENOMEM)
		}
		Xstrncpy(cgtls, *(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)), aas, ppuint64(aaent_len))
		*(*ppint8)(iqunsafe.ppPointer(*(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)) + ppuintptr(aaent_len))) = 0
		if ppint32(*(*ppint8)(iqunsafe.ppPointer(aat))) == 0 {
			aai = aai + 1
			break
		}
	...
	/* cap the array */
	*(*ppuintptr)(iqunsafe.ppPointer(aafilenames + ppuintptr(aai)*8)) = ppuintptr(0)

	aaretval = Xprofile_init(cgtls, aafilenames, aaret_profile)
...
func _profile_init(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint64

func _profile_iterator(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint64

func _profile_iterator_create(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppint32, ppuintptr) ppint64

func _profile_iterator_free(*iqlibc.ppTLS, ppuintptr)
