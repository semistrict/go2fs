...
const mvDICTCOUNT_T_MAX = "ULONG_MAX"
const mvDICT_DEPTH_MAX = 64
...
const mvallocnode = "dict_allocnode"
const mvcolor = "dict_color"
const mvcompare = "dict_compare"
const mvcontext = "dict_context"
const mvdata = "dict_data"
const mvdictptr = "dict_dictptr"
const mvdupes = "dict_dupes"
const mvfreenode = "dict_freenode"
const mvkey = "dict_key"
const mvleft = "dict_left"
const mvmaxcount = "dict_maxcount"
const mvnilnode = "dict_nilnode"
const mvnodecount = "dict_nodecount"
const mvparent = "dict_parent"
const mvright = "dict_right"
...
type tndictcount_t = ppuint64

type tndnode_color_t = ppint32

const ecdnode_red = 0
const ecdnode_black = 1

type tndnode_t = struct {
	fddict_left   ppuintptr
	fddict_right  ppuintptr
	fddict_parent ppuintptr
	fddict_color  tndnode_color_t
	fddict_key    ppuintptr
	fddict_data   ppuintptr
}

type tndict_comp_t = ppuintptr

type tndnode_alloc_t = ppuintptr

type tndnode_free_t = ppuintptr

type tndict_t = struct {
	fddict_nilnode   tndnode_t
	fddict_nodecount tndictcount_t
	fddict_maxcount  tndictcount_t
	fddict_compare   tndict_comp_t
	fddict_allocnode tndnode_alloc_t
	fddict_freenode  tndnode_free_t
	fddict_context   ppuintptr
	fdcmp_ctx        ppuintptr
	fddict_dupes     ppint32
}

type tndnode_process_t = ppuintptr

type tndict_load_t = struct {
	fddict_dictptr ppuintptr
	fddict_nilnode tndnode_t
}
...
func sirotate_left(cgtls *iqlibc.ppTLS, aaupper ppuintptr) {

	var aalower, aalowleft, aaupparent, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aalower, aalowleft, aaupparent, ccv1, ccv2

	aalower = (*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_right
	ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_left
	aalowleft = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_right = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aalowleft)).fddict_parent = aaupper

	ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_parent
	aaupparent = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_parent = ccv1

	/* don't need to check for root node here because root->parent is
	   the sentinel nil node, and root->parent->left points back to root */

	if aaupper == (*tndnode_t)(iqunsafe.ppPointer(aaupparent)).fddict_left {
		(*tndnode_t)(iqunsafe.ppPointer(aaupparent)).fddict_left = aalower
	} else {

		(*tndnode_t)(iqunsafe.ppPointer(aaupparent)).fddict_right = aalower
	}

	(*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_left = aaupper
	(*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_parent = aalower
}
...
func sirotate_right(cgtls *iqlibc.ppTLS, aaupper ppuintptr) {

	var aalower, aalowright, aaupparent, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aalower, aalowright, aaupparent, ccv1, ccv2

	aalower = (*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_left
	ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_right
	aalowright = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_left = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aalowright)).fddict_parent = aaupper

	ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_parent
	aaupparent = ccv1
	(*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_parent = ccv1

	if aaupper == (*tndnode_t)(iqunsafe.ppPointer(aaupparent)).fddict_right {
		(*tndnode_t)(iqunsafe.ppPointer(aaupparent)).fddict_right = aalower
	} else {
	...
	(*tndnode_t)(iqunsafe.ppPointer(aalower)).fddict_right = aaupper
	(*tndnode_t)(iqunsafe.ppPointer(aaupper)).fddict_parent = aalower
}
...
func sifree_nodes(cgtls *iqlibc.ppTLS, aadict ppuintptr, aanode ppuintptr, aanil ppuintptr) {

	if aanode == aanil {
		return
	}
	sifree_nodes(cgtls, aadict, (*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_left, aanil)
	sifree_nodes(cgtls, aadict, (*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_right, aanil)
	(*(*func(*iqlibc.ppTLS, ppuintptr, ppuintptr))(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_freenode})))(cgtls, aanode, (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_context)
}
...
func siverify_dict_has_node(cgtls *iqlibc.ppTLS, aanil ppuintptr, aaroot ppuintptr, aanode ppuintptr) (cgr ppint32) {

	if aaroot != aanil {
		return iqlibc.ppBoolInt32(aaroot == aanode || siverify_dict_has_node(cgtls, aanil, (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_left, aanode) != 0 || siverify_dict_has_node(cgtls, aanil, (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_right, aanode) != 0)
	}
	return 0
}

type tn__ccgo_fp__Xdict_set_allocator_1 = func(*iqlibc.ppTLS, ppuintptr) ppuintptr

type tn__ccgo_fp__Xdict_set_allocator_2 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr)

/*
 * Select a different set of node allocator routines.
 */

func Xdict_set_allocator(cgtls *iqlibc.ppTLS, aadict ppuintptr, aa__ccgo_fp_al tndnode_alloc_t, aa__ccgo_fp_fr tndnode_free_t, aadict_context ppuintptr) {

	var ccv1 tndnode_alloc_t
	var ccv2 tndnode_free_t
	pp_, pp_ = ccv1, ccv2

	if aa__ccgo_fp_al != 0 {
		ccv1 = aa__ccgo_fp_al
	} else {
		ccv1 = pp__ccgo_fp(sidnode_alloc)
	}
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_allocnode = ccv1
	if aa__ccgo_fp_fr != 0 {
		ccv2 = aa__ccgo_fp_fr
	} else {
		ccv2 = pp__ccgo_fp(sidnode_free)
	}
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_freenode = ccv2
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_context = aadict_context
}

func Xdict_set_cmp_context(cgtls *iqlibc.ppTLS, aadict ppuintptr, aacmp_ctx ppuintptr) {

	(*tndict_t)(iqunsafe.ppPointer(aadict)).fdcmp_ctx = aacmp_ctx
}
...
func Xdict_free_nodes(cgtls *iqlibc.ppTLS, aadict ppuintptr) {

	var aanil, aaroot ppuintptr
	pp_, pp_ = aanil, aaroot
	aanil = aadict
	aaroot = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left
	sifree_nodes(cgtls, aadict, aaroot, aanil)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount = ppuint64(0)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left = aadict
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_right = aadict
}

type tn__ccgo_fp__Xdict_init_2 = func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32

/*
 * Initialize a user-supplied dictionary object.
 */

func Xdict_init(cgtls *iqlibc.ppTLS, aadict ppuintptr, aadict_maxcount tndictcount_t, aa__ccgo_fp_comp tndict_comp_t) (cgr ppuintptr) {

	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_compare = aa__ccgo_fp_comp
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_allocnode = pp__ccgo_fp(sidnode_alloc)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_freenode = pp__ccgo_fp(sidnode_free)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_context = iqlibc.ppUintptrFromInt32(0)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount = ppuint64(0)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_maxcount = aadict_maxcount
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left = aadict
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_right = aadict
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_parent = aadict
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_color = ppint32(ecdnode_black)
	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_dupes = 0
	return aadict
}
...
func Xdict_lookup(cgtls *iqlibc.ppTLS, aadict ppuintptr, aadict_key ppuintptr) (cgr ppuintptr) {

	var aanil, aaroot, aasaved ppuintptr
	var aaresult ppint32
	pp_, pp_, pp_, pp_ = aanil, aaresult, aaroot, aasaved
	aaroot = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left
	aanil = aadict
	...
	for aaroot != aanil {
		aaresult = (*(*func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_compare})))(cgtls, (*tndict_t)(iqunsafe.ppPointer(aadict)).fdcmp_ctx, aadict_key, (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_key)
		if aaresult < 0 {
			aaroot = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_left
		} else {
			if aaresult > 0 {
				aaroot = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_right
			} else {
				if !((*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_dupes != 0) { /* no duplicates, return match		*/
					return aaroot
				} else { /* could be dupes, find leftmost one	*/
					for cgcond := true; cgcond; cgcond = aaroot != aanil {
						aasaved = aaroot
						aaroot = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_left
						for aaroot != aanil && (*(*func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_compare})))(cgtls, (*tndict_t)(iqunsafe.ppPointer(aadict)).fdcmp_ctx, aadict_key, (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_key) != 0 {
							aaroot = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_right
						}
					}
					return aasaved
...
func Xdict_insert(cgtls *iqlibc.ppTLS, aadict ppuintptr, aanode ppuintptr, aadict_key ppuintptr) {

	var aadict_parent, aagrandpa, aanil, aauncle, aawhere ppuintptr
	var aaresult ppint32
	pp_, pp_, pp_, pp_, pp_, pp_ = aadict_parent, aagrandpa, aanil, aaresult, aauncle, aawhere
	aawhere = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left
	aanil = aadict
	aadict_parent = aanil
	aaresult = -ppint32(1)

	(*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_key = aadict_key

	/* basic binary tree insert */

	for aawhere != aanil {
		aadict_parent = aawhere
		aaresult = (*(*func(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_compare})))(cgtls, (*tndict_t)(iqunsafe.ppPointer(aadict)).fdcmp_ctx, aadict_key, (*tndnode_t)(iqunsafe.ppPointer(aawhere)).fddict_key)
		/* trap attempts at duplicate key insertion unless it's explicitly allowed */

		if aaresult < 0 {
			aawhere = (*tndnode_t)(iqunsafe.ppPointer(aawhere)).fddict_left
		} else {
			aawhere = (*tndnode_t)(iqunsafe.ppPointer(aawhere)).fddict_right
		}
	}

	if aaresult < 0 {
		(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_left = aanode
	} else {
		(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_right = aanode
	}

	(*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_parent = aadict_parent
	(*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_left = aanil
	(*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_right = aanil

	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount + 1

	/* red black adjustments */

	(*tndnode_t)(iqunsafe.ppPointer(aanode)).fddict_color = ppint32(ecdnode_red)

	for (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_color == ppint32(ecdnode_red) {
		aagrandpa = (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_parent
		if aadict_parent == (*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_left {
			aauncle = (*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_right
			if (*tndnode_t)(iqunsafe.ppPointer(aauncle)).fddict_color == ppint32(ecdnode_red) { /* red parent, red uncle */
				(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aauncle)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_color = ppint32(ecdnode_red)
				aanode = aagrandpa
				aadict_parent = (*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_parent
			} else { /* red parent, black uncle */
				if aanode == (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_right {
					sirotate_left(cgtls, aadict_parent)
					aadict_parent = aanode

					/* rotation between parent and child preserves grandpa */
				}
				(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_color = ppint32(ecdnode_red)
				sirotate_right(cgtls, aagrandpa)
				break
			}
		} else { /* symmetric cases: parent == parent->parent->right */
			aauncle = (*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_left
			if (*tndnode_t)(iqunsafe.ppPointer(aauncle)).fddict_color == ppint32(ecdnode_red) {
				(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aauncle)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_color = ppint32(ecdnode_red)
				aanode = aagrandpa
				...
				if aanode == (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_left {
					sirotate_right(cgtls, aadict_parent)
					aadict_parent = aanode

				}
				(*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_color = ppint32(ecdnode_black)
				(*tndnode_t)(iqunsafe.ppPointer(aagrandpa)).fddict_color = ppint32(ecdnode_red)
				sirotate_left(cgtls, aagrandpa)
				break
			}
		}
	}

	(*tsdnode_t)(iqunsafe.ppPointer((*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left)).fddict_color = ppint32(ecdnode_black)
...
func Xdict_alloc_insert(cgtls *iqlibc.ppTLS, aadict ppuintptr, aadict_key ppuintptr, aadict_data ppuintptr) (cgr ppint32) {

	var aanode ppuintptr
	pp_ = aanode
	aanode = (*(*func(*iqlibc.ppTLS, ppuintptr) ppuintptr)(iqunsafe.ppPointer(&struct{ ppuintptr }{(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_allocnode})))(cgtls, (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_context)

	if aanode != 0 {
		Xdnode_init(cgtls, aanode, aadict_data)
		Xdict_insert(cgtls, aadict, aanode, aadict_key)
		return ppint32(1)
	}
	return 0
}
...
func Xdict_first(cgtls *iqlibc.ppTLS, aadict ppuintptr) (cgr ppuintptr) {

	var aadict_left, aanil, aaroot, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aadict_left, aanil, aaroot, ccv1, ccv2
	aanil = aadict
	aaroot = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left

	if aaroot != aanil {
		for {
			ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_left
			aadict_left = ccv1
			if !(ccv1 != aanil) {
				break
			}
	...
	if aaroot == aanil {
		ccv1 = iqlibc.ppUintptrFromInt32(0)
	} else {
		ccv1 = aaroot
	}
	return ccv1
...
func Xdict_last(cgtls *iqlibc.ppTLS, aadict ppuintptr) (cgr ppuintptr) {

	var aadict_right, aanil, aaroot, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aadict_right, aanil, aaroot, ccv1, ccv2
	aanil = aadict
	aaroot = (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left

	if aaroot != aanil {
		for {
			ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aaroot)).fddict_right
			aadict_right = ccv1
			if !(ccv1 != aanil) {
				break
			}
...
func Xdict_next(cgtls *iqlibc.ppTLS, aadict ppuintptr, aacurr ppuintptr) (cgr ppuintptr) {

	var aadict_left, aadict_parent, aanil, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aadict_left, aadict_parent, aanil, ccv1, ccv2
	aanil = aadict

	if (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_right != aanil {
		aacurr = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_right
		for {
			ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_left
			aadict_left = ccv1
			if !(ccv1 != aanil) {
				break
			}
	...
	aadict_parent = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_parent

	for aadict_parent != aanil && aacurr == (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_right {
		aacurr = aadict_parent
		aadict_parent = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_parent
	}

	if aadict_parent == aanil {
		ccv1 = iqlibc.ppUintptrFromInt32(0)
	} else {
		ccv1 = aadict_parent
	}
...
func Xdict_prev(cgtls *iqlibc.ppTLS, aadict ppuintptr, aacurr ppuintptr) (cgr ppuintptr) {

	var aadict_parent, aadict_right, aanil, ccv1, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aadict_parent, aadict_right, aanil, ccv1, ccv2
	aanil = aadict

	if (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_left != aanil {
		aacurr = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_left
		for {
			ccv1 = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_right
			aadict_right = ccv1
			if !(ccv1 != aanil) {
				break
			}
	...
	for aadict_parent != aanil && aacurr == (*tndnode_t)(iqunsafe.ppPointer(aadict_parent)).fddict_left {
		aacurr = aadict_parent
		aadict_parent = (*tndnode_t)(iqunsafe.ppPointer(aacurr)).fddict_parent
	}
...
func Xdict_allow_dupes(cgtls *iqlibc.ppTLS, aadict ppuintptr) {

	(*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_dupes = ppint32(1)
}

func Xdict_count(cgtls *iqlibc.ppTLS, aadict ppuintptr) (cgr tndictcount_t) {

	return (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount
}

func Xdict_isempty(cgtls *iqlibc.ppTLS, aadict ppuintptr) (cgr ppint32) {

	return iqlibc.ppBoolInt32((*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount == ppuint64(0))
}

func Xdict_isfull(cgtls *iqlibc.ppTLS, aadict ppuintptr) (cgr ppint32) {

	return iqlibc.ppBoolInt32((*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nodecount == (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_maxcount)
}

func Xdict_contains(cgtls *iqlibc.ppTLS, aadict ppuintptr, aanode ppuintptr) (cgr ppint32) {

	return siverify_dict_has_node(cgtls, aadict, (*tndict_t)(iqunsafe.ppPointer(aadict)).fddict_nilnode.fddict_left, aanode)
}

func sidnode_alloc(cgtls *iqlibc.ppTLS, aadict_context ppuintptr) (cgr ppuintptr) {

	return Xmalloc(cgtls, ppuint64(48))
}

func sidnode_free(cgtls *iqlibc.ppTLS, aanode ppuintptr, aadict_context ppuintptr) {

	Xfree(cgtls, aanode)
}

func Xdnode_create(cgtls *iqlibc.ppTLS, aadict_data ppuintptr) (cgr ppuintptr) {

	var aanew ppuintptr
	pp_ = aanew
	aanew = Xmalloc(cgtls, ppuint64(48))
	if aanew != 0 {
		(*tndnode_t)(iqunsafe.ppPointer(aanew)).fddict_data = aadict_data
		(*tndnode_t)(iqunsafe.ppPointer(aanew)).fddict_parent = iqlibc.ppUintptrFromInt32(0)
		(*tndnode_t)(iqunsafe.ppPointer(aanew)).fddict_left = iqlibc.ppUintptrFromInt32(0)
		(*tndnode_t)(iqunsafe.ppPointer(aanew)).fddict_right = iqlibc.ppUintptrFromInt32(0)
	}
	return aanew
}

func Xdnode_init(cgtls *iqlibc.ppTLS, aadnode ppuintptr, aadict_data ppuintptr) (cgr ppuintptr) {

	(*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_data = aadict_data
	(*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_parent = iqlibc.ppUintptrFromInt32(0)
	(*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_left = iqlibc.ppUintptrFromInt32(0)
	(*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_right = iqlibc.ppUintptrFromInt32(0)
	return aadnode
}

func Xdnode_destroy(cgtls *iqlibc.ppTLS, aadnode ppuintptr) {

	Xfree(cgtls, aadnode)
}

func Xdnode_get(cgtls *iqlibc.ppTLS, aadnode ppuintptr) (cgr ppuintptr) {

	return (*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_data
}

func Xdnode_getkey(cgtls *iqlibc.ppTLS, aadnode ppuintptr) (cgr ppuintptr) {

	return (*tndnode_t)(iqunsafe.ppPointer(aadnode)).fddict_key
}

type tsdnode_t = struct {
	fddict_left   ppuintptr
	fddict_right  ppuintptr
	fddict_parent ppuintptr
	fddict_color  tndnode_color_t
