...
func Xcom_right(cgtls *iqlibc.ppTLS, aalist ppuintptr, aacode ppint64) (cgr ppuintptr) {
	...
	for {
		...
		if aacode >= (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase && aacode < (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase+ppint64((*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdn_msgs) {
			return *(*ppuintptr)(iqunsafe.ppPointer((*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdmsgs + ppuintptr(aacode-(*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase)*8))
		}

		goto cg_1
	cg_1:
		;
		aap = (*tset_list)(iqunsafe.ppPointer(aap)).fdnext
	}
	return iqlibc.ppUintptrFromInt32(0)
}

func Xcom_right_r(cgtls *iqlibc.ppTLS, aalist ppuintptr, aacode ppint64, aastr ppuintptr, aalen tnsize_t) (cgr ppuintptr) {
	...
	for {
		...
		if aacode >= (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase && aacode < (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase+ppint64((*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdn_msgs) {
			Xstrncpy(cgtls, aastr, *(*ppuintptr)(iqunsafe.ppPointer((*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdmsgs + ppuintptr(aacode-(*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aap)).fdtable)).fdbase)*8)), aalen)
			*(*ppint8)(iqunsafe.ppPointer(aastr + ppuintptr(aalen-ppuint64(1)))) = ppint8('\000')
			return aastr
		}
...
//	 */
func Xinitialize_error_table_r(cgtls *iqlibc.ppTLS, aalist ppuintptr, aamessages ppuintptr, aanum_errors ppint32, aabase ppint64) {

	var aaend, aaet, aaf, aatab, ccv2 ppuintptr
	pp_, pp_, pp_, pp_, pp_ = aaend, aaet, aaf, aatab, ccv2
	...
	for {
		...
		if (*tserror_table)(iqunsafe.ppPointer((*tset_list)(iqunsafe.ppPointer(aaet)).fdtable)).fdmsgs == aamessages {
			return
		}
		goto cg_1
	cg_1:
	...
	ccv2 = aaf + 16
	aatab = ccv2
	(*tset_list)(iqunsafe.ppPointer(aaet)).fdtable = ccv2
	(*tserror_table)(iqunsafe.ppPointer(aatab)).fdmsgs = aamessages
	(*tserror_table)(iqunsafe.ppPointer(aatab)).fdn_msgs = aanum_errors
	(*tserror_table)(iqunsafe.ppPointer(aatab)).fdbase = aabase
	(*tset_list)(iqunsafe.ppPointer(aaet)).fdnext = iqlibc.ppUintptrFromInt32(0)
	*(*ppuintptr)(iqunsafe.ppPointer(aaend)) = aaet
}

func Xfree_error_table(cgtls *iqlibc.ppTLS, aaet ppuintptr) {
