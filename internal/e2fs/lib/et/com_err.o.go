...
const mvALTWERASE = 0x00000200
const mvB0 = 0
const mvB110 = 110
const mvB115200 = 115200
const mvB1200 = 1200
const mvB134 = 134
const mvB14400 = 14400
const mvB150 = 150
const mvB1800 = 1800
const mvB19200 = 19200
const mvB200 = 200
const mvB230400 = 230400
const mvB2400 = 2400
const mvB28800 = 28800
const mvB300 = 300
const mvB38400 = 38400
const mvB4800 = 4800
const mvB50 = 50
const mvB57600 = 57600
const mvB600 = 600
const mvB7200 = 7200
const mvB75 = 75
const mvB76800 = 76800
const mvB9600 = 9600
const mvBITS_PER_CHAR = 6
const mvBRKINT = 0x00000002
const mvBS0 = 0x00000000
const mvBS1 = 0x00008000
const mvBSDLY = 0x00008000
const mvBUFSIZ = 1024
const mvCBRK = "CEOL"
const mvCCAR_OFLOW = 0x00100000
const mvCCTS_OFLOW = 0x00010000
const mvCDSR_OFLOW = 0x00080000
const mvCDTR_IFLOW = 0x00040000
const mvCEOL = 0xff
const mvCEOT = "CEOF"
const mvCERASE = 0177
const mvCFLUSH = "CDISCARD"
const mvCIGNORE = 0x00000001
const mvCLOCAL = 0x00008000
const mvCMIN = 1
...
const mvCQUIT = 034
const mvCR0 = 0x00000000
const mvCR1 = 0x00001000
const mvCR2 = 0x00002000
const mvCR3 = 0x00003000
const mvCRDLY = 0x00003000
const mvCREAD = 0x00000800
const mvCRPRNT = "CREPRINT"
const mvCRTS_IFLOW = 0x00020000
const mvCS5 = 0x00000000
const mvCS6 = 0x00000100
const mvCS7 = 0x00000200
const mvCS8 = 0x00000300
const mvCSIZE = 0x00000300
const mvCSTOPB = 0x00000400
const mvCTIME = 0
const mvE2BIG = 7
const mvEACCES = 13
...
const mvECHILD = 10
const mvECHO = 0x00000008
const mvECHOCTL = 0x00000040
const mvECHOE = 0x00000002
const mvECHOK = 0x00000004
const mvECHOKE = 0x00000001
const mvECHONL = 0x00000010
const mvECHOPRT = 0x00000020
...
const mvEXTA = 19200
const mvEXTB = 38400
const mvEXTPROC = 0x00000800
const mvFD_SETSIZE = "__DARWIN_FD_SETSIZE"
const mvFF0 = 0x00000000
const mvFF1 = 0x00004000
const mvFFDLY = 0x00004000
const mvFILENAME_MAX = 1024
const mvFLUSHO = 0x00800000
...
const mvHUPCL = 0x00004000
const mvICANON = 0x00000100
const mvICRNL = 0x00000100
const mvIEXTEN = 0x00000400
const mvIGNBRK = 0x00000001
const mvIGNCR = 0x00000080
const mvIGNPAR = 0x00000004
const mvIMAXBEL = 0x00002000
const mvINLCR = 0x00000040
const mvINPCK = 0x00000010
const mvIOCPARM_MASK = 0x1fff
const mvISIG = 0x00000080
const mvISTRIP = 0x00000020
const mvIUTF8 = 0x00004000
const mvIXANY = 0x00000800
const mvIXOFF = 0x00000400
const mvIXON = 0x00000200
...
const mvMDMBUF = 0x00100000
const mvNCCS = 20
const mvNL0 = 0x00000000
const mvNL1 = 0x00000100
const mvNL2 = 0x00000200
const mvNL3 = 0x00000300
const mvNLDLY = 0x00000300
const mvNOFLSH = 0x80000000
const mvNOKERNINFO = 0x02000000
const mvOCRNL = 0x00000010
const mvOFDEL = 0x00020000
const mvOFILL = 0x00000080
const mvONLCR = 2
const mvONLRET = 0x00000040
const mvONOCR = 0x00000020
const mvONOEOT = 0x00000008
const mvOPOST = 1
const mvOXTABS = 0x00000004
...
const mvPARENB = 0x00001000
const mvPARMRK = 0x00000008
const mvPARODD = 0x00002000
const mvPENDIN = 0x20000000
const mvPPPDISC = 5
...
const mvTAB0 = 0x00000000
const mvTAB1 = 0x00000400
const mvTAB2 = 0x00000800
const mvTAB3 = 0x00000004
const mvTABDLY = 0x00000c04
const mvTABLDISC = 3
...
const mvTOSTOP = 0x00400000
const mvTTYDEF_SPEED = "B9600"
const mvTTYDISC = 0
const mvVDISCARD = 15
const mvVDSUSP = 11
const mvVEOF = 0
...
const mvVSTOP = 13
const mvVSUSP = 10
const mvVT0 = 0x00000000
const mvVT1 = 0x00010000
const mvVTDLY = 0x00010000
const mvVTIME = 17
const mvVWERASE = 4
...
type tntcflag_t = ppuint64

type tncc_t = ppuint8

type tnspeed_t = ppuint64

type tstermios = struct {
	fdc_iflag  tntcflag_t
	fdc_oflag  tntcflag_t
	fdc_cflag  tntcflag_t
	fdc_lflag  tntcflag_t
	fdc_cc     [20]tncc_t
	fdc_ispeed tnspeed_t
	fdc_ospeed tnspeed_t
}
...
func sidefault_com_err_proc(cgtls *iqlibc.ppTLS, aawhoami ppuintptr, aacode tnerrcode_t, aafmt ppuintptr, aaargs tnva_list) {
	cgbp := cgtls.ppAlloc(80)
	defer cgtls.ppFree(80)

	var aado_cr, aafd ppint32
	var pp_ /* t at bp+0 */ tstermios
	pp_, pp_ = aado_cr, aafd
	aado_cr = ppint32(1)
	aafd = Xfileno(cgtls, X__stderrp)

	if aawhoami != 0 {
		Xfputs(cgtls, aawhoami, X__stderrp)
		Xfputs(cgtls, ": \x00", X__stderrp)
	}
	if aacode != 0 {
		Xfputs(cgtls, Xerror_message(cgtls, aacode), X__stderrp)
		Xfputs(cgtls, " \x00", X__stderrp)
	}
	if aafmt != 0 {
		Xvfprintf(cgtls, X__stderrp, aafmt, aaargs)
	}
	if !(Xisatty(cgtls, aafd) != 0) {
		aado_cr = 0
	} else {

		if Xtcgetattr(cgtls, aafd, cgbp) == 0 && (*(*tstermios)(iqunsafe.ppPointer(cgbp))).fdc_oflag&ppuint64(mvOPOST) != 0 && (*(*tstermios)(iqunsafe.ppPointer(cgbp))).fdc_oflag&ppuint64(mvONLCR) != 0 {
			aado_cr = 0
		}
	}
	if aado_cr != 0 {
		Xfputc(cgtls, ppint32('\r'), X__stderrp)
	}
	Xfputc(cgtls, ppint32('\n'), X__stderrp)
	Xfflush(cgtls, X__stderrp)
}

type tnerrf = ppuintptr

var Xcom_err_hook = ppuintptr(0)

func init() {
	p := iqunsafe.ppPointer(&Xcom_err_hook)
	*(*uintptr)(iqunsafe.ppAdd(p, 0)) = pp__ccgo_fp(sidefault_com_err_proc)
}

func Xcom_err_va(cgtls *iqlibc.ppTLS, aawhoami ppuintptr, aacode tnerrcode_t, aafmt ppuintptr, aaargs tnva_list) {

	(*(*func(*iqlibc.ppTLS, ppuintptr, ppint64, ppuintptr, tnva_list))(iqunsafe.ppPointer(&struct{ ppuintptr }{Xcom_err_hook})))(cgtls, aawhoami, aacode, aafmt, aaargs)
}

func Xcom_err(cgtls *iqlibc.ppTLS, aawhoami ppuintptr, aacode tnerrcode_t, aafmt ppuintptr, cgva ppuintptr) {

	var aapvar tnva_list
	pp_ = aapvar

	if !(Xcom_err_hook != 0) {
		Xcom_err_hook = pp__ccgo_fp(sidefault_com_err_proc)
	}
	aapvar = cgva
	Xcom_err_va(cgtls, aawhoami, aacode, aafmt, aapvar)
	pp_ = aapvar
}

type tn__ccgo_fp__Xset_com_err_hook_0 = func(*iqlibc.ppTLS, ppuintptr, ppint64, ppuintptr, ppuintptr)

func Xset_com_err_hook(cgtls *iqlibc.ppTLS, aa__ccgo_fp_new_proc tnerrf) (cgr tnerrf) {

	var aax tnerrf
	pp_ = aax
	aax = Xcom_err_hook

	if aa__ccgo_fp_new_proc != 0 {
		Xcom_err_hook = aa__ccgo_fp_new_proc
	} else {
		Xcom_err_hook = pp__ccgo_fp(sidefault_com_err_proc)
	}
...
func Xreset_com_err_hook(cgtls *iqlibc.ppTLS) (cgr tnerrf) {
...
func _error_message(*iqlibc.ppTLS, ppint64) ppuintptr

func _fflush(*iqlibc.ppTLS, ppuintptr) ppint32

func _fileno(*iqlibc.ppTLS, ppuintptr) ppint32

func _fputc(*iqlibc.ppTLS, ppint32, ppuintptr) ppint32

func _fputs(*iqlibc.ppTLS, ppuintptr, ppuintptr) ppint32

func _isatty(*iqlibc.ppTLS, ppint32) ppint32

func _tcgetattr(*iqlibc.ppTLS, ppint32, ppuintptr) ppint32

func _vfprintf(*iqlibc.ppTLS, ppuintptr, ppuintptr, ppuintptr) ppint32
